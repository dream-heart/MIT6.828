	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 71 11 80 00 	movsbl 0x801171(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80032f:	ff 24 95 c0 12 80 00 	jmp    *0x8012c0(,%edx,4)
  ...
  80040b:	c7 44 24 08 92 11 80 	movl   $0x801192,0x8(%esp)
  800412:	00 
  ...
  80043b:	b8 82 11 80 00       	mov    $0x801182,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b80:	00 
  800b81:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800b88:	00 
  800b89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b90:	00 
  800b91:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c12:	00 
  800c13:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800c1a:	00 
  800c1b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c22:	00 
  800c23:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c65:	00 
  800c66:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800c6d:	00 
  800c6e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c75:	00 
  800c76:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cb8:	00 
  800cb9:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800cc0:	00 
  800cc1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc8:	00 
  800cc9:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d0b:	00 
  800d0c:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800d13:	00 
  800d14:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d1b:	00 
  800d1c:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d5e:	00 
  800d5f:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800d66:	00 
  800d67:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d6e:	00 
  800d6f:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800db1:	00 
  800db2:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800db9:	00 
  800dba:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dc1:	00 
  800dc2:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e26:	00 
  800e27:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800e2e:	00 
  800e2f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e36:	00 
  800e37:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e8d:	e8 5c f2 ff ff       	call   8000ee <vcprintf>
	cprintf("\n");
  800e92:	c7 04 24 d0 14 80 00 	movl   $0x8014d0,(%esp)
