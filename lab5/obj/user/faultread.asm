...
umain(int argc, char **argv)
{
  ...
  800042:	c7 04 24 40 11 80 00 	movl   $0x801140,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001df:	e8 cc 0c 00 00       	call   800eb0 <__udivdi3>
  ...
  80023f:	e8 9c 0d 00 00       	call   800fe0 <__umoddi3>
  800244:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800248:	0f be 80 68 11 80 00 	movsbl 0x801168(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80032f:	ff 24 95 a0 12 80 00 	jmp    *0x8012a0(,%edx,4)
  ...
  80040b:	c7 44 24 08 89 11 80 	movl   $0x801189,0x8(%esp)
  800412:	00 
  ...
  80043b:	b8 79 11 80 00       	mov    $0x801179,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b80:	00 
  800b81:	c7 44 24 08 5f 14 80 	movl   $0x80145f,0x8(%esp)
  800b88:	00 
  800b89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b90:	00 
  800b91:	c7 04 24 7c 14 80 00 	movl   $0x80147c,(%esp)
  800b98:	e8 ae 02 00 00       	call   800e4b <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c12:	00 
  800c13:	c7 44 24 08 5f 14 80 	movl   $0x80145f,0x8(%esp)
  800c1a:	00 
  800c1b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c22:	00 
  800c23:	c7 04 24 7c 14 80 00 	movl   $0x80147c,(%esp)
  800c2a:	e8 1c 02 00 00       	call   800e4b <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c65:	00 
  800c66:	c7 44 24 08 5f 14 80 	movl   $0x80145f,0x8(%esp)
  800c6d:	00 
  800c6e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c75:	00 
  800c76:	c7 04 24 7c 14 80 00 	movl   $0x80147c,(%esp)
  800c7d:	e8 c9 01 00 00       	call   800e4b <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cb8:	00 
  800cb9:	c7 44 24 08 5f 14 80 	movl   $0x80145f,0x8(%esp)
  800cc0:	00 
  800cc1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc8:	00 
  800cc9:	c7 04 24 7c 14 80 00 	movl   $0x80147c,(%esp)
  800cd0:	e8 76 01 00 00       	call   800e4b <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d0b:	00 
  800d0c:	c7 44 24 08 5f 14 80 	movl   $0x80145f,0x8(%esp)
  800d13:	00 
  800d14:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d1b:	00 
  800d1c:	c7 04 24 7c 14 80 00 	movl   $0x80147c,(%esp)
  800d23:	e8 23 01 00 00       	call   800e4b <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d5e:	00 
  800d5f:	c7 44 24 08 5f 14 80 	movl   $0x80145f,0x8(%esp)
  800d66:	00 
  800d67:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d6e:	00 
  800d6f:	c7 04 24 7c 14 80 00 	movl   $0x80147c,(%esp)
  800d76:	e8 d0 00 00 00       	call   800e4b <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800db1:	00 
  800db2:	c7 44 24 08 5f 14 80 	movl   $0x80145f,0x8(%esp)
  800db9:	00 
  800dba:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dc1:	00 
  800dc2:	c7 04 24 7c 14 80 00 	movl   $0x80147c,(%esp)
  800dc9:	e8 7d 00 00 00       	call   800e4b <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e26:	00 
  800e27:	c7 44 24 08 5f 14 80 	movl   $0x80145f,0x8(%esp)
  800e2e:	00 
  800e2f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e36:	00 
  800e37:	c7 04 24 7c 14 80 00 	movl   $0x80147c,(%esp)
  800e3e:	e8 08 00 00 00       	call   800e4b <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e50:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800e53:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800e56:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800e5c:	e8 44 fd ff ff       	call   800ba5 <sys_getenvid>
  800e61:	8b 55 0c             	mov    0xc(%ebp),%edx
  800e64:	89 54 24 10          	mov    %edx,0x10(%esp)
  800e68:	8b 55 08             	mov    0x8(%ebp),%edx
  800e6b:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800e6f:	89 74 24 08          	mov    %esi,0x8(%esp)
  800e73:	89 44 24 04          	mov    %eax,0x4(%esp)
  800e77:	c7 04 24 8c 14 80 00 	movl   $0x80148c,(%esp)
  800e7e:	e8 cc f2 ff ff       	call   80014f <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e83:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800e87:	8b 45 10             	mov    0x10(%ebp),%eax
  800e8a:	89 04 24             	mov    %eax,(%esp)
  800e8d:	e8 5c f2 ff ff       	call   8000ee <vcprintf>
	cprintf("\n");
  800e92:	c7 04 24 5c 11 80 00 	movl   $0x80115c,(%esp)
  800e99:	e8 b1 f2 ff ff       	call   80014f <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800e9e:	cc                   	int3   
  800e9f:	eb fd                	jmp    800e9e <_panic+0x53>
  800ea1:	66 90                	xchg   %ax,%ax
