...
duppage(envid_t dstenv, void *addr)
{
  ...
  80006a:	c7 44 24 08 40 13 80 	movl   $0x801340,0x8(%esp)
  800071:	00 
  800072:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  800079:	00 
  80007a:	c7 04 24 53 13 80 00 	movl   $0x801353,(%esp)
  ...
  8000b2:	c7 44 24 08 63 13 80 	movl   $0x801363,0x8(%esp)
  8000b9:	00 
  8000ba:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  8000c1:	00 
  8000c2:	c7 04 24 53 13 80 00 	movl   $0x801353,(%esp)
  ...
  800102:	c7 44 24 08 74 13 80 	movl   $0x801374,0x8(%esp)
  800109:	00 
  80010a:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
  800111:	00 
  800112:	c7 04 24 53 13 80 00 	movl   $0x801353,(%esp)
...
sys_exofork(void)
{
  ...
  80013e:	c7 44 24 08 87 13 80 	movl   $0x801387,0x8(%esp)
  800145:	00 
  800146:	c7 44 24 04 37 00 00 	movl   $0x37,0x4(%esp)
  80014d:	00 
  80014e:	c7 04 24 53 13 80 00 	movl   $0x801353,(%esp)
  ...
  8001d1:	c7 44 24 08 97 13 80 	movl   $0x801397,0x8(%esp)
  8001d8:	00 
  8001d9:	c7 44 24 04 4c 00 00 	movl   $0x4c,0x4(%esp)
  8001e0:	00 
  8001e1:	c7 04 24 53 13 80 00 	movl   $0x801353,(%esp)
...
umain(int argc, char **argv)
{
  ...
  80020c:	b8 b5 13 80 00       	mov    $0x8013b5,%eax
  800211:	eb 05                	jmp    800218 <umain+0x22>
  800213:	b8 ae 13 80 00       	mov    $0x8013ae,%eax
  800218:	89 44 24 08          	mov    %eax,0x8(%esp)
  80021c:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800220:	c7 04 24 bb 13 80 00 	movl   $0x8013bb,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8002d6:	c7 04 24 d8 13 80 00 	movl   $0x8013d8,(%esp)
  ...
  8002ec:	e8 51 00 00 00       	call   800342 <vcprintf>
	cprintf("\n");
  8002f1:	c7 04 24 cb 13 80 00 	movl   $0x8013cb,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80042f:	e8 6c 0c 00 00       	call   8010a0 <__udivdi3>
  ...
  80048f:	e8 3c 0d 00 00       	call   8011d0 <__umoddi3>
  800494:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800498:	0f be 80 fb 13 80 00 	movsbl 0x8013fb(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80057f:	ff 24 95 40 15 80 00 	jmp    *0x801540(,%edx,4)
  ...
  80065b:	c7 44 24 08 1c 14 80 	movl   $0x80141c,0x8(%esp)
  800662:	00 
  ...
  80068b:	b8 0c 14 80 00       	mov    $0x80140c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800dd0:	00 
  800dd1:	c7 44 24 08 00 17 80 	movl   $0x801700,0x8(%esp)
  800dd8:	00 
  800dd9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de0:	00 
  800de1:	c7 04 24 1d 17 80 00 	movl   $0x80171d,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800e62:	00 
  800e63:	c7 44 24 08 00 17 80 	movl   $0x801700,0x8(%esp)
  800e6a:	00 
  800e6b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e72:	00 
  800e73:	c7 04 24 1d 17 80 00 	movl   $0x80171d,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800eb5:	00 
  800eb6:	c7 44 24 08 00 17 80 	movl   $0x801700,0x8(%esp)
  800ebd:	00 
  800ebe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ec5:	00 
  800ec6:	c7 04 24 1d 17 80 00 	movl   $0x80171d,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800f08:	00 
  800f09:	c7 44 24 08 00 17 80 	movl   $0x801700,0x8(%esp)
  800f10:	00 
  800f11:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f18:	00 
  800f19:	c7 04 24 1d 17 80 00 	movl   $0x80171d,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800f5b:	00 
  800f5c:	c7 44 24 08 00 17 80 	movl   $0x801700,0x8(%esp)
  800f63:	00 
  800f64:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f6b:	00 
  800f6c:	c7 04 24 1d 17 80 00 	movl   $0x80171d,(%esp)
...
00800f80 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800fa1:	7e 28                	jle    800fcb <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800fa3:	89 44 24 10          	mov    %eax,0x10(%esp)
  800fa7:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800fae:	00 
  800faf:	c7 44 24 08 00 17 80 	movl   $0x801700,0x8(%esp)
  800fb6:	00 
  800fb7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800fbe:	00 
  800fbf:	c7 04 24 1d 17 80 00 	movl   $0x80171d,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ff4:	7e 28                	jle    80101e <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800ff6:	89 44 24 10          	mov    %eax,0x10(%esp)
  800ffa:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  801001:	00 
  801002:	c7 44 24 08 00 17 80 	movl   $0x801700,0x8(%esp)
  801009:	00 
  80100a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801011:	00 
  801012:	c7 04 24 1d 17 80 00 	movl   $0x80171d,(%esp)
  801019:	e8 8c f2 ff ff       	call   8002aa <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  801069:	7e 28                	jle    801093 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80106b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80106f:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  801076:	00 
  801077:	c7 44 24 08 00 17 80 	movl   $0x801700,0x8(%esp)
  80107e:	00 
  80107f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801086:	00 
  801087:	c7 04 24 1d 17 80 00 	movl   $0x80171d,(%esp)
  80108e:	e8 17 f2 ff ff       	call   8002aa <_panic>
