...
sys_env_destroy(envid_t envid)
{
  ...
  800115:	00 
  800116:	c7 44 24 08 4a 11 80 	movl   $0x80114a,0x8(%esp)
  80011d:	00 
  80011e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800125:	00 
  800126:	c7 04 24 67 11 80 00 	movl   $0x801167,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001a7:	00 
  8001a8:	c7 44 24 08 4a 11 80 	movl   $0x80114a,0x8(%esp)
  8001af:	00 
  8001b0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001b7:	00 
  8001b8:	c7 04 24 67 11 80 00 	movl   $0x801167,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001fa:	00 
  8001fb:	c7 44 24 08 4a 11 80 	movl   $0x80114a,0x8(%esp)
  800202:	00 
  800203:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020a:	00 
  80020b:	c7 04 24 67 11 80 00 	movl   $0x801167,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80024d:	00 
  80024e:	c7 44 24 08 4a 11 80 	movl   $0x80114a,0x8(%esp)
  800255:	00 
  800256:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80025d:	00 
  80025e:	c7 04 24 67 11 80 00 	movl   $0x801167,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a0:	00 
  8002a1:	c7 44 24 08 4a 11 80 	movl   $0x80114a,0x8(%esp)
  8002a8:	00 
  8002a9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b0:	00 
  8002b1:	c7 04 24 67 11 80 00 	movl   $0x801167,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002f3:	00 
  8002f4:	c7 44 24 08 4a 11 80 	movl   $0x80114a,0x8(%esp)
  8002fb:	00 
  8002fc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800303:	00 
  800304:	c7 04 24 67 11 80 00 	movl   $0x801167,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800346:	00 
  800347:	c7 44 24 08 4a 11 80 	movl   $0x80114a,0x8(%esp)
  80034e:	00 
  80034f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800356:	00 
  800357:	c7 04 24 67 11 80 00 	movl   $0x801167,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  8003bb:	00 
  8003bc:	c7 44 24 08 4a 11 80 	movl   $0x80114a,0x8(%esp)
  8003c3:	00 
  8003c4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003cb:	00 
  8003cc:	c7 04 24 67 11 80 00 	movl   $0x801167,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80040c:	c7 04 24 78 11 80 00 	movl   $0x801178,(%esp)
  ...
  800422:	e8 51 00 00 00       	call   800478 <vcprintf>
	cprintf("\n");
  800427:	c7 04 24 9b 11 80 00 	movl   $0x80119b,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8004b4:	e8 7b 01 00 00       	call   800634 <vprintfmt>
	sys_cputs(b.buf, b.idx);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8005d8:	0f be 80 9d 11 80 00 	movsbl 0x80119d(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80077b:	c7 44 24 08 b5 11 80 	movl   $0x8011b5,0x8(%esp)
  800782:	00 
  ...
  80079b:	c7 44 24 08 be 11 80 	movl   $0x8011be,0x8(%esp)
  8007a2:	00 
  ...
  8007cb:	b8 ae 11 80 00       	mov    $0x8011ae,%eax
