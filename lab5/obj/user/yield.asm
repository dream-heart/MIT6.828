...
umain(int argc, char **argv)
{
  ...
  800046:	c7 04 24 a0 11 80 00 	movl   $0x8011a0,(%esp)
  ...
  80006c:	c7 04 24 c0 11 80 00 	movl   $0x8011c0,(%esp)
...
umain(int argc, char **argv)
{
  ...
  80008c:	c7 04 24 ec 11 80 00 	movl   $0x8011ec,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80022f:	e8 cc 0c 00 00       	call   800f00 <__udivdi3>
  ...
  80028f:	e8 9c 0d 00 00       	call   801030 <__umoddi3>
  800294:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800298:	0f be 80 15 12 80 00 	movsbl 0x801215(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80037f:	ff 24 95 60 13 80 00 	jmp    *0x801360(,%edx,4)
  ...
  80045b:	c7 44 24 08 36 12 80 	movl   $0x801236,0x8(%esp)
  800462:	00 
  ...
  80048b:	b8 26 12 80 00       	mov    $0x801226,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bd0:	00 
  800bd1:	c7 44 24 08 1f 15 80 	movl   $0x80151f,0x8(%esp)
  800bd8:	00 
  800bd9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800be0:	00 
  800be1:	c7 04 24 3c 15 80 00 	movl   $0x80153c,(%esp)
  800be8:	e8 ae 02 00 00       	call   800e9b <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c62:	00 
  800c63:	c7 44 24 08 1f 15 80 	movl   $0x80151f,0x8(%esp)
  800c6a:	00 
  800c6b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c72:	00 
  800c73:	c7 04 24 3c 15 80 00 	movl   $0x80153c,(%esp)
  800c7a:	e8 1c 02 00 00       	call   800e9b <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cb5:	00 
  800cb6:	c7 44 24 08 1f 15 80 	movl   $0x80151f,0x8(%esp)
  800cbd:	00 
  800cbe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc5:	00 
  800cc6:	c7 04 24 3c 15 80 00 	movl   $0x80153c,(%esp)
  800ccd:	e8 c9 01 00 00       	call   800e9b <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d08:	00 
  800d09:	c7 44 24 08 1f 15 80 	movl   $0x80151f,0x8(%esp)
  800d10:	00 
  800d11:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d18:	00 
  800d19:	c7 04 24 3c 15 80 00 	movl   $0x80153c,(%esp)
  800d20:	e8 76 01 00 00       	call   800e9b <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d5b:	00 
  800d5c:	c7 44 24 08 1f 15 80 	movl   $0x80151f,0x8(%esp)
  800d63:	00 
  800d64:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d6b:	00 
  800d6c:	c7 04 24 3c 15 80 00 	movl   $0x80153c,(%esp)
  800d73:	e8 23 01 00 00       	call   800e9b <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800dae:	00 
  800daf:	c7 44 24 08 1f 15 80 	movl   $0x80151f,0x8(%esp)
  800db6:	00 
  800db7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dbe:	00 
  800dbf:	c7 04 24 3c 15 80 00 	movl   $0x80153c,(%esp)
  800dc6:	e8 d0 00 00 00       	call   800e9b <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e01:	00 
  800e02:	c7 44 24 08 1f 15 80 	movl   $0x80151f,0x8(%esp)
  800e09:	00 
  800e0a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e11:	00 
  800e12:	c7 04 24 3c 15 80 00 	movl   $0x80153c,(%esp)
  800e19:	e8 7d 00 00 00       	call   800e9b <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e76:	00 
  800e77:	c7 44 24 08 1f 15 80 	movl   $0x80151f,0x8(%esp)
  800e7e:	00 
  800e7f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e86:	00 
  800e87:	c7 04 24 3c 15 80 00 	movl   $0x80153c,(%esp)
  800e8e:	e8 08 00 00 00       	call   800e9b <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ea0:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800ea3:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800ea6:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800eac:	e8 44 fd ff ff       	call   800bf5 <sys_getenvid>
  800eb1:	8b 55 0c             	mov    0xc(%ebp),%edx
  800eb4:	89 54 24 10          	mov    %edx,0x10(%esp)
  800eb8:	8b 55 08             	mov    0x8(%ebp),%edx
  800ebb:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800ebf:	89 74 24 08          	mov    %esi,0x8(%esp)
  800ec3:	89 44 24 04          	mov    %eax,0x4(%esp)
  800ec7:	c7 04 24 4c 15 80 00 	movl   $0x80154c,(%esp)
  800ece:	e8 ca f2 ff ff       	call   80019d <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800ed3:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800ed7:	8b 45 10             	mov    0x10(%ebp),%eax
  800eda:	89 04 24             	mov    %eax,(%esp)
  800edd:	e8 5a f2 ff ff       	call   80013c <vcprintf>
	cprintf("\n");
  800ee2:	c7 04 24 70 15 80 00 	movl   $0x801570,(%esp)
  800ee9:	e8 af f2 ff ff       	call   80019d <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800eee:	cc                   	int3   
  800eef:	eb fd                	jmp    800eee <_panic+0x53>
