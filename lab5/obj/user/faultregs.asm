...
umain(int argc, char **argv)
{
  ...
  800491:	e8 55 0f 00 00       	call   8013eb <set_pgfault_handler>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80077f:	e8 3c 0d 00 00       	call   8014c0 <__udivdi3>
  ...
  8007df:	e8 0c 0e 00 00       	call   8015f0 <__umoddi3>
  8007e4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8007e8:	0f be 80 a3 18 80 00 	movsbl 0x8018a3(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8008cf:	ff 24 95 e0 19 80 00 	jmp    *0x8019e0(,%edx,4)
  ...
  8009ab:	c7 44 24 08 c4 18 80 	movl   $0x8018c4,0x8(%esp)
  8009b2:	00 
  ...
  8009db:	b8 b4 18 80 00       	mov    $0x8018b4,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  801120:	00 
  801121:	c7 44 24 08 9f 1b 80 	movl   $0x801b9f,0x8(%esp)
  801128:	00 
  801129:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801130:	00 
  801131:	c7 04 24 bc 1b 80 00 	movl   $0x801bbc,(%esp)
...
sys_yield(void)
{
  ...
  80116f:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8011b2:	00 
  8011b3:	c7 44 24 08 9f 1b 80 	movl   $0x801b9f,0x8(%esp)
  8011ba:	00 
  8011bb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8011c2:	00 
  8011c3:	c7 04 24 bc 1b 80 00 	movl   $0x801bbc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  801205:	00 
  801206:	c7 44 24 08 9f 1b 80 	movl   $0x801b9f,0x8(%esp)
  80120d:	00 
  80120e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801215:	00 
  801216:	c7 04 24 bc 1b 80 00 	movl   $0x801bbc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  801258:	00 
  801259:	c7 44 24 08 9f 1b 80 	movl   $0x801b9f,0x8(%esp)
  801260:	00 
  801261:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801268:	00 
  801269:	c7 04 24 bc 1b 80 00 	movl   $0x801bbc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8012ab:	00 
  8012ac:	c7 44 24 08 9f 1b 80 	movl   $0x801b9f,0x8(%esp)
  8012b3:	00 
  8012b4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8012bb:	00 
  8012bc:	c7 04 24 bc 1b 80 00 	movl   $0x801bbc,(%esp)
...
008012d0 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8012f1:	7e 28                	jle    80131b <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8012f3:	89 44 24 10          	mov    %eax,0x10(%esp)
  8012f7:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8012fe:	00 
  8012ff:	c7 44 24 08 9f 1b 80 	movl   $0x801b9f,0x8(%esp)
  801306:	00 
  801307:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80130e:	00 
  80130f:	c7 04 24 bc 1b 80 00 	movl   $0x801bbc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  801331:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  801344:	7e 28                	jle    80136e <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  801346:	89 44 24 10          	mov    %eax,0x10(%esp)
  80134a:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  801351:	00 
  801352:	c7 44 24 08 9f 1b 80 	movl   $0x801b9f,0x8(%esp)
  801359:	00 
  80135a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801361:	00 
  801362:	c7 04 24 bc 1b 80 00 	movl   $0x801bbc,(%esp)
  801369:	e8 83 f2 ff ff       	call   8005f1 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  801381:	b8 0c 00 00 00       	mov    $0xc,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  80139f:	83 ec 2c             	sub    $0x2c,%esp
	...
	asm volatile("int %1\n"
  8013a2:	b9 00 00 00 00       	mov    $0x0,%ecx
  8013a7:	b8 0d 00 00 00       	mov    $0xd,%eax
  8013ac:	8b 55 08             	mov    0x8(%ebp),%edx
  8013af:	89 cb                	mov    %ecx,%ebx
  8013b1:	89 cf                	mov    %ecx,%edi
  8013b3:	89 ce                	mov    %ecx,%esi
  ...
  8013b9:	7e 28                	jle    8013e3 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8013bb:	89 44 24 10          	mov    %eax,0x10(%esp)
  8013bf:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8013c6:	00 
  8013c7:	c7 44 24 08 9f 1b 80 	movl   $0x801b9f,0x8(%esp)
  8013ce:	00 
  8013cf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8013d6:	00 
  8013d7:	c7 04 24 bc 1b 80 00 	movl   $0x801bbc,(%esp)
  8013de:	e8 0e f2 ff ff       	call   8005f1 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8013f1:	83 3d d0 20 80 00 00 	cmpl   $0x0,0x8020d0
  8013f8:	75 44                	jne    80143e <set_pgfault_handler+0x53>
		// First time through!
		// LAB 4: Your code here.
		void* addr = (void*) (UXSTACKTOP-PGSIZE);
		r=sys_page_alloc(thisenv->env_id, addr, PTE_W|PTE_U|PTE_P);
  8013fa:	a1 cc 20 80 00       	mov    0x8020cc,%eax
  8013ff:	8b 40 48             	mov    0x48(%eax),%eax
  801402:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  801409:	00 
  80140a:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  801411:	ee 
  801412:	89 04 24             	mov    %eax,(%esp)
  801415:	e8 69 fd ff ff       	call   801183 <sys_page_alloc>
		if( r < 0)
  80141a:	85 c0                	test   %eax,%eax
  80141c:	79 20                	jns    80143e <set_pgfault_handler+0x53>
			panic("No memory for the UxStack, the mistake is %d\n",r);
  80141e:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801422:	c7 44 24 08 cc 1b 80 	movl   $0x801bcc,0x8(%esp)
  801429:	00 
  80142a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801431:	00 
  801432:	c7 04 24 28 1c 80 00 	movl   $0x801c28,(%esp)
  801439:	e8 b3 f1 ff ff       	call   8005f1 <_panic>
  ...
  801441:	a3 d0 20 80 00       	mov    %eax,0x8020d0
	if(( r= sys_env_set_pgfault_upcall(sys_getenvid(), _pgfault_upcall))<0)
  801446:	e8 fa fc ff ff       	call   801145 <sys_getenvid>
  80144b:	c7 44 24 04 81 14 80 	movl   $0x801481,0x4(%esp)
  801452:	00 
  801453:	89 04 24             	mov    %eax,(%esp)
  801456:	e8 c8 fe ff ff       	call   801323 <sys_env_set_pgfault_upcall>
  80145b:	85 c0                	test   %eax,%eax
  80145d:	79 20                	jns    80147f <set_pgfault_handler+0x94>
		panic("sys_env_set_pgfault_upcall is not right %d\n", r);
  80145f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801463:	c7 44 24 08 fc 1b 80 	movl   $0x801bfc,0x8(%esp)
  80146a:	00 
  80146b:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  801472:	00 
  801473:	c7 04 24 28 1c 80 00 	movl   $0x801c28,(%esp)
  80147a:	e8 72 f1 ff ff       	call   8005f1 <_panic>
...
_pgfault_upcall:
  ...
  801482:	a1 d0 20 80 00       	mov    0x8020d0,%eax
	call *%eax
  ...
  801489:	83 c4 04             	add    $0x4,%esp
	...
	//	trap-eip -> eax
		movl 0x28(%esp), %eax
  80148c:	8b 44 24 28          	mov    0x28(%esp),%eax
	//	trap-ebp-> ebx		
		movl 0x10(%esp), %ebx
  801490:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	//  trap->esp -> ecx 
		movl 0x30(%esp), %ecx
  801494:	8b 4c 24 30          	mov    0x30(%esp),%ecx

		movl %eax, -0x4(%ecx)
  801498:	89 41 fc             	mov    %eax,-0x4(%ecx)
		movl %ebx, -0x8(%ecx)
  80149b:	89 59 f8             	mov    %ebx,-0x8(%ecx)

		leal -0x8(%ecx), %ebp
  80149e:	8d 69 f8             	lea    -0x8(%ecx),%ebp

		movl 0x8(%esp), %edi
  8014a1:	8b 7c 24 08          	mov    0x8(%esp),%edi
		movl 0xc(%esp),	%esi
  8014a5:	8b 74 24 0c          	mov    0xc(%esp),%esi
		movl 0x18(%esp),%ebx
  8014a9:	8b 5c 24 18          	mov    0x18(%esp),%ebx
		movl 0x1c(%esp),%edx
  8014ad:	8b 54 24 1c          	mov    0x1c(%esp),%edx
		movl 0x20(%esp),%ecx
  8014b1:	8b 4c 24 20          	mov    0x20(%esp),%ecx
		movl 0x24(%esp),%eax
  8014b5:	8b 44 24 24          	mov    0x24(%esp),%eax
	...
	// LAB : Your code here.
		leal 0x2c(%esp), %esp
  8014b9:	8d 64 24 2c          	lea    0x2c(%esp),%esp
		popf
  8014bd:	9d                   	popf   
