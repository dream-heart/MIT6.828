...
umain(int argc, char **argv)
{
  ...
  8000c5:	e8 81 0e 00 00       	call   800f4b <set_pgfault_handler>
	cprintf("%s\n", (char*)0xDeadBeef);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002df:	e8 3c 0d 00 00       	call   801020 <__udivdi3>
  ...
  80033f:	e8 0c 0e 00 00       	call   801150 <__umoddi3>
  800344:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800348:	0f be 80 5b 13 80 00 	movsbl 0x80135b(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80042f:	ff 24 95 a0 14 80 00 	jmp    *0x8014a0(,%edx,4)
  ...
  80050b:	c7 44 24 08 7c 13 80 	movl   $0x80137c,0x8(%esp)
  800512:	00 
  ...
  80053b:	b8 6c 13 80 00       	mov    $0x80136c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c80:	00 
  800c81:	c7 44 24 08 5f 16 80 	movl   $0x80165f,0x8(%esp)
  800c88:	00 
  800c89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c90:	00 
  800c91:	c7 04 24 7c 16 80 00 	movl   $0x80167c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d12:	00 
  800d13:	c7 44 24 08 5f 16 80 	movl   $0x80165f,0x8(%esp)
  800d1a:	00 
  800d1b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d22:	00 
  800d23:	c7 04 24 7c 16 80 00 	movl   $0x80167c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d65:	00 
  800d66:	c7 44 24 08 5f 16 80 	movl   $0x80165f,0x8(%esp)
  800d6d:	00 
  800d6e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d75:	00 
  800d76:	c7 04 24 7c 16 80 00 	movl   $0x80167c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800db8:	00 
  800db9:	c7 44 24 08 5f 16 80 	movl   $0x80165f,0x8(%esp)
  800dc0:	00 
  800dc1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dc8:	00 
  800dc9:	c7 04 24 7c 16 80 00 	movl   $0x80167c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e0b:	00 
  800e0c:	c7 44 24 08 5f 16 80 	movl   $0x80165f,0x8(%esp)
  800e13:	00 
  800e14:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e1b:	00 
  800e1c:	c7 04 24 7c 16 80 00 	movl   $0x80167c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800e5e:	00 
  800e5f:	c7 44 24 08 5f 16 80 	movl   $0x80165f,0x8(%esp)
  800e66:	00 
  800e67:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e6e:	00 
  800e6f:	c7 04 24 7c 16 80 00 	movl   $0x80167c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800eb1:	00 
  800eb2:	c7 44 24 08 5f 16 80 	movl   $0x80165f,0x8(%esp)
  800eb9:	00 
  800eba:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ec1:	00 
  800ec2:	c7 04 24 7c 16 80 00 	movl   $0x80167c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800f26:	00 
  800f27:	c7 44 24 08 5f 16 80 	movl   $0x80165f,0x8(%esp)
  800f2e:	00 
  800f2f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f36:	00 
  800f37:	c7 04 24 7c 16 80 00 	movl   $0x80167c,(%esp)
  800f3e:	e8 0d f2 ff ff       	call   800150 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800f51:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800f58:	75 44                	jne    800f9e <set_pgfault_handler+0x53>
		// First time through!
		// LAB 4: Your code here.
		void* addr = (void*) (UXSTACKTOP-PGSIZE);
		r=sys_page_alloc(thisenv->env_id, addr, PTE_W|PTE_U|PTE_P);
  800f5a:	a1 04 20 80 00       	mov    0x802004,%eax
  800f5f:	8b 40 48             	mov    0x48(%eax),%eax
  800f62:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800f69:	00 
  800f6a:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  800f71:	ee 
  800f72:	89 04 24             	mov    %eax,(%esp)
  800f75:	e8 69 fd ff ff       	call   800ce3 <sys_page_alloc>
		if( r < 0)
  800f7a:	85 c0                	test   %eax,%eax
  800f7c:	79 20                	jns    800f9e <set_pgfault_handler+0x53>
			panic("No memory for the UxStack, the mistake is %d\n",r);
  800f7e:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f82:	c7 44 24 08 8c 16 80 	movl   $0x80168c,0x8(%esp)
  800f89:	00 
  800f8a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f91:	00 
  800f92:	c7 04 24 e8 16 80 00 	movl   $0x8016e8,(%esp)
  ...
  800fa1:	a3 08 20 80 00       	mov    %eax,0x802008
	if(( r= sys_env_set_pgfault_upcall(sys_getenvid(), _pgfault_upcall))<0)
  800fa6:	e8 fa fc ff ff       	call   800ca5 <sys_getenvid>
  800fab:	c7 44 24 04 e1 0f 80 	movl   $0x800fe1,0x4(%esp)
  800fb2:	00 
  800fb3:	89 04 24             	mov    %eax,(%esp)
  800fb6:	e8 c8 fe ff ff       	call   800e83 <sys_env_set_pgfault_upcall>
  800fbb:	85 c0                	test   %eax,%eax
  800fbd:	79 20                	jns    800fdf <set_pgfault_handler+0x94>
		panic("sys_env_set_pgfault_upcall is not right %d\n", r);
  800fbf:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800fc3:	c7 44 24 08 bc 16 80 	movl   $0x8016bc,0x8(%esp)
  800fca:	00 
  800fcb:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  800fd2:	00 
  800fd3:	c7 04 24 e8 16 80 00 	movl   $0x8016e8,(%esp)
  800fda:	e8 71 f1 ff ff       	call   800150 <_panic>
...
_pgfault_upcall:
  ...
  800fe9:	83 c4 04             	add    $0x4,%esp
	...
	//	trap-eip -> eax
		movl 0x28(%esp), %eax
  800fec:	8b 44 24 28          	mov    0x28(%esp),%eax
	//	trap-ebp-> ebx		
		movl 0x10(%esp), %ebx
  800ff0:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	//  trap->esp -> ecx 
		movl 0x30(%esp), %ecx
  800ff4:	8b 4c 24 30          	mov    0x30(%esp),%ecx

		movl %eax, -0x4(%ecx)
  800ff8:	89 41 fc             	mov    %eax,-0x4(%ecx)
		movl %ebx, -0x8(%ecx)
  800ffb:	89 59 f8             	mov    %ebx,-0x8(%ecx)

		leal -0x8(%ecx), %ebp
  800ffe:	8d 69 f8             	lea    -0x8(%ecx),%ebp

		movl 0x8(%esp), %edi
  801001:	8b 7c 24 08          	mov    0x8(%esp),%edi
		movl 0xc(%esp),	%esi
  801005:	8b 74 24 0c          	mov    0xc(%esp),%esi
		movl 0x18(%esp),%ebx
  801009:	8b 5c 24 18          	mov    0x18(%esp),%ebx
		movl 0x1c(%esp),%edx
  80100d:	8b 54 24 1c          	mov    0x1c(%esp),%edx
		movl 0x20(%esp),%ecx
  801011:	8b 4c 24 20          	mov    0x20(%esp),%ecx
		movl 0x24(%esp),%eax
  801015:	8b 44 24 24          	mov    0x24(%esp),%eax
	...
	// LAB : Your code here.
		leal 0x2c(%esp), %esp
  801019:	8d 64 24 2c          	lea    0x2c(%esp),%esp
		popf
  80101d:	9d                   	popf   
