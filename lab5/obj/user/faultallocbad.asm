...
handler(struct UTrapframe *utf)
{
  ...
  800069:	e8 55 0c 00 00       	call   800cc3 <sys_page_alloc>
  ...
  8000ad:	e8 96 07 00 00       	call   800848 <snprintf>
}
...
umain(int argc, char **argv)
{
  ...
  8000c5:	e8 61 0e 00 00       	call   800f2b <set_pgfault_handler>
	sys_cputs((char*)0xDEADBEEF, 4);
  8000ca:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
  8000d1:	00 
  8000d2:	c7 04 24 ef be ad de 	movl   $0xdeadbeef,(%esp)
  8000d9:	e8 18 0b 00 00       	call   800bf6 <sys_cputs>
}
  8000de:	c9                   	leave  
  8000df:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  8000ee:	e8 92 0b 00 00       	call   800c85 <sys_getenvid>
...
exit(void)
{
  ...
  800135:	e8 f9 0a 00 00       	call   800c33 <sys_env_destroy>
}
  80013a:	c9                   	leave  
  80013b:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80014d:	e8 33 0b 00 00       	call   800c85 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8001bf:	e8 32 0a 00 00       	call   800bf6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800210:	e8 6f 01 00 00       	call   800384 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800228:	e8 c9 09 00 00       	call   800bf6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002bf:	e8 3c 0d 00 00       	call   801000 <__udivdi3>
  ...
  80031f:	e8 0c 0e 00 00       	call   801130 <__umoddi3>
  800324:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800328:	0f be 80 3b 13 80 00 	movsbl 0x80133b(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80040f:	ff 24 95 80 14 80 00 	jmp    *0x801480(,%edx,4)
  ...
  8004eb:	c7 44 24 08 5c 13 80 	movl   $0x80135c,0x8(%esp)
  8004f2:	00 
  ...
  80051b:	b8 4c 13 80 00       	mov    $0x80134c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c60:	00 
  800c61:	c7 44 24 08 3f 16 80 	movl   $0x80163f,0x8(%esp)
  800c68:	00 
  800c69:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c70:	00 
  800c71:	c7 04 24 5c 16 80 00 	movl   $0x80165c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cf2:	00 
  800cf3:	c7 44 24 08 3f 16 80 	movl   $0x80163f,0x8(%esp)
  800cfa:	00 
  800cfb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d02:	00 
  800d03:	c7 04 24 5c 16 80 00 	movl   $0x80165c,(%esp)
  800d0a:	e8 2d f4 ff ff       	call   80013c <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d45:	00 
  800d46:	c7 44 24 08 3f 16 80 	movl   $0x80163f,0x8(%esp)
  800d4d:	00 
  800d4e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d55:	00 
  800d56:	c7 04 24 5c 16 80 00 	movl   $0x80165c,(%esp)
  800d5d:	e8 da f3 ff ff       	call   80013c <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d98:	00 
  800d99:	c7 44 24 08 3f 16 80 	movl   $0x80163f,0x8(%esp)
  800da0:	00 
  800da1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800da8:	00 
  800da9:	c7 04 24 5c 16 80 00 	movl   $0x80165c,(%esp)
  800db0:	e8 87 f3 ff ff       	call   80013c <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800deb:	00 
  800dec:	c7 44 24 08 3f 16 80 	movl   $0x80163f,0x8(%esp)
  800df3:	00 
  800df4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dfb:	00 
  800dfc:	c7 04 24 5c 16 80 00 	movl   $0x80165c,(%esp)
  800e03:	e8 34 f3 ff ff       	call   80013c <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800e3e:	00 
  800e3f:	c7 44 24 08 3f 16 80 	movl   $0x80163f,0x8(%esp)
  800e46:	00 
  800e47:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e4e:	00 
  800e4f:	c7 04 24 5c 16 80 00 	movl   $0x80165c,(%esp)
  800e56:	e8 e1 f2 ff ff       	call   80013c <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e91:	00 
  800e92:	c7 44 24 08 3f 16 80 	movl   $0x80163f,0x8(%esp)
  800e99:	00 
  800e9a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ea1:	00 
  800ea2:	c7 04 24 5c 16 80 00 	movl   $0x80165c,(%esp)
  800ea9:	e8 8e f2 ff ff       	call   80013c <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800f06:	00 
  800f07:	c7 44 24 08 3f 16 80 	movl   $0x80163f,0x8(%esp)
  800f0e:	00 
  800f0f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f16:	00 
  800f17:	c7 04 24 5c 16 80 00 	movl   $0x80165c,(%esp)
  800f1e:	e8 19 f2 ff ff       	call   80013c <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800f2e:	83 ec 18             	sub    $0x18,%esp
	int r;

	if (_pgfault_handler == 0) {
  800f31:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800f38:	75 44                	jne    800f7e <set_pgfault_handler+0x53>
		// First time through!
		// LAB 4: Your code here.
		void* addr = (void*) (UXSTACKTOP-PGSIZE);
		r=sys_page_alloc(thisenv->env_id, addr, PTE_W|PTE_U|PTE_P);
  800f3a:	a1 04 20 80 00       	mov    0x802004,%eax
  800f3f:	8b 40 48             	mov    0x48(%eax),%eax
  800f42:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800f49:	00 
  800f4a:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  800f51:	ee 
  800f52:	89 04 24             	mov    %eax,(%esp)
  800f55:	e8 69 fd ff ff       	call   800cc3 <sys_page_alloc>
		if( r < 0)
  800f5a:	85 c0                	test   %eax,%eax
  800f5c:	79 20                	jns    800f7e <set_pgfault_handler+0x53>
			panic("No memory for the UxStack, the mistake is %d\n",r);
  800f5e:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f62:	c7 44 24 08 6c 16 80 	movl   $0x80166c,0x8(%esp)
  800f69:	00 
  800f6a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f71:	00 
  800f72:	c7 04 24 c8 16 80 00 	movl   $0x8016c8,(%esp)
  800f79:	e8 be f1 ff ff       	call   80013c <_panic>
  ...
  800f81:	a3 08 20 80 00       	mov    %eax,0x802008
	if(( r= sys_env_set_pgfault_upcall(sys_getenvid(), _pgfault_upcall))<0)
  800f86:	e8 fa fc ff ff       	call   800c85 <sys_getenvid>
  800f8b:	c7 44 24 04 c1 0f 80 	movl   $0x800fc1,0x4(%esp)
  800f92:	00 
  800f93:	89 04 24             	mov    %eax,(%esp)
  800f96:	e8 c8 fe ff ff       	call   800e63 <sys_env_set_pgfault_upcall>
  800f9b:	85 c0                	test   %eax,%eax
  800f9d:	79 20                	jns    800fbf <set_pgfault_handler+0x94>
		panic("sys_env_set_pgfault_upcall is not right %d\n", r);
  800f9f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800fa3:	c7 44 24 08 9c 16 80 	movl   $0x80169c,0x8(%esp)
  800faa:	00 
  800fab:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  800fb2:	00 
  800fb3:	c7 04 24 c8 16 80 00 	movl   $0x8016c8,(%esp)
  800fba:	e8 7d f1 ff ff       	call   80013c <_panic>
...
_pgfault_upcall:
  ...
  800fc2:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  800fc7:	ff d0                	call   *%eax
	addl $4, %esp			// pop function argument
  800fc9:	83 c4 04             	add    $0x4,%esp
	...
	//	trap-eip -> eax
		movl 0x28(%esp), %eax
  800fcc:	8b 44 24 28          	mov    0x28(%esp),%eax
	//	trap-ebp-> ebx		
		movl 0x10(%esp), %ebx
  800fd0:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	//  trap->esp -> ecx 
		movl 0x30(%esp), %ecx
  800fd4:	8b 4c 24 30          	mov    0x30(%esp),%ecx

		movl %eax, -0x4(%ecx)
  800fd8:	89 41 fc             	mov    %eax,-0x4(%ecx)
		movl %ebx, -0x8(%ecx)
  800fdb:	89 59 f8             	mov    %ebx,-0x8(%ecx)

		leal -0x8(%ecx), %ebp
  800fde:	8d 69 f8             	lea    -0x8(%ecx),%ebp

		movl 0x8(%esp), %edi
  800fe1:	8b 7c 24 08          	mov    0x8(%esp),%edi
		movl 0xc(%esp),	%esi
  800fe5:	8b 74 24 0c          	mov    0xc(%esp),%esi
		movl 0x18(%esp),%ebx
  800fe9:	8b 5c 24 18          	mov    0x18(%esp),%ebx
		movl 0x1c(%esp),%edx
  800fed:	8b 54 24 1c          	mov    0x1c(%esp),%edx
		movl 0x20(%esp),%ecx
  800ff1:	8b 4c 24 20          	mov    0x20(%esp),%ecx
		movl 0x24(%esp),%eax
  800ff5:	8b 44 24 24          	mov    0x24(%esp),%eax
	...
	// LAB : Your code here.
		leal 0x2c(%esp), %esp
  800ff9:	8d 64 24 2c          	lea    0x2c(%esp),%esp
		popf
  800ffd:	9d                   	popf   
