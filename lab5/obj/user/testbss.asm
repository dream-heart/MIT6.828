...
umain(int argc, char **argv)
{
  ...
  800039:	c7 04 24 e0 11 80 00 	movl   $0x8011e0,(%esp)
  ...
  800058:	c7 44 24 08 5b 12 80 	movl   $0x80125b,0x8(%esp)
  80005f:	00 
  800060:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  800067:	00 
  800068:	c7 04 24 78 12 80 00 	movl   $0x801278,(%esp)
...
umain(int argc, char **argv)
{
  ...
  8000a6:	c7 44 24 08 00 12 80 	movl   $0x801200,0x8(%esp)
  8000ad:	00 
  8000ae:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  8000b5:	00 
  8000b6:	c7 04 24 78 12 80 00 	movl   $0x801278,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800186:	c7 04 24 a8 12 80 00 	movl   $0x8012a8,(%esp)
  ...
  80019c:	e8 51 00 00 00       	call   8001f2 <vcprintf>
	cprintf("\n");
  8001a1:	c7 04 24 76 12 80 00 	movl   $0x801276,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800348:	0f be 80 cb 12 80 00 	movsbl 0x8012cb(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80042f:	ff 24 95 20 14 80 00 	jmp    *0x801420(,%edx,4)
  ...
  80050b:	c7 44 24 08 ec 12 80 	movl   $0x8012ec,0x8(%esp)
  800512:	00 
  ...
  80053b:	b8 dc 12 80 00       	mov    $0x8012dc,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c80:	00 
  800c81:	c7 44 24 08 e0 15 80 	movl   $0x8015e0,0x8(%esp)
  800c88:	00 
  800c89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c90:	00 
  800c91:	c7 04 24 fd 15 80 00 	movl   $0x8015fd,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d12:	00 
  800d13:	c7 44 24 08 e0 15 80 	movl   $0x8015e0,0x8(%esp)
  800d1a:	00 
  800d1b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d22:	00 
  800d23:	c7 04 24 fd 15 80 00 	movl   $0x8015fd,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d65:	00 
  800d66:	c7 44 24 08 e0 15 80 	movl   $0x8015e0,0x8(%esp)
  800d6d:	00 
  800d6e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d75:	00 
  800d76:	c7 04 24 fd 15 80 00 	movl   $0x8015fd,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800db8:	00 
  800db9:	c7 44 24 08 e0 15 80 	movl   $0x8015e0,0x8(%esp)
  800dc0:	00 
  800dc1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dc8:	00 
  800dc9:	c7 04 24 fd 15 80 00 	movl   $0x8015fd,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e0b:	00 
  800e0c:	c7 44 24 08 e0 15 80 	movl   $0x8015e0,0x8(%esp)
  800e13:	00 
  800e14:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e1b:	00 
  800e1c:	c7 04 24 fd 15 80 00 	movl   $0x8015fd,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800e5e:	00 
  800e5f:	c7 44 24 08 e0 15 80 	movl   $0x8015e0,0x8(%esp)
  800e66:	00 
  800e67:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e6e:	00 
  800e6f:	c7 04 24 fd 15 80 00 	movl   $0x8015fd,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800eb1:	00 
  800eb2:	c7 44 24 08 e0 15 80 	movl   $0x8015e0,0x8(%esp)
  800eb9:	00 
  800eba:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ec1:	00 
  800ec2:	c7 04 24 fd 15 80 00 	movl   $0x8015fd,(%esp)
  800ec9:	e8 8c f2 ff ff       	call   80015a <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800f26:	00 
  800f27:	c7 44 24 08 e0 15 80 	movl   $0x8015e0,0x8(%esp)
  800f2e:	00 
  800f2f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f36:	00 
  800f37:	c7 04 24 fd 15 80 00 	movl   $0x8015fd,(%esp)
  800f3e:	e8 17 f2 ff ff       	call   80015a <_panic>
