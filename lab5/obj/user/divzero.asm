...
umain(int argc, char **argv)
{
  ...
  800054:	c7 04 24 60 11 80 00 	movl   $0x801160,(%esp)
...
exit(void)
{
  ...
  8000b7:	e8 a7 0a 00 00       	call   800b63 <sys_env_destroy>
}
  8000bc:	c9                   	leave  
  8000bd:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000eb:	e8 36 0a 00 00       	call   800b26 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80013c:	e8 73 01 00 00       	call   8002b4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800154:	e8 cd 09 00 00       	call   800b26 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 78 11 80 00 	movsbl 0x801178(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80033f:	ff 24 95 c0 12 80 00 	jmp    *0x8012c0(,%edx,4)
  ...
  80041b:	c7 44 24 08 99 11 80 	movl   $0x801199,0x8(%esp)
  800422:	00 
  ...
  80044b:	b8 89 11 80 00       	mov    $0x801189,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b90:	00 
  800b91:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800b98:	00 
  800b99:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ba0:	00 
  800ba1:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c22:	00 
  800c23:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800c2a:	00 
  800c2b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c32:	00 
  800c33:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c75:	00 
  800c76:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800c7d:	00 
  800c7e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c85:	00 
  800c86:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cc8:	00 
  800cc9:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d1b:	00 
  800d1c:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800d23:	00 
  800d24:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d2b:	00 
  800d2c:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d6e:	00 
  800d6f:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800d76:	00 
  800d77:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d7e:	00 
  800d7f:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dc1:	00 
  800dc2:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800dc9:	00 
  800dca:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dd1:	00 
  800dd2:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e36:	00 
  800e37:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800e3e:	00 
  800e3f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e46:	00 
  800e47:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e87:	c7 04 24 ac 14 80 00 	movl   $0x8014ac,(%esp)
  800e8e:	e8 ce f2 ff ff       	call   800161 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e93:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800e97:	8b 45 10             	mov    0x10(%ebp),%eax
  800e9a:	89 04 24             	mov    %eax,(%esp)
  800e9d:	e8 5e f2 ff ff       	call   800100 <vcprintf>
	cprintf("\n");
  800ea2:	c7 04 24 6c 11 80 00 	movl   $0x80116c,(%esp)
  800ea9:	e8 b3 f2 ff ff       	call   800161 <cprintf>
