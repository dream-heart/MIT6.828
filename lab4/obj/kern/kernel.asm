...
f010005f:	e8 25 63 00 00       	call   f0106389 <cpunum>
...
f0100089:	e8 b1 3e 00 00       	call   f0103f3f <vcprintf>
	cprintf("\n");
f010008e:	c7 04 24 90 7b 10 f0 	movl   $0xf0107b90,(%esp)
...
f01000b4:	2d df b9 22 f0       	sub    $0xf022b9df,%eax
f01000b9:	89 44 24 08          	mov    %eax,0x8(%esp)
f01000bd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
f01000c4:	00 
f01000c5:	c7 04 24 df b9 22 f0 	movl   $0xf022b9df,(%esp)
f01000cc:	e8 66 5c 00 00       	call   f0105d37 <memset>
...
f01000f4:	e8 67 3f 00 00       	call   f0104060 <trap_init>
	...
	mp_init();
f01000f9:	e8 7c 5f 00 00       	call   f010607a <mp_init>
	lapic_init();
f01000fe:	66 90                	xchg   %ax,%ax
f0100100:	e8 9f 62 00 00       	call   f01063a4 <lapic_init>
...
f0100119:	e8 ce 64 00 00       	call   f01065ec <__spin_initlock>
...
f0100125:	e8 dd 64 00 00       	call   f0106607 <spin_lock>
...
f0100157:	b8 b2 5f 10 f0       	mov    $0xf0105fb2,%eax
f010015c:	2d 38 5f 10 f0       	sub    $0xf0105f38,%eax
f0100161:	89 44 24 08          	mov    %eax,0x8(%esp)
f0100165:	c7 44 24 04 38 5f 10 	movl   $0xf0105f38,0x4(%esp)
f010016c:	f0 
f010016d:	c7 04 24 00 70 00 f0 	movl   $0xf0007000,(%esp)
f0100174:	e8 0b 5c 00 00       	call   f0105d84 <memmove>
...
f0100180:	e8 04 62 00 00       	call   f0106389 <cpunum>
...
f01001bd:	e8 32 63 00 00       	call   f01064f4 <lapic_startap>
...
f01001e4:	00 
f01001e5:	c7 04 24 ea 2f 22 f0 	movl   $0xf0222fea,(%esp)
...
*/
	...
	sched_yield();
f01001f1:	e8 97 49 00 00       	call   f0104b8d <sched_yield>
...
f0100230:	e8 54 61 00 00       	call   f0106389 <cpunum>
...
f0100240:	e8 2d 3d 00 00       	call   f0103f72 <cprintf>
	...
	lapic_init();
f0100245:	e8 5a 61 00 00       	call   f01063a4 <lapic_init>
	env_init_percpu();
...
f0100255:	e8 2f 61 00 00       	call   f0106389 <cpunum>
...
f0100273:	e8 8f 63 00 00       	call   f0106607 <spin_lock>
	...
	// Your code here:
		lock_kernel();
		sched_yield();
f0100278:	e8 10 49 00 00       	call   f0104b8d <sched_yield>
...
f01002ab:	e8 8f 3c 00 00       	call   f0103f3f <vcprintf>
	cprintf("\n");
f01002b0:	c7 04 24 90 7b 10 f0 	movl   $0xf0107b90,(%esp)
...
f01002fb:	a1 24 c2 22 f0       	mov    0xf022c224,%eax
f0100300:	8d 48 01             	lea    0x1(%eax),%ecx
f0100303:	89 0d 24 c2 22 f0    	mov    %ecx,0xf022c224
f0100309:	88 90 20 c0 22 f0    	mov    %dl,-0xfdd3fe0(%eax)
		if (cons.wpos == CONSBUFSIZE)
f010030f:	81 f9 00 02 00 00    	cmp    $0x200,%ecx
f0100315:	75 0a                	jne    f0100321 <cons_intr+0x35>
			cons.wpos = 0;
f0100317:	c7 05 24 c2 22 f0 00 	movl   $0x0,0xf022c224
f010031e:	00 00 00 
static void
cons_intr(int (*proc)(void))
{
...
f0100345:	75 0d                	jne    f0100354 <kbd_proc_data+0x24>
		// E0 escape character
		shift |= E0ESC;
f0100347:	83 0d 00 c0 22 f0 40 	orl    $0x40,0xf022c000
		return 0;
...
f010035f:	8b 0d 00 c0 22 f0    	mov    0xf022c000,%ecx
...
f01003a9:	89 0d 00 c0 22 f0    	mov    %ecx,0xf022c000
	}

	shift |= shiftcode[data];
f01003af:	0f b6 d2             	movzbl %dl,%edx
f01003b2:	0f b6 82 80 6c 10 f0 	movzbl -0xfef9380(%edx),%eax
f01003b9:	0b 05 00 c0 22 f0    	or     0xf022c000,%eax
	shift ^= togglecode[data];
f01003bf:	0f b6 8a 80 6b 10 f0 	movzbl -0xfef9480(%edx),%ecx
f01003c6:	31 c8                	xor    %ecx,%eax
f01003c8:	a3 00 c0 22 f0       	mov    %eax,0xf022c000

	c = charcode[shift & (CTL | SHIFT)][data];
f01003cd:	89 c1                	mov    %eax,%ecx
f01003cf:	83 e1 03             	and    $0x3,%ecx
f01003d2:	8b 0c 8d 60 6b 10 f0 	mov    -0xfef94a0(,%ecx,4),%ecx
...
f0100410:	75 21                	jne    f0100433 <kbd_proc_data+0x103>
		cprintf("Rebooting!\n");
f0100412:	c7 04 24 30 6b 10 f0 	movl   $0xf0106b30,(%esp)
...
f010051a:	eb 78                	jmp    f0100594 <cons_putc+0x15b>
	...
	case '\n':
		crt_pos += CRT_COLS;
f010051c:	66 83 05 28 c2 22 f0 	addw   $0x50,0xf022c228
f0100523:	50 
		/* fallthru */
	case '\r':
		crt_pos -= (crt_pos % CRT_COLS);
f0100524:	0f b7 05 28 c2 22 f0 	movzwl 0xf022c228,%eax
...
f010053a:	66 a3 28 c2 22 f0    	mov    %ax,0xf022c228
...
f0100576:	0f b7 05 28 c2 22 f0 	movzwl 0xf022c228,%eax
f010057d:	8d 50 01             	lea    0x1(%eax),%edx
f0100580:	66 89 15 28 c2 22 f0 	mov    %dx,0xf022c228
f0100587:	0f b7 c0             	movzwl %ax,%eax
f010058a:	8b 15 2c c2 22 f0    	mov    0xf022c22c,%edx
f0100590:	66 89 3c 42          	mov    %di,(%edx,%eax,2)
	...
	if (crt_pos >= CRT_SIZE) {
f0100594:	66 81 3d 28 c2 22 f0 	cmpw   $0x7cf,0xf022c228
f010059b:	cf 07 
f010059d:	76 42                	jbe    f01005e1 <cons_putc+0x1a8>
		int i;

		memmove(crt_buf, crt_buf + CRT_COLS, (CRT_SIZE - CRT_COLS) * sizeof(uint16_t));
f010059f:	a1 2c c2 22 f0       	mov    0xf022c22c,%eax
...
f01005b9:	e8 c6 57 00 00       	call   f0105d84 <memmove>
		for (i = CRT_SIZE - CRT_COLS; i < CRT_SIZE; i++)
			crt_buf[i] = 0x0700 | ' ';
f01005be:	8b 15 2c c2 22 f0    	mov    0xf022c22c,%edx
	// What is the purpose of this?
	if (crt_pos >= CRT_SIZE) {
		int i;
...
f01005d7:	75 f0                	jne    f01005c9 <cons_putc+0x190>
			crt_buf[i] = 0x0700 | ' ';
		crt_pos -= CRT_COLS;
f01005d9:	66 83 2d 28 c2 22 f0 	subw   $0x50,0xf022c228
f01005e0:	50 
	}

	/* move that little blinky thing */
	outb(addr_6845, 14);
f01005e1:	8b 0d 30 c2 22 f0    	mov    0xf022c230,%ecx
f01005e7:	b8 0e 00 00 00       	mov    $0xe,%eax
f01005ec:	89 ca                	mov    %ecx,%edx
f01005ee:	ee                   	out    %al,(%dx)
	outb(addr_6845 + 1, crt_pos >> 8);
f01005ef:	0f b7 1d 28 c2 22 f0 	movzwl 0xf022c228,%ebx
...
{
	if (serial_exists)
f0100617:	80 3d 34 c2 22 f0 00 	cmpb   $0x0,0xf022c234
...
f0100655:	a1 20 c2 22 f0       	mov    0xf022c220,%eax
f010065a:	3b 05 24 c2 22 f0    	cmp    0xf022c224,%eax
f0100660:	74 26                	je     f0100688 <cons_getc+0x43>
		c = cons.buf[cons.rpos++];
f0100662:	8d 50 01             	lea    0x1(%eax),%edx
f0100665:	89 15 20 c2 22 f0    	mov    %edx,0xf022c220
f010066b:	0f b6 88 20 c0 22 f0 	movzbl -0xfdd3fe0(%eax),%ecx
...
f010067a:	75 11                	jne    f010068d <cons_getc+0x48>
			cons.rpos = 0;
f010067c:	c7 05 20 c2 22 f0 00 	movl   $0x0,0xf022c220
f0100683:	00 00 00 
...
f01006b3:	74 11                	je     f01006c6 <cons_init+0x37>
		...
		addr_6845 = MONO_BASE;
f01006b5:	c7 05 30 c2 22 f0 b4 	movl   $0x3b4,0xf022c230
f01006bc:	03 00 00 
...
f01006c6:	66 89 15 00 80 0b f0 	mov    %dx,0xf00b8000
		addr_6845 = CGA_BASE;
f01006cd:	c7 05 30 c2 22 f0 d4 	movl   $0x3d4,0xf022c230
f01006d4:	03 00 00 
{
	volatile uint16_t *cp;
	uint16_t was;
...
f01006d7:	bf 00 80 0b f0       	mov    $0xf00b8000,%edi
	...
	outb(addr_6845, 14);
f01006dc:	8b 0d 30 c2 22 f0    	mov    0xf022c230,%ecx
...
f0100700:	ec                   	in     (%dx),%al
	...
	crt_buf = (uint16_t*) cp;
f0100701:	89 3d 2c c2 22 f0    	mov    %edi,0xf022c22c
...
f010070a:	09 de                	or     %ebx,%esi
	...
	crt_buf = (uint16_t*) cp;
	crt_pos = pos;
f010070c:	66 89 35 28 c2 22 f0 	mov    %si,0xf022c228
...
f0100776:	88 0d 34 c2 22 f0    	mov    %cl,0xf022c234
...
f0100786:	c7 04 24 3c 6b 10 f0 	movl   $0xf0106b3c,(%esp)
...
f01007d6:	c7 44 24 08 80 6d 10 	movl   $0xf0106d80,0x8(%esp)
f01007dd:	f0 
f01007de:	c7 44 24 04 9e 6d 10 	movl   $0xf0106d9e,0x4(%esp)
f01007e5:	f0 
f01007e6:	c7 04 24 a3 6d 10 f0 	movl   $0xf0106da3,(%esp)
f01007ed:	e8 80 37 00 00       	call   f0103f72 <cprintf>
f01007f2:	c7 44 24 08 0c 6e 10 	movl   $0xf0106e0c,0x8(%esp)
f01007f9:	f0 
f01007fa:	c7 44 24 04 ac 6d 10 	movl   $0xf0106dac,0x4(%esp)
f0100801:	f0 
f0100802:	c7 04 24 a3 6d 10 f0 	movl   $0xf0106da3,(%esp)
...
f010084a:	f0 
f010084b:	c7 04 24 5c 6e 10 f0 	movl   $0xf0106e5c,(%esp)
f0100852:	e8 1b 37 00 00       	call   f0103f72 <cprintf>
	cprintf("  etext  %08x (virt)  %08x (phys)\n", etext, etext - KERNBASE);
f0100857:	c7 44 24 08 57 6a 10 	movl   $0x106a57,0x8(%esp)
f010085e:	00 
f010085f:	c7 44 24 04 57 6a 10 	movl   $0xf0106a57,0x4(%esp)
f0100866:	f0 
f0100867:	c7 04 24 80 6e 10 f0 	movl   $0xf0106e80,(%esp)
f010086e:	e8 ff 36 00 00       	call   f0103f72 <cprintf>
	cprintf("  edata  %08x (virt)  %08x (phys)\n", edata, edata - KERNBASE);
f0100873:	c7 44 24 08 df b9 22 	movl   $0x22b9df,0x8(%esp)
f010087a:	00 
f010087b:	c7 44 24 04 df b9 22 	movl   $0xf022b9df,0x4(%esp)
f0100882:	f0 
f0100883:	c7 04 24 a4 6e 10 f0 	movl   $0xf0106ea4,(%esp)
f010088a:	e8 e3 36 00 00       	call   f0103f72 <cprintf>
	cprintf("  end    %08x (virt)  %08x (phys)\n", end, end - KERNBASE);
f010088f:	c7 44 24 08 08 e0 26 	movl   $0x26e008,0x8(%esp)
f0100896:	00 
f0100897:	c7 44 24 04 08 e0 26 	movl   $0xf026e008,0x4(%esp)
f010089e:	f0 
f010089f:	c7 04 24 c8 6e 10 f0 	movl   $0xf0106ec8,(%esp)
f01008a6:	e8 c7 36 00 00       	call   f0103f72 <cprintf>
	cprintf("Kernel executable memory footprint: %dKB\n",
		ROUNDUP(end - entry, 1024) / 1024);
f01008ab:	b8 07 e4 26 f0       	mov    $0xf026e407,%eax
...
f01008cc:	c7 04 24 ec 6e 10 f0 	movl   $0xf0106eec,(%esp)
...
f01008f2:	c7 04 24 18 6f 10 f0 	movl   $0xf0106f18,(%esp)
f01008f9:	e8 74 36 00 00       	call   f0103f72 <cprintf>
	cprintf("Type 'help' for a list of commands.\n");
f01008fe:	c7 04 24 3c 6f 10 f0 	movl   $0xf0106f3c,(%esp)
...
f0100916:	e8 80 3b 00 00       	call   f010449b <print_trapframe>
	...
	while (1) {
		buf = readline("K> ");
f010091b:	c7 04 24 ce 6d 10 f0 	movl   $0xf0106dce,(%esp)
f0100922:	e8 b9 51 00 00       	call   f0105ae0 <readline>
...
f0100953:	c7 04 24 d2 6d 10 f0 	movl   $0xf0106dd2,(%esp)
f010095a:	e8 9b 53 00 00       	call   f0105cfa <strchr>
...
f0100974:	00 
f0100975:	c7 04 24 d7 6d 10 f0 	movl   $0xf0106dd7,(%esp)
...
f010099d:	c7 04 24 d2 6d 10 f0 	movl   $0xf0106dd2,(%esp)
f01009a4:	e8 51 53 00 00       	call   f0105cfa <strchr>
...
f01009bf:	c7 44 24 04 9e 6d 10 	movl   $0xf0106d9e,0x4(%esp)
f01009c6:	f0 
f01009c7:	8b 45 a8             	mov    -0x58(%ebp),%eax
f01009ca:	89 04 24             	mov    %eax,(%esp)
f01009cd:	e8 ca 52 00 00       	call   f0105c9c <strcmp>
f01009d2:	85 c0                	test   %eax,%eax
f01009d4:	74 1b                	je     f01009f1 <monitor+0x108>
f01009d6:	c7 44 24 04 ac 6d 10 	movl   $0xf0106dac,0x4(%esp)
f01009dd:	f0 
f01009de:	8b 45 a8             	mov    -0x58(%ebp),%eax
f01009e1:	89 04 24             	mov    %eax,(%esp)
f01009e4:	e8 b3 52 00 00       	call   f0105c9c <strcmp>
...
f0100a0c:	ff 14 85 6c 6f 10 f0 	call   *-0xfef9094(,%eax,4)
		print_trapframe(tf);
...
f0100a23:	c7 04 24 f4 6d 10 f0 	movl   $0xf0106df4,(%esp)
...
f0100a41:	89 e5                	mov    %esp,%ebp
	...
	if (!nextfree) {
f0100a43:	83 3d 38 c2 22 f0 00 	cmpl   $0x0,0xf022c238
f0100a4a:	75 11                	jne    f0100a5d <boot_alloc+0x1d>
		extern char end[];
		nextfree = ROUNDUP((char *) end, PGSIZE);
f0100a4c:	ba 07 f0 26 f0       	mov    $0xf026f007,%edx
f0100a51:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
f0100a57:	89 15 38 c2 22 f0    	mov    %edx,0xf022c238
...
f0100a83:	2b 05 90 ce 22 f0    	sub    0xf022ce90,%eax
...
f0100a94:	3b 15 88 ce 22 f0    	cmp    0xf022ce88,%edx
...
f0100aa6:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f0100aad:	f0 
f0100aae:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
f0100ab5:	00 
f0100ab6:	c7 04 24 99 78 10 f0 	movl   $0xf0107899,(%esp)
...
f0100ade:	3b 0d 88 ce 22 f0    	cmp    0xf022ce88,%ecx
...
f0100af0:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f0100af7:	f0 
f0100af8:	c7 44 24 04 ad 03 00 	movl   $0x3ad,0x4(%esp)
f0100aff:	00 
f0100b00:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0100b4d:	c7 44 24 08 7c 6f 10 	movl   $0xf0106f7c,0x8(%esp)
f0100b54:	f0 
f0100b55:	c7 44 24 04 e2 02 00 	movl   $0x2e2,0x4(%esp)
f0100b5c:	00 
f0100b5d:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0100b77:	2b 15 90 ce 22 f0    	sub    0xf022ce90,%edx
...
f0100bad:	a3 40 c2 22 f0       	mov    %eax,0xf022c240
//
static void
check_page_free_list(bool only_low_memory)
{
...
f0100bb2:	be 01 00 00 00       	mov    $0x1,%esi
	...
	for (pp = page_free_list; pp; pp = pp->pp_link)
f0100bb7:	8b 1d 40 c2 22 f0    	mov    0xf022c240,%ebx
f0100bbd:	eb 63                	jmp    f0100c22 <check_page_free_list+0xeb>
f0100bbf:	89 d8                	mov    %ebx,%eax
f0100bc1:	2b 05 90 ce 22 f0    	sub    0xf022ce90,%eax
...
f0100bdb:	3b 15 88 ce 22 f0    	cmp    0xf022ce88,%edx
f0100be1:	72 20                	jb     f0100c03 <check_page_free_list+0xcc>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0100be3:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0100be7:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f0100bee:	f0 
f0100bef:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
f0100bf6:	00 
f0100bf7:	c7 04 24 99 78 10 f0 	movl   $0xf0107899,(%esp)
...
f0100c1b:	e8 17 51 00 00       	call   f0105d37 <memset>
		page_free_list = pp1;
	}
...
f0100c30:	89 45 c8             	mov    %eax,-0x38(%ebp)
	for (pp = page_free_list; pp; pp = pp->pp_link) {
f0100c33:	8b 15 40 c2 22 f0    	mov    0xf022c240,%edx
		// check that we didn't corrupt the free list itself
		assert(pp >= pages);
f0100c39:	8b 0d 90 ce 22 f0    	mov    0xf022ce90,%ecx
		assert(pp < pages + npages);
f0100c3f:	a1 88 ce 22 f0       	mov    0xf022ce88,%eax
...
f0100c62:	c7 44 24 0c b3 78 10 	movl   $0xf01078b3,0xc(%esp)
f0100c69:	f0 
f0100c6a:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0100c71:	f0 
f0100c72:	c7 44 24 04 fc 02 00 	movl   $0x2fc,0x4(%esp)
f0100c79:	00 
f0100c7a:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0100c8b:	c7 44 24 0c d4 78 10 	movl   $0xf01078d4,0xc(%esp)
f0100c92:	f0 
f0100c93:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0100c9a:	f0 
f0100c9b:	c7 44 24 04 fd 02 00 	movl   $0x2fd,0x4(%esp)
f0100ca2:	00 
f0100ca3:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0100cb8:	c7 44 24 0c a0 6f 10 	movl   $0xf0106fa0,0xc(%esp)
f0100cbf:	f0 
f0100cc0:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0100cc7:	f0 
f0100cc8:	c7 44 24 04 fe 02 00 	movl   $0x2fe,0x4(%esp)
f0100ccf:	00 
f0100cd0:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0100ce6:	c7 44 24 0c e8 78 10 	movl   $0xf01078e8,0xc(%esp)
f0100ced:	f0 
f0100cee:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0100cf5:	f0 
f0100cf6:	c7 44 24 04 01 03 00 	movl   $0x301,0x4(%esp)
f0100cfd:	00 
f0100cfe:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0100d11:	c7 44 24 0c f9 78 10 	movl   $0xf01078f9,0xc(%esp)
f0100d18:	f0 
f0100d19:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0100d20:	f0 
f0100d21:	c7 44 24 04 02 03 00 	movl   $0x302,0x4(%esp)
f0100d28:	00 
f0100d29:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0100d3c:	c7 44 24 0c d4 6f 10 	movl   $0xf0106fd4,0xc(%esp)
f0100d43:	f0 
f0100d44:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0100d4b:	f0 
f0100d4c:	c7 44 24 04 03 03 00 	movl   $0x303,0x4(%esp)
f0100d53:	00 
f0100d54:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0100d67:	c7 44 24 0c 12 79 10 	movl   $0xf0107912,0xc(%esp)
f0100d6e:	f0 
f0100d6f:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0100d76:	f0 
f0100d77:	c7 44 24 04 04 03 00 	movl   $0x304,0x4(%esp)
f0100d7e:	00 
f0100d7f:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0100da4:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f0100dab:	f0 
f0100dac:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
f0100db3:	00 
f0100db4:	c7 04 24 99 78 10 f0 	movl   $0xf0107899,(%esp)
...
f0100dcf:	c7 44 24 0c f8 6f 10 	movl   $0xf0106ff8,0xc(%esp)
f0100dd6:	f0 
f0100dd7:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0100dde:	f0 
f0100ddf:	c7 44 24 04 05 03 00 	movl   $0x305,0x4(%esp)
f0100de6:	00 
f0100de7:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0100dee:	e8 4d f2 ff ff       	call   f0100040 <_panic>
		// (new test for lab 4)
		assert(page2pa(pp) != MPENTRY_PADDR);
f0100df3:	c7 44 24 0c 2c 79 10 	movl   $0xf010792c,0xc(%esp)
f0100dfa:	f0 
f0100dfb:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0100e02:	f0 
f0100e03:	c7 44 24 04 07 03 00 	movl   $0x307,0x4(%esp)
f0100e0a:	00 
f0100e0b:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0100e2d:	c7 44 24 0c 49 79 10 	movl   $0xf0107949,0xc(%esp)
f0100e34:	f0 
f0100e35:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0100e3c:	f0 
f0100e3d:	c7 44 24 04 0f 03 00 	movl   $0x30f,0x4(%esp)
f0100e44:	00 
f0100e45:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0100e55:	c7 44 24 0c 5b 79 10 	movl   $0xf010795b,0xc(%esp)
f0100e5c:	f0 
f0100e5d:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0100e64:	f0 
f0100e65:	c7 44 24 04 10 03 00 	movl   $0x310,0x4(%esp)
f0100e6c:	00 
f0100e6d:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0100e74:	e8 c7 f1 ff ff       	call   f0100040 <_panic>
	...
	if (!page_free_list)
f0100e79:	a1 40 c2 22 f0       	mov    0xf022c240,%eax
...
f0100e8b:	83 3d 40 c2 22 f0 00 	cmpl   $0x0,0xf022c240
...
f0100ee3:	75 16                	jne    f0100efb <page_init+0x2e>
			{	pages[i].pp_ref = 1;
f0100ee5:	a1 90 ce 22 f0       	mov    0xf022ce90,%eax
...
f0100efe:	75 17                	jne    f0100f17 <page_init+0x4a>
				pages[i].pp_ref = 1;
f0100f00:	a1 90 ce 22 f0       	mov    0xf022ce90,%eax
...
f0100f17:	3b 1d 44 c2 22 f0    	cmp    0xf022c244,%ebx
f0100f1d:	73 25                	jae    f0100f44 <page_init+0x77>
		{
			pages[i].pp_ref = 0;
f0100f1f:	89 f0                	mov    %esi,%eax
f0100f21:	03 05 90 ce 22 f0    	add    0xf022ce90,%eax
f0100f27:	66 c7 40 04 00 00    	movw   $0x0,0x4(%eax)
			pages[i].pp_link = page_free_list; 
f0100f2d:	8b 15 40 c2 22 f0    	mov    0xf022c240,%edx
f0100f33:	89 10                	mov    %edx,(%eax)
			page_free_list = &pages[i];
f0100f35:	89 f0                	mov    %esi,%eax
f0100f37:	03 05 90 ce 22 f0    	add    0xf022ce90,%eax
f0100f3d:	a3 40 c2 22 f0       	mov    %eax,0xf022c240
...
f0100f51:	03 05 90 ce 22 f0    	add    0xf022ce90,%eax
...
f0100f85:	03 05 90 ce 22 f0    	add    0xf022ce90,%eax
...
f0100f9b:	03 05 90 ce 22 f0    	add    0xf022ce90,%eax
f0100fa1:	66 c7 40 04 00 00    	movw   $0x0,0x4(%eax)
			pages[i].pp_link = page_free_list;
f0100fa7:	8b 15 40 c2 22 f0    	mov    0xf022c240,%edx
f0100fad:	89 10                	mov    %edx,(%eax)
			page_free_list = &pages[i];
f0100faf:	89 f0                	mov    %esi,%eax
f0100fb1:	03 05 90 ce 22 f0    	add    0xf022ce90,%eax
f0100fb7:	a3 40 c2 22 f0       	mov    %eax,0xf022c240
	//
	// Change the code to reflect this.
	// NB: DO NOT actually touch the physical memory corresponding to
	// free pages!
...
f0100fc2:	3b 1d 88 ce 22 f0    	cmp    0xf022ce88,%ebx
...
f0100fd9:	8b 1d 40 c2 22 f0    	mov    0xf022c240,%ebx
...
f0100fe5:	a3 40 c2 22 f0       	mov    %eax,0xf022c240
	page->pp_link = 0;
...
{
	return (pp - pages) << PGSHIFT;
f0100ff8:	2b 05 90 ce 22 f0    	sub    0xf022ce90,%eax
...
f0101009:	3b 15 88 ce 22 f0    	cmp    0xf022ce88,%edx
f010100f:	72 20                	jb     f0101031 <page_alloc+0x5f>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0101011:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0101015:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f010101c:	f0 
f010101d:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
f0101024:	00 
f0101025:	c7 04 24 99 78 10 f0 	movl   $0xf0107899,(%esp)
...
f0101049:	e8 e9 4c 00 00       	call   f0105d37 <memset>
	return page;
...
f0101072:	c7 44 24 08 6c 79 10 	movl   $0xf010796c,0x8(%esp)
f0101079:	f0 
f010107a:	c7 44 24 04 96 01 00 	movl   $0x196,0x4(%esp)
f0101081:	00 
f0101082:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0101089:	e8 b2 ef ff ff       	call   f0100040 <_panic>
	pp->pp_link = page_free_list;
f010108e:	8b 15 40 c2 22 f0    	mov    0xf022c240,%edx
f0101094:	89 10                	mov    %edx,(%eax)
	page_free_list = pp;
f0101096:	a3 40 c2 22 f0       	mov    %eax,0xf022c240
	return; 
}
f010109b:	c9                   	leave  
f010109c:	c3                   	ret    
...
{
	return (pp - pages) << PGSHIFT;
f01010f6:	2b 05 90 ce 22 f0    	sub    0xf022ce90,%eax
...
f010111c:	3b 15 88 ce 22 f0    	cmp    0xf022ce88,%edx
f0101122:	72 20                	jb     f0101144 <pgdir_walk+0x84>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0101124:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0101128:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f010112f:	f0 
f0101130:	c7 44 24 04 d2 01 00 	movl   $0x1d2,0x4(%esp)
f0101137:	00 
f0101138:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01011fc:	3b 05 88 ce 22 f0    	cmp    0xf022ce88,%eax
f0101202:	72 1c                	jb     f0101220 <page_lookup+0x5f>
		panic("pa2page called with invalid pa");
f0101204:	c7 44 24 08 40 70 10 	movl   $0xf0107040,0x8(%esp)
f010120b:	f0 
f010120c:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
f0101213:	00 
f0101214:	c7 04 24 99 78 10 f0 	movl   $0xf0107899,(%esp)
f010121b:	e8 20 ee ff ff       	call   f0100040 <_panic>
	return &pages[PGNUM(pa)];
f0101220:	8b 15 90 ce 22 f0    	mov    0xf022ce90,%edx
...
f010123c:	e8 48 51 00 00       	call   f0106389 <cpunum>
f0101241:	6b c0 74             	imul   $0x74,%eax,%eax
f0101244:	83 b8 28 d0 22 f0 00 	cmpl   $0x0,-0xfdd2fd8(%eax)
f010124b:	74 16                	je     f0101263 <tlb_invalidate+0x2d>
f010124d:	e8 37 51 00 00       	call   f0106389 <cpunum>
f0101252:	6b c0 74             	imul   $0x74,%eax,%eax
f0101255:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
...
f01012fc:	2b 15 90 ce 22 f0    	sub    0xf022ce90,%edx
...
f010132e:	2b 05 90 ce 22 f0    	sub    0xf022ce90,%eax
...
f0101376:	8b 15 00 13 12 f0    	mov    0xf0121300,%edx
...
f0101386:	c7 44 24 08 60 70 10 	movl   $0xf0107060,0x8(%esp)
f010138d:	f0 
f010138e:	c7 44 24 04 80 02 00 	movl   $0x280,0x4(%esp)
f0101395:	00 
f0101396:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01013af:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
f01013b4:	e8 a7 fd ff ff       	call   f0101160 <boot_map_region>
	uintptr_t ret = base;
f01013b9:	a1 00 13 12 f0       	mov    0xf0121300,%eax
	base = base +size;
f01013be:	01 c3                	add    %eax,%ebx
f01013c0:	89 1d 00 13 12 f0    	mov    %ebx,0xf0121300
	return (void*) ret;
}
...
f0101407:	a3 44 c2 22 f0       	mov    %eax,0xf022c244
// --------------------------------------------------------------
...
f0101448:	89 15 88 ce 22 f0    	mov    %edx,0xf022ce88
f010144e:	eb 0c                	jmp    f010145c <mem_init+0x90>
	else
		npages = npages_basemem;
f0101450:	8b 15 44 c2 22 f0    	mov    0xf022c244,%edx
f0101456:	89 15 88 ce 22 f0    	mov    %edx,0xf022ce88
...
f0101462:	89 44 24 0c          	mov    %eax,0xc(%esp)
		npages * PGSIZE / 1024,
		npages_basemem * PGSIZE / 1024,
f0101466:	a1 44 c2 22 f0       	mov    0xf022c244,%eax
...
f0101471:	89 44 24 08          	mov    %eax,0x8(%esp)
		npages * PGSIZE / 1024,
f0101475:	a1 88 ce 22 f0       	mov    0xf022ce88,%eax
...
f0101484:	c7 04 24 80 70 10 f0 	movl   $0xf0107080,(%esp)
...
f010149a:	a3 8c ce 22 f0       	mov    %eax,0xf022ce8c
...
f01014b2:	e8 80 48 00 00       	call   f0105d37 <memset>
...
f01014b7:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f01014c7:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f01014ce:	f0 
f01014cf:	c7 44 24 04 93 00 00 	movl   $0x93,0x4(%esp)
f01014d6:	00 
f01014d7:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01014f2:	a1 88 ce 22 f0       	mov    0xf022ce88,%eax
f01014f7:	c1 e0 03             	shl    $0x3,%eax
f01014fa:	e8 41 f5 ff ff       	call   f0100a40 <boot_alloc>
f01014ff:	a3 90 ce 22 f0       	mov    %eax,0xf022ce90
	memset(pages, 0, npages*sizeof(struct PageInfo));
f0101504:	8b 0d 88 ce 22 f0    	mov    0xf022ce88,%ecx
...
f0101520:	e8 12 48 00 00       	call   f0105d37 <memset>
...
f010152f:	a3 48 c2 22 f0       	mov    %eax,0xf022c248
...
f0101547:	e8 eb 47 00 00       	call   f0105d37 <memset>
...
f0101556:	e8 dc f5 ff ff       	call   f0100b37 <check_page_free_list>
	...
	if (!pages)
f010155b:	83 3d 90 ce 22 f0 00 	cmpl   $0x0,0xf022ce90
f0101562:	75 1c                	jne    f0101580 <mem_init+0x1b4>
		panic("'pages' is a null pointer!");
f0101564:	c7 44 24 08 83 79 10 	movl   $0xf0107983,0x8(%esp)
f010156b:	f0 
f010156c:	c7 44 24 04 21 03 00 	movl   $0x321,0x4(%esp)
f0101573:	00 
f0101574:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f010157b:	e8 c0 ea ff ff       	call   f0100040 <_panic>

	// check number of free pages
	for (pp = page_free_list, nfree = 0; pp; pp = pp->pp_link)
f0101580:	a1 40 c2 22 f0       	mov    0xf022c240,%eax
...
f01015a7:	c7 44 24 0c 9e 79 10 	movl   $0xf010799e,0xc(%esp)
f01015ae:	f0 
f01015af:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01015b6:	f0 
f01015b7:	c7 44 24 04 29 03 00 	movl   $0x329,0x4(%esp)
f01015be:	00 
f01015bf:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01015dd:	c7 44 24 0c b4 79 10 	movl   $0xf01079b4,0xc(%esp)
f01015e4:	f0 
f01015e5:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01015ec:	f0 
f01015ed:	c7 44 24 04 2a 03 00 	movl   $0x32a,0x4(%esp)
f01015f4:	00 
f01015f5:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101614:	c7 44 24 0c ca 79 10 	movl   $0xf01079ca,0xc(%esp)
f010161b:	f0 
f010161c:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101623:	f0 
f0101624:	c7 44 24 04 2b 03 00 	movl   $0x32b,0x4(%esp)
f010162b:	00 
f010162c:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f010163c:	c7 44 24 0c e0 79 10 	movl   $0xf01079e0,0xc(%esp)
f0101643:	f0 
f0101644:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010164b:	f0 
f010164c:	c7 44 24 04 2e 03 00 	movl   $0x32e,0x4(%esp)
f0101653:	00 
f0101654:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f010166b:	c7 44 24 0c bc 70 10 	movl   $0xf01070bc,0xc(%esp)
f0101672:	f0 
f0101673:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010167a:	f0 
f010167b:	c7 44 24 04 2f 03 00 	movl   $0x32f,0x4(%esp)
f0101682:	00 
f0101683:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
{
	return (pp - pages) << PGSHIFT;
f010168f:	8b 15 90 ce 22 f0    	mov    0xf022ce90,%edx
	assert(page2pa(pp0) < npages*PGSIZE);
f0101695:	a1 88 ce 22 f0       	mov    0xf022ce88,%eax
...
f01016ab:	c7 44 24 0c f2 79 10 	movl   $0xf01079f2,0xc(%esp)
f01016b2:	f0 
f01016b3:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01016ba:	f0 
f01016bb:	c7 44 24 04 30 03 00 	movl   $0x330,0x4(%esp)
f01016c2:	00 
f01016c3:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01016dd:	c7 44 24 0c 0f 7a 10 	movl   $0xf0107a0f,0xc(%esp)
f01016e4:	f0 
f01016e5:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01016ec:	f0 
f01016ed:	c7 44 24 04 31 03 00 	movl   $0x331,0x4(%esp)
f01016f4:	00 
f01016f5:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101712:	c7 44 24 0c 2c 7a 10 	movl   $0xf0107a2c,0xc(%esp)
f0101719:	f0 
f010171a:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101721:	f0 
f0101722:	c7 44 24 04 32 03 00 	movl   $0x332,0x4(%esp)
f0101729:	00 
f010172a:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0101731:	e8 0a e9 ff ff       	call   f0100040 <_panic>

	// temporarily steal the rest of the free pages
	fl = page_free_list;
f0101736:	a1 40 c2 22 f0       	mov    0xf022c240,%eax
f010173b:	89 45 d0             	mov    %eax,-0x30(%ebp)
	page_free_list = 0;
f010173e:	c7 05 40 c2 22 f0 00 	movl   $0x0,0xf022c240
f0101745:	00 00 00 
...
f0101758:	c7 44 24 0c 49 7a 10 	movl   $0xf0107a49,0xc(%esp)
f010175f:	f0 
f0101760:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101767:	f0 
f0101768:	c7 44 24 04 39 03 00 	movl   $0x339,0x4(%esp)
f010176f:	00 
f0101770:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01017a9:	c7 44 24 0c 9e 79 10 	movl   $0xf010799e,0xc(%esp)
f01017b0:	f0 
f01017b1:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01017b8:	f0 
f01017b9:	c7 44 24 04 40 03 00 	movl   $0x340,0x4(%esp)
f01017c0:	00 
f01017c1:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01017df:	c7 44 24 0c b4 79 10 	movl   $0xf01079b4,0xc(%esp)
f01017e6:	f0 
f01017e7:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01017ee:	f0 
f01017ef:	c7 44 24 04 41 03 00 	movl   $0x341,0x4(%esp)
f01017f6:	00 
f01017f7:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101816:	c7 44 24 0c ca 79 10 	movl   $0xf01079ca,0xc(%esp)
f010181d:	f0 
f010181e:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101825:	f0 
f0101826:	c7 44 24 04 42 03 00 	movl   $0x342,0x4(%esp)
f010182d:	00 
f010182e:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0101835:	e8 06 e8 ff ff       	call   f0100040 <_panic>
	assert(pp0);
	assert(pp1 && pp1 != pp0);
f010183a:	39 fe                	cmp    %edi,%esi
f010183c:	75 24                	jne    f0101862 <mem_init+0x496>
f010183e:	c7 44 24 0c e0 79 10 	movl   $0xf01079e0,0xc(%esp)
f0101845:	f0 
f0101846:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010184d:	f0 
f010184e:	c7 44 24 04 44 03 00 	movl   $0x344,0x4(%esp)
f0101855:	00 
f0101856:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f010186d:	c7 44 24 0c bc 70 10 	movl   $0xf01070bc,0xc(%esp)
f0101874:	f0 
f0101875:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010187c:	f0 
f010187d:	c7 44 24 04 45 03 00 	movl   $0x345,0x4(%esp)
f0101884:	00 
f0101885:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01018a1:	c7 44 24 0c 49 7a 10 	movl   $0xf0107a49,0xc(%esp)
f01018a8:	f0 
f01018a9:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01018b0:	f0 
f01018b1:	c7 44 24 04 46 03 00 	movl   $0x346,0x4(%esp)
f01018b8:	00 
f01018b9:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f01018c0:	e8 7b e7 ff ff       	call   f0100040 <_panic>
f01018c5:	89 f0                	mov    %esi,%eax
f01018c7:	2b 05 90 ce 22 f0    	sub    0xf022ce90,%eax
...
f01018d8:	3b 15 88 ce 22 f0    	cmp    0xf022ce88,%edx
f01018de:	72 20                	jb     f0101900 <mem_init+0x534>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f01018e0:	89 44 24 0c          	mov    %eax,0xc(%esp)
f01018e4:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f01018eb:	f0 
f01018ec:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
f01018f3:	00 
f01018f4:	c7 04 24 99 78 10 f0 	movl   $0xf0107899,(%esp)
...
f0101918:	e8 1a 44 00 00       	call   f0105d37 <memset>
	page_free(pp0);
...
f0101935:	c7 44 24 0c 58 7a 10 	movl   $0xf0107a58,0xc(%esp)
f010193c:	f0 
f010193d:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101944:	f0 
f0101945:	c7 44 24 04 4b 03 00 	movl   $0x34b,0x4(%esp)
f010194c:	00 
f010194d:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0101954:	e8 e7 e6 ff ff       	call   f0100040 <_panic>
	assert(pp && pp0 == pp);
f0101959:	39 c6                	cmp    %eax,%esi
f010195b:	74 24                	je     f0101981 <mem_init+0x5b5>
f010195d:	c7 44 24 0c 76 7a 10 	movl   $0xf0107a76,0xc(%esp)
f0101964:	f0 
f0101965:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010196c:	f0 
f010196d:	c7 44 24 04 4c 03 00 	movl   $0x34c,0x4(%esp)
f0101974:	00 
f0101975:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101983:	2b 05 90 ce 22 f0    	sub    0xf022ce90,%eax
...
f0101994:	3b 15 88 ce 22 f0    	cmp    0xf022ce88,%edx
f010199a:	72 20                	jb     f01019bc <mem_init+0x5f0>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f010199c:	89 44 24 0c          	mov    %eax,0xc(%esp)
f01019a0:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f01019a7:	f0 
f01019a8:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
f01019af:	00 
f01019b0:	c7 04 24 99 78 10 f0 	movl   $0xf0107899,(%esp)
...
f01019cd:	c7 44 24 0c 86 7a 10 	movl   $0xf0107a86,0xc(%esp)
f01019d4:	f0 
f01019d5:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01019dc:	f0 
f01019dd:	c7 44 24 04 4f 03 00 	movl   $0x34f,0x4(%esp)
f01019e4:	00 
f01019e5:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01019fb:	a3 40 c2 22 f0       	mov    %eax,0xf022c240
...
f0101a16:	e8 42 f6 ff ff       	call   f010105d <page_free>
	...
	for (pp = page_free_list; pp; pp = pp->pp_link)
f0101a1b:	a1 40 c2 22 f0       	mov    0xf022c240,%eax
...
f0101a2f:	c7 44 24 0c 90 7a 10 	movl   $0xf0107a90,0xc(%esp)
f0101a36:	f0 
f0101a37:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101a3e:	f0 
f0101a3f:	c7 44 24 04 5c 03 00 	movl   $0x35c,0x4(%esp)
f0101a46:	00 
f0101a47:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0101a4e:	e8 ed e5 ff ff       	call   f0100040 <_panic>

	cprintf("check_page_alloc() succeeded!\n");
f0101a53:	c7 04 24 dc 70 10 f0 	movl   $0xf01070dc,(%esp)
...
f0101a72:	c7 44 24 0c 9e 79 10 	movl   $0xf010799e,0xc(%esp)
f0101a79:	f0 
f0101a7a:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101a81:	f0 
f0101a82:	c7 44 24 04 c2 03 00 	movl   $0x3c2,0x4(%esp)
f0101a89:	00 
f0101a8a:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101aa8:	c7 44 24 0c b4 79 10 	movl   $0xf01079b4,0xc(%esp)
f0101aaf:	f0 
f0101ab0:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101ab7:	f0 
f0101ab8:	c7 44 24 04 c3 03 00 	movl   $0x3c3,0x4(%esp)
f0101abf:	00 
f0101ac0:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101ade:	c7 44 24 0c ca 79 10 	movl   $0xf01079ca,0xc(%esp)
f0101ae5:	f0 
f0101ae6:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101aed:	f0 
f0101aee:	c7 44 24 04 c4 03 00 	movl   $0x3c4,0x4(%esp)
f0101af5:	00 
f0101af6:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101b07:	c7 44 24 0c e0 79 10 	movl   $0xf01079e0,0xc(%esp)
f0101b0e:	f0 
f0101b0f:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101b16:	f0 
f0101b17:	c7 44 24 04 c7 03 00 	movl   $0x3c7,0x4(%esp)
f0101b1e:	00 
f0101b1f:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101b34:	c7 44 24 0c bc 70 10 	movl   $0xf01070bc,0xc(%esp)
f0101b3b:	f0 
f0101b3c:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101b43:	f0 
f0101b44:	c7 44 24 04 c8 03 00 	movl   $0x3c8,0x4(%esp)
f0101b4b:	00 
f0101b4c:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0101b53:	e8 e8 e4 ff ff       	call   f0100040 <_panic>

	// temporarily steal the rest of the free pages
	fl = page_free_list;
f0101b58:	a1 40 c2 22 f0       	mov    0xf022c240,%eax
f0101b5d:	89 45 d0             	mov    %eax,-0x30(%ebp)
	page_free_list = 0;
f0101b60:	c7 05 40 c2 22 f0 00 	movl   $0x0,0xf022c240
f0101b67:	00 00 00 
...
f0101b7a:	c7 44 24 0c 49 7a 10 	movl   $0xf0107a49,0xc(%esp)
f0101b81:	f0 
f0101b82:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101b89:	f0 
f0101b8a:	c7 44 24 04 cf 03 00 	movl   $0x3cf,0x4(%esp)
f0101b91:	00 
f0101b92:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101bac:	00 
f0101bad:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0101bbe:	c7 44 24 0c fc 70 10 	movl   $0xf01070fc,0xc(%esp)
f0101bc5:	f0 
f0101bc6:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101bcd:	f0 
f0101bce:	c7 44 24 04 d2 03 00 	movl   $0x3d2,0x4(%esp)
f0101bd5:	00 
f0101bd6:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101bf6:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0101c07:	c7 44 24 0c 34 71 10 	movl   $0xf0107134,0xc(%esp)
f0101c0e:	f0 
f0101c0f:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101c16:	f0 
f0101c17:	c7 44 24 04 d5 03 00 	movl   $0x3d5,0x4(%esp)
f0101c1e:	00 
f0101c1f:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101c4a:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0101c5b:	c7 44 24 0c 64 71 10 	movl   $0xf0107164,0xc(%esp)
f0101c62:	f0 
f0101c63:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101c6a:	f0 
f0101c6b:	c7 44 24 04 d9 03 00 	movl   $0x3d9,0x4(%esp)
f0101c72:	00 
f0101c73:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0101c7a:	e8 c1 e3 ff ff       	call   f0100040 <_panic>
	assert(PTE_ADDR(kern_pgdir[0]) == page2pa(pp0));
f0101c7f:	8b 3d 8c ce 22 f0    	mov    0xf022ce8c,%edi
void	user_mem_assert(struct Env *env, const void *va, size_t len, int perm);
...
{
	return (pp - pages) << PGSHIFT;
f0101c85:	a1 90 ce 22 f0       	mov    0xf022ce90,%eax
...
f0101ca6:	c7 44 24 0c 94 71 10 	movl   $0xf0107194,0xc(%esp)
f0101cad:	f0 
f0101cae:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101cb5:	f0 
f0101cb6:	c7 44 24 04 da 03 00 	movl   $0x3da,0x4(%esp)
f0101cbd:	00 
f0101cbe:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101ce5:	c7 44 24 0c bc 71 10 	movl   $0xf01071bc,0xc(%esp)
f0101cec:	f0 
f0101ced:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101cf4:	f0 
f0101cf5:	c7 44 24 04 db 03 00 	movl   $0x3db,0x4(%esp)
f0101cfc:	00 
f0101cfd:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101d10:	c7 44 24 0c 9b 7a 10 	movl   $0xf0107a9b,0xc(%esp)
f0101d17:	f0 
f0101d18:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101d1f:	f0 
f0101d20:	c7 44 24 04 dc 03 00 	movl   $0x3dc,0x4(%esp)
f0101d27:	00 
f0101d28:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101d3e:	c7 44 24 0c ac 7a 10 	movl   $0xf0107aac,0xc(%esp)
f0101d45:	f0 
f0101d46:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101d4d:	f0 
f0101d4e:	c7 44 24 04 dd 03 00 	movl   $0x3dd,0x4(%esp)
f0101d55:	00 
f0101d56:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101d82:	c7 44 24 0c ec 71 10 	movl   $0xf01071ec,0xc(%esp)
f0101d89:	f0 
f0101d8a:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101d91:	f0 
f0101d92:	c7 44 24 04 e0 03 00 	movl   $0x3e0,0x4(%esp)
f0101d99:	00 
f0101d9a:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0101da1:	e8 9a e2 ff ff       	call   f0100040 <_panic>
	assert(check_va2pa(kern_pgdir, PGSIZE) == page2pa(pp2));
f0101da6:	ba 00 10 00 00       	mov    $0x1000,%edx
f0101dab:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
f0101db0:	e8 13 ed ff ff       	call   f0100ac8 <check_va2pa>
f0101db5:	89 f2                	mov    %esi,%edx
f0101db7:	2b 15 90 ce 22 f0    	sub    0xf022ce90,%edx
...
f0101dc7:	c7 44 24 0c 28 72 10 	movl   $0xf0107228,0xc(%esp)
f0101dce:	f0 
f0101dcf:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101dd6:	f0 
f0101dd7:	c7 44 24 04 e1 03 00 	movl   $0x3e1,0x4(%esp)
f0101dde:	00 
f0101ddf:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101df2:	c7 44 24 0c bd 7a 10 	movl   $0xf0107abd,0xc(%esp)
f0101df9:	f0 
f0101dfa:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101e01:	f0 
f0101e02:	c7 44 24 04 e2 03 00 	movl   $0x3e2,0x4(%esp)
f0101e09:	00 
f0101e0a:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101e26:	c7 44 24 0c 49 7a 10 	movl   $0xf0107a49,0xc(%esp)
f0101e2d:	f0 
f0101e2e:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101e35:	f0 
f0101e36:	c7 44 24 04 e5 03 00 	movl   $0x3e5,0x4(%esp)
f0101e3d:	00 
f0101e3e:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101e5e:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0101e6f:	c7 44 24 0c ec 71 10 	movl   $0xf01071ec,0xc(%esp)
f0101e76:	f0 
f0101e77:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101e7e:	f0 
f0101e7f:	c7 44 24 04 e8 03 00 	movl   $0x3e8,0x4(%esp)
f0101e86:	00 
f0101e87:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0101e8e:	e8 ad e1 ff ff       	call   f0100040 <_panic>
	assert(check_va2pa(kern_pgdir, PGSIZE) == page2pa(pp2));
f0101e93:	ba 00 10 00 00       	mov    $0x1000,%edx
f0101e98:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
f0101e9d:	e8 26 ec ff ff       	call   f0100ac8 <check_va2pa>
f0101ea2:	89 f2                	mov    %esi,%edx
f0101ea4:	2b 15 90 ce 22 f0    	sub    0xf022ce90,%edx
...
f0101eb4:	c7 44 24 0c 28 72 10 	movl   $0xf0107228,0xc(%esp)
f0101ebb:	f0 
f0101ebc:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101ec3:	f0 
f0101ec4:	c7 44 24 04 e9 03 00 	movl   $0x3e9,0x4(%esp)
f0101ecb:	00 
f0101ecc:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101edf:	c7 44 24 0c bd 7a 10 	movl   $0xf0107abd,0xc(%esp)
f0101ee6:	f0 
f0101ee7:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101eee:	f0 
f0101eef:	c7 44 24 04 ea 03 00 	movl   $0x3ea,0x4(%esp)
f0101ef6:	00 
f0101ef7:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101f13:	c7 44 24 0c 49 7a 10 	movl   $0xf0107a49,0xc(%esp)
f0101f1a:	f0 
f0101f1b:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101f22:	f0 
f0101f23:	c7 44 24 04 ee 03 00 	movl   $0x3ee,0x4(%esp)
f0101f2a:	00 
f0101f2b:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0101f32:	e8 09 e1 ff ff       	call   f0100040 <_panic>

	// check that pgdir_walk returns a pointer to the pte
	ptep = (pte_t *) KADDR(PTE_ADDR(kern_pgdir[PDX(PGSIZE)]));
f0101f37:	8b 15 8c ce 22 f0    	mov    0xf022ce8c,%edx
...
f0101f49:	3b 0d 88 ce 22 f0    	cmp    0xf022ce88,%ecx
f0101f4f:	72 20                	jb     f0101f71 <mem_init+0xba5>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0101f51:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0101f55:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f0101f5c:	f0 
f0101f5d:	c7 44 24 04 f1 03 00 	movl   $0x3f1,0x4(%esp)
f0101f64:	00 
f0101f65:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101f9b:	c7 44 24 0c 58 72 10 	movl   $0xf0107258,0xc(%esp)
f0101fa2:	f0 
f0101fa3:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101faa:	f0 
f0101fab:	c7 44 24 04 f2 03 00 	movl   $0x3f2,0x4(%esp)
f0101fb2:	00 
f0101fb3:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0101fd3:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0101fe4:	c7 44 24 0c 98 72 10 	movl   $0xf0107298,0xc(%esp)
f0101feb:	f0 
f0101fec:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0101ff3:	f0 
f0101ff4:	c7 44 24 04 f5 03 00 	movl   $0x3f5,0x4(%esp)
f0101ffb:	00 
f0101ffc:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0102003:	e8 38 e0 ff ff       	call   f0100040 <_panic>
	assert(check_va2pa(kern_pgdir, PGSIZE) == page2pa(pp2));
f0102008:	8b 3d 8c ce 22 f0    	mov    0xf022ce8c,%edi
...
f010201c:	2b 15 90 ce 22 f0    	sub    0xf022ce90,%edx
...
f010202c:	c7 44 24 0c 28 72 10 	movl   $0xf0107228,0xc(%esp)
f0102033:	f0 
f0102034:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010203b:	f0 
f010203c:	c7 44 24 04 f6 03 00 	movl   $0x3f6,0x4(%esp)
f0102043:	00 
f0102044:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102057:	c7 44 24 0c bd 7a 10 	movl   $0xf0107abd,0xc(%esp)
f010205e:	f0 
f010205f:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102066:	f0 
f0102067:	c7 44 24 04 f7 03 00 	movl   $0x3f7,0x4(%esp)
f010206e:	00 
f010206f:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102098:	c7 44 24 0c d8 72 10 	movl   $0xf01072d8,0xc(%esp)
f010209f:	f0 
f01020a0:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01020a7:	f0 
f01020a8:	c7 44 24 04 f8 03 00 	movl   $0x3f8,0x4(%esp)
f01020af:	00 
f01020b0:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f01020b7:	e8 84 df ff ff       	call   f0100040 <_panic>
	assert(kern_pgdir[0] & PTE_U);
f01020bc:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
f01020c1:	f6 00 04             	testb  $0x4,(%eax)
f01020c4:	75 24                	jne    f01020ea <mem_init+0xd1e>
f01020c6:	c7 44 24 0c ce 7a 10 	movl   $0xf0107ace,0xc(%esp)
f01020cd:	f0 
f01020ce:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01020d5:	f0 
f01020d6:	c7 44 24 04 f9 03 00 	movl   $0x3f9,0x4(%esp)
f01020dd:	00 
f01020de:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f010210a:	c7 44 24 0c ec 71 10 	movl   $0xf01071ec,0xc(%esp)
f0102111:	f0 
f0102112:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102119:	f0 
f010211a:	c7 44 24 04 fc 03 00 	movl   $0x3fc,0x4(%esp)
f0102121:	00 
f0102122:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f010213d:	00 
f010213e:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0102150:	c7 44 24 0c 0c 73 10 	movl   $0xf010730c,0xc(%esp)
f0102157:	f0 
f0102158:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010215f:	f0 
f0102160:	c7 44 24 04 fd 03 00 	movl   $0x3fd,0x4(%esp)
f0102167:	00 
f0102168:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102183:	00 
f0102184:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0102196:	c7 44 24 0c 40 73 10 	movl   $0xf0107340,0xc(%esp)
f010219d:	f0 
f010219e:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01021a5:	f0 
f01021a6:	c7 44 24 04 fe 03 00 	movl   $0x3fe,0x4(%esp)
f01021ad:	00 
f01021ae:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01021e2:	c7 44 24 0c 78 73 10 	movl   $0xf0107378,0xc(%esp)
f01021e9:	f0 
f01021ea:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01021f1:	f0 
f01021f2:	c7 44 24 04 01 04 00 	movl   $0x401,0x4(%esp)
f01021f9:	00 
f01021fa:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f010221a:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f010222b:	c7 44 24 0c b0 73 10 	movl   $0xf01073b0,0xc(%esp)
f0102232:	f0 
f0102233:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010223a:	f0 
f010223b:	c7 44 24 04 04 04 00 	movl   $0x404,0x4(%esp)
f0102242:	00 
f0102243:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f010225e:	00 
f010225f:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0102271:	c7 44 24 0c 40 73 10 	movl   $0xf0107340,0xc(%esp)
f0102278:	f0 
f0102279:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102280:	f0 
f0102281:	c7 44 24 04 05 04 00 	movl   $0x405,0x4(%esp)
f0102288:	00 
f0102289:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0102290:	e8 ab dd ff ff       	call   f0100040 <_panic>

	// should have pp1 at both 0 and PGSIZE, pp2 nowhere, ...
	assert(check_va2pa(kern_pgdir, 0) == page2pa(pp1));
f0102295:	8b 3d 8c ce 22 f0    	mov    0xf022ce8c,%edi
...
f01022ae:	2b 05 90 ce 22 f0    	sub    0xf022ce90,%eax
...
f01022be:	c7 44 24 0c ec 73 10 	movl   $0xf01073ec,0xc(%esp)
f01022c5:	f0 
f01022c6:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01022cd:	f0 
f01022ce:	c7 44 24 04 08 04 00 	movl   $0x408,0x4(%esp)
f01022d5:	00 
f01022d6:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01022f3:	c7 44 24 0c 18 74 10 	movl   $0xf0107418,0xc(%esp)
f01022fa:	f0 
f01022fb:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102302:	f0 
f0102303:	c7 44 24 04 09 04 00 	movl   $0x409,0x4(%esp)
f010230a:	00 
f010230b:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f010231e:	c7 44 24 0c e4 7a 10 	movl   $0xf0107ae4,0xc(%esp)
f0102325:	f0 
f0102326:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010232d:	f0 
f010232e:	c7 44 24 04 0b 04 00 	movl   $0x40b,0x4(%esp)
f0102335:	00 
f0102336:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102349:	c7 44 24 0c f5 7a 10 	movl   $0xf0107af5,0xc(%esp)
f0102350:	f0 
f0102351:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102358:	f0 
f0102359:	c7 44 24 04 0c 04 00 	movl   $0x40c,0x4(%esp)
f0102360:	00 
f0102361:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102381:	c7 44 24 0c 48 74 10 	movl   $0xf0107448,0xc(%esp)
f0102388:	f0 
f0102389:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102390:	f0 
f0102391:	c7 44 24 04 0f 04 00 	movl   $0x40f,0x4(%esp)
f0102398:	00 
f0102399:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01023ac:	00 
f01023ad:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
f01023b2:	89 04 24             	mov    %eax,(%esp)
f01023b5:	e8 b1 ee ff ff       	call   f010126b <page_remove>
	assert(check_va2pa(kern_pgdir, 0x0) == ~0);
f01023ba:	8b 3d 8c ce 22 f0    	mov    0xf022ce8c,%edi
...
f01023d1:	c7 44 24 0c 6c 74 10 	movl   $0xf010746c,0xc(%esp)
f01023d8:	f0 
f01023d9:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01023e0:	f0 
f01023e1:	c7 44 24 04 13 04 00 	movl   $0x413,0x4(%esp)
f01023e8:	00 
f01023e9:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102403:	2b 15 90 ce 22 f0    	sub    0xf022ce90,%edx
...
f0102413:	c7 44 24 0c 18 74 10 	movl   $0xf0107418,0xc(%esp)
f010241a:	f0 
f010241b:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102422:	f0 
f0102423:	c7 44 24 04 14 04 00 	movl   $0x414,0x4(%esp)
f010242a:	00 
f010242b:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f010243e:	c7 44 24 0c 9b 7a 10 	movl   $0xf0107a9b,0xc(%esp)
f0102445:	f0 
f0102446:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010244d:	f0 
f010244e:	c7 44 24 04 15 04 00 	movl   $0x415,0x4(%esp)
f0102455:	00 
f0102456:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102469:	c7 44 24 0c f5 7a 10 	movl   $0xf0107af5,0xc(%esp)
f0102470:	f0 
f0102471:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102478:	f0 
f0102479:	c7 44 24 04 16 04 00 	movl   $0x416,0x4(%esp)
f0102480:	00 
f0102481:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01024ad:	c7 44 24 0c 90 74 10 	movl   $0xf0107490,0xc(%esp)
f01024b4:	f0 
f01024b5:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01024bc:	f0 
f01024bd:	c7 44 24 04 19 04 00 	movl   $0x419,0x4(%esp)
f01024c4:	00 
f01024c5:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01024d8:	c7 44 24 0c 06 7b 10 	movl   $0xf0107b06,0xc(%esp)
f01024df:	f0 
f01024e0:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01024e7:	f0 
f01024e8:	c7 44 24 04 1a 04 00 	movl   $0x41a,0x4(%esp)
f01024ef:	00 
f01024f0:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f01024f7:	e8 44 db ff ff       	call   f0100040 <_panic>
	assert(pp1->pp_link == NULL);
f01024fc:	83 3b 00             	cmpl   $0x0,(%ebx)
f01024ff:	74 24                	je     f0102525 <mem_init+0x1159>
f0102501:	c7 44 24 0c 12 7b 10 	movl   $0xf0107b12,0xc(%esp)
f0102508:	f0 
f0102509:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102510:	f0 
f0102511:	c7 44 24 04 1b 04 00 	movl   $0x41b,0x4(%esp)
f0102518:	00 
f0102519:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f010252c:	00 
f010252d:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
f0102532:	89 04 24             	mov    %eax,(%esp)
f0102535:	e8 31 ed ff ff       	call   f010126b <page_remove>
	assert(check_va2pa(kern_pgdir, 0x0) == ~0);
f010253a:	8b 3d 8c ce 22 f0    	mov    0xf022ce8c,%edi
...
f0102551:	c7 44 24 0c 6c 74 10 	movl   $0xf010746c,0xc(%esp)
f0102558:	f0 
f0102559:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102560:	f0 
f0102561:	c7 44 24 04 1f 04 00 	movl   $0x41f,0x4(%esp)
f0102568:	00 
f0102569:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102586:	c7 44 24 0c c8 74 10 	movl   $0xf01074c8,0xc(%esp)
f010258d:	f0 
f010258e:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102595:	f0 
f0102596:	c7 44 24 04 20 04 00 	movl   $0x420,0x4(%esp)
f010259d:	00 
f010259e:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01025b1:	c7 44 24 0c 27 7b 10 	movl   $0xf0107b27,0xc(%esp)
f01025b8:	f0 
f01025b9:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01025c0:	f0 
f01025c1:	c7 44 24 04 21 04 00 	movl   $0x421,0x4(%esp)
f01025c8:	00 
f01025c9:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01025dc:	c7 44 24 0c f5 7a 10 	movl   $0xf0107af5,0xc(%esp)
f01025e3:	f0 
f01025e4:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01025eb:	f0 
f01025ec:	c7 44 24 04 22 04 00 	movl   $0x422,0x4(%esp)
f01025f3:	00 
f01025f4:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102614:	c7 44 24 0c f0 74 10 	movl   $0xf01074f0,0xc(%esp)
f010261b:	f0 
f010261c:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102623:	f0 
f0102624:	c7 44 24 04 25 04 00 	movl   $0x425,0x4(%esp)
f010262b:	00 
f010262c:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102648:	c7 44 24 0c 49 7a 10 	movl   $0xf0107a49,0xc(%esp)
f010264f:	f0 
f0102650:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102657:	f0 
f0102658:	c7 44 24 04 28 04 00 	movl   $0x428,0x4(%esp)
f010265f:	00 
f0102660:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0102667:	e8 d4 d9 ff ff       	call   f0100040 <_panic>

	// forcibly take pp0 back
	assert(PTE_ADDR(kern_pgdir[0]) == page2pa(pp0));
f010266c:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
f0102671:	8b 08                	mov    (%eax),%ecx
f0102673:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
f0102679:	8b 55 d4             	mov    -0x2c(%ebp),%edx
f010267c:	2b 15 90 ce 22 f0    	sub    0xf022ce90,%edx
...
f010268c:	c7 44 24 0c 94 71 10 	movl   $0xf0107194,0xc(%esp)
f0102693:	f0 
f0102694:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010269b:	f0 
f010269c:	c7 44 24 04 2b 04 00 	movl   $0x42b,0x4(%esp)
f01026a3:	00 
f01026a4:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01026c0:	c7 44 24 0c ac 7a 10 	movl   $0xf0107aac,0xc(%esp)
f01026c7:	f0 
f01026c8:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01026cf:	f0 
f01026d0:	c7 44 24 04 2d 04 00 	movl   $0x42d,0x4(%esp)
f01026d7:	00 
f01026d8:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102704:	00 
f0102705:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0102718:	8b 15 8c ce 22 f0    	mov    0xf022ce8c,%edx
...
{
	if (PGNUM(pa) >= npages)
f0102727:	8b 0d 88 ce 22 f0    	mov    0xf022ce88,%ecx
...
f010273a:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f0102741:	f0 
f0102742:	c7 44 24 04 34 04 00 	movl   $0x434,0x4(%esp)
f0102749:	00 
f010274a:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102761:	c7 44 24 0c 38 7b 10 	movl   $0xf0107b38,0xc(%esp)
f0102768:	f0 
f0102769:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102770:	f0 
f0102771:	c7 44 24 04 35 04 00 	movl   $0x435,0x4(%esp)
f0102778:	00 
f0102779:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
{
	return (pp - pages) << PGSHIFT;
f0102795:	2b 05 90 ce 22 f0    	sub    0xf022ce90,%eax
...
f01027ae:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f01027b5:	f0 
f01027b6:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
f01027bd:	00 
f01027be:	c7 04 24 99 78 10 f0 	movl   $0xf0107899,(%esp)
...
f01027e2:	e8 50 35 00 00       	call   f0105d37 <memset>
	page_free(pp0);
...
f0102801:	00 
f0102802:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0102811:	2b 15 90 ce 22 f0    	sub    0xf022ce90,%edx
...
f0102822:	3b 05 88 ce 22 f0    	cmp    0xf022ce88,%eax
f0102828:	72 20                	jb     f010284a <mem_init+0x147e>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f010282a:	89 54 24 0c          	mov    %edx,0xc(%esp)
f010282e:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f0102835:	f0 
f0102836:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
f010283d:	00 
f010283e:	c7 04 24 99 78 10 f0 	movl   $0xf0107899,(%esp)
...
f010285e:	c7 44 24 0c 50 7b 10 	movl   $0xf0107b50,0xc(%esp)
f0102865:	f0 
f0102866:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010286d:	f0 
f010286e:	c7 44 24 04 3f 04 00 	movl   $0x43f,0x4(%esp)
f0102875:	00 
f0102876:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102887:	75 d0                	jne    f0102859 <mem_init+0x148d>
		assert((ptep[i] & PTE_P) == 0);
	kern_pgdir[0] = 0;
f0102889:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f01028a0:	89 0d 40 c2 22 f0    	mov    %ecx,0xf022c240
...
f01028ff:	c7 44 24 0c 14 75 10 	movl   $0xf0107514,0xc(%esp)
f0102906:	f0 
f0102907:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010290e:	f0 
f010290f:	c7 44 24 04 4f 04 00 	movl   $0x44f,0x4(%esp)
f0102916:	00 
f0102917:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102939:	c7 44 24 0c 3c 75 10 	movl   $0xf010753c,0xc(%esp)
f0102940:	f0 
f0102941:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102948:	f0 
f0102949:	c7 44 24 04 50 04 00 	movl   $0x450,0x4(%esp)
f0102950:	00 
f0102951:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102969:	c7 44 24 0c 64 75 10 	movl   $0xf0107564,0xc(%esp)
f0102970:	f0 
f0102971:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102978:	f0 
f0102979:	c7 44 24 04 52 04 00 	movl   $0x452,0x4(%esp)
f0102980:	00 
f0102981:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f0102988:	e8 b3 d6 ff ff       	call   f0100040 <_panic>
	// check that they don't overlap
	assert(mm1 + 8096 <= mm2);
f010298d:	39 c6                	cmp    %eax,%esi
f010298f:	73 24                	jae    f01029b5 <mem_init+0x15e9>
f0102991:	c7 44 24 0c 67 7b 10 	movl   $0xf0107b67,0xc(%esp)
f0102998:	f0 
f0102999:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01029a0:	f0 
f01029a1:	c7 44 24 04 54 04 00 	movl   $0x454,0x4(%esp)
f01029a8:	00 
f01029a9:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f01029b0:	e8 8b d6 ff ff       	call   f0100040 <_panic>
	// check page mappings
	assert(check_va2pa(kern_pgdir, mm1) == 0);
f01029b5:	8b 3d 8c ce 22 f0    	mov    0xf022ce8c,%edi
...
f01029c8:	c7 44 24 0c 8c 75 10 	movl   $0xf010758c,0xc(%esp)
f01029cf:	f0 
f01029d0:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01029d7:	f0 
f01029d8:	c7 44 24 04 56 04 00 	movl   $0x456,0x4(%esp)
f01029df:	00 
f01029e0:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102a05:	c7 44 24 0c b0 75 10 	movl   $0xf01075b0,0xc(%esp)
f0102a0c:	f0 
f0102a0d:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102a14:	f0 
f0102a15:	c7 44 24 04 57 04 00 	movl   $0x457,0x4(%esp)
f0102a1c:	00 
f0102a1d:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102a36:	c7 44 24 0c e0 75 10 	movl   $0xf01075e0,0xc(%esp)
f0102a3d:	f0 
f0102a3e:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102a45:	f0 
f0102a46:	c7 44 24 04 58 04 00 	movl   $0x458,0x4(%esp)
f0102a4d:	00 
f0102a4e:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102a6c:	c7 44 24 0c 04 76 10 	movl   $0xf0107604,0xc(%esp)
f0102a73:	f0 
f0102a74:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102a7b:	f0 
f0102a7c:	c7 44 24 04 59 04 00 	movl   $0x459,0x4(%esp)
f0102a83:	00 
f0102a84:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102aa9:	c7 44 24 0c 30 76 10 	movl   $0xf0107630,0xc(%esp)
f0102ab0:	f0 
f0102ab1:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102ab8:	f0 
f0102ab9:	c7 44 24 04 5b 04 00 	movl   $0x45b,0x4(%esp)
f0102ac0:	00 
f0102ac1:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102ad9:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0102aeb:	c7 44 24 0c 74 76 10 	movl   $0xf0107674,0xc(%esp)
f0102af2:	f0 
f0102af3:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102afa:	f0 
f0102afb:	c7 44 24 04 5c 04 00 	movl   $0x45c,0x4(%esp)
f0102b02:	00 
f0102b03:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102b1b:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0102b3d:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0102b5c:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0102b6f:	c7 04 24 79 7b 10 f0 	movl   $0xf0107b79,(%esp)
...
f0102b7b:	a1 88 ce 22 f0       	mov    0xf022ce88,%eax
...
f0102b8d:	a1 90 ce 22 f0       	mov    0xf022ce90,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0102b9d:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0102ba4:	f0 
f0102ba5:	c7 44 24 04 bd 00 00 	movl   $0xbd,0x4(%esp)
f0102bac:	00 
f0102bad:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102bec:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0102bf3:	f0 
f0102bf4:	c7 44 24 04 be 00 00 	movl   $0xbe,0x4(%esp)
f0102bfb:	00 
f0102bfc:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102c1b:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0102c25:	a1 48 c2 22 f0       	mov    0xf022c248,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0102c35:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0102c3c:	f0 
f0102c3d:	c7 44 24 04 c8 00 00 	movl   $0xc8,0x4(%esp)
f0102c44:	00 
f0102c45:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102c87:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0102c8e:	f0 
f0102c8f:	c7 44 24 04 c9 00 00 	movl   $0xc9,0x4(%esp)
f0102c96:	00 
f0102c97:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102cb9:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0102cf6:	00 
f0102cf7:	c7 04 24 00 70 11 00 	movl   $0x117000,(%esp)
f0102cfe:	b9 00 80 00 00       	mov    $0x8000,%ecx
f0102d03:	ba 00 80 ff ef       	mov    $0xefff8000,%edx
f0102d08:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0102d2b:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
f0102d30:	e8 2b e4 ff ff       	call   f0101160 <boot_map_region>
f0102d35:	bf 00 e0 26 f0       	mov    $0xf026e000,%edi
f0102d3a:	bb 00 e0 22 f0       	mov    $0xf022e000,%ebx
...
f0102d50:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0102d57:	f0 
f0102d58:	c7 44 24 04 1f 01 00 	movl   $0x11f,0x4(%esp)
f0102d5f:	00 
f0102d60:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102d84:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
check_kern_pgdir(void)
{
	...
	pgdir = kern_pgdir;
f0102d9e:	8b 3d 8c ce 22 f0    	mov    0xf022ce8c,%edi

	// check pages array
	n = ROUNDUP(npages*sizeof(struct PageInfo), PGSIZE);
f0102da4:	a1 88 ce 22 f0       	mov    0xf022ce88,%eax
...
f0102dbb:	8b 35 90 ce 22 f0    	mov    0xf022ce90,%esi
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0102dee:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0102df5:	f0 
f0102df6:	c7 44 24 04 74 03 00 	movl   $0x374,0x4(%esp)
f0102dfd:	00 
f0102dfe:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102e14:	c7 44 24 0c a8 76 10 	movl   $0xf01076a8,0xc(%esp)
f0102e1b:	f0 
f0102e1c:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102e23:	f0 
f0102e24:	c7 44 24 04 74 03 00 	movl   $0x374,0x4(%esp)
f0102e2b:	00 
f0102e2c:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102e43:	8b 1d 48 c2 22 f0    	mov    0xf022c248,%ebx
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0102e63:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0102e6a:	f0 
f0102e6b:	c7 44 24 04 79 03 00 	movl   $0x379,0x4(%esp)
f0102e72:	00 
f0102e73:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102e91:	c7 44 24 0c dc 76 10 	movl   $0xf01076dc,0xc(%esp)
f0102e98:	f0 
f0102e99:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102ea0:	f0 
f0102ea1:	c7 44 24 04 79 03 00 	movl   $0x379,0x4(%esp)
f0102ea8:	00 
f0102ea9:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102ee5:	c7 44 24 0c 10 77 10 	movl   $0xf0107710,0xc(%esp)
f0102eec:	f0 
f0102eed:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102ef4:	f0 
f0102ef5:	c7 44 24 04 7d 03 00 	movl   $0x37d,0x4(%esp)
f0102efc:	00 
f0102efd:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102f13:	c7 45 d0 00 e0 22 f0 	movl   $0xf022e000,-0x30(%ebp)
f0102f1a:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
f0102f21:	be 00 80 ff ef       	mov    $0xefff8000,%esi
f0102f26:	b8 00 e0 22 f0       	mov    $0xf022e000,%eax
...
f0102f54:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0102f5b:	f0 
f0102f5c:	c7 44 24 04 85 03 00 	movl   $0x385,0x4(%esp)
f0102f63:	00 
f0102f64:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102f85:	c7 44 24 0c 38 77 10 	movl   $0xf0107738,0xc(%esp)
f0102f8c:	f0 
f0102f8d:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102f94:	f0 
f0102f95:	c7 44 24 04 85 03 00 	movl   $0x385,0x4(%esp)
f0102f9c:	00 
f0102f9d:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0102fcc:	c7 44 24 0c 80 77 10 	movl   $0xf0107780,0xc(%esp)
f0102fd3:	f0 
f0102fd4:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0102fdb:	f0 
f0102fdc:	c7 44 24 04 87 03 00 	movl   $0x387,0x4(%esp)
f0102fe3:	00 
f0102fe4:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0103039:	c7 44 24 0c 92 7b 10 	movl   $0xf0107b92,0xc(%esp)
f0103040:	f0 
f0103041:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0103048:	f0 
f0103049:	c7 44 24 04 92 03 00 	movl   $0x392,0x4(%esp)
f0103050:	00 
f0103051:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f010306c:	c7 44 24 0c 92 7b 10 	movl   $0xf0107b92,0xc(%esp)
f0103073:	f0 
f0103074:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010307b:	f0 
f010307c:	c7 44 24 04 96 03 00 	movl   $0x396,0x4(%esp)
f0103083:	00 
f0103084:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f010308b:	e8 b0 cf ff ff       	call   f0100040 <_panic>
				assert(pgdir[i] & PTE_W);
f0103090:	f6 c2 02             	test   $0x2,%dl
f0103093:	75 4e                	jne    f01030e3 <mem_init+0x1d17>
f0103095:	c7 44 24 0c a3 7b 10 	movl   $0xf0107ba3,0xc(%esp)
f010309c:	f0 
f010309d:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01030a4:	f0 
f01030a5:	c7 44 24 04 97 03 00 	movl   $0x397,0x4(%esp)
f01030ac:	00 
f01030ad:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01030bf:	c7 44 24 0c b4 7b 10 	movl   $0xf0107bb4,0xc(%esp)
f01030c6:	f0 
f01030c7:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01030ce:	f0 
f01030cf:	c7 44 24 04 99 03 00 	movl   $0x399,0x4(%esp)
f01030d6:	00 
f01030d7:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01030f1:	c7 04 24 a4 77 10 f0 	movl   $0xf01077a4,(%esp)
...
f010315b:	c7 44 24 0c 9e 79 10 	movl   $0xf010799e,0xc(%esp)
f0103162:	f0 
f0103163:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010316a:	f0 
f010316b:	c7 44 24 04 71 04 00 	movl   $0x471,0x4(%esp)
f0103172:	00 
f0103173:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0103191:	c7 44 24 0c b4 79 10 	movl   $0xf01079b4,0xc(%esp)
f0103198:	f0 
f0103199:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01031a0:	f0 
f01031a1:	c7 44 24 04 72 04 00 	movl   $0x472,0x4(%esp)
f01031a8:	00 
f01031a9:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01031c7:	c7 44 24 0c ca 79 10 	movl   $0xf01079ca,0xc(%esp)
f01031ce:	f0 
f01031cf:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01031d6:	f0 
f01031d7:	c7 44 24 04 73 04 00 	movl   $0x473,0x4(%esp)
f01031de:	00 
f01031df:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f010320d:	e8 25 2b 00 00       	call   f0105d37 <memset>
...
f010322c:	e8 06 2b 00 00       	call   f0105d37 <memset>
...
f0103245:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f0103259:	c7 44 24 0c 9b 7a 10 	movl   $0xf0107a9b,0xc(%esp)
f0103260:	f0 
f0103261:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0103268:	f0 
f0103269:	c7 44 24 04 78 04 00 	movl   $0x478,0x4(%esp)
f0103270:	00 
f0103271:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0103289:	c7 44 24 0c c4 77 10 	movl   $0xf01077c4,0xc(%esp)
f0103290:	f0 
f0103291:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0103298:	f0 
f0103299:	c7 44 24 04 79 04 00 	movl   $0x479,0x4(%esp)
f01032a0:	00 
f01032a1:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f01032c1:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f01032da:	c7 44 24 0c e8 77 10 	movl   $0xf01077e8,0xc(%esp)
f01032e1:	f0 
f01032e2:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01032e9:	f0 
f01032ea:	c7 44 24 04 7b 04 00 	movl   $0x47b,0x4(%esp)
f01032f1:	00 
f01032f2:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0103305:	c7 44 24 0c bd 7a 10 	movl   $0xf0107abd,0xc(%esp)
f010330c:	f0 
f010330d:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0103314:	f0 
f0103315:	c7 44 24 04 7c 04 00 	movl   $0x47c,0x4(%esp)
f010331c:	00 
f010331d:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0103330:	c7 44 24 0c 27 7b 10 	movl   $0xf0107b27,0xc(%esp)
f0103337:	f0 
f0103338:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010333f:	f0 
f0103340:	c7 44 24 04 7d 04 00 	movl   $0x47d,0x4(%esp)
f0103347:	00 
f0103348:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f010336d:	c7 44 24 0c 0c 78 10 	movl   $0xf010780c,0xc(%esp)
f0103374:	f0 
f0103375:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010337c:	f0 
f010337d:	c7 44 24 04 7f 04 00 	movl   $0x47f,0x4(%esp)
f0103384:	00 
f0103385:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f010338c:	e8 af cc ff ff       	call   f0100040 <_panic>
	page_remove(kern_pgdir, (void*) PGSIZE);
f0103391:	c7 44 24 04 00 10 00 	movl   $0x1000,0x4(%esp)
f0103398:	00 
f0103399:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f01033ad:	c7 44 24 0c f5 7a 10 	movl   $0xf0107af5,0xc(%esp)
f01033b4:	f0 
f01033b5:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01033bc:	f0 
f01033bd:	c7 44 24 04 81 04 00 	movl   $0x481,0x4(%esp)
f01033c4:	00 
f01033c5:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
f01033cc:	e8 6f cc ff ff       	call   f0100040 <_panic>

	// forcibly take pp0 back
	assert(PTE_ADDR(kern_pgdir[0]) == page2pa(pp0));
f01033d1:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
...
f01033e0:	2b 15 90 ce 22 f0    	sub    0xf022ce90,%edx
...
f01033f0:	c7 44 24 0c 94 71 10 	movl   $0xf0107194,0xc(%esp)
f01033f7:	f0 
f01033f8:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f01033ff:	f0 
f0103400:	c7 44 24 04 84 04 00 	movl   $0x484,0x4(%esp)
f0103407:	00 
f0103408:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0103421:	c7 44 24 0c ac 7a 10 	movl   $0xf0107aac,0xc(%esp)
f0103428:	f0 
f0103429:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0103430:	f0 
f0103431:	c7 44 24 04 86 04 00 	movl   $0x486,0x4(%esp)
f0103438:	00 
f0103439:	c7 04 24 a7 78 10 f0 	movl   $0xf01078a7,(%esp)
...
f0103453:	c7 04 24 38 78 10 f0 	movl   $0xf0107838,(%esp)
...
f01034bb:	a3 3c c2 22 f0       	mov    %eax,0xf022c23c
        return -E_FAULT;
...
f01034f6:	a3 3c c2 22 f0       	mov    %eax,0xf022c23c
            else
            {
...
f0103500:	eb 1d                	jmp    f010351f <user_mem_check+0x9a>
            ...
            {
                user_mem_check_addr = (uintptr_t)addr;
f0103502:	89 1d 3c c2 22 f0    	mov    %ebx,0xf022c23c
            }
...
f01035c0:	c7 44 24 08 c4 7b 10 	movl   $0xf0107bc4,0x8(%esp)
f01035c7:	f0 
f01035c8:	c7 44 24 04 32 01 00 	movl   $0x132,0x4(%esp)
f01035cf:	00 
f01035d0:	c7 04 24 f3 7b 10 f0 	movl   $0xf0107bf3,(%esp)
...
f01035fe:	c7 44 24 08 fe 7b 10 	movl   $0xf0107bfe,0x8(%esp)
f0103605:	f0 
f0103606:	c7 44 24 04 35 01 00 	movl   $0x135,0x4(%esp)
f010360d:	00 
f010360e:	c7 04 24 f3 7b 10 f0 	movl   $0xf0107bf3,(%esp)
...
f0103637:	75 1a                	jne    f0103653 <envid2env+0x29>
		*env_store = curenv;
f0103639:	e8 4b 2d 00 00       	call   f0106389 <cpunum>
f010363e:	6b c0 74             	imul   $0x74,%eax,%eax
f0103641:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
...
f010365e:	03 1d 48 c2 22 f0    	add    0xf022c248,%ebx
...
f0103683:	e8 01 2d 00 00       	call   f0106389 <cpunum>
f0103688:	6b c0 74             	imul   $0x74,%eax,%eax
f010368b:	39 98 28 d0 22 f0    	cmp    %ebx,-0xfdd2fd8(%eax)
f0103691:	74 26                	je     f01036b9 <envid2env+0x8f>
f0103693:	8b 73 4c             	mov    0x4c(%ebx),%esi
f0103696:	e8 ee 2c 00 00       	call   f0106389 <cpunum>
f010369b:	6b c0 74             	imul   $0x74,%eax,%eax
f010369e:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
...
f01036ca:	b8 20 13 12 f0       	mov    $0xf0121320,%eax
...
f01036f5:	53                   	push   %ebx
	...
	for( i = NENV -1; i>=0; i--){
		envs[i].env_id = 0;
f01036f6:	8b 35 48 c2 22 f0    	mov    0xf022c248,%esi
...
f0103724:	89 35 4c c2 22 f0    	mov    %esi,0xf022c24c
	}
...
f0103737:	83 ec 14             	sub    $0x14,%esp
	...
	if (!(e = env_free_list))
f010373a:	8b 1d 4c c2 22 f0    	mov    0xf022c24c,%ebx
...
f010375e:	2b 15 90 ce 22 f0    	sub    0xf022ce90,%edx
...
f010376f:	3b 0d 88 ce 22 f0    	cmp    0xf022ce88,%ecx
f0103775:	72 20                	jb     f0103797 <env_alloc+0x64>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0103777:	89 54 24 0c          	mov    %edx,0xc(%esp)
f010377b:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f0103782:	f0 
f0103783:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
f010378a:	00 
f010378b:	c7 04 24 99 78 10 f0 	movl   $0xf0107899,(%esp)
...
f01037d7:	e8 5b 25 00 00       	call   f0105d37 <memset>
...
f01037ea:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f01037f1:	f0 
f01037f2:	c7 44 24 04 cc 00 00 	movl   $0xcc,0x4(%esp)
f01037f9:	00 
f01037fa:	c7 04 24 f3 7b 10 f0 	movl   $0xf0107bf3,(%esp)
...
f010382c:	2b 15 48 c2 22 f0    	sub    0xf022c248,%edx
...
f010386e:	e8 c4 24 00 00       	call   f0105d37 <memset>
...
f01038a0:	a3 4c c2 22 f0       	mov    %eax,0xf022c24c
	*newenv_store = e;
...
f0103928:	c7 44 24 08 25 7c 10 	movl   $0xf0107c25,0x8(%esp)
f010392f:	f0 
f0103930:	c7 44 24 04 a5 01 00 	movl   $0x1a5,0x4(%esp)
f0103937:	00 
f0103938:	c7 04 24 f3 7b 10 f0 	movl   $0xf0107bf3,(%esp)
...
f0103955:	c7 44 24 08 37 7c 10 	movl   $0xf0107c37,0x8(%esp)
f010395c:	f0 
f010395d:	c7 44 24 04 73 01 00 	movl   $0x173,0x4(%esp)
f0103964:	00 
f0103965:	c7 04 24 f3 7b 10 f0 	movl   $0xf0107bf3,(%esp)
...
f0103982:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0103989:	f0 
f010398a:	c7 44 24 04 75 01 00 	movl   $0x175,0x4(%esp)
f0103991:	00 
f0103992:	c7 04 24 f3 7b 10 f0 	movl   $0xf0107bf3,(%esp)
...
f01039e9:	e8 96 23 00 00       	call   f0105d84 <memmove>
...
f0103a08:	e8 2a 23 00 00       	call   f0105d37 <memset>
...
f0103a2c:	e8 4e fb ff ff       	call   f010357f <region_alloc>
		    lcr3(PADDR(kern_pgdir));
f0103a31:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0103a41:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0103a48:	f0 
f0103a49:	c7 44 24 04 93 01 00 	movl   $0x193,0x4(%esp)
f0103a50:	00 
f0103a51:	c7 04 24 f3 7b 10 f0 	movl   $0xf0107bf3,(%esp)
...
f0103a7f:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	// gets reused.
	if (e == curenv)
f0103a82:	e8 02 29 00 00       	call   f0106389 <cpunum>
f0103a87:	6b c0 74             	imul   $0x74,%eax,%eax
f0103a8a:	39 b8 28 d0 22 f0    	cmp    %edi,-0xfdd2fd8(%eax)
f0103a90:	75 34                	jne    f0103ac6 <env_free+0x50>
		lcr3(PADDR(kern_pgdir));
f0103a92:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
f0103aa2:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0103aa9:	f0 
f0103aaa:	c7 44 24 04 b8 01 00 	movl   $0x1b8,0x4(%esp)
f0103ab1:	00 
f0103ab2:	c7 04 24 f3 7b 10 f0 	movl   $0xf0107bf3,(%esp)
...
f0103b36:	3b 05 88 ce 22 f0    	cmp    0xf022ce88,%eax
f0103b3c:	72 20                	jb     f0103b5e <env_free+0xe8>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0103b3e:	89 74 24 0c          	mov    %esi,0xc(%esp)
f0103b42:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f0103b49:	f0 
f0103b4a:	c7 44 24 04 c7 01 00 	movl   $0x1c7,0x4(%esp)
f0103b51:	00 
f0103b52:	c7 04 24 f3 7b 10 f0 	movl   $0xf0107bf3,(%esp)
...
f0103ba8:	3b 05 88 ce 22 f0    	cmp    0xf022ce88,%eax
f0103bae:	72 1c                	jb     f0103bcc <env_free+0x156>
		panic("pa2page called with invalid pa");
f0103bb0:	c7 44 24 08 40 70 10 	movl   $0xf0107040,0x8(%esp)
f0103bb7:	f0 
f0103bb8:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
f0103bbf:	00 
f0103bc0:	c7 04 24 99 78 10 f0 	movl   $0xf0107899,(%esp)
f0103bc7:	e8 74 c4 ff ff       	call   f0100040 <_panic>
	return &pages[PGNUM(pa)];
f0103bcc:	a1 90 ce 22 f0       	mov    0xf022ce90,%eax
...
f0103bfe:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0103c05:	f0 
f0103c06:	c7 44 24 04 d5 01 00 	movl   $0x1d5,0x4(%esp)
f0103c0d:	00 
f0103c0e:	c7 04 24 f3 7b 10 f0 	movl   $0xf0107bf3,(%esp)
...
f0103c29:	3b 05 88 ce 22 f0    	cmp    0xf022ce88,%eax
f0103c2f:	72 1c                	jb     f0103c4d <env_free+0x1d7>
		panic("pa2page called with invalid pa");
f0103c31:	c7 44 24 08 40 70 10 	movl   $0xf0107040,0x8(%esp)
f0103c38:	f0 
f0103c39:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
f0103c40:	00 
f0103c41:	c7 04 24 99 78 10 f0 	movl   $0xf0107899,(%esp)
f0103c48:	e8 f3 c3 ff ff       	call   f0100040 <_panic>
	return &pages[PGNUM(pa)];
f0103c4d:	8b 15 90 ce 22 f0    	mov    0xf022ce90,%edx
...
f0103c65:	a1 4c c2 22 f0       	mov    0xf022c24c,%eax
f0103c6a:	89 47 44             	mov    %eax,0x44(%edi)
	env_free_list = e;
f0103c6d:	89 3d 4c c2 22 f0    	mov    %edi,0xf022c24c
}
...
f0103c8b:	e8 f9 26 00 00       	call   f0106389 <cpunum>
f0103c90:	6b c0 74             	imul   $0x74,%eax,%eax
f0103c93:	39 98 28 d0 22 f0    	cmp    %ebx,-0xfdd2fd8(%eax)
...
f0103ca7:	e8 ca fd ff ff       	call   f0103a76 <env_free>
	...
	if (curenv == e) {
f0103cac:	e8 d8 26 00 00       	call   f0106389 <cpunum>
f0103cb1:	6b c0 74             	imul   $0x74,%eax,%eax
f0103cb4:	39 98 28 d0 22 f0    	cmp    %ebx,-0xfdd2fd8(%eax)
f0103cba:	75 17                	jne    f0103cd3 <env_destroy+0x58>
		curenv = NULL;
f0103cbc:	e8 c8 26 00 00       	call   f0106389 <cpunum>
f0103cc1:	6b c0 74             	imul   $0x74,%eax,%eax
f0103cc4:	c7 80 28 d0 22 f0 00 	movl   $0x0,-0xfdd2fd8(%eax)
f0103ccb:	00 00 00 
		sched_yield();
f0103cce:	e8 ba 0e 00 00       	call   f0104b8d <sched_yield>
	}
}
...
f0103ce0:	e8 a4 26 00 00       	call   f0106389 <cpunum>
f0103ce5:	6b c0 74             	imul   $0x74,%eax,%eax
f0103ce8:	8b 98 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%ebx
f0103cee:	e8 96 26 00 00       	call   f0106389 <cpunum>
...
f0103d00:	c7 44 24 08 63 7c 10 	movl   $0xf0107c63,0x8(%esp)
f0103d07:	f0 
f0103d08:	c7 44 24 04 0b 02 00 	movl   $0x20b,0x4(%esp)
f0103d0f:	00 
f0103d10:	c7 04 24 f3 7b 10 f0 	movl   $0xf0107bf3,(%esp)
...
f0103d23:	8b 5d 08             	mov    0x8(%ebp),%ebx
	...
	// LAB 3: Your code here.
	if(curenv == 0)
f0103d26:	e8 5e 26 00 00       	call   f0106389 <cpunum>
f0103d2b:	6b c0 74             	imul   $0x74,%eax,%eax
f0103d2e:	83 b8 28 d0 22 f0 00 	cmpl   $0x0,-0xfdd2fd8(%eax)
f0103d35:	75 10                	jne    f0103d47 <env_run+0x2b>
		curenv = e;
f0103d37:	e8 4d 26 00 00       	call   f0106389 <cpunum>
f0103d3c:	6b c0 74             	imul   $0x74,%eax,%eax
f0103d3f:	89 98 28 d0 22 f0    	mov    %ebx,-0xfdd2fd8(%eax)
f0103d45:	eb 29                	jmp    f0103d70 <env_run+0x54>
	else if(curenv->env_status == ENV_RUNNING)
f0103d47:	e8 3d 26 00 00       	call   f0106389 <cpunum>
f0103d4c:	6b c0 74             	imul   $0x74,%eax,%eax
f0103d4f:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f0103d55:	83 78 54 03          	cmpl   $0x3,0x54(%eax)
f0103d59:	75 15                	jne    f0103d70 <env_run+0x54>
		curenv->env_status = ENV_RUNNABLE;
f0103d5b:	e8 29 26 00 00       	call   f0106389 <cpunum>
f0103d60:	6b c0 74             	imul   $0x74,%eax,%eax
f0103d63:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f0103d69:	c7 40 54 02 00 00 00 	movl   $0x2,0x54(%eax)
	curenv = e;
f0103d70:	e8 14 26 00 00       	call   f0106389 <cpunum>
f0103d75:	6b c0 74             	imul   $0x74,%eax,%eax
f0103d78:	89 98 28 d0 22 f0    	mov    %ebx,-0xfdd2fd8(%eax)
	curenv->env_status = ENV_RUNNING;
f0103d7e:	e8 06 26 00 00       	call   f0106389 <cpunum>
f0103d83:	6b c0 74             	imul   $0x74,%eax,%eax
f0103d86:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f0103d8c:	c7 40 54 03 00 00 00 	movl   $0x3,0x54(%eax)
	curenv->env_runs++;
f0103d93:	e8 f1 25 00 00       	call   f0106389 <cpunum>
f0103d98:	6b c0 74             	imul   $0x74,%eax,%eax
f0103d9b:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f0103da1:	83 40 58 01          	addl   $0x1,0x58(%eax)
	lcr3( PADDR(curenv->env_pgdir) );
f0103da5:	e8 df 25 00 00       	call   f0106389 <cpunum>
f0103daa:	6b c0 74             	imul   $0x74,%eax,%eax
f0103dad:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
...
f0103dc1:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0103dc8:	f0 
f0103dc9:	c7 44 24 04 30 02 00 	movl   $0x230,0x4(%esp)
f0103dd0:	00 
f0103dd1:	c7 04 24 f3 7b 10 f0 	movl   $0xf0107bf3,(%esp)
...
f0103de5:	c7 04 24 c0 13 12 f0 	movl   $0xf01213c0,(%esp)
f0103dec:	e8 c2 28 00 00       	call   f01066b3 <spin_unlock>
...
f0103df3:	e8 91 25 00 00       	call   f0106389 <cpunum>
f0103df8:	6b c0 74             	imul   $0x74,%eax,%eax
f0103dfb:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
...
f0103e3b:	8b 45 08             	mov    0x8(%ebp),%eax
	int i;
	irq_mask_8259A = mask;
f0103e3e:	66 a3 a8 13 12 f0    	mov    %ax,0xf01213a8
	if (!didinit)
f0103e44:	80 3d 50 c2 22 f0 00 	cmpb   $0x0,0xf022c250
...
f0103e5c:	c7 04 24 6f 7c 10 f0 	movl   $0xf0107c6f,(%esp)
...
f0103e7b:	c7 04 24 3f 81 10 f0 	movl   $0xf010813f,(%esp)
...
f0103e8d:	75 e3                	jne    f0103e72 <irq_setmask_8259A+0x3f>
		if (~mask & (1<<i))
			cprintf(" %d", i);
	cprintf("\n");
f0103e8f:	c7 04 24 90 7b 10 f0 	movl   $0xf0107b90,(%esp)
...
{
	didinit = 1;
f0103ea2:	c6 05 50 c2 22 f0 01 	movb   $0x1,0xf022c250
...
f0103f0b:	0f b7 05 a8 13 12 f0 	movzwl 0xf01213a8,%eax
...
f0103f68:	e8 87 16 00 00       	call   f01055f4 <vprintfmt>
	return cnt;
}
...
f0103f99:	e8 eb 23 00 00       	call   f0106389 <cpunum>
f0103f9e:	6b c0 74             	imul   $0x74,%eax,%eax
f0103fa1:	0f b6 98 20 d0 22 f0 	movzbl -0xfdd2fe0(%eax),%ebx
	cprintf("cpu_id == %d\n",cpu_id );
f0103fa8:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f0103fac:	c7 04 24 83 7c 10 f0 	movl   $0xf0107c83,(%esp)
f0103fb3:	e8 ba ff ff ff       	call   f0103f72 <cprintf>
	thiscpu->cpu_ts.ts_esp0 = KSTACKTOP - cpu_id*( KSTKSIZE  + KSTKGAP);
f0103fb8:	e8 cc 23 00 00       	call   f0106389 <cpunum>
...
f0103fcd:	89 90 30 d0 22 f0    	mov    %edx,-0xfdd2fd0(%eax)
	thiscpu->cpu_ts.ts_ss0 = GD_KD;
f0103fd3:	e8 b1 23 00 00       	call   f0106389 <cpunum>
f0103fd8:	6b c0 74             	imul   $0x74,%eax,%eax
f0103fdb:	66 c7 80 34 d0 22 f0 	movw   $0x10,-0xfdd2fcc(%eax)
f0103fe2:	10 00 
	gdt[ (GD_TSS0 >> 3) + cpu_id] = SEG16(STS_T32A, (uint32_t) (& (thiscpu->cpu_ts) ),
f0103fe4:	83 c3 05             	add    $0x5,%ebx
f0103fe7:	e8 9d 23 00 00       	call   f0106389 <cpunum>
f0103fec:	89 c7                	mov    %eax,%edi
f0103fee:	e8 96 23 00 00       	call   f0106389 <cpunum>
f0103ff3:	89 c6                	mov    %eax,%esi
f0103ff5:	e8 8f 23 00 00       	call   f0106389 <cpunum>
f0103ffa:	66 c7 04 dd 40 13 12 	movw   $0x67,-0xfedecc0(,%ebx,8)
f0104001:	f0 67 00 
f0104004:	6b ff 74             	imul   $0x74,%edi,%edi
f0104007:	81 c7 2c d0 22 f0    	add    $0xf022d02c,%edi
f010400d:	66 89 3c dd 42 13 12 	mov    %di,-0xfedecbe(,%ebx,8)
f0104014:	f0 
f0104015:	6b d6 74             	imul   $0x74,%esi,%edx
f0104018:	81 c2 2c d0 22 f0    	add    $0xf022d02c,%edx
...
f0104033:	05 2c d0 22 f0       	add    $0xf022d02c,%eax
...
f0104050:	b8 aa 13 12 f0       	mov    $0xf01213aa,%eax
...
f0104066:	b8 e2 49 10 f0       	mov    $0xf01049e2,%eax
f010406b:	66 a3 60 c2 22 f0    	mov    %ax,0xf022c260
f0104071:	66 c7 05 62 c2 22 f0 	movw   $0x8,0xf022c262
f0104078:	08 00 
f010407a:	c6 05 64 c2 22 f0 00 	movb   $0x0,0xf022c264
f0104081:	c6 05 65 c2 22 f0 8e 	movb   $0x8e,0xf022c265
f0104088:	c1 e8 10             	shr    $0x10,%eax
f010408b:	66 a3 66 c2 22 f0    	mov    %ax,0xf022c266
    SETGATE(idt[1], 0, GD_KT, handler1, 0);
f0104091:	b8 ec 49 10 f0       	mov    $0xf01049ec,%eax
f0104096:	66 a3 68 c2 22 f0    	mov    %ax,0xf022c268
f010409c:	66 c7 05 6a c2 22 f0 	movw   $0x8,0xf022c26a
f01040a3:	08 00 
f01040a5:	c6 05 6c c2 22 f0 00 	movb   $0x0,0xf022c26c
f01040ac:	c6 05 6d c2 22 f0 8e 	movb   $0x8e,0xf022c26d
f01040b3:	c1 e8 10             	shr    $0x10,%eax
f01040b6:	66 a3 6e c2 22 f0    	mov    %ax,0xf022c26e
    SETGATE(idt[2], 0, GD_KT, handler2, 0);
f01040bc:	b8 f6 49 10 f0       	mov    $0xf01049f6,%eax
f01040c1:	66 a3 70 c2 22 f0    	mov    %ax,0xf022c270
f01040c7:	66 c7 05 72 c2 22 f0 	movw   $0x8,0xf022c272
f01040ce:	08 00 
f01040d0:	c6 05 74 c2 22 f0 00 	movb   $0x0,0xf022c274
f01040d7:	c6 05 75 c2 22 f0 8e 	movb   $0x8e,0xf022c275
f01040de:	c1 e8 10             	shr    $0x10,%eax
f01040e1:	66 a3 76 c2 22 f0    	mov    %ax,0xf022c276
    SETGATE(idt[3], 0, GD_KT, handler3, 3);
f01040e7:	b8 00 4a 10 f0       	mov    $0xf0104a00,%eax
f01040ec:	66 a3 78 c2 22 f0    	mov    %ax,0xf022c278
f01040f2:	66 c7 05 7a c2 22 f0 	movw   $0x8,0xf022c27a
f01040f9:	08 00 
f01040fb:	c6 05 7c c2 22 f0 00 	movb   $0x0,0xf022c27c
f0104102:	c6 05 7d c2 22 f0 ee 	movb   $0xee,0xf022c27d
f0104109:	c1 e8 10             	shr    $0x10,%eax
f010410c:	66 a3 7e c2 22 f0    	mov    %ax,0xf022c27e
    SETGATE(idt[4], 0, GD_KT, handler4, 0);
f0104112:	b8 0a 4a 10 f0       	mov    $0xf0104a0a,%eax
f0104117:	66 a3 80 c2 22 f0    	mov    %ax,0xf022c280
f010411d:	66 c7 05 82 c2 22 f0 	movw   $0x8,0xf022c282
f0104124:	08 00 
f0104126:	c6 05 84 c2 22 f0 00 	movb   $0x0,0xf022c284
f010412d:	c6 05 85 c2 22 f0 8e 	movb   $0x8e,0xf022c285
f0104134:	c1 e8 10             	shr    $0x10,%eax
f0104137:	66 a3 86 c2 22 f0    	mov    %ax,0xf022c286
    SETGATE(idt[5], 0, GD_KT, handler5, 0);
f010413d:	b8 14 4a 10 f0       	mov    $0xf0104a14,%eax
f0104142:	66 a3 88 c2 22 f0    	mov    %ax,0xf022c288
f0104148:	66 c7 05 8a c2 22 f0 	movw   $0x8,0xf022c28a
f010414f:	08 00 
f0104151:	c6 05 8c c2 22 f0 00 	movb   $0x0,0xf022c28c
f0104158:	c6 05 8d c2 22 f0 8e 	movb   $0x8e,0xf022c28d
f010415f:	c1 e8 10             	shr    $0x10,%eax
f0104162:	66 a3 8e c2 22 f0    	mov    %ax,0xf022c28e
    SETGATE(idt[6], 0, GD_KT, handler6, 0);
f0104168:	b8 1e 4a 10 f0       	mov    $0xf0104a1e,%eax
f010416d:	66 a3 90 c2 22 f0    	mov    %ax,0xf022c290
f0104173:	66 c7 05 92 c2 22 f0 	movw   $0x8,0xf022c292
f010417a:	08 00 
f010417c:	c6 05 94 c2 22 f0 00 	movb   $0x0,0xf022c294
f0104183:	c6 05 95 c2 22 f0 8e 	movb   $0x8e,0xf022c295
f010418a:	c1 e8 10             	shr    $0x10,%eax
f010418d:	66 a3 96 c2 22 f0    	mov    %ax,0xf022c296
    SETGATE(idt[7], 0, GD_KT, handler7, 0);
f0104193:	b8 28 4a 10 f0       	mov    $0xf0104a28,%eax
f0104198:	66 a3 98 c2 22 f0    	mov    %ax,0xf022c298
f010419e:	66 c7 05 9a c2 22 f0 	movw   $0x8,0xf022c29a
f01041a5:	08 00 
f01041a7:	c6 05 9c c2 22 f0 00 	movb   $0x0,0xf022c29c
f01041ae:	c6 05 9d c2 22 f0 8e 	movb   $0x8e,0xf022c29d
f01041b5:	c1 e8 10             	shr    $0x10,%eax
f01041b8:	66 a3 9e c2 22 f0    	mov    %ax,0xf022c29e
    SETGATE(idt[8], 0, GD_KT, handler8, 0);
f01041be:	b8 32 4a 10 f0       	mov    $0xf0104a32,%eax
f01041c3:	66 a3 a0 c2 22 f0    	mov    %ax,0xf022c2a0
f01041c9:	66 c7 05 a2 c2 22 f0 	movw   $0x8,0xf022c2a2
f01041d0:	08 00 
f01041d2:	c6 05 a4 c2 22 f0 00 	movb   $0x0,0xf022c2a4
f01041d9:	c6 05 a5 c2 22 f0 8e 	movb   $0x8e,0xf022c2a5
f01041e0:	c1 e8 10             	shr    $0x10,%eax
f01041e3:	66 a3 a6 c2 22 f0    	mov    %ax,0xf022c2a6
    SETGATE(idt[9], 0, GD_KT, handler9, 0);
f01041e9:	b8 3a 4a 10 f0       	mov    $0xf0104a3a,%eax
f01041ee:	66 a3 a8 c2 22 f0    	mov    %ax,0xf022c2a8
f01041f4:	66 c7 05 aa c2 22 f0 	movw   $0x8,0xf022c2aa
f01041fb:	08 00 
f01041fd:	c6 05 ac c2 22 f0 00 	movb   $0x0,0xf022c2ac
f0104204:	c6 05 ad c2 22 f0 8e 	movb   $0x8e,0xf022c2ad
f010420b:	c1 e8 10             	shr    $0x10,%eax
f010420e:	66 a3 ae c2 22 f0    	mov    %ax,0xf022c2ae
    SETGATE(idt[10], 0, GD_KT, handler10, 0);
f0104214:	b8 44 4a 10 f0       	mov    $0xf0104a44,%eax
f0104219:	66 a3 b0 c2 22 f0    	mov    %ax,0xf022c2b0
f010421f:	66 c7 05 b2 c2 22 f0 	movw   $0x8,0xf022c2b2
f0104226:	08 00 
f0104228:	c6 05 b4 c2 22 f0 00 	movb   $0x0,0xf022c2b4
f010422f:	c6 05 b5 c2 22 f0 8e 	movb   $0x8e,0xf022c2b5
f0104236:	c1 e8 10             	shr    $0x10,%eax
f0104239:	66 a3 b6 c2 22 f0    	mov    %ax,0xf022c2b6
    SETGATE(idt[11], 0, GD_KT, handler11, 0);
f010423f:	b8 4c 4a 10 f0       	mov    $0xf0104a4c,%eax
f0104244:	66 a3 b8 c2 22 f0    	mov    %ax,0xf022c2b8
f010424a:	66 c7 05 ba c2 22 f0 	movw   $0x8,0xf022c2ba
f0104251:	08 00 
f0104253:	c6 05 bc c2 22 f0 00 	movb   $0x0,0xf022c2bc
f010425a:	c6 05 bd c2 22 f0 8e 	movb   $0x8e,0xf022c2bd
f0104261:	c1 e8 10             	shr    $0x10,%eax
f0104264:	66 a3 be c2 22 f0    	mov    %ax,0xf022c2be
    SETGATE(idt[12], 0, GD_KT, handler12, 0);
f010426a:	b8 54 4a 10 f0       	mov    $0xf0104a54,%eax
f010426f:	66 a3 c0 c2 22 f0    	mov    %ax,0xf022c2c0
f0104275:	66 c7 05 c2 c2 22 f0 	movw   $0x8,0xf022c2c2
f010427c:	08 00 
f010427e:	c6 05 c4 c2 22 f0 00 	movb   $0x0,0xf022c2c4
f0104285:	c6 05 c5 c2 22 f0 8e 	movb   $0x8e,0xf022c2c5
f010428c:	c1 e8 10             	shr    $0x10,%eax
f010428f:	66 a3 c6 c2 22 f0    	mov    %ax,0xf022c2c6
    SETGATE(idt[13], 0, GD_KT, handler13, 0);
f0104295:	b8 5c 4a 10 f0       	mov    $0xf0104a5c,%eax
f010429a:	66 a3 c8 c2 22 f0    	mov    %ax,0xf022c2c8
f01042a0:	66 c7 05 ca c2 22 f0 	movw   $0x8,0xf022c2ca
f01042a7:	08 00 
f01042a9:	c6 05 cc c2 22 f0 00 	movb   $0x0,0xf022c2cc
f01042b0:	c6 05 cd c2 22 f0 8e 	movb   $0x8e,0xf022c2cd
f01042b7:	c1 e8 10             	shr    $0x10,%eax
f01042ba:	66 a3 ce c2 22 f0    	mov    %ax,0xf022c2ce
    SETGATE(idt[14], 0, GD_KT, handler14, 0);
f01042c0:	b8 64 4a 10 f0       	mov    $0xf0104a64,%eax
f01042c5:	66 a3 d0 c2 22 f0    	mov    %ax,0xf022c2d0
f01042cb:	66 c7 05 d2 c2 22 f0 	movw   $0x8,0xf022c2d2
f01042d2:	08 00 
f01042d4:	c6 05 d4 c2 22 f0 00 	movb   $0x0,0xf022c2d4
f01042db:	c6 05 d5 c2 22 f0 8e 	movb   $0x8e,0xf022c2d5
f01042e2:	c1 e8 10             	shr    $0x10,%eax
f01042e5:	66 a3 d6 c2 22 f0    	mov    %ax,0xf022c2d6
    SETGATE(idt[15], 0, GD_KT, handler15, 0);
f01042eb:	b8 6c 4a 10 f0       	mov    $0xf0104a6c,%eax
f01042f0:	66 a3 d8 c2 22 f0    	mov    %ax,0xf022c2d8
f01042f6:	66 c7 05 da c2 22 f0 	movw   $0x8,0xf022c2da
f01042fd:	08 00 
f01042ff:	c6 05 dc c2 22 f0 00 	movb   $0x0,0xf022c2dc
f0104306:	c6 05 dd c2 22 f0 8e 	movb   $0x8e,0xf022c2dd
f010430d:	c1 e8 10             	shr    $0x10,%eax
f0104310:	66 a3 de c2 22 f0    	mov    %ax,0xf022c2de
    SETGATE(idt[16], 0, GD_KT, handler16, 0);
f0104316:	b8 76 4a 10 f0       	mov    $0xf0104a76,%eax
f010431b:	66 a3 e0 c2 22 f0    	mov    %ax,0xf022c2e0
f0104321:	66 c7 05 e2 c2 22 f0 	movw   $0x8,0xf022c2e2
f0104328:	08 00 
f010432a:	c6 05 e4 c2 22 f0 00 	movb   $0x0,0xf022c2e4
f0104331:	c6 05 e5 c2 22 f0 8e 	movb   $0x8e,0xf022c2e5
f0104338:	c1 e8 10             	shr    $0x10,%eax
f010433b:	66 a3 e6 c2 22 f0    	mov    %ax,0xf022c2e6
    SETGATE(idt[17], 0, GD_KT, handler17, 0);
f0104341:	b8 80 4a 10 f0       	mov    $0xf0104a80,%eax
f0104346:	66 a3 e8 c2 22 f0    	mov    %ax,0xf022c2e8
f010434c:	66 c7 05 ea c2 22 f0 	movw   $0x8,0xf022c2ea
f0104353:	08 00 
f0104355:	c6 05 ec c2 22 f0 00 	movb   $0x0,0xf022c2ec
f010435c:	c6 05 ed c2 22 f0 8e 	movb   $0x8e,0xf022c2ed
f0104363:	c1 e8 10             	shr    $0x10,%eax
f0104366:	66 a3 ee c2 22 f0    	mov    %ax,0xf022c2ee
    SETGATE(idt[18], 0, GD_KT, handler18, 0);
f010436c:	b8 88 4a 10 f0       	mov    $0xf0104a88,%eax
f0104371:	66 a3 f0 c2 22 f0    	mov    %ax,0xf022c2f0
f0104377:	66 c7 05 f2 c2 22 f0 	movw   $0x8,0xf022c2f2
f010437e:	08 00 
f0104380:	c6 05 f4 c2 22 f0 00 	movb   $0x0,0xf022c2f4
f0104387:	c6 05 f5 c2 22 f0 8e 	movb   $0x8e,0xf022c2f5
f010438e:	c1 e8 10             	shr    $0x10,%eax
f0104391:	66 a3 f6 c2 22 f0    	mov    %ax,0xf022c2f6
    SETGATE(idt[19], 0, GD_KT, handler19, 0);
f0104397:	b8 92 4a 10 f0       	mov    $0xf0104a92,%eax
f010439c:	66 a3 f8 c2 22 f0    	mov    %ax,0xf022c2f8
f01043a2:	66 c7 05 fa c2 22 f0 	movw   $0x8,0xf022c2fa
f01043a9:	08 00 
f01043ab:	c6 05 fc c2 22 f0 00 	movb   $0x0,0xf022c2fc
f01043b2:	c6 05 fd c2 22 f0 8e 	movb   $0x8e,0xf022c2fd
f01043b9:	c1 e8 10             	shr    $0x10,%eax
f01043bc:	66 a3 fe c2 22 f0    	mov    %ax,0xf022c2fe

    SETGATE(idt[T_SYSCALL], 0, GD_KT, handler_syscall, 3);
f01043c2:	b8 9c 4a 10 f0       	mov    $0xf0104a9c,%eax
f01043c7:	66 a3 e0 c3 22 f0    	mov    %ax,0xf022c3e0
f01043cd:	66 c7 05 e2 c3 22 f0 	movw   $0x8,0xf022c3e2
f01043d4:	08 00 
f01043d6:	c6 05 e4 c3 22 f0 00 	movb   $0x0,0xf022c3e4
f01043dd:	c6 05 e5 c3 22 f0 ee 	movb   $0xee,0xf022c3e5
f01043e4:	c1 e8 10             	shr    $0x10,%eax
f01043e7:	66 a3 e6 c3 22 f0    	mov    %ax,0xf022c3e6
...
f01044a6:	e8 de 1e 00 00       	call   f0106389 <cpunum>
f01044ab:	89 44 24 08          	mov    %eax,0x8(%esp)
f01044af:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f01044b3:	c7 04 24 5e 7d 10 f0 	movl   $0xf0107d5e,(%esp)
...
f01044cf:	c7 04 24 7c 7d 10 f0 	movl   $0xf0107d7c,(%esp)
...
f01044e3:	c7 04 24 8f 7d 10 f0 	movl   $0xf0107d8f,(%esp)
...
f01044f7:	8b 14 85 20 80 10 f0 	mov    -0xfef7fe0(,%eax,4),%edx
...
f010450b:	ba 15 7d 10 f0       	mov    $0xf0107d15,%edx
f0104510:	b9 28 7d 10 f0       	mov    $0xf0107d28,%ecx
...
f0104518:	eb 05                	jmp    f010451f <print_trapframe+0x84>
	...
	if (trapno == T_SYSCALL)
		return "System call";
f010451a:	ba 09 7d 10 f0       	mov    $0xf0107d09,%edx
{
	cprintf("TRAP frame at %p from CPU %d\n", tf, cpunum());
	print_regs(&tf->tf_regs);
	cprintf("  es   0x----%04x\n", tf->tf_es);
...
f0104527:	c7 04 24 a2 7d 10 f0 	movl   $0xf0107da2,(%esp)
f010452e:	e8 3f fa ff ff       	call   f0103f72 <cprintf>
	// If this trap was a page fault that just happened
	// (so %cr2 is meaningful), print the faulting linear address.
	if (tf == last_tf && tf->tf_trapno == T_PGFLT)
f0104533:	3b 1d 60 ca 22 f0    	cmp    0xf022ca60,%ebx
...
f0104575:	ba 37 7d 10 f0       	mov    $0xf0107d37,%edx
f010457a:	b9 42 7d 10 f0       	mov    $0xf0107d42,%ecx
f010457f:	0f 45 ca             	cmovne %edx,%ecx
f0104582:	89 c2                	mov    %eax,%edx
f0104584:	83 e2 02             	and    $0x2,%edx
f0104587:	ba 4e 7d 10 f0       	mov    $0xf0107d4e,%edx
f010458c:	be 54 7d 10 f0       	mov    $0xf0107d54,%esi
f0104591:	0f 44 d6             	cmove  %esi,%edx
f0104594:	83 e0 04             	and    $0x4,%eax
f0104597:	b8 59 7d 10 f0       	mov    $0xf0107d59,%eax
f010459c:	be 8e 7e 10 f0       	mov    $0xf0107e8e,%esi
...
f01045b0:	c7 04 24 d1 7d 10 f0 	movl   $0xf0107dd1,(%esp)
...
f0104611:	c7 04 24 11 7e 10 f0 	movl   $0xf0107e11,(%esp)
...
f0104625:	c7 04 24 20 7e 10 f0 	movl   $0xf0107e20,(%esp)
...
f010463e:	83 ec 5c             	sub    $0x5c,%esp
f0104641:	8b 5d 08             	mov    0x8(%ebp),%ebx
f0104644:	0f 20 d7             	mov    %cr2,%edi
	fault_va = rcr2();
...
f010464e:	c7 44 24 08 d8 7f 10 	movl   $0xf0107fd8,0x8(%esp)
f0104655:	f0 
f0104656:	c7 44 24 04 64 01 00 	movl   $0x164,0x4(%esp)
f010465d:	00 
f010465e:	c7 04 24 33 7e 10 f0 	movl   $0xf0107e33,(%esp)
...
f010466a:	e8 1a 1d 00 00       	call   f0106389 <cpunum>
f010466f:	6b c0 74             	imul   $0x74,%eax,%eax
f0104672:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f0104678:	83 78 64 00          	cmpl   $0x0,0x64(%eax)
f010467c:	75 4a                	jne    f01046c8 <page_fault_handler+0x90>
		// Destroy the environment that caused the fault.
		cprintf("[%08x] user fault va %08x ip %08x\n",
f010467e:	8b 73 30             	mov    0x30(%ebx),%esi
			curenv->env_id, fault_va, tf->tf_eip);
f0104681:	e8 03 1d 00 00       	call   f0106389 <cpunum>
	//   (the 'tf' variable points at 'curenv->env_tf').
	...
	if(!curenv->env_pgfault_upcall){
		// Destroy the environment that caused the fault.
		cprintf("[%08x] user fault va %08x ip %08x\n",
f0104686:	89 74 24 0c          	mov    %esi,0xc(%esp)
f010468a:	89 7c 24 08          	mov    %edi,0x8(%esp)
			curenv->env_id, fault_va, tf->tf_eip);
f010468e:	6b c0 74             	imul   $0x74,%eax,%eax
	...
	if(!curenv->env_pgfault_upcall){
		// Destroy the environment that caused the fault.
		cprintf("[%08x] user fault va %08x ip %08x\n",
f0104691:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f0104697:	8b 40 48             	mov    0x48(%eax),%eax
f010469a:	89 44 24 04          	mov    %eax,0x4(%esp)
f010469e:	c7 04 24 fc 7f 10 f0 	movl   $0xf0107ffc,(%esp)
f01046a5:	e8 c8 f8 ff ff       	call   f0103f72 <cprintf>
			curenv->env_id, fault_va, tf->tf_eip);
		print_trapframe(tf);
f01046aa:	89 1c 24             	mov    %ebx,(%esp)
f01046ad:	e8 e9 fd ff ff       	call   f010449b <print_trapframe>
		env_destroy(curenv);
f01046b2:	e8 d2 1c 00 00       	call   f0106389 <cpunum>
f01046b7:	6b c0 74             	imul   $0x74,%eax,%eax
f01046ba:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f01046c0:	89 04 24             	mov    %eax,(%esp)
f01046c3:	e8 b3 f5 ff ff       	call   f0103c7b <env_destroy>
	}
	/************debug code*
...
f01046c8:	e8 bc 1c 00 00       	call   f0106389 <cpunum>
f01046cd:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
f01046d4:	00 
f01046d5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
f01046dc:	00 
f01046dd:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
f01046e4:	ee 
f01046e5:	6b c0 74             	imul   $0x74,%eax,%eax
f01046e8:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f01046ee:	89 04 24             	mov    %eax,(%esp)
f01046f1:	e8 31 ee ff ff       	call   f0103527 <user_mem_assert>
...
f01046f6:	8b 43 3c             	mov    0x3c(%ebx),%eax
f01046f9:	8d 90 00 10 40 11    	lea    0x11401000(%eax),%edx
...
f01046ff:	8d 70 c4             	lea    -0x3c(%eax),%esi
f0104702:	81 fa ff 0f 00 00    	cmp    $0xfff,%edx
f0104708:	ba cc ff bf ee       	mov    $0xeebfffcc,%edx
f010470d:	0f 47 f2             	cmova  %edx,%esi
	
	UT.utf_err = tf->tf_err;
f0104710:	8b 53 2c             	mov    0x2c(%ebx),%edx
f0104713:	89 55 b8             	mov    %edx,-0x48(%ebp)
	UT.utf_regs = tf->tf_regs;
f0104716:	8b 13                	mov    (%ebx),%edx
f0104718:	89 55 bc             	mov    %edx,-0x44(%ebp)
f010471b:	8b 53 04             	mov    0x4(%ebx),%edx
f010471e:	89 55 c0             	mov    %edx,-0x40(%ebp)
f0104721:	8b 53 08             	mov    0x8(%ebx),%edx
f0104724:	89 55 c4             	mov    %edx,-0x3c(%ebp)
f0104727:	8b 53 0c             	mov    0xc(%ebx),%edx
f010472a:	89 55 c8             	mov    %edx,-0x38(%ebp)
f010472d:	8b 53 10             	mov    0x10(%ebx),%edx
f0104730:	89 55 cc             	mov    %edx,-0x34(%ebp)
f0104733:	8b 53 14             	mov    0x14(%ebx),%edx
f0104736:	89 55 d0             	mov    %edx,-0x30(%ebp)
f0104739:	8b 53 18             	mov    0x18(%ebx),%edx
f010473c:	89 55 d4             	mov    %edx,-0x2c(%ebp)
f010473f:	8b 53 1c             	mov    0x1c(%ebx),%edx
f0104742:	89 55 d8             	mov    %edx,-0x28(%ebp)
	UT.utf_eflags = tf->tf_eflags;
f0104745:	8b 53 38             	mov    0x38(%ebx),%edx
f0104748:	89 55 e0             	mov    %edx,-0x20(%ebp)
	UT.utf_eip = tf->tf_eip;
f010474b:	8b 53 30             	mov    0x30(%ebx),%edx
f010474e:	89 55 dc             	mov    %edx,-0x24(%ebp)
	UT.utf_esp = tf->tf_esp;
f0104751:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	UT.utf_fault_va = fault_va;
f0104754:	89 7d b4             	mov    %edi,-0x4c(%ebp)

	user_mem_assert(curenv,(void*)newEsp, sizeof(struct UTrapframe),PTE_U|PTE_P|PTE_W );
f0104757:	e8 2d 1c 00 00       	call   f0106389 <cpunum>
f010475c:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
f0104763:	00 
f0104764:	c7 44 24 08 34 00 00 	movl   $0x34,0x8(%esp)
f010476b:	00 
f010476c:	89 74 24 04          	mov    %esi,0x4(%esp)
f0104770:	6b c0 74             	imul   $0x74,%eax,%eax
f0104773:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f0104779:	89 04 24             	mov    %eax,(%esp)
f010477c:	e8 a6 ed ff ff       	call   f0103527 <user_mem_assert>
	memcpy((void*)newEsp, (&UT) ,sizeof(struct UTrapframe));
f0104781:	c7 44 24 08 34 00 00 	movl   $0x34,0x8(%esp)
f0104788:	00 
f0104789:	8d 45 b4             	lea    -0x4c(%ebp),%eax
f010478c:	89 44 24 04          	mov    %eax,0x4(%esp)
f0104790:	89 34 24             	mov    %esi,(%esp)
f0104793:	e8 54 16 00 00       	call   f0105dec <memcpy>
	tf->tf_esp = newEsp;
f0104798:	89 73 3c             	mov    %esi,0x3c(%ebx)
	tf->tf_eip = (uintptr_t)curenv->env_pgfault_upcall;
f010479b:	e8 e9 1b 00 00       	call   f0106389 <cpunum>
f01047a0:	6b c0 74             	imul   $0x74,%eax,%eax
f01047a3:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f01047a9:	8b 40 64             	mov    0x64(%eax),%eax
f01047ac:	89 43 30             	mov    %eax,0x30(%ebx)
	env_run(curenv);
f01047af:	e8 d5 1b 00 00       	call   f0106389 <cpunum>
f01047b4:	6b c0 74             	imul   $0x74,%eax,%eax
f01047b7:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f01047bd:	89 04 24             	mov    %eax,(%esp)
f01047c0:	e8 57 f5 ff ff       	call   f0103d1c <env_run>
...
f01047c8:	57                   	push   %edi
f01047c9:	56                   	push   %esi
f01047ca:	83 ec 20             	sub    $0x20,%esp
...
f01047d0:	fc                   	cld    
	...
	if (panicstr)
f01047d1:	83 3d 80 ce 22 f0 00 	cmpl   $0x0,0xf022ce80
f01047d8:	74 01                	je     f01047db <trap+0x16>
		asm volatile("hlt");
f01047da:	f4                   	hlt    
...
f01047db:	e8 a9 1b 00 00       	call   f0106389 <cpunum>
f01047e0:	6b d0 74             	imul   $0x74,%eax,%edx
f01047e3:	81 c2 20 d0 22 f0    	add    $0xf022d020,%edx
xchg(volatile uint32_t *addr, uint32_t newval)
{
	uint32_t result;
	...
	// The + in "+m" denotes a read-modify-write operand.
	asm volatile("lock; xchgl %0, %1" :
f01047e9:	b8 01 00 00 00       	mov    $0x1,%eax
f01047ee:	f0 87 42 04          	lock xchg %eax,0x4(%edx)
f01047f2:	83 f8 02             	cmp    $0x2,%eax
f01047f5:	75 0c                	jne    f0104803 <trap+0x3e>
extern struct spinlock kernel_lock;
...
{
	spin_lock(&kernel_lock);
f01047f7:	c7 04 24 c0 13 12 f0 	movl   $0xf01213c0,(%esp)
f01047fe:	e8 04 1e 00 00       	call   f0106607 <spin_lock>
...
f0104805:	f6 c4 02             	test   $0x2,%ah
f0104808:	74 24                	je     f010482e <trap+0x69>
f010480a:	c7 44 24 0c 3f 7e 10 	movl   $0xf0107e3f,0xc(%esp)
f0104811:	f0 
f0104812:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f0104819:	f0 
f010481a:	c7 44 24 04 2e 01 00 	movl   $0x12e,0x4(%esp)
f0104821:	00 
f0104822:	c7 04 24 33 7e 10 f0 	movl   $0xf0107e33,(%esp)
...
f0104839:	0f 85 a7 00 00 00    	jne    f01048e6 <trap+0x121>
f010483f:	c7 04 24 c0 13 12 f0 	movl   $0xf01213c0,(%esp)
f0104846:	e8 bc 1d 00 00       	call   f0106607 <spin_lock>
		...
		lock_kernel();
		assert(curenv);
f010484b:	e8 39 1b 00 00       	call   f0106389 <cpunum>
f0104850:	6b c0 74             	imul   $0x74,%eax,%eax
f0104853:	83 b8 28 d0 22 f0 00 	cmpl   $0x0,-0xfdd2fd8(%eax)
f010485a:	75 24                	jne    f0104880 <trap+0xbb>
f010485c:	c7 44 24 0c 58 7e 10 	movl   $0xf0107e58,0xc(%esp)
f0104863:	f0 
f0104864:	c7 44 24 08 bf 78 10 	movl   $0xf01078bf,0x8(%esp)
f010486b:	f0 
f010486c:	c7 44 24 04 36 01 00 	movl   $0x136,0x4(%esp)
f0104873:	00 
f0104874:	c7 04 24 33 7e 10 f0 	movl   $0xf0107e33,(%esp)
f010487b:	e8 c0 b7 ff ff       	call   f0100040 <_panic>

		// Garbage collect if current enviroment is a zombie
		if (curenv->env_status == ENV_DYING) {
f0104880:	e8 04 1b 00 00       	call   f0106389 <cpunum>
f0104885:	6b c0 74             	imul   $0x74,%eax,%eax
f0104888:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f010488e:	83 78 54 01          	cmpl   $0x1,0x54(%eax)
f0104892:	75 2d                	jne    f01048c1 <trap+0xfc>
			env_free(curenv);
f0104894:	e8 f0 1a 00 00       	call   f0106389 <cpunum>
f0104899:	6b c0 74             	imul   $0x74,%eax,%eax
f010489c:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f01048a2:	89 04 24             	mov    %eax,(%esp)
f01048a5:	e8 cc f1 ff ff       	call   f0103a76 <env_free>
			curenv = NULL;
f01048aa:	e8 da 1a 00 00       	call   f0106389 <cpunum>
f01048af:	6b c0 74             	imul   $0x74,%eax,%eax
f01048b2:	c7 80 28 d0 22 f0 00 	movl   $0x0,-0xfdd2fd8(%eax)
f01048b9:	00 00 00 
			sched_yield();
f01048bc:	e8 cc 02 00 00       	call   f0104b8d <sched_yield>
		}
		...
		curenv->env_tf = *tf;
f01048c1:	e8 c3 1a 00 00       	call   f0106389 <cpunum>
f01048c6:	6b c0 74             	imul   $0x74,%eax,%eax
f01048c9:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f01048cf:	b9 11 00 00 00       	mov    $0x11,%ecx
f01048d4:	89 c7                	mov    %eax,%edi
f01048d6:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
		// The trapframe on the stack should be ignored from here on.
		tf = &curenv->env_tf;
f01048d8:	e8 ac 1a 00 00       	call   f0106389 <cpunum>
f01048dd:	6b c0 74             	imul   $0x74,%eax,%eax
f01048e0:	8b b0 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%esi
	}

	// Record that tf is the last real trapframe so
	// print_trapframe can print some additional information.
	last_tf = tf;
f01048e6:	89 35 60 ca 22 f0    	mov    %esi,0xf022ca60
static void
trap_dispatch(struct Trapframe *tf)
{
	...
	// LAB 3: Your code here.
	if(tf->tf_trapno == T_PGFLT){
f01048ec:	8b 46 28             	mov    0x28(%esi),%eax
f01048ef:	83 f8 0e             	cmp    $0xe,%eax
f01048f2:	75 08                	jne    f01048fc <trap+0x137>
		page_fault_handler(tf);
f01048f4:	89 34 24             	mov    %esi,(%esp)
f01048f7:	e8 3c fd ff ff       	call   f0104638 <page_fault_handler>
		return;
	}
	if(tf->tf_trapno == T_BRKPT){
f01048fc:	83 f8 03             	cmp    $0x3,%eax
f01048ff:	75 0d                	jne    f010490e <trap+0x149>
		monitor(tf);
f0104901:	89 34 24             	mov    %esi,(%esp)
f0104904:	e8 e0 bf ff ff       	call   f01008e9 <monitor>
f0104909:	e9 93 00 00 00       	jmp    f01049a1 <trap+0x1dc>
		return;
	}
	if(tf->tf_trapno == T_SYSCALL){
f010490e:	83 f8 30             	cmp    $0x30,%eax
f0104911:	75 32                	jne    f0104945 <trap+0x180>
		tf->tf_regs.reg_eax= syscall(tf->tf_regs.reg_eax, 
f0104913:	8b 46 04             	mov    0x4(%esi),%eax
f0104916:	89 44 24 14          	mov    %eax,0x14(%esp)
f010491a:	8b 06                	mov    (%esi),%eax
f010491c:	89 44 24 10          	mov    %eax,0x10(%esp)
f0104920:	8b 46 10             	mov    0x10(%esi),%eax
f0104923:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0104927:	8b 46 18             	mov    0x18(%esi),%eax
f010492a:	89 44 24 08          	mov    %eax,0x8(%esp)
f010492e:	8b 46 14             	mov    0x14(%esi),%eax
f0104931:	89 44 24 04          	mov    %eax,0x4(%esp)
f0104935:	8b 46 1c             	mov    0x1c(%esi),%eax
f0104938:	89 04 24             	mov    %eax,(%esp)
f010493b:	e8 00 03 00 00       	call   f0104c40 <syscall>
f0104940:	89 46 1c             	mov    %eax,0x1c(%esi)
f0104943:	eb 5c                	jmp    f01049a1 <trap+0x1dc>
                            return;	
	}
...
f0104945:	83 f8 27             	cmp    $0x27,%eax
f0104948:	75 16                	jne    f0104960 <trap+0x19b>
		cprintf("Spurious interrupt on irq 7\n");
f010494a:	c7 04 24 5f 7e 10 f0 	movl   $0xf0107e5f,(%esp)
f0104951:	e8 1c f6 ff ff       	call   f0103f72 <cprintf>
		print_trapframe(tf);
f0104956:	89 34 24             	mov    %esi,(%esp)
f0104959:	e8 3d fb ff ff       	call   f010449b <print_trapframe>
f010495e:	eb 41                	jmp    f01049a1 <trap+0x1dc>
	...
	print_trapframe(tf);
f0104960:	89 34 24             	mov    %esi,(%esp)
f0104963:	e8 33 fb ff ff       	call   f010449b <print_trapframe>
	if (tf->tf_cs == GD_KT)
f0104968:	66 83 7e 34 08       	cmpw   $0x8,0x34(%esi)
f010496d:	75 1c                	jne    f010498b <trap+0x1c6>
		panic("unhandled trap in kernel");
f010496f:	c7 44 24 08 7c 7e 10 	movl   $0xf0107e7c,0x8(%esp)
f0104976:	f0 
f0104977:	c7 44 24 04 14 01 00 	movl   $0x114,0x4(%esp)
f010497e:	00 
f010497f:	c7 04 24 33 7e 10 f0 	movl   $0xf0107e33,(%esp)
f0104986:	e8 b5 b6 ff ff       	call   f0100040 <_panic>
	else {
		env_destroy(curenv);
f010498b:	e8 f9 19 00 00       	call   f0106389 <cpunum>
f0104990:	6b c0 74             	imul   $0x74,%eax,%eax
f0104993:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f0104999:	89 04 24             	mov    %eax,(%esp)
f010499c:	e8 da f2 ff ff       	call   f0103c7b <env_destroy>
	trap_dispatch(tf);
...
f01049a1:	e8 e3 19 00 00       	call   f0106389 <cpunum>
f01049a6:	6b c0 74             	imul   $0x74,%eax,%eax
f01049a9:	83 b8 28 d0 22 f0 00 	cmpl   $0x0,-0xfdd2fd8(%eax)
f01049b0:	74 2a                	je     f01049dc <trap+0x217>
f01049b2:	e8 d2 19 00 00       	call   f0106389 <cpunum>
f01049b7:	6b c0 74             	imul   $0x74,%eax,%eax
f01049ba:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f01049c0:	83 78 54 03          	cmpl   $0x3,0x54(%eax)
f01049c4:	75 16                	jne    f01049dc <trap+0x217>
		env_run(curenv);
f01049c6:	e8 be 19 00 00       	call   f0106389 <cpunum>
f01049cb:	6b c0 74             	imul   $0x74,%eax,%eax
f01049ce:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f01049d4:	89 04 24             	mov    %eax,(%esp)
f01049d7:	e8 40 f3 ff ff       	call   f0103d1c <env_run>
	else
		sched_yield();
f01049dc:	e8 ac 01 00 00       	call   f0104b8d <sched_yield>
f01049e1:	90                   	nop
...
f01049e6:	e9 ba 00 00 00       	jmp    f0104aa5 <_alltraps>
f01049eb:	90                   	nop
...
f01049f0:	e9 b0 00 00 00       	jmp    f0104aa5 <_alltraps>
f01049f5:	90                   	nop

f01049f6 <handler2>:
TRAPHANDLER_NOEC(handler2, T_NMI)
f01049f6:	6a 00                	push   $0x0
f01049f8:	6a 02                	push   $0x2
f01049fa:	e9 a6 00 00 00       	jmp    f0104aa5 <_alltraps>
f01049ff:	90                   	nop

f0104a00 <handler3>:
TRAPHANDLER_NOEC(handler3, T_BRKPT)
f0104a00:	6a 00                	push   $0x0
f0104a02:	6a 03                	push   $0x3
f0104a04:	e9 9c 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a09:	90                   	nop

f0104a0a <handler4>:
TRAPHANDLER_NOEC(handler4, T_OFLOW)
f0104a0a:	6a 00                	push   $0x0
f0104a0c:	6a 04                	push   $0x4
f0104a0e:	e9 92 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a13:	90                   	nop

f0104a14 <handler5>:
TRAPHANDLER_NOEC(handler5, T_BOUND)
f0104a14:	6a 00                	push   $0x0
f0104a16:	6a 05                	push   $0x5
f0104a18:	e9 88 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a1d:	90                   	nop

f0104a1e <handler6>:
TRAPHANDLER_NOEC(handler6, T_ILLOP)
f0104a1e:	6a 00                	push   $0x0
f0104a20:	6a 06                	push   $0x6
f0104a22:	e9 7e 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a27:	90                   	nop

f0104a28 <handler7>:
TRAPHANDLER_NOEC(handler7, T_DEVICE)
f0104a28:	6a 00                	push   $0x0
f0104a2a:	6a 07                	push   $0x7
f0104a2c:	e9 74 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a31:	90                   	nop

f0104a32 <handler8>:
TRAPHANDLER(handler8, T_DBLFLT)
f0104a32:	6a 08                	push   $0x8
f0104a34:	e9 6c 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a39:	90                   	nop

f0104a3a <handler9>:
TRAPHANDLER_NOEC(handler9, T_COPROC) /* reserved */
f0104a3a:	6a 00                	push   $0x0
f0104a3c:	6a 09                	push   $0x9
f0104a3e:	e9 62 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a43:	90                   	nop

f0104a44 <handler10>:
TRAPHANDLER(handler10, T_TSS)
f0104a44:	6a 0a                	push   $0xa
f0104a46:	e9 5a 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a4b:	90                   	nop

f0104a4c <handler11>:
TRAPHANDLER(handler11, T_SEGNP)
f0104a4c:	6a 0b                	push   $0xb
f0104a4e:	e9 52 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a53:	90                   	nop

f0104a54 <handler12>:
TRAPHANDLER(handler12, T_STACK)
f0104a54:	6a 0c                	push   $0xc
f0104a56:	e9 4a 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a5b:	90                   	nop

f0104a5c <handler13>:
TRAPHANDLER(handler13, T_GPFLT)
f0104a5c:	6a 0d                	push   $0xd
f0104a5e:	e9 42 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a63:	90                   	nop

f0104a64 <handler14>:
TRAPHANDLER(handler14, T_PGFLT)
f0104a64:	6a 0e                	push   $0xe
f0104a66:	e9 3a 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a6b:	90                   	nop

f0104a6c <handler15>:
TRAPHANDLER_NOEC(handler15, T_RES)  /* reserved */
f0104a6c:	6a 00                	push   $0x0
f0104a6e:	6a 0f                	push   $0xf
f0104a70:	e9 30 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a75:	90                   	nop

f0104a76 <handler16>:
TRAPHANDLER_NOEC(handler16, T_FPERR)
f0104a76:	6a 00                	push   $0x0
f0104a78:	6a 10                	push   $0x10
f0104a7a:	e9 26 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a7f:	90                   	nop

f0104a80 <handler17>:
TRAPHANDLER(handler17, T_ALIGN)
f0104a80:	6a 11                	push   $0x11
f0104a82:	e9 1e 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a87:	90                   	nop

f0104a88 <handler18>:
TRAPHANDLER_NOEC(handler18, T_MCHK)
f0104a88:	6a 00                	push   $0x0
f0104a8a:	6a 12                	push   $0x12
f0104a8c:	e9 14 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a91:	90                   	nop

f0104a92 <handler19>:
TRAPHANDLER_NOEC(handler19, T_SIMDERR)
f0104a92:	6a 00                	push   $0x0
f0104a94:	6a 13                	push   $0x13
f0104a96:	e9 0a 00 00 00       	jmp    f0104aa5 <_alltraps>
f0104a9b:	90                   	nop

f0104a9c <handler_syscall>:

TRAPHANDLER_NOEC(handler_syscall, T_SYSCALL)
f0104a9c:	6a 00                	push   $0x0
f0104a9e:	6a 30                	push   $0x30
f0104aa0:	e9 00 00 00 00       	jmp    f0104aa5 <_alltraps>
...
f0104aa7:	60                   	pusha  
	movl $GD_KD, %eax
f0104aa8:	b8 10 00 00 00       	mov    $0x10,%eax
	movw %ax, %ds
f0104aad:	8e d8                	mov    %eax,%ds
	movw %ax, %es
f0104aaf:	8e c0                	mov    %eax,%es

	pushl %esp
f0104ab1:	54                   	push   %esp
	call trap
f0104ab2:	e8 0e fd ff ff       	call   f01047c5 <trap>
...
f0104aba:	83 ec 18             	sub    $0x18,%esp
f0104abd:	8b 15 48 c2 22 f0    	mov    0xf022c248,%edx
	int i;
...
f0104ac8:	8b 4a 54             	mov    0x54(%edx),%ecx
f0104acb:	83 e9 01             	sub    $0x1,%ecx
	int i;
	...
	for (i = 0; i < NENV; i++) {
		if ((envs[i].env_status == ENV_RUNNABLE ||
f0104ace:	83 f9 02             	cmp    $0x2,%ecx
f0104ad1:	76 0f                	jbe    f0104ae2 <sched_halt+0x2b>
{
	int i;
	...
	// environments in the system, then drop into the kernel monitor.
	for (i = 0; i < NENV; i++) {
f0104ad3:	83 c0 01             	add    $0x1,%eax
f0104ad6:	83 c2 7c             	add    $0x7c,%edx
f0104ad9:	3d 00 04 00 00       	cmp    $0x400,%eax
f0104ade:	75 e8                	jne    f0104ac8 <sched_halt+0x11>
f0104ae0:	eb 07                	jmp    f0104ae9 <sched_halt+0x32>
		if ((envs[i].env_status == ENV_RUNNABLE ||
		     envs[i].env_status == ENV_RUNNING ||
	...
	if (i == NENV) {
f0104ae2:	3d 00 04 00 00       	cmp    $0x400,%eax
f0104ae7:	75 1a                	jne    f0104b03 <sched_halt+0x4c>
		cprintf("No runnable environments in the system!\n");
f0104ae9:	c7 04 24 70 80 10 f0 	movl   $0xf0108070,(%esp)
f0104af0:	e8 7d f4 ff ff       	call   f0103f72 <cprintf>
		while (1)
			monitor(NULL);
f0104af5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
f0104afc:	e8 e8 bd ff ff       	call   f01008e9 <monitor>
f0104b01:	eb f2                	jmp    f0104af5 <sched_halt+0x3e>
	}

	// Mark that no environment is running on this CPU
	curenv = NULL;
f0104b03:	e8 81 18 00 00       	call   f0106389 <cpunum>
f0104b08:	6b c0 74             	imul   $0x74,%eax,%eax
f0104b0b:	c7 80 28 d0 22 f0 00 	movl   $0x0,-0xfdd2fd8(%eax)
f0104b12:	00 00 00 
	lcr3(PADDR(kern_pgdir));
f0104b15:	a1 8c ce 22 f0       	mov    0xf022ce8c,%eax
#define PADDR(kva) _paddr(__FILE__, __LINE__, kva)
...
{
	if ((uint32_t)kva < KERNBASE)
f0104b1a:	3d ff ff ff ef       	cmp    $0xefffffff,%eax
f0104b1f:	77 20                	ja     f0104b41 <sched_halt+0x8a>
		_panic(file, line, "PADDR called with invalid kva %08lx", kva);
f0104b21:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0104b25:	c7 44 24 08 a8 6a 10 	movl   $0xf0106aa8,0x8(%esp)
f0104b2c:	f0 
f0104b2d:	c7 44 24 04 59 00 00 	movl   $0x59,0x4(%esp)
f0104b34:	00 
f0104b35:	c7 04 24 99 80 10 f0 	movl   $0xf0108099,(%esp)
f0104b3c:	e8 ff b4 ff ff       	call   f0100040 <_panic>
	return (physaddr_t)kva - KERNBASE;
f0104b41:	05 00 00 00 10       	add    $0x10000000,%eax
}
...
{
	__asm __volatile("movl %0,%%cr3" : : "r" (val));
f0104b46:	0f 22 d8             	mov    %eax,%cr3

	// Mark that this CPU is in the HALT state, so that when
	// timer interupts come in, we know we should re-acquire the
	// big kernel lock
	xchg(&thiscpu->cpu_status, CPU_HALTED);
f0104b49:	e8 3b 18 00 00       	call   f0106389 <cpunum>
f0104b4e:	6b d0 74             	imul   $0x74,%eax,%edx
f0104b51:	81 c2 20 d0 22 f0    	add    $0xf022d020,%edx
xchg(volatile uint32_t *addr, uint32_t newval)
{
	uint32_t result;
	...
	// The + in "+m" denotes a read-modify-write operand.
	asm volatile("lock; xchgl %0, %1" :
f0104b57:	b8 02 00 00 00       	mov    $0x2,%eax
f0104b5c:	f0 87 42 04          	lock xchg %eax,0x4(%edx)
}
...
{
	spin_unlock(&kernel_lock);
f0104b60:	c7 04 24 c0 13 12 f0 	movl   $0xf01213c0,(%esp)
f0104b67:	e8 47 1b 00 00       	call   f01066b3 <spin_unlock>
...
f0104b6e:	e8 16 18 00 00       	call   f0106389 <cpunum>
f0104b73:	6b c0 74             	imul   $0x74,%eax,%eax
	...
	asm volatile (
f0104b76:	8b 80 30 d0 22 f0    	mov    -0xfdd2fd0(%eax),%eax
f0104b7c:	bd 00 00 00 00       	mov    $0x0,%ebp
f0104b81:	89 c4                	mov    %eax,%esp
f0104b83:	6a 00                	push   $0x0
f0104b85:	6a 00                	push   $0x0
f0104b87:	fb                   	sti    
f0104b88:	f4                   	hlt    
f0104b89:	eb fd                	jmp    f0104b88 <sched_halt+0xd1>
		"sti\n"
		"1:\n"
		"hlt\n"
		"jmp 1b\n"
...
f0104b96:	e8 ee 17 00 00       	call   f0106389 <cpunum>
f0104b9b:	6b c0 74             	imul   $0x74,%eax,%eax
f0104b9e:	8b 98 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%ebx
	int EnvID = 0;
	int startID = 0;
	int i=0;
	bool firstEnv = true;
	if(e != NULL){
f0104ba4:	85 db                	test   %ebx,%ebx
f0104ba6:	74 3f                	je     f0104be7 <sched_yield+0x5a>
			
		EnvID =  e-envs;
f0104ba8:	89 de                	mov    %ebx,%esi
f0104baa:	2b 35 48 c2 22 f0    	sub    0xf022c248,%esi
f0104bb0:	c1 fe 02             	sar    $0x2,%esi
f0104bb3:	69 f6 df 7b ef bd    	imul   $0xbdef7bdf,%esi,%esi
f0104bb9:	89 f1                	mov    %esi,%ecx
		e->env_status = ENV_RUNNABLE;
f0104bbb:	c7 43 54 02 00 00 00 	movl   $0x2,0x54(%ebx)
		startID = (EnvID+1) % (NENV-1);
f0104bc2:	83 c6 01             	add    $0x1,%esi
f0104bc5:	ba 03 08 20 80       	mov    $0x80200803,%edx
f0104bca:	89 f0                	mov    %esi,%eax
f0104bcc:	f7 ea                	imul   %edx
f0104bce:	01 f2                	add    %esi,%edx
f0104bd0:	c1 fa 09             	sar    $0x9,%edx
f0104bd3:	89 f0                	mov    %esi,%eax
f0104bd5:	c1 f8 1f             	sar    $0x1f,%eax
f0104bd8:	29 c2                	sub    %eax,%edx
f0104bda:	89 d0                	mov    %edx,%eax
f0104bdc:	c1 e0 0a             	shl    $0xa,%eax
f0104bdf:	29 d0                	sub    %edx,%eax
f0104be1:	89 f2                	mov    %esi,%edx
f0104be3:	29 c2                	sub    %eax,%edx
f0104be5:	eb 0a                	jmp    f0104bf1 <sched_yield+0x64>
	...
	int EnvID = 0;
	int startID = 0;
f0104be7:	ba 00 00 00 00       	mov    $0x0,%edx
	// below to halt the cpu.
	...
	struct Env *e = thiscpu->cpu_env;
	int EnvID = 0;
f0104bec:	b9 00 00 00 00       	mov    $0x0,%ecx
		startID = (EnvID+1) % (NENV-1);
	}
	...
	for(i = startID; firstEnv || i != EnvID; i = (i+1)%(NENV) ){
		if(envs[i].env_status == ENV_RUNNABLE){
f0104bf1:	8b 3d 48 c2 22 f0    	mov    0xf022c248,%edi
f0104bf7:	6b c2 7c             	imul   $0x7c,%edx,%eax
f0104bfa:	01 f8                	add    %edi,%eax
f0104bfc:	83 78 54 02          	cmpl   $0x2,0x54(%eax)
f0104c00:	75 08                	jne    f0104c0a <sched_yield+0x7d>
			//envs[i].env_cpunum = cpunum();
			env_run(&envs[i]);
f0104c02:	89 04 24             	mov    %eax,(%esp)
f0104c05:	e8 12 f1 ff ff       	call   f0103d1c <env_run>
		e->env_status = ENV_RUNNABLE;
		startID = (EnvID+1) % (NENV-1);
	}
	...
	//cprintf("startID = %d, EnvID = %d\n", startID, EnvID);
	for(i = startID; firstEnv || i != EnvID; i = (i+1)%(NENV) ){
f0104c0a:	83 c2 01             	add    $0x1,%edx
f0104c0d:	89 d6                	mov    %edx,%esi
f0104c0f:	c1 fe 1f             	sar    $0x1f,%esi
f0104c12:	c1 ee 16             	shr    $0x16,%esi
f0104c15:	01 f2                	add    %esi,%edx
f0104c17:	89 d0                	mov    %edx,%eax
f0104c19:	25 ff 03 00 00       	and    $0x3ff,%eax
f0104c1e:	29 f0                	sub    %esi,%eax
f0104c20:	89 c2                	mov    %eax,%edx
f0104c22:	39 c1                	cmp    %eax,%ecx
f0104c24:	75 d1                	jne    f0104bf7 <sched_yield+0x6a>
			env_run(&envs[i]);
		}
		firstEnv = false;
	}
	...
	if(e)
f0104c26:	85 db                	test   %ebx,%ebx
f0104c28:	74 08                	je     f0104c32 <sched_yield+0xa5>
		env_run(e);
f0104c2a:	89 1c 24             	mov    %ebx,(%esp)
f0104c2d:	e8 ea f0 ff ff       	call   f0103d1c <env_run>
	...
	sched_halt();
f0104c32:	e8 80 fe ff ff       	call   f0104ab7 <sched_halt>
	}
f0104c37:	83 c4 1c             	add    $0x1c,%esp
f0104c3a:	5b                   	pop    %ebx
f0104c3b:	5e                   	pop    %esi
f0104c3c:	5f                   	pop    %edi
f0104c3d:	5d                   	pop    %ebp
...
f0104c46:	83 ec 2c             	sub    $0x2c,%esp
f0104c49:	8b 45 08             	mov    0x8(%ebp),%eax
	...
	int ret = 0;
	switch(syscallno){
f0104c4c:	83 f8 0a             	cmp    $0xa,%eax
f0104c4f:	0f 87 62 04 00 00    	ja     f01050b7 <syscall+0x477>
f0104c55:	ff 24 85 ec 80 10 f0 	jmp    *-0xfef7f14(,%eax,4)
{
	...
	// LAB 3: Your code here.
	cprintf("let me see\n");
f0104c5c:	c7 04 24 a6 80 10 f0 	movl   $0xf01080a6,(%esp)
f0104c63:	e8 0a f3 ff ff       	call   f0103f72 <cprintf>
	user_mem_assert(curenv, s, len, PTE_U);
f0104c68:	e8 1c 17 00 00       	call   f0106389 <cpunum>
f0104c6d:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
f0104c74:	00 
f0104c75:	8b 4d 10             	mov    0x10(%ebp),%ecx
f0104c78:	89 4c 24 08          	mov    %ecx,0x8(%esp)
f0104c7c:	8b 7d 0c             	mov    0xc(%ebp),%edi
f0104c7f:	89 7c 24 04          	mov    %edi,0x4(%esp)
f0104c83:	6b c0 74             	imul   $0x74,%eax,%eax
f0104c86:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f0104c8c:	89 04 24             	mov    %eax,(%esp)
f0104c8f:	e8 93 e8 ff ff       	call   f0103527 <user_mem_assert>
	cprintf("let me see\n");
f0104c94:	c7 04 24 a6 80 10 f0 	movl   $0xf01080a6,(%esp)
f0104c9b:	e8 d2 f2 ff ff       	call   f0103f72 <cprintf>
	// Print the string supplied by the user.
	cprintf("%.*s", len, s);
f0104ca0:	8b 45 0c             	mov    0xc(%ebp),%eax
f0104ca3:	89 44 24 08          	mov    %eax,0x8(%esp)
f0104ca7:	8b 45 10             	mov    0x10(%ebp),%eax
f0104caa:	89 44 24 04          	mov    %eax,0x4(%esp)
f0104cae:	c7 04 24 b2 80 10 f0 	movl   $0xf01080b2,(%esp)
f0104cb5:	e8 b8 f2 ff ff       	call   f0103f72 <cprintf>
{
	// Call the function corresponding to the 'syscallno' parameter.
	// Return any appropriate return value.
	// LAB 3: Your code here.
...
f0104cbf:	e9 f8 03 00 00       	jmp    f01050bc <syscall+0x47c>
...
{
	return cons_getc();
f0104cc4:	e8 7c b9 ff ff       	call   f0100645 <cons_getc>
	int ret = 0;
	switch(syscallno){
		...
		case SYS_cgetc: 		ret = sys_cgetc();		
						break;
f0104cc9:	e9 ee 03 00 00       	jmp    f01050bc <syscall+0x47c>
...
f0104cd0:	e8 b4 16 00 00       	call   f0106389 <cpunum>
...
f0104cde:	8b 40 48             	mov    0x48(%eax),%eax
		...
		case SYS_getenvid:	 ret =sys_getenvid();	
						break;
f0104ce1:	e9 d6 03 00 00       	jmp    f01050bc <syscall+0x47c>
...
f0104cfb:	e8 2a e9 ff ff       	call   f010362a <envid2env>
		return r;
...
f0104d04:	78 6e                	js     f0104d74 <syscall+0x134>
		return r;
	if (e == curenv)
f0104d06:	e8 7e 16 00 00       	call   f0106389 <cpunum>
f0104d0b:	8b 55 e4             	mov    -0x1c(%ebp),%edx
f0104d0e:	6b c0 74             	imul   $0x74,%eax,%eax
f0104d11:	39 90 28 d0 22 f0    	cmp    %edx,-0xfdd2fd8(%eax)
f0104d17:	75 23                	jne    f0104d3c <syscall+0xfc>
		cprintf("[%08x] exiting gracefully\n", curenv->env_id);
f0104d19:	e8 6b 16 00 00       	call   f0106389 <cpunum>
f0104d1e:	6b c0 74             	imul   $0x74,%eax,%eax
f0104d21:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f0104d27:	8b 40 48             	mov    0x48(%eax),%eax
f0104d2a:	89 44 24 04          	mov    %eax,0x4(%esp)
f0104d2e:	c7 04 24 b7 80 10 f0 	movl   $0xf01080b7,(%esp)
f0104d35:	e8 38 f2 ff ff       	call   f0103f72 <cprintf>
f0104d3a:	eb 28                	jmp    f0104d64 <syscall+0x124>
	else
		cprintf("[%08x] destroying %08x\n", curenv->env_id, e->env_id);
f0104d3c:	8b 5a 48             	mov    0x48(%edx),%ebx
f0104d3f:	e8 45 16 00 00       	call   f0106389 <cpunum>
f0104d44:	89 5c 24 08          	mov    %ebx,0x8(%esp)
f0104d48:	6b c0 74             	imul   $0x74,%eax,%eax
f0104d4b:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f0104d51:	8b 40 48             	mov    0x48(%eax),%eax
f0104d54:	89 44 24 04          	mov    %eax,0x4(%esp)
f0104d58:	c7 04 24 d2 80 10 f0 	movl   $0xf01080d2,(%esp)
f0104d5f:	e8 0e f2 ff ff       	call   f0103f72 <cprintf>
	env_destroy(e);
f0104d64:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0104d67:	89 04 24             	mov    %eax,(%esp)
f0104d6a:	e8 0c ef ff ff       	call   f0103c7b <env_destroy>
	return 0;
...
f0104d74:	89 d0                	mov    %edx,%eax
						break;
f0104d76:	e9 41 03 00 00       	jmp    f01050bc <syscall+0x47c>
...
{
	sched_yield();
f0104d7b:	e8 0d fe ff ff       	call   f0104b8d <sched_yield>
...
f0104d80:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	struct Env* parentEnv = curenv;
f0104d87:	e8 fd 15 00 00       	call   f0106389 <cpunum>
f0104d8c:	6b c0 74             	imul   $0x74,%eax,%eax
f0104d8f:	8b b0 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%esi
	int r = env_alloc(&childEnv, parentEnv->env_id);
f0104d95:	8b 46 48             	mov    0x48(%esi),%eax
f0104d98:	89 44 24 04          	mov    %eax,0x4(%esp)
f0104d9c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
f0104d9f:	89 04 24             	mov    %eax,(%esp)
f0104da2:	e8 8c e9 ff ff       	call   f0103733 <env_alloc>
	if(r < 0)
f0104da7:	85 c0                	test   %eax,%eax
f0104da9:	0f 88 0d 03 00 00    	js     f01050bc <syscall+0x47c>
		return r;
	//init the childEnv
	childEnv->env_tf = parentEnv->env_tf;
f0104daf:	b9 11 00 00 00       	mov    $0x11,%ecx
f0104db4:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f0104db7:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
	childEnv->env_status = ENV_NOT_RUNNABLE;
f0104db9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0104dbc:	c7 40 54 04 00 00 00 	movl   $0x4,0x54(%eax)
	
	childEnv->env_tf.tf_regs.reg_eax = 0;
f0104dc3:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
	return childEnv->env_id;
f0104dca:	8b 40 48             	mov    0x48(%eax),%eax
f0104dcd:	e9 ea 02 00 00       	jmp    f01050bc <syscall+0x47c>
	...
	// LAB 4: Your code here.
	struct Env *e =0;
f0104dd2:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	int r =0;
	if((r = envid2env(envid, &e, 1)) < 0)
f0104dd9:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
f0104de0:	00 
f0104de1:	8d 45 e4             	lea    -0x1c(%ebp),%eax
f0104de4:	89 44 24 04          	mov    %eax,0x4(%esp)
f0104de8:	8b 45 0c             	mov    0xc(%ebp),%eax
f0104deb:	89 04 24             	mov    %eax,(%esp)
f0104dee:	e8 37 e8 ff ff       	call   f010362a <envid2env>
f0104df3:	85 c0                	test   %eax,%eax
f0104df5:	0f 88 c1 02 00 00    	js     f01050bc <syscall+0x47c>
		return r;

	if(status != ENV_RUNNABLE && status != ENV_NOT_RUNNABLE)
f0104dfb:	83 7d 10 04          	cmpl   $0x4,0x10(%ebp)
f0104dff:	74 06                	je     f0104e07 <syscall+0x1c7>
f0104e01:	83 7d 10 02          	cmpl   $0x2,0x10(%ebp)
f0104e05:	75 13                	jne    f0104e1a <syscall+0x1da>
		return -E_INVAL;
	e->env_status = status;
f0104e07:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0104e0a:	8b 4d 10             	mov    0x10(%ebp),%ecx
f0104e0d:	89 48 54             	mov    %ecx,0x54(%eax)
	return 0;
f0104e10:	b8 00 00 00 00       	mov    $0x0,%eax
f0104e15:	e9 a2 02 00 00       	jmp    f01050bc <syscall+0x47c>
	int r =0;
	if((r = envid2env(envid, &e, 1)) < 0)
		return r;
	...
	if(status != ENV_RUNNABLE && status != ENV_NOT_RUNNABLE)
		return -E_INVAL;
f0104e1a:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
						break;
		...
		case SYS_env_set_status: ret = sys_env_set_status(a1, a2);
						break;
f0104e1f:	e9 98 02 00 00       	jmp    f01050bc <syscall+0x47c>
	...
	struct Env *e =0;
f0104e24:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	int r =0;
	if((r = envid2env(envid, &e, 1)) < 0)
f0104e2b:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
f0104e32:	00 
f0104e33:	8d 45 e4             	lea    -0x1c(%ebp),%eax
f0104e36:	89 44 24 04          	mov    %eax,0x4(%esp)
f0104e3a:	8b 45 0c             	mov    0xc(%ebp),%eax
f0104e3d:	89 04 24             	mov    %eax,(%esp)
f0104e40:	e8 e5 e7 ff ff       	call   f010362a <envid2env>
f0104e45:	85 c0                	test   %eax,%eax
f0104e47:	78 6c                	js     f0104eb5 <syscall+0x275>
		return r;
	if( (int)va >= UTOP || ( (int)va % PGSIZE) != 0)
f0104e49:	81 7d 10 ff ff bf ee 	cmpl   $0xeebfffff,0x10(%ebp)
f0104e50:	77 67                	ja     f0104eb9 <syscall+0x279>
f0104e52:	f7 45 10 ff 0f 00 00 	testl  $0xfff,0x10(%ebp)
f0104e59:	75 67                	jne    f0104ec2 <syscall+0x282>
		return  -E_INVAL;
	if(  (perm & (~PTE_SYSCALL) ) !=0 )
f0104e5b:	8b 75 14             	mov    0x14(%ebp),%esi
f0104e5e:	81 e6 f8 f1 ff ff    	and    $0xfffff1f8,%esi
f0104e64:	75 63                	jne    f0104ec9 <syscall+0x289>
		return  -E_INVAL;
	if( (perm & PTE_U )== 0 || (perm& PTE_P) ==0)
f0104e66:	8b 45 14             	mov    0x14(%ebp),%eax
f0104e69:	83 e0 05             	and    $0x5,%eax
f0104e6c:	83 f8 05             	cmp    $0x5,%eax
f0104e6f:	75 5f                	jne    f0104ed0 <syscall+0x290>
		return  -E_INVAL;
	struct PageInfo * page = page_alloc(1);
f0104e71:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
f0104e78:	e8 55 c1 ff ff       	call   f0100fd2 <page_alloc>
f0104e7d:	89 c3                	mov    %eax,%ebx
	if(page == 0)
f0104e7f:	85 c0                	test   %eax,%eax
f0104e81:	74 54                	je     f0104ed7 <syscall+0x297>
		return -E_NO_MEM ;
	r = page_insert(e->env_pgdir, page, va,perm);
f0104e83:	8b 45 14             	mov    0x14(%ebp),%eax
f0104e86:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0104e8a:	8b 45 10             	mov    0x10(%ebp),%eax
f0104e8d:	89 44 24 08          	mov    %eax,0x8(%esp)
f0104e91:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f0104e95:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0104e98:	8b 40 60             	mov    0x60(%eax),%eax
f0104e9b:	89 04 24             	mov    %eax,(%esp)
f0104e9e:	e8 21 c4 ff ff       	call   f01012c4 <page_insert>
f0104ea3:	89 c7                	mov    %eax,%edi
	if(r <0){
f0104ea5:	85 c0                	test   %eax,%eax
f0104ea7:	79 33                	jns    f0104edc <syscall+0x29c>
		page_free(page);
f0104ea9:	89 1c 24             	mov    %ebx,(%esp)
f0104eac:	e8 ac c1 ff ff       	call   f010105d <page_free>
		return r;
f0104eb1:	89 fe                	mov    %edi,%esi
f0104eb3:	eb 27                	jmp    f0104edc <syscall+0x29c>
	// LAB 4: Your code here.
	...
	if((r = envid2env(envid, &e, 1)) < 0)
		return r;
f0104eb5:	89 c6                	mov    %eax,%esi
f0104eb7:	eb 23                	jmp    f0104edc <syscall+0x29c>
	if( (int)va >= UTOP || ( (int)va % PGSIZE) != 0)
		return  -E_INVAL;
f0104eb9:	be fd ff ff ff       	mov    $0xfffffffd,%esi
f0104ebe:	66 90                	xchg   %ax,%ax
f0104ec0:	eb 1a                	jmp    f0104edc <syscall+0x29c>
f0104ec2:	be fd ff ff ff       	mov    $0xfffffffd,%esi
f0104ec7:	eb 13                	jmp    f0104edc <syscall+0x29c>
	if(  (perm & (~PTE_SYSCALL) ) !=0 )
		return  -E_INVAL;
f0104ec9:	be fd ff ff ff       	mov    $0xfffffffd,%esi
f0104ece:	eb 0c                	jmp    f0104edc <syscall+0x29c>
	if( (perm & PTE_U )== 0 || (perm& PTE_P) ==0)
		return  -E_INVAL;
f0104ed0:	be fd ff ff ff       	mov    $0xfffffffd,%esi
f0104ed5:	eb 05                	jmp    f0104edc <syscall+0x29c>
	struct PageInfo * page = page_alloc(1);
	if(page == 0)
		return -E_NO_MEM ;
f0104ed7:	be fc ff ff ff       	mov    $0xfffffffc,%esi
...
f0104edc:	89 f0                	mov    %esi,%eax
						break;
f0104ede:	e9 d9 01 00 00       	jmp    f01050bc <syscall+0x47c>
...
f0104ee3:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
f0104eea:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
	int r =0;
	if((r = envid2env(srcenvid, &srcE, 1)) < 0)
f0104ef1:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
f0104ef8:	00 
f0104ef9:	8d 45 dc             	lea    -0x24(%ebp),%eax
f0104efc:	89 44 24 04          	mov    %eax,0x4(%esp)
f0104f00:	8b 45 0c             	mov    0xc(%ebp),%eax
f0104f03:	89 04 24             	mov    %eax,(%esp)
f0104f06:	e8 1f e7 ff ff       	call   f010362a <envid2env>
		return r;
f0104f0b:	89 c2                	mov    %eax,%edx
	//   check the current permissions on the page.
...
f0104f0f:	0f 88 05 01 00 00    	js     f010501a <syscall+0x3da>
		return r;
	if((r = envid2env(dstenvid, &destE, 1)) < 0)
f0104f15:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
f0104f1c:	00 
f0104f1d:	8d 45 e0             	lea    -0x20(%ebp),%eax
f0104f20:	89 44 24 04          	mov    %eax,0x4(%esp)
f0104f24:	8b 45 14             	mov    0x14(%ebp),%eax
f0104f27:	89 04 24             	mov    %eax,(%esp)
f0104f2a:	e8 fb e6 ff ff       	call   f010362a <envid2env>
f0104f2f:	85 c0                	test   %eax,%eax
f0104f31:	0f 88 a9 00 00 00    	js     f0104fe0 <syscall+0x3a0>
		return r;
	if( (int)srcva >= UTOP || ( (int)srcva % PGSIZE) != 0)
f0104f37:	81 7d 10 ff ff bf ee 	cmpl   $0xeebfffff,0x10(%ebp)
f0104f3e:	0f 87 a0 00 00 00    	ja     f0104fe4 <syscall+0x3a4>
f0104f44:	f7 45 10 ff 0f 00 00 	testl  $0xfff,0x10(%ebp)
f0104f4b:	0f 85 9a 00 00 00    	jne    f0104feb <syscall+0x3ab>
		return  -E_INVAL;
	if( (int)dstva >= UTOP || ( (int)dstva % PGSIZE) != 0)
f0104f51:	81 7d 18 ff ff bf ee 	cmpl   $0xeebfffff,0x18(%ebp)
f0104f58:	0f 87 94 00 00 00    	ja     f0104ff2 <syscall+0x3b2>
f0104f5e:	f7 45 18 ff 0f 00 00 	testl  $0xfff,0x18(%ebp)
f0104f65:	0f 85 8e 00 00 00    	jne    f0104ff9 <syscall+0x3b9>
		return  -E_INVAL;
	pte_t * srcPTE=0;
f0104f6b:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	struct PageInfo *page = page_lookup(srcE->env_pgdir, srcva, &srcPTE);
f0104f72:	8d 45 e4             	lea    -0x1c(%ebp),%eax
f0104f75:	89 44 24 08          	mov    %eax,0x8(%esp)
f0104f79:	8b 45 10             	mov    0x10(%ebp),%eax
f0104f7c:	89 44 24 04          	mov    %eax,0x4(%esp)
f0104f80:	8b 45 dc             	mov    -0x24(%ebp),%eax
f0104f83:	8b 40 60             	mov    0x60(%eax),%eax
f0104f86:	89 04 24             	mov    %eax,(%esp)
f0104f89:	e8 33 c2 ff ff       	call   f01011c1 <page_lookup>
	if(page == 0)
f0104f8e:	85 c0                	test   %eax,%eax
f0104f90:	74 6e                	je     f0105000 <syscall+0x3c0>
		return -E_INVAL;
	if(  (perm & (~PTE_SYSCALL) ) !=0 )
f0104f92:	f7 45 1c f8 f1 ff ff 	testl  $0xfffff1f8,0x1c(%ebp)
f0104f99:	75 6c                	jne    f0105007 <syscall+0x3c7>
		return  -E_INVAL;
	if( (perm & PTE_U )== 0 || (perm& PTE_P) ==0)
f0104f9b:	8b 55 1c             	mov    0x1c(%ebp),%edx
f0104f9e:	83 e2 05             	and    $0x5,%edx
f0104fa1:	83 fa 05             	cmp    $0x5,%edx
f0104fa4:	75 68                	jne    f010500e <syscall+0x3ce>
		return  -E_INVAL;
	if ( (perm & PTE_W) && ( (*srcPTE & PTE_W )== 0) )
f0104fa6:	f6 45 1c 02          	testb  $0x2,0x1c(%ebp)
f0104faa:	74 08                	je     f0104fb4 <syscall+0x374>
f0104fac:	8b 55 e4             	mov    -0x1c(%ebp),%edx
f0104faf:	f6 02 02             	testb  $0x2,(%edx)
f0104fb2:	74 61                	je     f0105015 <syscall+0x3d5>
		return -E_INVAL;

	r = page_insert(destE->env_pgdir, page, dstva,perm);
f0104fb4:	8b 5d 1c             	mov    0x1c(%ebp),%ebx
f0104fb7:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
f0104fbb:	8b 7d 18             	mov    0x18(%ebp),%edi
f0104fbe:	89 7c 24 08          	mov    %edi,0x8(%esp)
f0104fc2:	89 44 24 04          	mov    %eax,0x4(%esp)
f0104fc6:	8b 45 e0             	mov    -0x20(%ebp),%eax
f0104fc9:	8b 40 60             	mov    0x60(%eax),%eax
f0104fcc:	89 04 24             	mov    %eax,(%esp)
f0104fcf:	e8 f0 c2 ff ff       	call   f01012c4 <page_insert>
f0104fd4:	85 c0                	test   %eax,%eax
f0104fd6:	ba 00 00 00 00       	mov    $0x0,%edx
f0104fdb:	0f 4e d0             	cmovle %eax,%edx
f0104fde:	eb 3a                	jmp    f010501a <syscall+0x3da>
	struct Env *srcE=0, *destE = 0;
	int r =0;
	if((r = envid2env(srcenvid, &srcE, 1)) < 0)
		return r;
...
f0104fe2:	eb 36                	jmp    f010501a <syscall+0x3da>
	if( (int)srcva >= UTOP || ( (int)srcva % PGSIZE) != 0)
		return  -E_INVAL;
f0104fe4:	ba fd ff ff ff       	mov    $0xfffffffd,%edx
f0104fe9:	eb 2f                	jmp    f010501a <syscall+0x3da>
f0104feb:	ba fd ff ff ff       	mov    $0xfffffffd,%edx
f0104ff0:	eb 28                	jmp    f010501a <syscall+0x3da>
	if( (int)dstva >= UTOP || ( (int)dstva % PGSIZE) != 0)
		return  -E_INVAL;
f0104ff2:	ba fd ff ff ff       	mov    $0xfffffffd,%edx
f0104ff7:	eb 21                	jmp    f010501a <syscall+0x3da>
f0104ff9:	ba fd ff ff ff       	mov    $0xfffffffd,%edx
f0104ffe:	eb 1a                	jmp    f010501a <syscall+0x3da>
	pte_t * srcPTE=0;
	struct PageInfo *page = page_lookup(srcE->env_pgdir, srcva, &srcPTE);
	if(page == 0)
		return -E_INVAL;
f0105000:	ba fd ff ff ff       	mov    $0xfffffffd,%edx
f0105005:	eb 13                	jmp    f010501a <syscall+0x3da>
	if(  (perm & (~PTE_SYSCALL) ) !=0 )
		return  -E_INVAL;
f0105007:	ba fd ff ff ff       	mov    $0xfffffffd,%edx
f010500c:	eb 0c                	jmp    f010501a <syscall+0x3da>
	if( (perm & PTE_U )== 0 || (perm& PTE_P) ==0)
		return  -E_INVAL;
f010500e:	ba fd ff ff ff       	mov    $0xfffffffd,%edx
f0105013:	eb 05                	jmp    f010501a <syscall+0x3da>
	if ( (perm & PTE_W) && ( (*srcPTE & PTE_W )== 0) )
		return -E_INVAL;
f0105015:	ba fd ff ff ff       	mov    $0xfffffffd,%edx
						break;
		case SYS_env_set_status: ret = sys_env_set_status(a1, a2);
						break;
		case SYS_page_alloc: 	ret = sys_page_alloc(a1, (void*) a2, a3);
...
f010501a:	89 d0                	mov    %edx,%eax
						break;
f010501c:	e9 9b 00 00 00       	jmp    f01050bc <syscall+0x47c>
sys_page_unmap(envid_t envid, void *va)
{
	...
	// LAB 4: Your code here.
	struct Env *e =0;
f0105021:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	int r =0;
	if((r = envid2env(envid, &e, 1)) < 0)
f0105028:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
f010502f:	00 
f0105030:	8d 45 e4             	lea    -0x1c(%ebp),%eax
f0105033:	89 44 24 04          	mov    %eax,0x4(%esp)
f0105037:	8b 45 0c             	mov    0xc(%ebp),%eax
f010503a:	89 04 24             	mov    %eax,(%esp)
f010503d:	e8 e8 e5 ff ff       	call   f010362a <envid2env>
f0105042:	85 c0                	test   %eax,%eax
f0105044:	78 76                	js     f01050bc <syscall+0x47c>
		return r;
	if( (int)va >= UTOP || ( (int)va % PGSIZE) != 0)
f0105046:	81 7d 10 ff ff bf ee 	cmpl   $0xeebfffff,0x10(%ebp)
f010504d:	77 25                	ja     f0105074 <syscall+0x434>
f010504f:	f7 45 10 ff 0f 00 00 	testl  $0xfff,0x10(%ebp)
f0105056:	75 23                	jne    f010507b <syscall+0x43b>
		return  -E_INVAL;
	page_remove(e->env_pgdir, va);
f0105058:	8b 45 10             	mov    0x10(%ebp),%eax
f010505b:	89 44 24 04          	mov    %eax,0x4(%esp)
f010505f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0105062:	8b 40 60             	mov    0x60(%eax),%eax
f0105065:	89 04 24             	mov    %eax,(%esp)
f0105068:	e8 fe c1 ff ff       	call   f010126b <page_remove>
	return 0;
f010506d:	b8 00 00 00 00       	mov    $0x0,%eax
f0105072:	eb 48                	jmp    f01050bc <syscall+0x47c>
	struct Env *e =0;
	int r =0;
	if((r = envid2env(envid, &e, 1)) < 0)
		return r;
	if( (int)va >= UTOP || ( (int)va % PGSIZE) != 0)
		return  -E_INVAL;
f0105074:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
f0105079:	eb 41                	jmp    f01050bc <syscall+0x47c>
f010507b:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
		...
		case SYS_page_unmap:	ret = sys_page_unmap(a1, (void*) a2);
						break;
f0105080:	eb 3a                	jmp    f01050bc <syscall+0x47c>
static int
sys_env_set_pgfault_upcall(envid_t envid, void *func)
{
	...
	// LAB 4: Your code here.
	struct Env *e =0;
f0105082:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	int r =0;
	if((r = envid2env(envid, &e, 1)) < 0)
f0105089:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
f0105090:	00 
f0105091:	8d 45 e4             	lea    -0x1c(%ebp),%eax
f0105094:	89 44 24 04          	mov    %eax,0x4(%esp)
f0105098:	8b 45 0c             	mov    0xc(%ebp),%eax
f010509b:	89 04 24             	mov    %eax,(%esp)
f010509e:	e8 87 e5 ff ff       	call   f010362a <envid2env>
f01050a3:	85 c0                	test   %eax,%eax
f01050a5:	78 15                	js     f01050bc <syscall+0x47c>
		return r;
	e->env_pgfault_upcall = func;
f01050a7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f01050aa:	8b 5d 10             	mov    0x10(%ebp),%ebx
f01050ad:	89 58 64             	mov    %ebx,0x64(%eax)
	return 0;
f01050b0:	b8 00 00 00 00       	mov    $0x0,%eax
f01050b5:	eb 05                	jmp    f01050bc <syscall+0x47c>
		...
		default:
			return -E_NO_SYS;
f01050b7:	b8 f9 ff ff ff       	mov    $0xfffffff9,%eax
	}
	return ret;
}
f01050bc:	83 c4 2c             	add    $0x2c,%esp
f01050bf:	5b                   	pop    %ebx
f01050c0:	5e                   	pop    %esi
f01050c1:	5f                   	pop    %edi
f01050c2:	5d                   	pop    %ebp
...
{
f01050c4:	55                   	push   %ebp
f01050c5:	89 e5                	mov    %esp,%ebp
f01050c7:	57                   	push   %edi
f01050c8:	56                   	push   %esi
f01050c9:	53                   	push   %ebx
f01050ca:	83 ec 14             	sub    $0x14,%esp
f01050cd:	89 45 ec             	mov    %eax,-0x14(%ebp)
f01050d0:	89 55 e4             	mov    %edx,-0x1c(%ebp)
f01050d3:	89 4d e0             	mov    %ecx,-0x20(%ebp)
f01050d6:	8b 75 08             	mov    0x8(%ebp),%esi
	int l = *region_left, r = *region_right, any_matches = 0;
f01050d9:	8b 1a                	mov    (%edx),%ebx
f01050db:	8b 01                	mov    (%ecx),%eax
f01050dd:	89 45 f0             	mov    %eax,-0x10(%ebp)
f01050e0:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)

	while (l <= r) {
f01050e7:	e9 88 00 00 00       	jmp    f0105174 <stab_binsearch+0xb0>
		int true_m = (l + r) / 2, m = true_m;
f01050ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
f01050ef:	01 d8                	add    %ebx,%eax
f01050f1:	89 c7                	mov    %eax,%edi
f01050f3:	c1 ef 1f             	shr    $0x1f,%edi
f01050f6:	01 c7                	add    %eax,%edi
f01050f8:	d1 ff                	sar    %edi
f01050fa:	8d 04 7f             	lea    (%edi,%edi,2),%eax
f01050fd:	8b 4d ec             	mov    -0x14(%ebp),%ecx
f0105100:	8d 14 81             	lea    (%ecx,%eax,4),%edx
f0105103:	89 f8                	mov    %edi,%eax

		// search for earliest stab with right type
		while (m >= l && stabs[m].n_type != type)
f0105105:	eb 03                	jmp    f010510a <stab_binsearch+0x46>
			m--;
f0105107:	83 e8 01             	sub    $0x1,%eax
	...
	while (l <= r) {
		...
		// search for earliest stab with right type
		while (m >= l && stabs[m].n_type != type)
f010510a:	39 c3                	cmp    %eax,%ebx
f010510c:	7f 1f                	jg     f010512d <stab_binsearch+0x69>
f010510e:	0f b6 4a 04          	movzbl 0x4(%edx),%ecx
f0105112:	83 ea 0c             	sub    $0xc,%edx
f0105115:	39 f1                	cmp    %esi,%ecx
f0105117:	75 ee                	jne    f0105107 <stab_binsearch+0x43>
f0105119:	89 45 e8             	mov    %eax,-0x18(%ebp)
			continue;
		}
...
f010511c:	8d 14 40             	lea    (%eax,%eax,2),%edx
f010511f:	8b 4d ec             	mov    -0x14(%ebp),%ecx
f0105122:	8b 54 91 08          	mov    0x8(%ecx,%edx,4),%edx
f0105126:	39 55 0c             	cmp    %edx,0xc(%ebp)
f0105129:	76 18                	jbe    f0105143 <stab_binsearch+0x7f>
f010512b:	eb 05                	jmp    f0105132 <stab_binsearch+0x6e>
		...
		if (m < l) {	// no match in [l, m]
			l = true_m + 1;
f010512d:	8d 5f 01             	lea    0x1(%edi),%ebx
			continue;
f0105130:	eb 42                	jmp    f0105174 <stab_binsearch+0xb0>
		}
...
f0105135:	89 03                	mov    %eax,(%ebx)
			l = true_m + 1;
f0105137:	8d 5f 01             	lea    0x1(%edi),%ebx
			l = true_m + 1;
			continue;
		}
		...
		// actual binary search
		any_matches = 1;
f010513a:	c7 45 e8 01 00 00 00 	movl   $0x1,-0x18(%ebp)
f0105141:	eb 31                	jmp    f0105174 <stab_binsearch+0xb0>
		if (stabs[m].n_value < addr) {
			*region_left = m;
			l = true_m + 1;
		} else if (stabs[m].n_value > addr) {
f0105143:	39 55 0c             	cmp    %edx,0xc(%ebp)
f0105146:	73 17                	jae    f010515f <stab_binsearch+0x9b>
			*region_right = m - 1;
f0105148:	8b 45 e8             	mov    -0x18(%ebp),%eax
f010514b:	83 e8 01             	sub    $0x1,%eax
f010514e:	89 45 f0             	mov    %eax,-0x10(%ebp)
f0105151:	8b 7d e0             	mov    -0x20(%ebp),%edi
f0105154:	89 07                	mov    %eax,(%edi)
			l = true_m + 1;
			continue;
		}
		...
		// actual binary search
		any_matches = 1;
f0105156:	c7 45 e8 01 00 00 00 	movl   $0x1,-0x18(%ebp)
f010515d:	eb 15                	jmp    f0105174 <stab_binsearch+0xb0>
			*region_right = m - 1;
			r = m - 1;
		} else {
...
f0105162:	8b 5d e8             	mov    -0x18(%ebp),%ebx
f0105165:	89 1f                	mov    %ebx,(%edi)
			l = m;
			addr++;
f0105167:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
f010516b:	89 c3                	mov    %eax,%ebx
			l = true_m + 1;
			continue;
		}
		...
		// actual binary search
		any_matches = 1;
f010516d:	c7 45 e8 01 00 00 00 	movl   $0x1,-0x18(%ebp)
stab_binsearch(const struct Stab *stabs, int *region_left, int *region_right,
	       int type, uintptr_t addr)
{
	int l = *region_left, r = *region_right, any_matches = 0;
	...
	while (l <= r) {
f0105174:	3b 5d f0             	cmp    -0x10(%ebp),%ebx
f0105177:	0f 8e 6f ff ff ff    	jle    f01050ec <stab_binsearch+0x28>
			l = m;
			addr++;
		}
	}
	...
	if (!any_matches)
f010517d:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
f0105181:	75 0f                	jne    f0105192 <stab_binsearch+0xce>
		*region_right = *region_left - 1;
f0105183:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0105186:	8b 00                	mov    (%eax),%eax
f0105188:	83 e8 01             	sub    $0x1,%eax
f010518b:	8b 7d e0             	mov    -0x20(%ebp),%edi
f010518e:	89 07                	mov    %eax,(%edi)
f0105190:	eb 2c                	jmp    f01051be <stab_binsearch+0xfa>
	else {
		// find rightmost region containing 'addr'
		for (l = *region_right;
f0105192:	8b 45 e0             	mov    -0x20(%ebp),%eax
f0105195:	8b 00                	mov    (%eax),%eax
		     l > *region_left && stabs[l].n_type != type;
f0105197:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f010519a:	8b 0f                	mov    (%edi),%ecx
f010519c:	8d 14 40             	lea    (%eax,%eax,2),%edx
f010519f:	8b 7d ec             	mov    -0x14(%ebp),%edi
f01051a2:	8d 14 97             	lea    (%edi,%edx,4),%edx
	...
	if (!any_matches)
		*region_right = *region_left - 1;
		...
		// find rightmost region containing 'addr'
		for (l = *region_right;
f01051a5:	eb 03                	jmp    f01051aa <stab_binsearch+0xe6>
		     l > *region_left && stabs[l].n_type != type;
		     l--)
f01051a7:	83 e8 01             	sub    $0x1,%eax
	...
	if (!any_matches)
		*region_right = *region_left - 1;
		...
		// find rightmost region containing 'addr'
		for (l = *region_right;
f01051aa:	39 c8                	cmp    %ecx,%eax
f01051ac:	7e 0b                	jle    f01051b9 <stab_binsearch+0xf5>
		     l > *region_left && stabs[l].n_type != type;
f01051ae:	0f b6 5a 04          	movzbl 0x4(%edx),%ebx
f01051b2:	83 ea 0c             	sub    $0xc,%edx
f01051b5:	39 f3                	cmp    %esi,%ebx
f01051b7:	75 ee                	jne    f01051a7 <stab_binsearch+0xe3>
		     l--)
			/* do nothing */;
		*region_left = l;
f01051b9:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f01051bc:	89 07                	mov    %eax,(%edi)
	}
}
f01051be:	83 c4 14             	add    $0x14,%esp
f01051c1:	5b                   	pop    %ebx
f01051c2:	5e                   	pop    %esi
f01051c3:	5f                   	pop    %edi
f01051c4:	5d                   	pop    %ebp
...
f01051c9:	57                   	push   %edi
f01051ca:	56                   	push   %esi
f01051cb:	53                   	push   %ebx
f01051cc:	83 ec 4c             	sub    $0x4c,%esp
f01051cf:	8b 75 08             	mov    0x8(%ebp),%esi
f01051d2:	8b 7d 0c             	mov    0xc(%ebp),%edi
...
f01051d5:	c7 07 18 81 10 f0    	movl   $0xf0108118,(%edi)
	info->eip_line = 0;
f01051db:	c7 47 04 00 00 00 00 	movl   $0x0,0x4(%edi)
	info->eip_fn_name = "<unknown>";
f01051e2:	c7 47 08 18 81 10 f0 	movl   $0xf0108118,0x8(%edi)
	info->eip_fn_namelen = 9;
f01051e9:	c7 47 0c 09 00 00 00 	movl   $0x9,0xc(%edi)
	info->eip_fn_addr = addr;
f01051f0:	89 77 10             	mov    %esi,0x10(%edi)
	info->eip_fn_narg = 0;
f01051f3:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
	// return 0;
	// Find the relevant set of stabs
	if (addr >= ULIM) {
f01051fa:	81 fe ff ff 7f ef    	cmp    $0xef7fffff,%esi
f0105200:	0f 87 c1 00 00 00    	ja     f01052c7 <debuginfo_eip+0x101>
...
f0105206:	e8 7e 11 00 00       	call   f0106389 <cpunum>
f010520b:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
f0105212:	00 
f0105213:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
f010521a:	00 
f010521b:	c7 44 24 04 00 00 20 	movl   $0x200000,0x4(%esp)
f0105222:	00 
f0105223:	6b c0 74             	imul   $0x74,%eax,%eax
f0105226:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f010522c:	89 04 24             	mov    %eax,(%esp)
f010522f:	e8 51 e2 ff ff       	call   f0103485 <user_mem_check>
f0105234:	85 c0                	test   %eax,%eax
f0105236:	0f 85 49 02 00 00    	jne    f0105485 <debuginfo_eip+0x2bf>
			return -1;

		stabs = usd->stabs;
f010523c:	a1 00 00 20 00       	mov    0x200000,%eax
f0105241:	89 45 c4             	mov    %eax,-0x3c(%ebp)
		stab_end = usd->stab_end;
f0105244:	8b 1d 04 00 20 00    	mov    0x200004,%ebx
		stabstr = usd->stabstr;
f010524a:	a1 08 00 20 00       	mov    0x200008,%eax
f010524f:	89 45 c0             	mov    %eax,-0x40(%ebp)
		stabstr_end = usd->stabstr_end;
f0105252:	8b 15 0c 00 20 00    	mov    0x20000c,%edx
f0105258:	89 55 bc             	mov    %edx,-0x44(%ebp)

		// Make sure the STABS and string table memory is valid.
		// LAB 3: Your code here.
		if (user_mem_check(curenv, stabs, sizeof(struct Stab), PTE_U))
f010525b:	e8 29 11 00 00       	call   f0106389 <cpunum>
f0105260:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
f0105267:	00 
f0105268:	c7 44 24 08 0c 00 00 	movl   $0xc,0x8(%esp)
f010526f:	00 
f0105270:	8b 4d c4             	mov    -0x3c(%ebp),%ecx
f0105273:	89 4c 24 04          	mov    %ecx,0x4(%esp)
f0105277:	6b c0 74             	imul   $0x74,%eax,%eax
f010527a:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f0105280:	89 04 24             	mov    %eax,(%esp)
f0105283:	e8 fd e1 ff ff       	call   f0103485 <user_mem_check>
f0105288:	85 c0                	test   %eax,%eax
f010528a:	0f 85 fc 01 00 00    	jne    f010548c <debuginfo_eip+0x2c6>
			return -1;

		if (user_mem_check(curenv, stabstr, stabstr_end-stabstr, PTE_U))
f0105290:	e8 f4 10 00 00       	call   f0106389 <cpunum>
f0105295:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
f010529c:	00 
f010529d:	8b 55 bc             	mov    -0x44(%ebp),%edx
f01052a0:	8b 4d c0             	mov    -0x40(%ebp),%ecx
f01052a3:	29 ca                	sub    %ecx,%edx
f01052a5:	89 54 24 08          	mov    %edx,0x8(%esp)
f01052a9:	89 4c 24 04          	mov    %ecx,0x4(%esp)
f01052ad:	6b c0 74             	imul   $0x74,%eax,%eax
f01052b0:	8b 80 28 d0 22 f0    	mov    -0xfdd2fd8(%eax),%eax
f01052b6:	89 04 24             	mov    %eax,(%esp)
f01052b9:	e8 c7 e1 ff ff       	call   f0103485 <user_mem_check>
f01052be:	85 c0                	test   %eax,%eax
f01052c0:	74 1f                	je     f01052e1 <debuginfo_eip+0x11b>
f01052c2:	e9 cc 01 00 00       	jmp    f0105493 <debuginfo_eip+0x2cd>
	// Find the relevant set of stabs
	if (addr >= ULIM) {
...
f01052c7:	c7 45 bc a5 60 11 f0 	movl   $0xf01160a5,-0x44(%ebp)
	// return 0;
	// Find the relevant set of stabs
	if (addr >= ULIM) {
		stabs = __STAB_BEGIN__;
		stab_end = __STAB_END__;
		stabstr = __STABSTR_BEGIN__;
f01052ce:	c7 45 c0 51 2a 11 f0 	movl   $0xf0112a51,-0x40(%ebp)
	info->eip_fn_narg = 0;
	// return 0;
	// Find the relevant set of stabs
	if (addr >= ULIM) {
		stabs = __STAB_BEGIN__;
		stab_end = __STAB_END__;
f01052d5:	bb 50 2a 11 f0       	mov    $0xf0112a50,%ebx
	info->eip_fn_addr = addr;
	info->eip_fn_narg = 0;
	// return 0;
	// Find the relevant set of stabs
	if (addr >= ULIM) {
		stabs = __STAB_BEGIN__;
f01052da:	c7 45 c4 ec 85 10 f0 	movl   $0xf01085ec,-0x3c(%ebp)
		if (user_mem_check(curenv, stabstr, stabstr_end-stabstr, PTE_U))
			return -1;
	}
...
f01052e1:	8b 45 bc             	mov    -0x44(%ebp),%eax
f01052e4:	39 45 c0             	cmp    %eax,-0x40(%ebp)
f01052e7:	0f 83 ad 01 00 00    	jae    f010549a <debuginfo_eip+0x2d4>
f01052ed:	80 78 ff 00          	cmpb   $0x0,-0x1(%eax)
f01052f1:	0f 85 aa 01 00 00    	jne    f01054a1 <debuginfo_eip+0x2db>
	...
	lfile = 0;
f01052f7:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	rfile = (stab_end - stabs) - 1;
f01052fe:	2b 5d c4             	sub    -0x3c(%ebp),%ebx
f0105301:	c1 fb 02             	sar    $0x2,%ebx
f0105304:	69 c3 ab aa aa aa    	imul   $0xaaaaaaab,%ebx,%eax
f010530a:	83 e8 01             	sub    $0x1,%eax
f010530d:	89 45 e0             	mov    %eax,-0x20(%ebp)
	stab_binsearch(stabs, &lfile, &rfile, N_SO, addr);
f0105310:	89 74 24 04          	mov    %esi,0x4(%esp)
f0105314:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
f010531b:	8d 4d e0             	lea    -0x20(%ebp),%ecx
f010531e:	8d 55 e4             	lea    -0x1c(%ebp),%edx
f0105321:	8b 5d c4             	mov    -0x3c(%ebp),%ebx
f0105324:	89 d8                	mov    %ebx,%eax
f0105326:	e8 99 fd ff ff       	call   f01050c4 <stab_binsearch>
	if (lfile == 0)
f010532b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f010532e:	85 c0                	test   %eax,%eax
f0105330:	0f 84 72 01 00 00    	je     f01054a8 <debuginfo_eip+0x2e2>
		return -1;

	// Search within that file's stabs for the function definition
	// (N_FUN).
	lfun = lfile;
f0105336:	89 45 dc             	mov    %eax,-0x24(%ebp)
	rfun = rfile;
f0105339:	8b 45 e0             	mov    -0x20(%ebp),%eax
f010533c:	89 45 d8             	mov    %eax,-0x28(%ebp)
	stab_binsearch(stabs, &lfun, &rfun, N_FUN, addr);
f010533f:	89 74 24 04          	mov    %esi,0x4(%esp)
f0105343:	c7 04 24 24 00 00 00 	movl   $0x24,(%esp)
f010534a:	8d 4d d8             	lea    -0x28(%ebp),%ecx
f010534d:	8d 55 dc             	lea    -0x24(%ebp),%edx
f0105350:	89 d8                	mov    %ebx,%eax
f0105352:	e8 6d fd ff ff       	call   f01050c4 <stab_binsearch>

	if (lfun <= rfun) {
f0105357:	8b 45 dc             	mov    -0x24(%ebp),%eax
f010535a:	8b 5d d8             	mov    -0x28(%ebp),%ebx
f010535d:	39 d8                	cmp    %ebx,%eax
f010535f:	7f 32                	jg     f0105393 <debuginfo_eip+0x1cd>
		// stabs[lfun] points to the function name
		// in the string table, but check bounds just in case.
		if (stabs[lfun].n_strx < stabstr_end - stabstr)
f0105361:	8d 14 40             	lea    (%eax,%eax,2),%edx
f0105364:	8b 4d c4             	mov    -0x3c(%ebp),%ecx
f0105367:	8d 14 91             	lea    (%ecx,%edx,4),%edx
f010536a:	8b 0a                	mov    (%edx),%ecx
f010536c:	89 4d b8             	mov    %ecx,-0x48(%ebp)
f010536f:	8b 4d bc             	mov    -0x44(%ebp),%ecx
f0105372:	2b 4d c0             	sub    -0x40(%ebp),%ecx
f0105375:	39 4d b8             	cmp    %ecx,-0x48(%ebp)
f0105378:	73 09                	jae    f0105383 <debuginfo_eip+0x1bd>
			info->eip_fn_name = stabstr + stabs[lfun].n_strx;
f010537a:	8b 4d b8             	mov    -0x48(%ebp),%ecx
f010537d:	03 4d c0             	add    -0x40(%ebp),%ecx
f0105380:	89 4f 08             	mov    %ecx,0x8(%edi)
		info->eip_fn_addr = stabs[lfun].n_value;
f0105383:	8b 52 08             	mov    0x8(%edx),%edx
f0105386:	89 57 10             	mov    %edx,0x10(%edi)
		addr -= info->eip_fn_addr;
f0105389:	29 d6                	sub    %edx,%esi
		// Search within the function definition for the line number.
		lline = lfun;
f010538b:	89 45 d4             	mov    %eax,-0x2c(%ebp)
		rline = rfun;
f010538e:	89 5d d0             	mov    %ebx,-0x30(%ebp)
f0105391:	eb 0f                	jmp    f01053a2 <debuginfo_eip+0x1dc>
	} else {
		// Couldn't find function stab!  Maybe we're in an assembly
		// file.  Search the whole file for the line number.
		info->eip_fn_addr = addr;
f0105393:	89 77 10             	mov    %esi,0x10(%edi)
		lline = lfile;
f0105396:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0105399:	89 45 d4             	mov    %eax,-0x2c(%ebp)
		rline = rfile;
f010539c:	8b 45 e0             	mov    -0x20(%ebp),%eax
f010539f:	89 45 d0             	mov    %eax,-0x30(%ebp)
	}
	// Ignore stuff after the colon.
	info->eip_fn_namelen = strfind(info->eip_fn_name, ':') - info->eip_fn_name;
f01053a2:	c7 44 24 04 3a 00 00 	movl   $0x3a,0x4(%esp)
f01053a9:	00 
f01053aa:	8b 47 08             	mov    0x8(%edi),%eax
f01053ad:	89 04 24             	mov    %eax,(%esp)
f01053b0:	e8 66 09 00 00       	call   f0105d1b <strfind>
f01053b5:	2b 47 08             	sub    0x8(%edi),%eax
f01053b8:	89 47 0c             	mov    %eax,0xc(%edi)
	// Hint:
...
f01053bb:	89 74 24 04          	mov    %esi,0x4(%esp)
f01053bf:	c7 04 24 44 00 00 00 	movl   $0x44,(%esp)
f01053c6:	8d 4d d0             	lea    -0x30(%ebp),%ecx
f01053c9:	8d 55 d4             	lea    -0x2c(%ebp),%edx
f01053cc:	8b 75 c4             	mov    -0x3c(%ebp),%esi
f01053cf:	89 f0                	mov    %esi,%eax
f01053d1:	e8 ee fc ff ff       	call   f01050c4 <stab_binsearch>
	info->eip_line = stabs[lline].n_desc;
f01053d6:	8b 55 d4             	mov    -0x2c(%ebp),%edx
f01053d9:	8d 0c 12             	lea    (%edx,%edx,1),%ecx
f01053dc:	8d 04 11             	lea    (%ecx,%edx,1),%eax
f01053df:	0f b7 44 86 06       	movzwl 0x6(%esi,%eax,4),%eax
f01053e4:	89 47 04             	mov    %eax,0x4(%edi)
...
f01053ea:	89 c3                	mov    %eax,%ebx
f01053ec:	89 d0                	mov    %edx,%eax
f01053ee:	01 ca                	add    %ecx,%edx
f01053f0:	8d 14 96             	lea    (%esi,%edx,4),%edx
f01053f3:	89 7d 0c             	mov    %edi,0xc(%ebp)
f01053f6:	89 df                	mov    %ebx,%edi
f01053f8:	eb 06                	jmp    f0105400 <debuginfo_eip+0x23a>
f01053fa:	83 e8 01             	sub    $0x1,%eax
f01053fd:	83 ea 0c             	sub    $0xc,%edx
f0105400:	89 c6                	mov    %eax,%esi
f0105402:	39 c7                	cmp    %eax,%edi
f0105404:	7f 3c                	jg     f0105442 <debuginfo_eip+0x27c>
	       && stabs[lline].n_type != N_SOL
f0105406:	0f b6 4a 04          	movzbl 0x4(%edx),%ecx
f010540a:	80 f9 84             	cmp    $0x84,%cl
f010540d:	75 08                	jne    f0105417 <debuginfo_eip+0x251>
f010540f:	8b 7d 0c             	mov    0xc(%ebp),%edi
f0105412:	89 45 d4             	mov    %eax,-0x2c(%ebp)
f0105415:	eb 11                	jmp    f0105428 <debuginfo_eip+0x262>
	       && (stabs[lline].n_type != N_SO || !stabs[lline].n_value))
f0105417:	80 f9 64             	cmp    $0x64,%cl
f010541a:	75 de                	jne    f01053fa <debuginfo_eip+0x234>
f010541c:	83 7a 08 00          	cmpl   $0x0,0x8(%edx)
f0105420:	74 d8                	je     f01053fa <debuginfo_eip+0x234>
f0105422:	8b 7d 0c             	mov    0xc(%ebp),%edi
f0105425:	89 45 d4             	mov    %eax,-0x2c(%ebp)
		lline--;
	if (lline >= lfile && stabs[lline].n_strx < stabstr_end - stabstr)
f0105428:	8d 04 76             	lea    (%esi,%esi,2),%eax
f010542b:	8b 75 c4             	mov    -0x3c(%ebp),%esi
f010542e:	8b 04 86             	mov    (%esi,%eax,4),%eax
f0105431:	8b 55 bc             	mov    -0x44(%ebp),%edx
f0105434:	2b 55 c0             	sub    -0x40(%ebp),%edx
f0105437:	39 d0                	cmp    %edx,%eax
f0105439:	73 0a                	jae    f0105445 <debuginfo_eip+0x27f>
		info->eip_file = stabstr + stabs[lline].n_strx;
f010543b:	03 45 c0             	add    -0x40(%ebp),%eax
f010543e:	89 07                	mov    %eax,(%edi)
f0105440:	eb 03                	jmp    f0105445 <debuginfo_eip+0x27f>
f0105442:	8b 7d 0c             	mov    0xc(%ebp),%edi


	// Set eip_fn_narg to the number of arguments taken by the function,
	// or 0 if there was no containing function.
	if (lfun < rfun)
f0105445:	8b 55 dc             	mov    -0x24(%ebp),%edx
f0105448:	8b 5d d8             	mov    -0x28(%ebp),%ebx
		for (lline = lfun + 1;
...
f010544b:	b8 00 00 00 00       	mov    $0x0,%eax
	...
	// or 0 if there was no containing function.
	if (lfun < rfun)
f0105450:	39 da                	cmp    %ebx,%edx
f0105452:	7d 60                	jge    f01054b4 <debuginfo_eip+0x2ee>
		for (lline = lfun + 1;
f0105454:	83 c2 01             	add    $0x1,%edx
f0105457:	89 55 d4             	mov    %edx,-0x2c(%ebp)
f010545a:	89 d0                	mov    %edx,%eax
f010545c:	8d 14 52             	lea    (%edx,%edx,2),%edx
f010545f:	8b 75 c4             	mov    -0x3c(%ebp),%esi
f0105462:	8d 14 96             	lea    (%esi,%edx,4),%edx
f0105465:	eb 04                	jmp    f010546b <debuginfo_eip+0x2a5>
		     lline < rfun && stabs[lline].n_type == N_PSYM;
		     lline++)
			info->eip_fn_narg++;
f0105467:	83 47 14 01          	addl   $0x1,0x14(%edi)
	...
	if (lfun < rfun)
		for (lline = lfun + 1;
f010546b:	39 c3                	cmp    %eax,%ebx
f010546d:	7e 40                	jle    f01054af <debuginfo_eip+0x2e9>
		     lline < rfun && stabs[lline].n_type == N_PSYM;
f010546f:	0f b6 4a 04          	movzbl 0x4(%edx),%ecx
f0105473:	83 c0 01             	add    $0x1,%eax
f0105476:	83 c2 0c             	add    $0xc,%edx
f0105479:	80 f9 a0             	cmp    $0xa0,%cl
f010547c:	74 e9                	je     f0105467 <debuginfo_eip+0x2a1>
		     lline++)
			info->eip_fn_narg++;

	return 0;
f010547e:	b8 00 00 00 00       	mov    $0x0,%eax
f0105483:	eb 2f                	jmp    f01054b4 <debuginfo_eip+0x2ee>
		// Return -1 if it is not.  Hint: Call user_mem_check.
		// LAB 3: Your code here.
		// user_mem_check
		//
...
f010548a:	eb 28                	jmp    f01054b4 <debuginfo_eip+0x2ee>
		stabstr_end = usd->stabstr_end;
...
f0105491:	eb 21                	jmp    f01054b4 <debuginfo_eip+0x2ee>

		if (user_mem_check(curenv, stabstr, stabstr_end-stabstr, PTE_U))
			return -1;
f0105493:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
f0105498:	eb 1a                	jmp    f01054b4 <debuginfo_eip+0x2ee>
	}
...
f010549f:	eb 13                	jmp    f01054b4 <debuginfo_eip+0x2ee>
f01054a1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
f01054a6:	eb 0c                	jmp    f01054b4 <debuginfo_eip+0x2ee>
	// Search the entire set of stabs for the source file (type N_SO).
	lfile = 0;
	rfile = (stab_end - stabs) - 1;
	stab_binsearch(stabs, &lfile, &rfile, N_SO, addr);
	if (lfile == 0)
		return -1;
f01054a8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
f01054ad:	eb 05                	jmp    f01054b4 <debuginfo_eip+0x2ee>
		for (lline = lfun + 1;
		     lline < rfun && stabs[lline].n_type == N_PSYM;
		     lline++)
			info->eip_fn_narg++;
...
f01054b4:	83 c4 4c             	add    $0x4c,%esp
f01054b7:	5b                   	pop    %ebx
f01054b8:	5e                   	pop    %esi
f01054b9:	5f                   	pop    %edi
f01054ba:	5d                   	pop    %ebp
...
f01054d4:	8b 45 0c             	mov    0xc(%ebp),%eax
f01054d7:	89 c3                	mov    %eax,%ebx
f01054d9:	89 45 d4             	mov    %eax,-0x2c(%ebp)
f01054dc:	8b 45 10             	mov    0x10(%ebp),%eax
f01054df:	8b 75 14             	mov    0x14(%ebp),%esi
	// first recursively print all preceding (more significant) digits
	if (num >= base) {
f01054e2:	b9 00 00 00 00       	mov    $0x0,%ecx
f01054e7:	89 45 d8             	mov    %eax,-0x28(%ebp)
f01054ea:	89 4d dc             	mov    %ecx,-0x24(%ebp)
f01054ed:	39 d9                	cmp    %ebx,%ecx
f01054ef:	72 05                	jb     f01054f6 <printnum+0x36>
f01054f1:	3b 45 e0             	cmp    -0x20(%ebp),%eax
f01054f4:	77 69                	ja     f010555f <printnum+0x9f>
		printnum(putch, putdat, num / base, base, width - 1, padc);
f01054f6:	8b 4d 18             	mov    0x18(%ebp),%ecx
f01054f9:	89 4c 24 10          	mov    %ecx,0x10(%esp)
f01054fd:	83 ee 01             	sub    $0x1,%esi
f0105500:	89 74 24 0c          	mov    %esi,0xc(%esp)
f0105504:	89 44 24 08          	mov    %eax,0x8(%esp)
f0105508:	8b 44 24 08          	mov    0x8(%esp),%eax
f010550c:	8b 54 24 0c          	mov    0xc(%esp),%edx
f0105510:	89 c3                	mov    %eax,%ebx
f0105512:	89 d6                	mov    %edx,%esi
f0105514:	8b 55 d8             	mov    -0x28(%ebp),%edx
f0105517:	8b 4d dc             	mov    -0x24(%ebp),%ecx
f010551a:	89 54 24 08          	mov    %edx,0x8(%esp)
f010551e:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
f0105522:	8b 45 e0             	mov    -0x20(%ebp),%eax
f0105525:	89 04 24             	mov    %eax,(%esp)
f0105528:	8b 45 d4             	mov    -0x2c(%ebp),%eax
f010552b:	89 44 24 04          	mov    %eax,0x4(%esp)
f010552f:	e8 9c 12 00 00       	call   f01067d0 <__udivdi3>
f0105534:	89 d9                	mov    %ebx,%ecx
f0105536:	89 4c 24 08          	mov    %ecx,0x8(%esp)
f010553a:	89 74 24 0c          	mov    %esi,0xc(%esp)
f010553e:	89 04 24             	mov    %eax,(%esp)
f0105541:	89 54 24 04          	mov    %edx,0x4(%esp)
f0105545:	89 fa                	mov    %edi,%edx
f0105547:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f010554a:	e8 71 ff ff ff       	call   f01054c0 <printnum>
f010554f:	eb 1b                	jmp    f010556c <printnum+0xac>
	} else {
		// print any needed pad characters before first digit
		while (--width > 0)
			putch(padc, putdat);
f0105551:	89 7c 24 04          	mov    %edi,0x4(%esp)
f0105555:	8b 45 18             	mov    0x18(%ebp),%eax
f0105558:	89 04 24             	mov    %eax,(%esp)
f010555b:	ff d3                	call   *%ebx
f010555d:	eb 03                	jmp    f0105562 <printnum+0xa2>
f010555f:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
	// first recursively print all preceding (more significant) digits
	if (num >= base) {
		printnum(putch, putdat, num / base, base, width - 1, padc);
	} else {
		// print any needed pad characters before first digit
		while (--width > 0)
f0105562:	83 ee 01             	sub    $0x1,%esi
f0105565:	85 f6                	test   %esi,%esi
f0105567:	7f e8                	jg     f0105551 <printnum+0x91>
f0105569:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
			putch(padc, putdat);
	}

	// then print this (the least significant) digit
	putch("0123456789abcdef"[num % base], putdat);
f010556c:	89 7c 24 04          	mov    %edi,0x4(%esp)
f0105570:	8b 7c 24 04          	mov    0x4(%esp),%edi
f0105574:	8b 45 d8             	mov    -0x28(%ebp),%eax
f0105577:	8b 55 dc             	mov    -0x24(%ebp),%edx
f010557a:	89 44 24 08          	mov    %eax,0x8(%esp)
f010557e:	89 54 24 0c          	mov    %edx,0xc(%esp)
f0105582:	8b 45 e0             	mov    -0x20(%ebp),%eax
f0105585:	89 04 24             	mov    %eax,(%esp)
f0105588:	8b 45 d4             	mov    -0x2c(%ebp),%eax
f010558b:	89 44 24 04          	mov    %eax,0x4(%esp)
f010558f:	e8 6c 13 00 00       	call   f0106900 <__umoddi3>
f0105594:	89 7c 24 04          	mov    %edi,0x4(%esp)
f0105598:	0f be 80 22 81 10 f0 	movsbl -0xfef7ede(%eax),%eax
f010559f:	89 04 24             	mov    %eax,(%esp)
f01055a2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f01055a5:	ff d0                	call   *%eax
}
f01055a7:	83 c4 3c             	add    $0x3c,%esp
f01055aa:	5b                   	pop    %ebx
f01055ab:	5e                   	pop    %esi
f01055ac:	5f                   	pop    %edi
f01055ad:	5d                   	pop    %ebp
...
f01055b2:	8b 45 0c             	mov    0xc(%ebp),%eax
	b->cnt++;
f01055b5:	83 40 08 01          	addl   $0x1,0x8(%eax)
	if (b->buf < b->ebuf)
f01055b9:	8b 10                	mov    (%eax),%edx
f01055bb:	3b 50 04             	cmp    0x4(%eax),%edx
f01055be:	73 0a                	jae    f01055ca <sprintputch+0x1b>
		*b->buf++ = ch;
f01055c0:	8d 4a 01             	lea    0x1(%edx),%ecx
f01055c3:	89 08                	mov    %ecx,(%eax)
f01055c5:	8b 45 08             	mov    0x8(%ebp),%eax
f01055c8:	88 02                	mov    %al,(%edx)
}
f01055ca:	5d                   	pop    %ebp
f01055cb:	c3                   	ret    
...
f01055cf:	83 ec 18             	sub    $0x18,%esp
	va_list ap;

	va_start(ap, fmt);
f01055d2:	8d 45 14             	lea    0x14(%ebp),%eax
	vprintfmt(putch, putdat, fmt, ap);
f01055d5:	89 44 24 0c          	mov    %eax,0xc(%esp)
f01055d9:	8b 45 10             	mov    0x10(%ebp),%eax
f01055dc:	89 44 24 08          	mov    %eax,0x8(%esp)
f01055e0:	8b 45 0c             	mov    0xc(%ebp),%eax
f01055e3:	89 44 24 04          	mov    %eax,0x4(%esp)
f01055e7:	8b 45 08             	mov    0x8(%ebp),%eax
f01055ea:	89 04 24             	mov    %eax,(%esp)
f01055ed:	e8 02 00 00 00       	call   f01055f4 <vprintfmt>
	va_end(ap);
}
f01055f2:	c9                   	leave  
f01055f3:	c3                   	ret    
...
f01055fa:	83 ec 3c             	sub    $0x3c,%esp
f01055fd:	8b 75 08             	mov    0x8(%ebp),%esi
f0105600:	8b 5d 0c             	mov    0xc(%ebp),%ebx
f0105603:	8b 7d 10             	mov    0x10(%ebp),%edi
f0105606:	eb 11                	jmp    f0105619 <vprintfmt+0x25>
...
f010560a:	0f 84 48 04 00 00    	je     f0105a58 <vprintfmt+0x464>
				return;
			putch(ch, putdat);
f0105610:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f0105614:	89 04 24             	mov    %eax,(%esp)
f0105617:	ff d6                	call   *%esi
	...
	while (1) {
		while ((ch = *(unsigned char *) fmt++) != '%') {
f0105619:	83 c7 01             	add    $0x1,%edi
f010561c:	0f b6 47 ff          	movzbl -0x1(%edi),%eax
f0105620:	83 f8 25             	cmp    $0x25,%eax
f0105623:	75 e3                	jne    f0105608 <vprintfmt+0x14>
f0105625:	c6 45 d4 20          	movb   $0x20,-0x2c(%ebp)
f0105629:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%ebp)
f0105630:	c7 45 d0 ff ff ff ff 	movl   $0xffffffff,-0x30(%ebp)
f0105637:	c7 45 e0 ff ff ff ff 	movl   $0xffffffff,-0x20(%ebp)
f010563e:	b9 00 00 00 00       	mov    $0x0,%ecx
f0105643:	eb 1f                	jmp    f0105664 <vprintfmt+0x70>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
...
f0105645:	8b 7d e4             	mov    -0x1c(%ebp),%edi

		// flag to pad on the right
		case '-':
			padc = '-';
f0105648:	c6 45 d4 2d          	movb   $0x2d,-0x2c(%ebp)
f010564c:	eb 16                	jmp    f0105664 <vprintfmt+0x70>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f010564e:	8b 7d e4             	mov    -0x1c(%ebp),%edi
			padc = '-';
			goto reswitch;
		...
		case '0':
			padc = '0';
f0105651:	c6 45 d4 30          	movb   $0x30,-0x2c(%ebp)
f0105655:	eb 0d                	jmp    f0105664 <vprintfmt+0x70>
			altflag = 1;
			goto reswitch;
...
f0105657:	8b 45 d0             	mov    -0x30(%ebp),%eax
f010565a:	89 45 e0             	mov    %eax,-0x20(%ebp)
f010565d:	c7 45 d0 ff ff ff ff 	movl   $0xffffffff,-0x30(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0105664:	8d 47 01             	lea    0x1(%edi),%eax
f0105667:	89 45 e4             	mov    %eax,-0x1c(%ebp)
f010566a:	0f b6 17             	movzbl (%edi),%edx
f010566d:	0f b6 c2             	movzbl %dl,%eax
f0105670:	83 ea 23             	sub    $0x23,%edx
f0105673:	80 fa 55             	cmp    $0x55,%dl
f0105676:	0f 87 bf 03 00 00    	ja     f0105a3b <vprintfmt+0x447>
f010567c:	0f b6 d2             	movzbl %dl,%edx
f010567f:	ff 24 95 e0 81 10 f0 	jmp    *-0xfef7e20(,%edx,4)
f0105686:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f0105689:	ba 00 00 00 00       	mov    $0x0,%edx
f010568e:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		case '6':
		case '7':
		case '8':
		case '9':
...
f0105691:	8d 14 92             	lea    (%edx,%edx,4),%edx
f0105694:	8d 54 50 d0          	lea    -0x30(%eax,%edx,2),%edx
				ch = *fmt;
f0105698:	0f be 07             	movsbl (%edi),%eax
				if (ch < '0' || ch > '9')
f010569b:	8d 48 d0             	lea    -0x30(%eax),%ecx
f010569e:	83 f9 09             	cmp    $0x9,%ecx
f01056a1:	77 3c                	ja     f01056df <vprintfmt+0xeb>
		case '5':
		case '6':
		case '7':
		case '8':
		case '9':
			for (precision = 0; ; ++fmt) {
f01056a3:	83 c7 01             	add    $0x1,%edi
				precision = precision * 10 + ch - '0';
				ch = *fmt;
				if (ch < '0' || ch > '9')
					break;
			}
f01056a6:	eb e9                	jmp    f0105691 <vprintfmt+0x9d>
...
f01056ad:	89 45 d0             	mov    %eax,-0x30(%ebp)
f01056b0:	8b 45 14             	mov    0x14(%ebp),%eax
f01056b3:	8d 40 04             	lea    0x4(%eax),%eax
f01056b6:	89 45 14             	mov    %eax,0x14(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
...
f01056b9:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '*':
			precision = va_arg(ap, int);
			goto process_precision;
f01056bc:	eb 27                	jmp    f01056e5 <vprintfmt+0xf1>
f01056be:	8b 55 e0             	mov    -0x20(%ebp),%edx
f01056c1:	85 d2                	test   %edx,%edx
f01056c3:	b8 00 00 00 00       	mov    $0x0,%eax
f01056c8:	0f 49 c2             	cmovns %edx,%eax
f01056cb:	89 45 e0             	mov    %eax,-0x20(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f01056ce:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f01056d1:	eb 91                	jmp    f0105664 <vprintfmt+0x70>
f01056d3:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '#':
			altflag = 1;
f01056d6:	c7 45 d8 01 00 00 00 	movl   $0x1,-0x28(%ebp)
			goto reswitch;
f01056dd:	eb 85                	jmp    f0105664 <vprintfmt+0x70>
f01056df:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
f01056e2:	89 55 d0             	mov    %edx,-0x30(%ebp)

		process_precision:
			if (width < 0)
f01056e5:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
f01056e9:	0f 89 75 ff ff ff    	jns    f0105664 <vprintfmt+0x70>
f01056ef:	e9 63 ff ff ff       	jmp    f0105657 <vprintfmt+0x63>
				width = precision, precision = -1;
			goto reswitch;
...
f01056f7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case 'l':
			lflag++;
			goto reswitch;
f01056fa:	e9 65 ff ff ff       	jmp    f0105664 <vprintfmt+0x70>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
...
f0105702:	83 45 14 04          	addl   $0x4,0x14(%ebp)
f0105706:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f010570a:	8b 00                	mov    (%eax),%eax
...
f0105711:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case 'c':
			putch(va_arg(ap, int), putdat);
			break;
f0105714:	e9 00 ff ff ff       	jmp    f0105619 <vprintfmt+0x25>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
...
f0105719:	8b 45 14             	mov    0x14(%ebp),%eax
		...
		case 'e':
			err = va_arg(ap, int);
f010571c:	83 45 14 04          	addl   $0x4,0x14(%ebp)
f0105720:	8b 00                	mov    (%eax),%eax
f0105722:	99                   	cltd   
f0105723:	31 d0                	xor    %edx,%eax
f0105725:	29 d0                	sub    %edx,%eax
			if (err < 0)
				err = -err;
			if (err >= MAXERROR || (p = error_string[err]) == NULL)
f0105727:	83 f8 09             	cmp    $0x9,%eax
f010572a:	7f 0b                	jg     f0105737 <vprintfmt+0x143>
f010572c:	8b 14 85 40 83 10 f0 	mov    -0xfef7cc0(,%eax,4),%edx
f0105733:	85 d2                	test   %edx,%edx
f0105735:	75 20                	jne    f0105757 <vprintfmt+0x163>
				printfmt(putch, putdat, "error %d", err);
f0105737:	89 44 24 0c          	mov    %eax,0xc(%esp)
f010573b:	c7 44 24 08 3a 81 10 	movl   $0xf010813a,0x8(%esp)
f0105742:	f0 
f0105743:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f0105747:	89 34 24             	mov    %esi,(%esp)
f010574a:	e8 7d fe ff ff       	call   f01055cc <printfmt>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
...
f010574f:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		case 'e':
			...
			if (err >= MAXERROR || (p = error_string[err]) == NULL)
				printfmt(putch, putdat, "error %d", err);
f0105752:	e9 c2 fe ff ff       	jmp    f0105619 <vprintfmt+0x25>
			else
				printfmt(putch, putdat, "%s", p);
f0105757:	89 54 24 0c          	mov    %edx,0xc(%esp)
f010575b:	c7 44 24 08 d1 78 10 	movl   $0xf01078d1,0x8(%esp)
f0105762:	f0 
f0105763:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f0105767:	89 34 24             	mov    %esi,(%esp)
f010576a:	e8 5d fe ff ff       	call   f01055cc <printfmt>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f010576f:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f0105772:	e9 a2 fe ff ff       	jmp    f0105619 <vprintfmt+0x25>
f0105777:	8b 45 14             	mov    0x14(%ebp),%eax
f010577a:	8b 55 d0             	mov    -0x30(%ebp),%edx
f010577d:	8b 4d e0             	mov    -0x20(%ebp),%ecx
f0105780:	89 4d cc             	mov    %ecx,-0x34(%ebp)
				printfmt(putch, putdat, "%s", p);
			break;
...
f0105783:	83 45 14 04          	addl   $0x4,0x14(%ebp)
f0105787:	8b 38                	mov    (%eax),%edi
				p = "(null)";
f0105789:	85 ff                	test   %edi,%edi
f010578b:	b8 33 81 10 f0       	mov    $0xf0108133,%eax
f0105790:	0f 44 f8             	cmove  %eax,%edi
			if (width > 0 && padc != '-')
f0105793:	80 7d d4 2d          	cmpb   $0x2d,-0x2c(%ebp)
f0105797:	0f 84 92 00 00 00    	je     f010582f <vprintfmt+0x23b>
f010579d:	85 c9                	test   %ecx,%ecx
f010579f:	0f 8e 98 00 00 00    	jle    f010583d <vprintfmt+0x249>
				for (width -= strnlen(p, precision); width > 0; width--)
f01057a5:	89 54 24 04          	mov    %edx,0x4(%esp)
f01057a9:	89 3c 24             	mov    %edi,(%esp)
f01057ac:	e8 17 04 00 00       	call   f0105bc8 <strnlen>
f01057b1:	8b 4d cc             	mov    -0x34(%ebp),%ecx
f01057b4:	29 c1                	sub    %eax,%ecx
f01057b6:	89 4d cc             	mov    %ecx,-0x34(%ebp)
					putch(padc, putdat);
f01057b9:	0f be 45 d4          	movsbl -0x2c(%ebp),%eax
f01057bd:	89 45 e0             	mov    %eax,-0x20(%ebp)
f01057c0:	89 7d d4             	mov    %edi,-0x2c(%ebp)
f01057c3:	89 cf                	mov    %ecx,%edi
		// string
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
f01057c5:	eb 0f                	jmp    f01057d6 <vprintfmt+0x1e2>
					putch(padc, putdat);
f01057c7:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f01057cb:	8b 45 e0             	mov    -0x20(%ebp),%eax
f01057ce:	89 04 24             	mov    %eax,(%esp)
f01057d1:	ff d6                	call   *%esi
		// string
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
f01057d3:	83 ef 01             	sub    $0x1,%edi
f01057d6:	85 ff                	test   %edi,%edi
f01057d8:	7f ed                	jg     f01057c7 <vprintfmt+0x1d3>
f01057da:	8b 7d d4             	mov    -0x2c(%ebp),%edi
f01057dd:	8b 4d cc             	mov    -0x34(%ebp),%ecx
f01057e0:	85 c9                	test   %ecx,%ecx
f01057e2:	b8 00 00 00 00       	mov    $0x0,%eax
f01057e7:	0f 49 c1             	cmovns %ecx,%eax
f01057ea:	29 c1                	sub    %eax,%ecx
f01057ec:	89 75 08             	mov    %esi,0x8(%ebp)
f01057ef:	8b 75 d0             	mov    -0x30(%ebp),%esi
f01057f2:	89 5d 0c             	mov    %ebx,0xc(%ebp)
f01057f5:	89 cb                	mov    %ecx,%ebx
f01057f7:	eb 50                	jmp    f0105849 <vprintfmt+0x255>
					putch(padc, putdat);
			for (; (ch = *p++) != '\0' && (precision < 0 || --precision >= 0); width--)
				if (altflag && (ch < ' ' || ch > '~'))
f01057f9:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
f01057fd:	74 1e                	je     f010581d <vprintfmt+0x229>
f01057ff:	0f be d2             	movsbl %dl,%edx
f0105802:	83 ea 20             	sub    $0x20,%edx
f0105805:	83 fa 5e             	cmp    $0x5e,%edx
f0105808:	76 13                	jbe    f010581d <vprintfmt+0x229>
					putch('?', putdat);
...
f010581b:	eb 0d                	jmp    f010582a <vprintfmt+0x236>
				else
					putch(ch, putdat);
f010581d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
f0105820:	89 4c 24 04          	mov    %ecx,0x4(%esp)
...
f010582d:	eb 1a                	jmp    f0105849 <vprintfmt+0x255>
f010582f:	89 75 08             	mov    %esi,0x8(%ebp)
f0105832:	8b 75 d0             	mov    -0x30(%ebp),%esi
f0105835:	89 5d 0c             	mov    %ebx,0xc(%ebp)
f0105838:	8b 5d e0             	mov    -0x20(%ebp),%ebx
f010583b:	eb 0c                	jmp    f0105849 <vprintfmt+0x255>
f010583d:	89 75 08             	mov    %esi,0x8(%ebp)
f0105840:	8b 75 d0             	mov    -0x30(%ebp),%esi
f0105843:	89 5d 0c             	mov    %ebx,0xc(%ebp)
f0105846:	8b 5d e0             	mov    -0x20(%ebp),%ebx
f0105849:	83 c7 01             	add    $0x1,%edi
f010584c:	0f b6 57 ff          	movzbl -0x1(%edi),%edx
f0105850:	0f be c2             	movsbl %dl,%eax
f0105853:	85 c0                	test   %eax,%eax
f0105855:	74 25                	je     f010587c <vprintfmt+0x288>
f0105857:	85 f6                	test   %esi,%esi
f0105859:	78 9e                	js     f01057f9 <vprintfmt+0x205>
f010585b:	83 ee 01             	sub    $0x1,%esi
f010585e:	79 99                	jns    f01057f9 <vprintfmt+0x205>
f0105860:	89 df                	mov    %ebx,%edi
f0105862:	8b 75 08             	mov    0x8(%ebp),%esi
f0105865:	8b 5d 0c             	mov    0xc(%ebp),%ebx
f0105868:	eb 1a                	jmp    f0105884 <vprintfmt+0x290>
				if (altflag && (ch < ' ' || ch > '~'))
					putch('?', putdat);
				else
					putch(ch, putdat);
...
f010587a:	eb 08                	jmp    f0105884 <vprintfmt+0x290>
f010587c:	89 df                	mov    %ebx,%edi
f010587e:	8b 75 08             	mov    0x8(%ebp),%esi
f0105881:	8b 5d 0c             	mov    0xc(%ebp),%ebx
f0105884:	85 ff                	test   %edi,%edi
f0105886:	7f e2                	jg     f010586a <vprintfmt+0x276>
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0105888:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f010588b:	e9 89 fd ff ff       	jmp    f0105619 <vprintfmt+0x25>
...
{
	if (lflag >= 2)
f0105890:	83 f9 01             	cmp    $0x1,%ecx
f0105893:	7e 19                	jle    f01058ae <vprintfmt+0x2ba>
		return va_arg(*ap, long long);
f0105895:	8b 45 14             	mov    0x14(%ebp),%eax
f0105898:	8b 50 04             	mov    0x4(%eax),%edx
f010589b:	8b 00                	mov    (%eax),%eax
f010589d:	89 45 d8             	mov    %eax,-0x28(%ebp)
f01058a0:	89 55 dc             	mov    %edx,-0x24(%ebp)
f01058a3:	8b 45 14             	mov    0x14(%ebp),%eax
f01058a6:	8d 40 08             	lea    0x8(%eax),%eax
f01058a9:	89 45 14             	mov    %eax,0x14(%ebp)
f01058ac:	eb 38                	jmp    f01058e6 <vprintfmt+0x2f2>
	else if (lflag)
f01058ae:	85 c9                	test   %ecx,%ecx
f01058b0:	74 1b                	je     f01058cd <vprintfmt+0x2d9>
		return va_arg(*ap, long);
f01058b2:	8b 45 14             	mov    0x14(%ebp),%eax
f01058b5:	8b 00                	mov    (%eax),%eax
f01058b7:	89 45 d8             	mov    %eax,-0x28(%ebp)
f01058ba:	89 c1                	mov    %eax,%ecx
f01058bc:	c1 f9 1f             	sar    $0x1f,%ecx
f01058bf:	89 4d dc             	mov    %ecx,-0x24(%ebp)
f01058c2:	8b 45 14             	mov    0x14(%ebp),%eax
f01058c5:	8d 40 04             	lea    0x4(%eax),%eax
f01058c8:	89 45 14             	mov    %eax,0x14(%ebp)
f01058cb:	eb 19                	jmp    f01058e6 <vprintfmt+0x2f2>
	else
		return va_arg(*ap, int);
f01058cd:	8b 45 14             	mov    0x14(%ebp),%eax
f01058d0:	8b 00                	mov    (%eax),%eax
f01058d2:	89 45 d8             	mov    %eax,-0x28(%ebp)
f01058d5:	89 c1                	mov    %eax,%ecx
f01058d7:	c1 f9 1f             	sar    $0x1f,%ecx
f01058da:	89 4d dc             	mov    %ecx,-0x24(%ebp)
f01058dd:	8b 45 14             	mov    0x14(%ebp),%eax
f01058e0:	8d 40 04             	lea    0x4(%eax),%eax
f01058e3:	89 45 14             	mov    %eax,0x14(%ebp)
				putch(' ', putdat);
			break;
		...
		case 'd':
			num = getint(&ap, lflag);
f01058e6:	8b 55 d8             	mov    -0x28(%ebp),%edx
f01058e9:	8b 4d dc             	mov    -0x24(%ebp),%ecx
			if ((long long) num < 0) {
				putch('-', putdat);
				num = -(long long) num;
			}
			base = 10;
f01058ec:	bf 0a 00 00 00       	mov    $0xa,%edi
			break;
...
f01058f5:	0f 89 04 01 00 00    	jns    f01059ff <vprintfmt+0x40b>
				putch('-', putdat);
f01058fb:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f01058ff:	c7 04 24 2d 00 00 00 	movl   $0x2d,(%esp)
...
f0105915:	e9 e5 00 00 00       	jmp    f01059ff <vprintfmt+0x40b>
...
{
	if (lflag >= 2)
f010591a:	83 f9 01             	cmp    $0x1,%ecx
f010591d:	7e 10                	jle    f010592f <vprintfmt+0x33b>
		return va_arg(*ap, unsigned long long);
f010591f:	8b 45 14             	mov    0x14(%ebp),%eax
f0105922:	8b 10                	mov    (%eax),%edx
f0105924:	8b 48 04             	mov    0x4(%eax),%ecx
f0105927:	8d 40 08             	lea    0x8(%eax),%eax
f010592a:	89 45 14             	mov    %eax,0x14(%ebp)
f010592d:	eb 26                	jmp    f0105955 <vprintfmt+0x361>
	else if (lflag)
f010592f:	85 c9                	test   %ecx,%ecx
f0105931:	74 12                	je     f0105945 <vprintfmt+0x351>
		return va_arg(*ap, unsigned long);
f0105933:	8b 45 14             	mov    0x14(%ebp),%eax
f0105936:	8b 10                	mov    (%eax),%edx
f0105938:	b9 00 00 00 00       	mov    $0x0,%ecx
f010593d:	8d 40 04             	lea    0x4(%eax),%eax
f0105940:	89 45 14             	mov    %eax,0x14(%ebp)
f0105943:	eb 10                	jmp    f0105955 <vprintfmt+0x361>
	else
		return va_arg(*ap, unsigned int);
f0105945:	8b 45 14             	mov    0x14(%ebp),%eax
f0105948:	8b 10                	mov    (%eax),%edx
f010594a:	b9 00 00 00 00       	mov    $0x0,%ecx
f010594f:	8d 40 04             	lea    0x4(%eax),%eax
f0105952:	89 45 14             	mov    %eax,0x14(%ebp)
			goto number;
		...
		case 'u':
			...
			base = 10;
f0105955:	bf 0a 00 00 00       	mov    $0xa,%edi
			goto number;
f010595a:	e9 a0 00 00 00       	jmp    f01059ff <vprintfmt+0x40b>

		// (unsigned) octal
		case 'o':
			// Replace this with your code.
			putch('X', putdat);
f010595f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f0105963:	c7 04 24 58 00 00 00 	movl   $0x58,(%esp)
f010596a:	ff d6                	call   *%esi
			putch('X', putdat);
f010596c:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f0105970:	c7 04 24 58 00 00 00 	movl   $0x58,(%esp)
f0105977:	ff d6                	call   *%esi
			putch('X', putdat);
f0105979:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f010597d:	c7 04 24 58 00 00 00 	movl   $0x58,(%esp)
f0105984:	ff d6                	call   *%esi
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0105986:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		case 'o':
			// Replace this with your code.
			putch('X', putdat);
			putch('X', putdat);
			putch('X', putdat);
			break;
f0105989:	e9 8b fc ff ff       	jmp    f0105619 <vprintfmt+0x25>

		// pointer
		case 'p':
			putch('0', putdat);
f010598e:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f0105992:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
f0105999:	ff d6                	call   *%esi
			putch('x', putdat);
f010599b:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f010599f:	c7 04 24 78 00 00 00 	movl   $0x78,(%esp)
f01059a6:	ff d6                	call   *%esi
			num = (unsigned long long)
f01059a8:	8b 45 14             	mov    0x14(%ebp),%eax
f01059ab:	8b 10                	mov    (%eax),%edx
f01059ad:	b9 00 00 00 00       	mov    $0x0,%ecx
				(uintptr_t) va_arg(ap, void *);
f01059b2:	8d 40 04             	lea    0x4(%eax),%eax
f01059b5:	89 45 14             	mov    %eax,0x14(%ebp)
			base = 16;
f01059b8:	bf 10 00 00 00       	mov    $0x10,%edi
			goto number;
f01059bd:	eb 40                	jmp    f01059ff <vprintfmt+0x40b>
// Get an unsigned int of various possible sizes from a varargs list,
// depending on the lflag parameter.
static unsigned long long
getuint(va_list *ap, int lflag)
{
	if (lflag >= 2)
f01059bf:	83 f9 01             	cmp    $0x1,%ecx
f01059c2:	7e 10                	jle    f01059d4 <vprintfmt+0x3e0>
		return va_arg(*ap, unsigned long long);
f01059c4:	8b 45 14             	mov    0x14(%ebp),%eax
f01059c7:	8b 10                	mov    (%eax),%edx
f01059c9:	8b 48 04             	mov    0x4(%eax),%ecx
f01059cc:	8d 40 08             	lea    0x8(%eax),%eax
f01059cf:	89 45 14             	mov    %eax,0x14(%ebp)
f01059d2:	eb 26                	jmp    f01059fa <vprintfmt+0x406>
	else if (lflag)
f01059d4:	85 c9                	test   %ecx,%ecx
f01059d6:	74 12                	je     f01059ea <vprintfmt+0x3f6>
		return va_arg(*ap, unsigned long);
...
f01059e8:	eb 10                	jmp    f01059fa <vprintfmt+0x406>
	else
		return va_arg(*ap, unsigned int);
f01059ea:	8b 45 14             	mov    0x14(%ebp),%eax
f01059ed:	8b 10                	mov    (%eax),%edx
f01059ef:	b9 00 00 00 00       	mov    $0x0,%ecx
f01059f4:	8d 40 04             	lea    0x4(%eax),%eax
f01059f7:	89 45 14             	mov    %eax,0x14(%ebp)
			goto number;
		...
		case 'x':
			num = getuint(&ap, lflag);
			base = 16;
f01059fa:	bf 10 00 00 00       	mov    $0x10,%edi
		number:
			printnum(putch, putdat, num, base, width, padc);
f01059ff:	0f be 45 d4          	movsbl -0x2c(%ebp),%eax
f0105a03:	89 44 24 10          	mov    %eax,0x10(%esp)
f0105a07:	8b 45 e0             	mov    -0x20(%ebp),%eax
f0105a0a:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0105a0e:	89 7c 24 08          	mov    %edi,0x8(%esp)
f0105a12:	89 14 24             	mov    %edx,(%esp)
f0105a15:	89 4c 24 04          	mov    %ecx,0x4(%esp)
f0105a19:	89 da                	mov    %ebx,%edx
f0105a1b:	89 f0                	mov    %esi,%eax
f0105a1d:	e8 9e fa ff ff       	call   f01054c0 <printnum>
			break;
f0105a22:	8b 7d e4             	mov    -0x1c(%ebp),%edi
f0105a25:	e9 ef fb ff ff       	jmp    f0105619 <vprintfmt+0x25>

		// escaped '%' character
		case '%':
			putch(ch, putdat);
f0105a2a:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f0105a2e:	89 04 24             	mov    %eax,(%esp)
f0105a31:	ff d6                	call   *%esi
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
f0105a33:	8b 7d e4             	mov    -0x1c(%ebp),%edi
			break;
		...
		case '%':
			putch(ch, putdat);
			break;
f0105a36:	e9 de fb ff ff       	jmp    f0105619 <vprintfmt+0x25>

		// unrecognized escape sequence - just print it literally
		default:
			putch('%', putdat);
f0105a3b:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f0105a3f:	c7 04 24 25 00 00 00 	movl   $0x25,(%esp)
f0105a46:	ff d6                	call   *%esi
			for (fmt--; fmt[-1] != '%'; fmt--)
f0105a48:	eb 03                	jmp    f0105a4d <vprintfmt+0x459>
f0105a4a:	83 ef 01             	sub    $0x1,%edi
f0105a4d:	80 7f ff 25          	cmpb   $0x25,-0x1(%edi)
f0105a51:	75 f7                	jne    f0105a4a <vprintfmt+0x456>
f0105a53:	e9 c1 fb ff ff       	jmp    f0105619 <vprintfmt+0x25>
				/* do nothing */;
			break;
		}
	}
}
f0105a58:	83 c4 3c             	add    $0x3c,%esp
f0105a5b:	5b                   	pop    %ebx
f0105a5c:	5e                   	pop    %esi
f0105a5d:	5f                   	pop    %edi
f0105a5e:	5d                   	pop    %ebp
...
f0105a63:	83 ec 28             	sub    $0x28,%esp
f0105a66:	8b 45 08             	mov    0x8(%ebp),%eax
f0105a69:	8b 55 0c             	mov    0xc(%ebp),%edx
	struct sprintbuf b = {buf, buf+n-1, 0};
f0105a6c:	89 45 ec             	mov    %eax,-0x14(%ebp)
f0105a6f:	8d 4c 10 ff          	lea    -0x1(%eax,%edx,1),%ecx
f0105a73:	89 4d f0             	mov    %ecx,-0x10(%ebp)
f0105a76:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	if (buf == NULL || n < 1)
f0105a7d:	85 c0                	test   %eax,%eax
f0105a7f:	74 30                	je     f0105ab1 <vsnprintf+0x51>
f0105a81:	85 d2                	test   %edx,%edx
f0105a83:	7e 2c                	jle    f0105ab1 <vsnprintf+0x51>
		return -E_INVAL;

	// print the string to the buffer
	vprintfmt((void*)sprintputch, &b, fmt, ap);
f0105a85:	8b 45 14             	mov    0x14(%ebp),%eax
f0105a88:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0105a8c:	8b 45 10             	mov    0x10(%ebp),%eax
f0105a8f:	89 44 24 08          	mov    %eax,0x8(%esp)
f0105a93:	8d 45 ec             	lea    -0x14(%ebp),%eax
f0105a96:	89 44 24 04          	mov    %eax,0x4(%esp)
f0105a9a:	c7 04 24 af 55 10 f0 	movl   $0xf01055af,(%esp)
f0105aa1:	e8 4e fb ff ff       	call   f01055f4 <vprintfmt>

	// null terminate the buffer
	*b.buf = '\0';
f0105aa6:	8b 45 ec             	mov    -0x14(%ebp),%eax
f0105aa9:	c6 00 00             	movb   $0x0,(%eax)

	return b.cnt;
f0105aac:	8b 45 f4             	mov    -0xc(%ebp),%eax
f0105aaf:	eb 05                	jmp    f0105ab6 <vsnprintf+0x56>
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
	struct sprintbuf b = {buf, buf+n-1, 0};
	...
	if (buf == NULL || n < 1)
		return -E_INVAL;
f0105ab1:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
...
f0105abb:	83 ec 18             	sub    $0x18,%esp
	...
	va_start(ap, fmt);
f0105abe:	8d 45 14             	lea    0x14(%ebp),%eax
	rc = vsnprintf(buf, n, fmt, ap);
f0105ac1:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0105ac5:	8b 45 10             	mov    0x10(%ebp),%eax
f0105ac8:	89 44 24 08          	mov    %eax,0x8(%esp)
f0105acc:	8b 45 0c             	mov    0xc(%ebp),%eax
f0105acf:	89 44 24 04          	mov    %eax,0x4(%esp)
f0105ad3:	8b 45 08             	mov    0x8(%ebp),%eax
f0105ad6:	89 04 24             	mov    %eax,(%esp)
f0105ad9:	e8 82 ff ff ff       	call   f0105a60 <vsnprintf>
	va_end(ap);
...
f0105af4:	c7 04 24 d1 78 10 f0 	movl   $0xf01078d1,(%esp)
f0105afb:	e8 72 e4 ff ff       	call   f0103f72 <cprintf>

	i = 0;
	echoing = iscons(0);
f0105b00:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
f0105b07:	e8 af ac ff ff       	call   f01007bb <iscons>
...
f0105b0e:	be 00 00 00 00       	mov    $0x0,%esi
	...
	while (1) {
		c = getchar();
f0105b13:	e8 92 ac ff ff       	call   f01007aa <getchar>
f0105b18:	89 c3                	mov    %eax,%ebx
		if (c < 0) {
f0105b1a:	85 c0                	test   %eax,%eax
f0105b1c:	79 17                	jns    f0105b35 <readline+0x55>
			cprintf("read error: %e\n", c);
f0105b1e:	89 44 24 04          	mov    %eax,0x4(%esp)
f0105b22:	c7 04 24 68 83 10 f0 	movl   $0xf0108368,(%esp)
f0105b29:	e8 44 e4 ff ff       	call   f0103f72 <cprintf>
			return NULL;
f0105b2e:	b8 00 00 00 00       	mov    $0x0,%eax
f0105b33:	eb 6d                	jmp    f0105ba2 <readline+0xc2>
		} else if ((c == '\b' || c == '\x7f') && i > 0) {
f0105b35:	83 f8 7f             	cmp    $0x7f,%eax
f0105b38:	74 05                	je     f0105b3f <readline+0x5f>
f0105b3a:	83 f8 08             	cmp    $0x8,%eax
f0105b3d:	75 19                	jne    f0105b58 <readline+0x78>
f0105b3f:	85 f6                	test   %esi,%esi
f0105b41:	7e 15                	jle    f0105b58 <readline+0x78>
			if (echoing)
f0105b43:	85 ff                	test   %edi,%edi
f0105b45:	74 0c                	je     f0105b53 <readline+0x73>
				cputchar('\b');
f0105b47:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
f0105b4e:	e8 47 ac ff ff       	call   f010079a <cputchar>
			i--;
f0105b53:	83 ee 01             	sub    $0x1,%esi
f0105b56:	eb bb                	jmp    f0105b13 <readline+0x33>
		} else if (c >= ' ' && i < BUFLEN-1) {
f0105b58:	81 fe fe 03 00 00    	cmp    $0x3fe,%esi
f0105b5e:	7f 1c                	jg     f0105b7c <readline+0x9c>
f0105b60:	83 fb 1f             	cmp    $0x1f,%ebx
f0105b63:	7e 17                	jle    f0105b7c <readline+0x9c>
			if (echoing)
f0105b65:	85 ff                	test   %edi,%edi
f0105b67:	74 08                	je     f0105b71 <readline+0x91>
				cputchar(c);
f0105b69:	89 1c 24             	mov    %ebx,(%esp)
f0105b6c:	e8 29 ac ff ff       	call   f010079a <cputchar>
			buf[i++] = c;
f0105b71:	88 9e 80 ca 22 f0    	mov    %bl,-0xfdd3580(%esi)
f0105b77:	8d 76 01             	lea    0x1(%esi),%esi
f0105b7a:	eb 97                	jmp    f0105b13 <readline+0x33>
		} else if (c == '\n' || c == '\r') {
f0105b7c:	83 fb 0d             	cmp    $0xd,%ebx
f0105b7f:	74 05                	je     f0105b86 <readline+0xa6>
f0105b81:	83 fb 0a             	cmp    $0xa,%ebx
f0105b84:	75 8d                	jne    f0105b13 <readline+0x33>
			if (echoing)
f0105b86:	85 ff                	test   %edi,%edi
f0105b88:	74 0c                	je     f0105b96 <readline+0xb6>
				cputchar('\n');
f0105b8a:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
f0105b91:	e8 04 ac ff ff       	call   f010079a <cputchar>
			buf[i] = 0;
f0105b96:	c6 86 80 ca 22 f0 00 	movb   $0x0,-0xfdd3580(%esi)
			return buf;
f0105b9d:	b8 80 ca 22 f0       	mov    $0xf022ca80,%eax
		}
	}
}
f0105ba2:	83 c4 1c             	add    $0x1c,%esp
f0105ba5:	5b                   	pop    %ebx
f0105ba6:	5e                   	pop    %esi
f0105ba7:	5f                   	pop    %edi
f0105ba8:	5d                   	pop    %ebp
...
f0105bb3:	8b 55 08             	mov    0x8(%ebp),%edx
	int n;

	for (n = 0; *s != '\0'; s++)
f0105bb6:	b8 00 00 00 00       	mov    $0x0,%eax
f0105bbb:	eb 03                	jmp    f0105bc0 <strlen+0x10>
		n++;
...
strlen(const char *s)
{
	...
	for (n = 0; *s != '\0'; s++)
f0105bc0:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
f0105bc4:	75 f7                	jne    f0105bbd <strlen+0xd>
		n++;
	return n;
}
f0105bc6:	5d                   	pop    %ebp
...
f0105bcb:	8b 4d 08             	mov    0x8(%ebp),%ecx
f0105bce:	8b 55 0c             	mov    0xc(%ebp),%edx
	int n;

	for (n = 0; size > 0 && *s != '\0'; s++, size--)
f0105bd1:	b8 00 00 00 00       	mov    $0x0,%eax
f0105bd6:	eb 03                	jmp    f0105bdb <strnlen+0x13>
		n++;
f0105bd8:	83 c0 01             	add    $0x1,%eax
int
strnlen(const char *s, size_t size)
{
	int n;
	...
	for (n = 0; size > 0 && *s != '\0'; s++, size--)
f0105bdb:	39 d0                	cmp    %edx,%eax
f0105bdd:	74 06                	je     f0105be5 <strnlen+0x1d>
f0105bdf:	80 3c 01 00          	cmpb   $0x0,(%ecx,%eax,1)
f0105be3:	75 f3                	jne    f0105bd8 <strnlen+0x10>
		n++;
	return n;
}
f0105be5:	5d                   	pop    %ebp
...
f0105bee:	8b 4d 0c             	mov    0xc(%ebp),%ecx
	char *ret;

	ret = dst;
	while ((*dst++ = *src++) != '\0')
f0105bf1:	89 c2                	mov    %eax,%edx
f0105bf3:	83 c2 01             	add    $0x1,%edx
f0105bf6:	83 c1 01             	add    $0x1,%ecx
f0105bf9:	0f b6 59 ff          	movzbl -0x1(%ecx),%ebx
f0105bfd:	88 5a ff             	mov    %bl,-0x1(%edx)
f0105c00:	84 db                	test   %bl,%bl
f0105c02:	75 ef                	jne    f0105bf3 <strcpy+0xc>
		/* do nothing */;
	return ret;
}
f0105c04:	5b                   	pop    %ebx
...
f0105c0e:	8b 5d 08             	mov    0x8(%ebp),%ebx
	int len = strlen(dst);
f0105c11:	89 1c 24             	mov    %ebx,(%esp)
f0105c14:	e8 97 ff ff ff       	call   f0105bb0 <strlen>
	strcpy(dst + len, src);
f0105c19:	8b 55 0c             	mov    0xc(%ebp),%edx
f0105c1c:	89 54 24 04          	mov    %edx,0x4(%esp)
f0105c20:	01 d8                	add    %ebx,%eax
f0105c22:	89 04 24             	mov    %eax,(%esp)
f0105c25:	e8 bd ff ff ff       	call   f0105be7 <strcpy>
	return dst;
}
f0105c2a:	89 d8                	mov    %ebx,%eax
...
f0105c35:	56                   	push   %esi
f0105c36:	53                   	push   %ebx
f0105c37:	8b 75 08             	mov    0x8(%ebp),%esi
f0105c3a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
f0105c3d:	89 f3                	mov    %esi,%ebx
f0105c3f:	03 5d 10             	add    0x10(%ebp),%ebx
	size_t i;
	char *ret;
...
f0105c44:	eb 0f                	jmp    f0105c55 <strncpy+0x23>
		*dst++ = *src;
f0105c46:	83 c2 01             	add    $0x1,%edx
f0105c49:	0f b6 01             	movzbl (%ecx),%eax
f0105c4c:	88 42 ff             	mov    %al,-0x1(%edx)
		// If strlen(src) < size, null-pad 'dst' out to 'size' chars
		if (*src != '\0')
			src++;
f0105c4f:	80 39 01             	cmpb   $0x1,(%ecx)
f0105c52:	83 d9 ff             	sbb    $0xffffffff,%ecx
strncpy(char *dst, const char *src, size_t size) {
	size_t i;
	char *ret;
	...
	ret = dst;
	for (i = 0; i < size; i++) {
f0105c55:	39 da                	cmp    %ebx,%edx
f0105c57:	75 ed                	jne    f0105c46 <strncpy+0x14>
		// If strlen(src) < size, null-pad 'dst' out to 'size' chars
		if (*src != '\0')
			src++;
	}
...
f0105c64:	8b 75 08             	mov    0x8(%ebp),%esi
f0105c67:	8b 55 0c             	mov    0xc(%ebp),%edx
f0105c6a:	8b 4d 10             	mov    0x10(%ebp),%ecx
f0105c6d:	89 f0                	mov    %esi,%eax
f0105c6f:	8d 5c 0e ff          	lea    -0x1(%esi,%ecx,1),%ebx
	char *dst_in;

	dst_in = dst;
	if (size > 0) {
f0105c73:	85 c9                	test   %ecx,%ecx
f0105c75:	75 0b                	jne    f0105c82 <strlcpy+0x23>
f0105c77:	eb 1d                	jmp    f0105c96 <strlcpy+0x37>
		while (--size > 0 && *src != '\0')
			*dst++ = *src++;
f0105c79:	83 c0 01             	add    $0x1,%eax
f0105c7c:	83 c2 01             	add    $0x1,%edx
f0105c7f:	88 48 ff             	mov    %cl,-0x1(%eax)
{
	char *dst_in;
	...
	if (size > 0) {
		while (--size > 0 && *src != '\0')
f0105c82:	39 d8                	cmp    %ebx,%eax
f0105c84:	74 0b                	je     f0105c91 <strlcpy+0x32>
f0105c86:	0f b6 0a             	movzbl (%edx),%ecx
f0105c89:	84 c9                	test   %cl,%cl
f0105c8b:	75 ec                	jne    f0105c79 <strlcpy+0x1a>
f0105c8d:	89 c2                	mov    %eax,%edx
f0105c8f:	eb 02                	jmp    f0105c93 <strlcpy+0x34>
f0105c91:	89 c2                	mov    %eax,%edx
			*dst++ = *src++;
		*dst = '\0';
f0105c93:	c6 02 00             	movb   $0x0,(%edx)
	}
	return dst - dst_in;
f0105c96:	29 f0                	sub    %esi,%eax
}
f0105c98:	5b                   	pop    %ebx
f0105c99:	5e                   	pop    %esi
f0105c9a:	5d                   	pop    %ebp
...
f0105c9f:	8b 4d 08             	mov    0x8(%ebp),%ecx
f0105ca2:	8b 55 0c             	mov    0xc(%ebp),%edx
	while (*p && *p == *q)
f0105ca5:	eb 06                	jmp    f0105cad <strcmp+0x11>
		p++, q++;
f0105ca7:	83 c1 01             	add    $0x1,%ecx
f0105caa:	83 c2 01             	add    $0x1,%edx
}
...
{
	while (*p && *p == *q)
f0105cad:	0f b6 01             	movzbl (%ecx),%eax
f0105cb0:	84 c0                	test   %al,%al
f0105cb2:	74 04                	je     f0105cb8 <strcmp+0x1c>
f0105cb4:	3a 02                	cmp    (%edx),%al
f0105cb6:	74 ef                	je     f0105ca7 <strcmp+0xb>
		p++, q++;
	return (int) ((unsigned char) *p - (unsigned char) *q);
f0105cb8:	0f b6 c0             	movzbl %al,%eax
f0105cbb:	0f b6 12             	movzbl (%edx),%edx
f0105cbe:	29 d0                	sub    %edx,%eax
}
f0105cc0:	5d                   	pop    %ebp
f0105cc1:	c3                   	ret    
...
f0105ccc:	89 c3                	mov    %eax,%ebx
f0105cce:	03 5d 10             	add    0x10(%ebp),%ebx
	while (n > 0 && *p && *p == *q)
f0105cd1:	eb 06                	jmp    f0105cd9 <strncmp+0x17>
		n--, p++, q++;
f0105cd3:	83 c0 01             	add    $0x1,%eax
...
{
	while (n > 0 && *p && *p == *q)
f0105cd9:	39 d8                	cmp    %ebx,%eax
f0105cdb:	74 15                	je     f0105cf2 <strncmp+0x30>
f0105cdd:	0f b6 08             	movzbl (%eax),%ecx
f0105ce0:	84 c9                	test   %cl,%cl
f0105ce2:	74 04                	je     f0105ce8 <strncmp+0x26>
f0105ce4:	3a 0a                	cmp    (%edx),%cl
f0105ce6:	74 eb                	je     f0105cd3 <strncmp+0x11>
		n--, p++, q++;
	if (n == 0)
		return 0;
	else
		return (int) ((unsigned char) *p - (unsigned char) *q);
f0105ce8:	0f b6 00             	movzbl (%eax),%eax
f0105ceb:	0f b6 12             	movzbl (%edx),%edx
f0105cee:	29 d0                	sub    %edx,%eax
f0105cf0:	eb 05                	jmp    f0105cf7 <strncmp+0x35>
strncmp(const char *p, const char *q, size_t n)
{
	while (n > 0 && *p && *p == *q)
		n--, p++, q++;
	if (n == 0)
		return 0;
f0105cf2:	b8 00 00 00 00       	mov    $0x0,%eax
	else
		return (int) ((unsigned char) *p - (unsigned char) *q);
}
f0105cf7:	5b                   	pop    %ebx
...
f0105d00:	0f b6 4d 0c          	movzbl 0xc(%ebp),%ecx
	for (; *s; s++)
f0105d04:	eb 07                	jmp    f0105d0d <strchr+0x13>
		if (*s == c)
f0105d06:	38 ca                	cmp    %cl,%dl
f0105d08:	74 0f                	je     f0105d19 <strchr+0x1f>
// Return a pointer to the first occurrence of 'c' in 's',
// or a null pointer if the string has no 'c'.
char *
strchr(const char *s, char c)
...
f0105d0d:	0f b6 10             	movzbl (%eax),%edx
f0105d10:	84 d2                	test   %dl,%dl
f0105d12:	75 f2                	jne    f0105d06 <strchr+0xc>
		if (*s == c)
			return (char *) s;
	return 0;
f0105d14:	b8 00 00 00 00       	mov    $0x0,%eax
}
f0105d19:	5d                   	pop    %ebp
f0105d1a:	c3                   	ret    
...
f0105d1e:	8b 45 08             	mov    0x8(%ebp),%eax
f0105d21:	0f b6 4d 0c          	movzbl 0xc(%ebp),%ecx
	for (; *s; s++)
f0105d25:	eb 07                	jmp    f0105d2e <strfind+0x13>
		if (*s == c)
f0105d27:	38 ca                	cmp    %cl,%dl
f0105d29:	74 0a                	je     f0105d35 <strfind+0x1a>
// Return a pointer to the first occurrence of 'c' in 's',
// or a pointer to the string-ending null character if the string has no 'c'.
char *
strfind(const char *s, char c)
{
	for (; *s; s++)
f0105d2b:	83 c0 01             	add    $0x1,%eax
f0105d2e:	0f b6 10             	movzbl (%eax),%edx
f0105d31:	84 d2                	test   %dl,%dl
f0105d33:	75 f2                	jne    f0105d27 <strfind+0xc>
		if (*s == c)
			break;
	return (char *) s;
}
...
f0105d3d:	8b 7d 08             	mov    0x8(%ebp),%edi
f0105d40:	8b 4d 10             	mov    0x10(%ebp),%ecx
	char *p;

	if (n == 0)
f0105d43:	85 c9                	test   %ecx,%ecx
f0105d45:	74 36                	je     f0105d7d <memset+0x46>
		return v;
	if ((int)v%4 == 0 && n%4 == 0) {
f0105d47:	f7 c7 03 00 00 00    	test   $0x3,%edi
f0105d4d:	75 28                	jne    f0105d77 <memset+0x40>
f0105d4f:	f6 c1 03             	test   $0x3,%cl
f0105d52:	75 23                	jne    f0105d77 <memset+0x40>
		c &= 0xFF;
f0105d54:	0f b6 55 0c          	movzbl 0xc(%ebp),%edx
		c = (c<<24)|(c<<16)|(c<<8)|c;
f0105d58:	89 d3                	mov    %edx,%ebx
f0105d5a:	c1 e3 08             	shl    $0x8,%ebx
f0105d5d:	89 d6                	mov    %edx,%esi
f0105d5f:	c1 e6 18             	shl    $0x18,%esi
f0105d62:	89 d0                	mov    %edx,%eax
f0105d64:	c1 e0 10             	shl    $0x10,%eax
f0105d67:	09 f0                	or     %esi,%eax
f0105d69:	09 c2                	or     %eax,%edx
f0105d6b:	89 d0                	mov    %edx,%eax
f0105d6d:	09 d8                	or     %ebx,%eax
		asm volatile("cld; rep stosl\n"
			:: "D" (v), "a" (c), "c" (n/4)
f0105d6f:	c1 e9 02             	shr    $0x2,%ecx
	if (n == 0)
		return v;
	if ((int)v%4 == 0 && n%4 == 0) {
		c &= 0xFF;
		...
		asm volatile("cld; rep stosl\n"
f0105d72:	fc                   	cld    
f0105d73:	f3 ab                	rep stos %eax,%es:(%edi)
f0105d75:	eb 06                	jmp    f0105d7d <memset+0x46>
			:: "D" (v), "a" (c), "c" (n/4)
			: "cc", "memory");
	} else
		asm volatile("cld; rep stosb\n"
f0105d77:	8b 45 0c             	mov    0xc(%ebp),%eax
f0105d7a:	fc                   	cld    
f0105d7b:	f3 aa                	rep stos %al,%es:(%edi)
			:: "D" (v), "a" (c), "c" (n)
			: "cc", "memory");
	return v;
}
f0105d7d:	89 f8                	mov    %edi,%eax
f0105d7f:	5b                   	pop    %ebx
f0105d80:	5e                   	pop    %esi
f0105d81:	5f                   	pop    %edi
f0105d82:	5d                   	pop    %ebp
...
f0105d87:	57                   	push   %edi
f0105d88:	56                   	push   %esi
f0105d89:	8b 45 08             	mov    0x8(%ebp),%eax
f0105d8c:	8b 75 0c             	mov    0xc(%ebp),%esi
f0105d8f:	8b 4d 10             	mov    0x10(%ebp),%ecx
	const char *s;
	char *d;
	...
	d = dst;
	if (s < d && s + n > d) {
f0105d92:	39 c6                	cmp    %eax,%esi
f0105d94:	73 35                	jae    f0105dcb <memmove+0x47>
f0105d96:	8d 14 0e             	lea    (%esi,%ecx,1),%edx
f0105d99:	39 d0                	cmp    %edx,%eax
f0105d9b:	73 2e                	jae    f0105dcb <memmove+0x47>
		s += n;
		d += n;
f0105d9d:	8d 3c 08             	lea    (%eax,%ecx,1),%edi
f0105da0:	89 d6                	mov    %edx,%esi
f0105da2:	09 fe                	or     %edi,%esi
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
f0105da4:	f7 c6 03 00 00 00    	test   $0x3,%esi
f0105daa:	75 13                	jne    f0105dbf <memmove+0x3b>
f0105dac:	f6 c1 03             	test   $0x3,%cl
f0105daf:	75 0e                	jne    f0105dbf <memmove+0x3b>
			asm volatile("std; rep movsl\n"
				:: "D" (d-4), "S" (s-4), "c" (n/4) : "cc", "memory");
f0105db1:	83 ef 04             	sub    $0x4,%edi
f0105db4:	8d 72 fc             	lea    -0x4(%edx),%esi
f0105db7:	c1 e9 02             	shr    $0x2,%ecx
	d = dst;
	if (s < d && s + n > d) {
		s += n;
		d += n;
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
			asm volatile("std; rep movsl\n"
f0105dba:	fd                   	std    
f0105dbb:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
f0105dbd:	eb 09                	jmp    f0105dc8 <memmove+0x44>
				:: "D" (d-4), "S" (s-4), "c" (n/4) : "cc", "memory");
		else
			asm volatile("std; rep movsb\n"
				:: "D" (d-1), "S" (s-1), "c" (n) : "cc", "memory");
f0105dbf:	83 ef 01             	sub    $0x1,%edi
f0105dc2:	8d 72 ff             	lea    -0x1(%edx),%esi
		d += n;
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
			asm volatile("std; rep movsl\n"
				:: "D" (d-4), "S" (s-4), "c" (n/4) : "cc", "memory");
			...
			asm volatile("std; rep movsb\n"
f0105dc5:	fd                   	std    
f0105dc6:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
				:: "D" (d-1), "S" (s-1), "c" (n) : "cc", "memory");
		// Some versions of GCC rely on DF being clear
		asm volatile("cld" ::: "cc");
f0105dc8:	fc                   	cld    
f0105dc9:	eb 1d                	jmp    f0105de8 <memmove+0x64>
f0105dcb:	89 f2                	mov    %esi,%edx
f0105dcd:	09 c2                	or     %eax,%edx
	} else {
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
f0105dcf:	f6 c2 03             	test   $0x3,%dl
f0105dd2:	75 0f                	jne    f0105de3 <memmove+0x5f>
f0105dd4:	f6 c1 03             	test   $0x3,%cl
f0105dd7:	75 0a                	jne    f0105de3 <memmove+0x5f>
			asm volatile("cld; rep movsl\n"
				:: "D" (d), "S" (s), "c" (n/4) : "cc", "memory");
f0105dd9:	c1 e9 02             	shr    $0x2,%ecx
				:: "D" (d-1), "S" (s-1), "c" (n) : "cc", "memory");
		// Some versions of GCC rely on DF being clear
		asm volatile("cld" ::: "cc");
	} else {
...
f0105dde:	fc                   	cld    
f0105ddf:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
f0105de1:	eb 05                	jmp    f0105de8 <memmove+0x64>
				:: "D" (d), "S" (s), "c" (n/4) : "cc", "memory");
		else
			asm volatile("cld; rep movsb\n"
f0105de3:	89 c7                	mov    %eax,%edi
f0105de5:	fc                   	cld    
f0105de6:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
...
f0105def:	83 ec 0c             	sub    $0xc,%esp
	return memmove(dst, src, n);
f0105df2:	8b 45 10             	mov    0x10(%ebp),%eax
f0105df5:	89 44 24 08          	mov    %eax,0x8(%esp)
f0105df9:	8b 45 0c             	mov    0xc(%ebp),%eax
f0105dfc:	89 44 24 04          	mov    %eax,0x4(%esp)
f0105e00:	8b 45 08             	mov    0x8(%ebp),%eax
f0105e03:	89 04 24             	mov    %eax,(%esp)
f0105e06:	e8 79 ff ff ff       	call   f0105d84 <memmove>
}
f0105e0b:	c9                   	leave  
f0105e0c:	c3                   	ret    
...
{
f0105e0d:	55                   	push   %ebp
f0105e0e:	89 e5                	mov    %esp,%ebp
f0105e10:	56                   	push   %esi
f0105e11:	53                   	push   %ebx
f0105e12:	8b 55 08             	mov    0x8(%ebp),%edx
f0105e15:	8b 4d 0c             	mov    0xc(%ebp),%ecx
f0105e18:	89 d6                	mov    %edx,%esi
f0105e1a:	03 75 10             	add    0x10(%ebp),%esi
	const uint8_t *s1 = (const uint8_t *) v1;
	const uint8_t *s2 = (const uint8_t *) v2;

	while (n-- > 0) {
f0105e1d:	eb 1a                	jmp    f0105e39 <memcmp+0x2c>
		if (*s1 != *s2)
f0105e1f:	0f b6 02             	movzbl (%edx),%eax
f0105e22:	0f b6 19             	movzbl (%ecx),%ebx
f0105e25:	38 d8                	cmp    %bl,%al
f0105e27:	74 0a                	je     f0105e33 <memcmp+0x26>
			return (int) *s1 - (int) *s2;
f0105e29:	0f b6 c0             	movzbl %al,%eax
f0105e2c:	0f b6 db             	movzbl %bl,%ebx
f0105e2f:	29 d8                	sub    %ebx,%eax
f0105e31:	eb 0f                	jmp    f0105e42 <memcmp+0x35>
		s1++, s2++;
f0105e33:	83 c2 01             	add    $0x1,%edx
f0105e36:	83 c1 01             	add    $0x1,%ecx
memcmp(const void *v1, const void *v2, size_t n)
{
	const uint8_t *s1 = (const uint8_t *) v1;
	const uint8_t *s2 = (const uint8_t *) v2;
	...
	while (n-- > 0) {
f0105e39:	39 f2                	cmp    %esi,%edx
f0105e3b:	75 e2                	jne    f0105e1f <memcmp+0x12>
		if (*s1 != *s2)
			return (int) *s1 - (int) *s2;
		s1++, s2++;
	}
...
f0105e4c:	8b 4d 0c             	mov    0xc(%ebp),%ecx
	const void *ends = (const char *) s + n;
f0105e4f:	89 c2                	mov    %eax,%edx
f0105e51:	03 55 10             	add    0x10(%ebp),%edx
	for (; s < ends; s++)
f0105e54:	eb 07                	jmp    f0105e5d <memfind+0x17>
		if (*(const unsigned char *) s == (unsigned char) c)
f0105e56:	38 08                	cmp    %cl,(%eax)
f0105e58:	74 07                	je     f0105e61 <memfind+0x1b>
...
f0105e5d:	39 d0                	cmp    %edx,%eax
f0105e5f:	72 f5                	jb     f0105e56 <memfind+0x10>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
	return (void *) s;
}
...
f0105e66:	57                   	push   %edi
f0105e67:	56                   	push   %esi
f0105e68:	53                   	push   %ebx
f0105e69:	8b 55 08             	mov    0x8(%ebp),%edx
f0105e6c:	8b 45 10             	mov    0x10(%ebp),%eax
	int neg = 0;
	long val = 0;

	// gobble initial whitespace
	while (*s == ' ' || *s == '\t')
f0105e6f:	eb 03                	jmp    f0105e74 <strtol+0x11>
		s++;
f0105e71:	83 c2 01             	add    $0x1,%edx
{
	int neg = 0;
	long val = 0;
	...
	// gobble initial whitespace
	while (*s == ' ' || *s == '\t')
f0105e74:	0f b6 0a             	movzbl (%edx),%ecx
f0105e77:	80 f9 09             	cmp    $0x9,%cl
f0105e7a:	74 f5                	je     f0105e71 <strtol+0xe>
f0105e7c:	80 f9 20             	cmp    $0x20,%cl
f0105e7f:	74 f0                	je     f0105e71 <strtol+0xe>
		s++;

	// plus/minus sign
	if (*s == '+')
f0105e81:	80 f9 2b             	cmp    $0x2b,%cl
f0105e84:	75 0a                	jne    f0105e90 <strtol+0x2d>
		s++;
f0105e86:	83 c2 01             	add    $0x1,%edx
}
...
{
	int neg = 0;
f0105e89:	bf 00 00 00 00       	mov    $0x0,%edi
f0105e8e:	eb 11                	jmp    f0105ea1 <strtol+0x3e>
f0105e90:	bf 00 00 00 00       	mov    $0x0,%edi
		s++;
...
f0105e95:	80 f9 2d             	cmp    $0x2d,%cl
f0105e98:	75 07                	jne    f0105ea1 <strtol+0x3e>
		s++, neg = 1;
f0105e9a:	8d 52 01             	lea    0x1(%edx),%edx
f0105e9d:	66 bf 01 00          	mov    $0x1,%di

	// hex or octal base prefix
	if ((base == 0 || base == 16) && (s[0] == '0' && s[1] == 'x'))
f0105ea1:	a9 ef ff ff ff       	test   $0xffffffef,%eax
f0105ea6:	75 15                	jne    f0105ebd <strtol+0x5a>
f0105ea8:	80 3a 30             	cmpb   $0x30,(%edx)
f0105eab:	75 10                	jne    f0105ebd <strtol+0x5a>
f0105ead:	80 7a 01 78          	cmpb   $0x78,0x1(%edx)
f0105eb1:	75 0a                	jne    f0105ebd <strtol+0x5a>
		s += 2, base = 16;
f0105eb3:	83 c2 02             	add    $0x2,%edx
f0105eb6:	b8 10 00 00 00       	mov    $0x10,%eax
f0105ebb:	eb 10                	jmp    f0105ecd <strtol+0x6a>
	else if (base == 0 && s[0] == '0')
f0105ebd:	85 c0                	test   %eax,%eax
f0105ebf:	75 0c                	jne    f0105ecd <strtol+0x6a>
		s++, base = 8;
	else if (base == 0)
		base = 10;
f0105ec1:	b0 0a                	mov    $0xa,%al
		s++, neg = 1;
...
f0105ec6:	75 05                	jne    f0105ecd <strtol+0x6a>
		s++, base = 8;
f0105ec8:	83 c2 01             	add    $0x1,%edx
f0105ecb:	b0 08                	mov    $0x8,%al
	else if (base == 0)
		base = 10;
f0105ecd:	bb 00 00 00 00       	mov    $0x0,%ebx
f0105ed2:	89 45 10             	mov    %eax,0x10(%ebp)
	...
	while (1) {
		...
		if (*s >= '0' && *s <= '9')
f0105ed5:	0f b6 0a             	movzbl (%edx),%ecx
f0105ed8:	8d 71 d0             	lea    -0x30(%ecx),%esi
f0105edb:	89 f0                	mov    %esi,%eax
f0105edd:	3c 09                	cmp    $0x9,%al
f0105edf:	77 08                	ja     f0105ee9 <strtol+0x86>
			dig = *s - '0';
f0105ee1:	0f be c9             	movsbl %cl,%ecx
f0105ee4:	83 e9 30             	sub    $0x30,%ecx
f0105ee7:	eb 20                	jmp    f0105f09 <strtol+0xa6>
		else if (*s >= 'a' && *s <= 'z')
f0105ee9:	8d 71 9f             	lea    -0x61(%ecx),%esi
f0105eec:	89 f0                	mov    %esi,%eax
f0105eee:	3c 19                	cmp    $0x19,%al
f0105ef0:	77 08                	ja     f0105efa <strtol+0x97>
			dig = *s - 'a' + 10;
f0105ef2:	0f be c9             	movsbl %cl,%ecx
f0105ef5:	83 e9 57             	sub    $0x57,%ecx
f0105ef8:	eb 0f                	jmp    f0105f09 <strtol+0xa6>
		else if (*s >= 'A' && *s <= 'Z')
f0105efa:	8d 71 bf             	lea    -0x41(%ecx),%esi
f0105efd:	89 f0                	mov    %esi,%eax
f0105eff:	3c 19                	cmp    $0x19,%al
f0105f01:	77 16                	ja     f0105f19 <strtol+0xb6>
			dig = *s - 'A' + 10;
f0105f03:	0f be c9             	movsbl %cl,%ecx
f0105f06:	83 e9 37             	sub    $0x37,%ecx
		else
			break;
		if (dig >= base)
f0105f09:	3b 4d 10             	cmp    0x10(%ebp),%ecx
f0105f0c:	7d 0f                	jge    f0105f1d <strtol+0xba>
			break;
		s++, val = (val * base) + dig;
f0105f0e:	83 c2 01             	add    $0x1,%edx
f0105f11:	0f af 5d 10          	imul   0x10(%ebp),%ebx
f0105f15:	01 cb                	add    %ecx,%ebx
		// we don't properly detect overflow!
	}
f0105f17:	eb bc                	jmp    f0105ed5 <strtol+0x72>
f0105f19:	89 d8                	mov    %ebx,%eax
f0105f1b:	eb 02                	jmp    f0105f1f <strtol+0xbc>
f0105f1d:	89 d8                	mov    %ebx,%eax

	if (endptr)
f0105f1f:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
f0105f23:	74 05                	je     f0105f2a <strtol+0xc7>
		*endptr = (char *) s;
f0105f25:	8b 75 0c             	mov    0xc(%ebp),%esi
f0105f28:	89 16                	mov    %edx,(%esi)
	return (neg ? -val : val);
f0105f2a:	f7 d8                	neg    %eax
f0105f2c:	85 ff                	test   %edi,%edi
f0105f2e:	0f 44 c3             	cmove  %ebx,%eax
}
f0105f31:	5b                   	pop    %ebx
f0105f32:	5e                   	pop    %esi
f0105f33:	5f                   	pop    %edi
...
f0105f38:	fa                   	cli    
	...
	xorw    %ax, %ax
f0105f39:	31 c0                	xor    %eax,%eax
	movw    %ax, %ds
f0105f3b:	8e d8                	mov    %eax,%ds
	movw    %ax, %es
f0105f3d:	8e c0                	mov    %eax,%es
	movw    %ax, %ss
f0105f3f:	8e d0                	mov    %eax,%ss

	lgdt    MPBOOTPHYS(gdtdesc)
f0105f41:	0f 01 16             	lgdtl  (%esi)
f0105f44:	74 70                	je     f0105fb6 <mpentry_end+0x4>
	movl    %cr0, %eax
f0105f46:	0f 20 c0             	mov    %cr0,%eax
	orl     $CR0_PE, %eax
f0105f49:	66 83 c8 01          	or     $0x1,%ax
	movl    %eax, %cr0
f0105f4d:	0f 22 c0             	mov    %eax,%cr0

	ljmpl   $(PROT_MODE_CSEG), $(MPBOOTPHYS(start32))
f0105f50:	66 ea 20 70 00 00    	ljmpw  $0x0,$0x7020
f0105f56:	08 00                	or     %al,(%eax)
...
f0105f58:	66 b8 10 00          	mov    $0x10,%ax
	movw    %ax, %ds
f0105f5c:	8e d8                	mov    %eax,%ds
	movw    %ax, %es
f0105f5e:	8e c0                	mov    %eax,%es
	movw    %ax, %ss
f0105f60:	8e d0                	mov    %eax,%ss
	movw    $0, %ax
f0105f62:	66 b8 00 00          	mov    $0x0,%ax
	movw    %ax, %fs
f0105f66:	8e e0                	mov    %eax,%fs
	movw    %ax, %gs
f0105f68:	8e e8                	mov    %eax,%gs

	# Set up initial page table. We cannot use kern_pgdir yet because
	# we are still running at a low EIP.
	movl    $(RELOC(entry_pgdir)), %eax
f0105f6a:	b8 00 f0 11 00       	mov    $0x11f000,%eax
	movl    %eax, %cr3
f0105f6f:	0f 22 d8             	mov    %eax,%cr3
	# Turn on paging.
	movl    %cr0, %eax
f0105f72:	0f 20 c0             	mov    %cr0,%eax
	orl     $(CR0_PE|CR0_PG|CR0_WP), %eax
f0105f75:	0d 01 00 01 80       	or     $0x80010001,%eax
	movl    %eax, %cr0
f0105f7a:	0f 22 c0             	mov    %eax,%cr0

	# Switch to the per-cpu stack allocated in boot_aps()
	movl    mpentry_kstack, %esp
f0105f7d:	8b 25 84 ce 22 f0    	mov    0xf022ce84,%esp
	movl    $0x0, %ebp       # nuke frame pointer
f0105f83:	bd 00 00 00 00       	mov    $0x0,%ebp

	# Call mp_main().  (Exercise for the reader: why the indirect call?)
	movl    $mp_main, %eax
f0105f88:	b8 f6 01 10 f0       	mov    $0xf01001f6,%eax
	call    *%eax
f0105f8d:	ff d0                	call   *%eax
...
spin:
	jmp     spin
f0105f8f:	eb fe                	jmp    f0105f8f <spin>
f0105f91:	8d 76 00             	lea    0x0(%esi),%esi

f0105f94 <gdt>:
	...
f0105f9c:	ff                   	(bad)  
f0105f9d:	ff 00                	incl   (%eax)
f0105f9f:	00 00                	add    %al,(%eax)
f0105fa1:	9a cf 00 ff ff 00 00 	lcall  $0x0,$0xffff00cf
f0105fa8:	00 92 cf 00 17 00    	add    %dl,0x1700cf(%edx)

f0105fac <gdtdesc>:
f0105fac:	17                   	pop    %ss
f0105fad:	00 5c 70 00          	add    %bl,0x0(%eax,%esi,2)
	...

f0105fb2 <mpentry_end>:
...
mpentry_end:
	nop
f0105fb2:	90                   	nop
f0105fb3:	66 90                	xchg   %ax,%ax
f0105fb5:	66 90                	xchg   %ax,%ax
f0105fb7:	66 90                	xchg   %ax,%ax
f0105fb9:	66 90                	xchg   %ax,%ax
f0105fbb:	66 90                	xchg   %ax,%ax
f0105fbd:	66 90                	xchg   %ax,%ax
f0105fbf:	90                   	nop
...
f0105fc5:	83 ec 10             	sub    $0x10,%esp
#define KADDR(pa) _kaddr(__FILE__, __LINE__, pa)
...
{
	if (PGNUM(pa) >= npages)
f0105fc8:	8b 0d 88 ce 22 f0    	mov    0xf022ce88,%ecx
f0105fce:	89 c3                	mov    %eax,%ebx
f0105fd0:	c1 eb 0c             	shr    $0xc,%ebx
f0105fd3:	39 cb                	cmp    %ecx,%ebx
f0105fd5:	72 20                	jb     f0105ff7 <mpsearch1+0x37>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0105fd7:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0105fdb:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f0105fe2:	f0 
f0105fe3:	c7 44 24 04 57 00 00 	movl   $0x57,0x4(%esp)
f0105fea:	00 
f0105feb:	c7 04 24 05 85 10 f0 	movl   $0xf0108505,(%esp)
f0105ff2:	e8 49 a0 ff ff       	call   f0100040 <_panic>
	return (void *)(pa + KERNBASE);
f0105ff7:	8d 98 00 00 00 f0    	lea    -0x10000000(%eax),%ebx
...
{
	if (PGNUM(pa) >= npages)
f0105fff:	89 c2                	mov    %eax,%edx
f0106001:	c1 ea 0c             	shr    $0xc,%edx
f0106004:	39 d1                	cmp    %edx,%ecx
f0106006:	77 20                	ja     f0106028 <mpsearch1+0x68>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0106008:	89 44 24 0c          	mov    %eax,0xc(%esp)
f010600c:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f0106013:	f0 
f0106014:	c7 44 24 04 57 00 00 	movl   $0x57,0x4(%esp)
f010601b:	00 
f010601c:	c7 04 24 05 85 10 f0 	movl   $0xf0108505,(%esp)
f0106023:	e8 18 a0 ff ff       	call   f0100040 <_panic>
	return (void *)(pa + KERNBASE);
f0106028:	8d b0 00 00 00 f0    	lea    -0x10000000(%eax),%esi

	for (; mp < end; mp++)
f010602e:	eb 36                	jmp    f0106066 <mpsearch1+0xa6>
		if (memcmp(mp->signature, "_MP_", 4) == 0 &&
f0106030:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
f0106037:	00 
f0106038:	c7 44 24 04 15 85 10 	movl   $0xf0108515,0x4(%esp)
f010603f:	f0 
f0106040:	89 1c 24             	mov    %ebx,(%esp)
f0106043:	e8 c5 fd ff ff       	call   f0105e0d <memcmp>
f0106048:	85 c0                	test   %eax,%eax
f010604a:	75 17                	jne    f0106063 <mpsearch1+0xa3>
...
f010604c:	ba 00 00 00 00       	mov    $0x0,%edx
		sum += ((uint8_t *)addr)[i];
f0106051:	0f b6 0c 13          	movzbl (%ebx,%edx,1),%ecx
f0106055:	01 c8                	add    %ecx,%eax
sum(void *addr, int len)
{
	int i, sum;
...
f010605a:	83 fa 10             	cmp    $0x10,%edx
f010605d:	75 f2                	jne    f0106051 <mpsearch1+0x91>
mpsearch1(physaddr_t a, int len)
{
	struct mp *mp = KADDR(a), *end = KADDR(a + len);
	...
	for (; mp < end; mp++)
		if (memcmp(mp->signature, "_MP_", 4) == 0 &&
f010605f:	84 c0                	test   %al,%al
f0106061:	74 0e                	je     f0106071 <mpsearch1+0xb1>
static struct mp *
mpsearch1(physaddr_t a, int len)
{
	struct mp *mp = KADDR(a), *end = KADDR(a + len);
	...
	for (; mp < end; mp++)
f0106063:	83 c3 10             	add    $0x10,%ebx
f0106066:	39 f3                	cmp    %esi,%ebx
f0106068:	72 c6                	jb     f0106030 <mpsearch1+0x70>
		if (memcmp(mp->signature, "_MP_", 4) == 0 &&
		    sum(mp, sizeof(*mp)) == 0)
			return mp;
	return NULL;
f010606a:	b8 00 00 00 00       	mov    $0x0,%eax
f010606f:	eb 02                	jmp    f0106073 <mpsearch1+0xb3>
...
f0106080:	83 ec 2c             	sub    $0x2c,%esp
	struct mpconf *conf;
	struct mpproc *proc;
	uint8_t *p;
	unsigned int i;
	...
	bootcpu = &cpus[0];
f0106083:	c7 05 c0 d3 22 f0 20 	movl   $0xf022d020,0xf022d3c0
f010608a:	d0 22 f0 
#define KADDR(pa) _kaddr(__FILE__, __LINE__, pa)
...
{
	if (PGNUM(pa) >= npages)
f010608d:	83 3d 88 ce 22 f0 00 	cmpl   $0x0,0xf022ce88
f0106094:	75 24                	jne    f01060ba <mp_init+0x40>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0106096:	c7 44 24 0c 00 04 00 	movl   $0x400,0xc(%esp)
f010609d:	00 
f010609e:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f01060a5:	f0 
f01060a6:	c7 44 24 04 6f 00 00 	movl   $0x6f,0x4(%esp)
f01060ad:	00 
f01060ae:	c7 04 24 05 85 10 f0 	movl   $0xf0108505,(%esp)
...
f01060c3:	74 16                	je     f01060db <mp_init+0x61>
		p <<= 4;	// Translate from segment to PA
f01060c5:	c1 e0 04             	shl    $0x4,%eax
		if ((mp = mpsearch1(p, 1024)))
f01060c8:	ba 00 04 00 00       	mov    $0x400,%edx
f01060cd:	e8 ee fe ff ff       	call   f0105fc0 <mpsearch1>
f01060d2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
f01060d5:	85 c0                	test   %eax,%eax
f01060d7:	75 3c                	jne    f0106115 <mp_init+0x9b>
f01060d9:	eb 20                	jmp    f01060fb <mp_init+0x81>
			return mp;
	} else {
...
f010610f:	0f 84 54 02 00 00    	je     f0106369 <mp_init+0x2ef>
		return NULL;
	if (mp->physaddr == 0 || mp->type != 0) {
f0106115:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0106118:	8b 70 04             	mov    0x4(%eax),%esi
f010611b:	85 f6                	test   %esi,%esi
f010611d:	74 06                	je     f0106125 <mp_init+0xab>
f010611f:	80 78 0b 00          	cmpb   $0x0,0xb(%eax)
f0106123:	74 11                	je     f0106136 <mp_init+0xbc>
		cprintf("SMP: Default configurations not implemented\n");
f0106125:	c7 04 24 78 83 10 f0 	movl   $0xf0108378,(%esp)
f010612c:	e8 41 de ff ff       	call   f0103f72 <cprintf>
f0106131:	e9 33 02 00 00       	jmp    f0106369 <mp_init+0x2ef>
#define KADDR(pa) _kaddr(__FILE__, __LINE__, pa)
...
{
	if (PGNUM(pa) >= npages)
f0106136:	89 f0                	mov    %esi,%eax
f0106138:	c1 e8 0c             	shr    $0xc,%eax
f010613b:	3b 05 88 ce 22 f0    	cmp    0xf022ce88,%eax
f0106141:	72 20                	jb     f0106163 <mp_init+0xe9>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f0106143:	89 74 24 0c          	mov    %esi,0xc(%esp)
f0106147:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f010614e:	f0 
f010614f:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
f0106156:	00 
f0106157:	c7 04 24 05 85 10 f0 	movl   $0xf0108505,(%esp)
f010615e:	e8 dd 9e ff ff       	call   f0100040 <_panic>
	return (void *)(pa + KERNBASE);
f0106163:	8d 9e 00 00 00 f0    	lea    -0x10000000(%esi),%ebx
		return NULL;
	}
	conf = (struct mpconf *) KADDR(mp->physaddr);
	if (memcmp(conf, "PCMP", 4) != 0) {
f0106169:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
f0106170:	00 
f0106171:	c7 44 24 04 1a 85 10 	movl   $0xf010851a,0x4(%esp)
f0106178:	f0 
f0106179:	89 1c 24             	mov    %ebx,(%esp)
f010617c:	e8 8c fc ff ff       	call   f0105e0d <memcmp>
f0106181:	85 c0                	test   %eax,%eax
f0106183:	74 11                	je     f0106196 <mp_init+0x11c>
		cprintf("SMP: Incorrect MP configuration table signature\n");
f0106185:	c7 04 24 a8 83 10 f0 	movl   $0xf01083a8,(%esp)
f010618c:	e8 e1 dd ff ff       	call   f0103f72 <cprintf>
f0106191:	e9 d3 01 00 00       	jmp    f0106369 <mp_init+0x2ef>
		return NULL;
	}
	if (sum(conf, conf->length) != 0) {
f0106196:	0f b7 43 04          	movzwl 0x4(%ebx),%eax
f010619a:	66 89 45 e2          	mov    %ax,-0x1e(%ebp)
f010619e:	0f b7 f8             	movzwl %ax,%edi
static uint8_t
sum(void *addr, int len)
{
	int i, sum;
	...
	sum = 0;
f01061a1:	ba 00 00 00 00       	mov    $0x0,%edx
	for (i = 0; i < len; i++)
f01061a6:	b8 00 00 00 00       	mov    $0x0,%eax
f01061ab:	eb 0d                	jmp    f01061ba <mp_init+0x140>
		sum += ((uint8_t *)addr)[i];
f01061ad:	0f b6 8c 30 00 00 00 	movzbl -0x10000000(%eax,%esi,1),%ecx
f01061b4:	f0 
f01061b5:	01 ca                	add    %ecx,%edx
sum(void *addr, int len)
{
	int i, sum;
	...
	sum = 0;
	for (i = 0; i < len; i++)
f01061b7:	83 c0 01             	add    $0x1,%eax
f01061ba:	39 c7                	cmp    %eax,%edi
f01061bc:	7f ef                	jg     f01061ad <mp_init+0x133>
	conf = (struct mpconf *) KADDR(mp->physaddr);
	if (memcmp(conf, "PCMP", 4) != 0) {
		cprintf("SMP: Incorrect MP configuration table signature\n");
		return NULL;
	...
	if (sum(conf, conf->length) != 0) {
f01061be:	84 d2                	test   %dl,%dl
f01061c0:	74 11                	je     f01061d3 <mp_init+0x159>
		cprintf("SMP: Bad MP configuration checksum\n");
f01061c2:	c7 04 24 dc 83 10 f0 	movl   $0xf01083dc,(%esp)
f01061c9:	e8 a4 dd ff ff       	call   f0103f72 <cprintf>
f01061ce:	e9 96 01 00 00       	jmp    f0106369 <mp_init+0x2ef>
		return NULL;
	}
	if (conf->version != 1 && conf->version != 4) {
f01061d3:	0f b6 43 06          	movzbl 0x6(%ebx),%eax
f01061d7:	3c 04                	cmp    $0x4,%al
f01061d9:	74 1f                	je     f01061fa <mp_init+0x180>
f01061db:	3c 01                	cmp    $0x1,%al
f01061dd:	8d 76 00             	lea    0x0(%esi),%esi
f01061e0:	74 18                	je     f01061fa <mp_init+0x180>
		cprintf("SMP: Unsupported MP version %d\n", conf->version);
f01061e2:	0f b6 c0             	movzbl %al,%eax
f01061e5:	89 44 24 04          	mov    %eax,0x4(%esp)
f01061e9:	c7 04 24 00 84 10 f0 	movl   $0xf0108400,(%esp)
f01061f0:	e8 7d dd ff ff       	call   f0103f72 <cprintf>
f01061f5:	e9 6f 01 00 00       	jmp    f0106369 <mp_init+0x2ef>
		return NULL;
	}
	if ((sum((uint8_t *)conf + conf->length, conf->xlength) + conf->xchecksum) & 0xff) {
f01061fa:	0f b7 73 28          	movzwl 0x28(%ebx),%esi
f01061fe:	0f b7 7d e2          	movzwl -0x1e(%ebp),%edi
f0106202:	01 df                	add    %ebx,%edi
static uint8_t
sum(void *addr, int len)
{
	int i, sum;
	...
	sum = 0;
f0106204:	ba 00 00 00 00       	mov    $0x0,%edx
	for (i = 0; i < len; i++)
f0106209:	b8 00 00 00 00       	mov    $0x0,%eax
f010620e:	eb 09                	jmp    f0106219 <mp_init+0x19f>
		sum += ((uint8_t *)addr)[i];
f0106210:	0f b6 0c 07          	movzbl (%edi,%eax,1),%ecx
f0106214:	01 ca                	add    %ecx,%edx
sum(void *addr, int len)
{
	int i, sum;
	...
	sum = 0;
	for (i = 0; i < len; i++)
f0106216:	83 c0 01             	add    $0x1,%eax
f0106219:	39 c6                	cmp    %eax,%esi
f010621b:	7f f3                	jg     f0106210 <mp_init+0x196>
	}
	if (conf->version != 1 && conf->version != 4) {
		cprintf("SMP: Unsupported MP version %d\n", conf->version);
		return NULL;
	...
	if ((sum((uint8_t *)conf + conf->length, conf->xlength) + conf->xchecksum) & 0xff) {
f010621d:	02 53 2a             	add    0x2a(%ebx),%dl
f0106220:	84 d2                	test   %dl,%dl
f0106222:	74 11                	je     f0106235 <mp_init+0x1bb>
		cprintf("SMP: Bad MP configuration extended checksum\n");
f0106224:	c7 04 24 20 84 10 f0 	movl   $0xf0108420,(%esp)
f010622b:	e8 42 dd ff ff       	call   f0103f72 <cprintf>
f0106230:	e9 34 01 00 00       	jmp    f0106369 <mp_init+0x2ef>
	struct mpproc *proc;
	uint8_t *p;
	unsigned int i;
...
f0106235:	85 db                	test   %ebx,%ebx
f0106237:	0f 84 2c 01 00 00    	je     f0106369 <mp_init+0x2ef>
		return;
	ismp = 1;
f010623d:	c7 05 00 d0 22 f0 01 	movl   $0x1,0xf022d000
f0106244:	00 00 00 
	lapicaddr = conf->lapicaddr;
f0106247:	8b 43 24             	mov    0x24(%ebx),%eax
f010624a:	a3 00 e0 26 f0       	mov    %eax,0xf026e000

	for (p = conf->entries, i = 0; i < conf->entry; i++) {
f010624f:	8d 7b 2c             	lea    0x2c(%ebx),%edi
f0106252:	be 00 00 00 00       	mov    $0x0,%esi
f0106257:	e9 86 00 00 00       	jmp    f01062e2 <mp_init+0x268>
		switch (*p) {
f010625c:	0f b6 07             	movzbl (%edi),%eax
f010625f:	84 c0                	test   %al,%al
f0106261:	74 06                	je     f0106269 <mp_init+0x1ef>
f0106263:	3c 04                	cmp    $0x4,%al
f0106265:	77 57                	ja     f01062be <mp_init+0x244>
f0106267:	eb 50                	jmp    f01062b9 <mp_init+0x23f>
		case MPPROC:
			proc = (struct mpproc *)p;
			if (proc->flags & MPPROC_BOOT)
f0106269:	f6 47 03 02          	testb  $0x2,0x3(%edi)
f010626d:	8d 76 00             	lea    0x0(%esi),%esi
f0106270:	74 11                	je     f0106283 <mp_init+0x209>
				bootcpu = &cpus[ncpu];
f0106272:	6b 05 c4 d3 22 f0 74 	imul   $0x74,0xf022d3c4,%eax
f0106279:	05 20 d0 22 f0       	add    $0xf022d020,%eax
f010627e:	a3 c0 d3 22 f0       	mov    %eax,0xf022d3c0
			if (ncpu < NCPU) {
f0106283:	a1 c4 d3 22 f0       	mov    0xf022d3c4,%eax
f0106288:	83 f8 07             	cmp    $0x7,%eax
f010628b:	7f 13                	jg     f01062a0 <mp_init+0x226>
				cpus[ncpu].cpu_id = ncpu;
f010628d:	6b d0 74             	imul   $0x74,%eax,%edx
f0106290:	88 82 20 d0 22 f0    	mov    %al,-0xfdd2fe0(%edx)
				ncpu++;
f0106296:	83 c0 01             	add    $0x1,%eax
f0106299:	a3 c4 d3 22 f0       	mov    %eax,0xf022d3c4
f010629e:	eb 14                	jmp    f01062b4 <mp_init+0x23a>
			} else {
				cprintf("SMP: too many CPUs, CPU %d disabled\n",
f01062a0:	0f b6 47 01          	movzbl 0x1(%edi),%eax
f01062a4:	89 44 24 04          	mov    %eax,0x4(%esp)
f01062a8:	c7 04 24 50 84 10 f0 	movl   $0xf0108450,(%esp)
f01062af:	e8 be dc ff ff       	call   f0103f72 <cprintf>
					proc->apicid);
			}
			p += sizeof(struct mpproc);
f01062b4:	83 c7 14             	add    $0x14,%edi
			continue;
f01062b7:	eb 26                	jmp    f01062df <mp_init+0x265>
		case MPBUS:
		case MPIOAPIC:
		case MPIOINTR:
		case MPLINTR:
...
f01062b9:	83 c7 08             	add    $0x8,%edi
			continue;
f01062bc:	eb 21                	jmp    f01062df <mp_init+0x265>
		default:
			cprintf("mpinit: unknown config type %x\n", *p);
f01062be:	0f b6 c0             	movzbl %al,%eax
f01062c1:	89 44 24 04          	mov    %eax,0x4(%esp)
f01062c5:	c7 04 24 78 84 10 f0 	movl   $0xf0108478,(%esp)
f01062cc:	e8 a1 dc ff ff       	call   f0103f72 <cprintf>
			ismp = 0;
f01062d1:	c7 05 00 d0 22 f0 00 	movl   $0x0,0xf022d000
f01062d8:	00 00 00 
			i = conf->entry;
f01062db:	0f b7 73 22          	movzwl 0x22(%ebx),%esi
	if ((conf = mpconfig(&mp)) == 0)
		return;
	ismp = 1;
	lapicaddr = conf->lapicaddr;
	...
	for (p = conf->entries, i = 0; i < conf->entry; i++) {
f01062df:	83 c6 01             	add    $0x1,%esi
f01062e2:	0f b7 43 22          	movzwl 0x22(%ebx),%eax
f01062e6:	39 c6                	cmp    %eax,%esi
f01062e8:	0f 82 6e ff ff ff    	jb     f010625c <mp_init+0x1e2>
			ismp = 0;
			i = conf->entry;
		}
	}
...
f01062ee:	a1 c0 d3 22 f0       	mov    0xf022d3c0,%eax
f01062f3:	c7 40 04 01 00 00 00 	movl   $0x1,0x4(%eax)
	if (!ismp) {
f01062fa:	83 3d 00 d0 22 f0 00 	cmpl   $0x0,0xf022d000
f0106301:	75 22                	jne    f0106325 <mp_init+0x2ab>
		// Didn't like what we found; fall back to no MP.
		ncpu = 1;
f0106303:	c7 05 c4 d3 22 f0 01 	movl   $0x1,0xf022d3c4
f010630a:	00 00 00 
		lapicaddr = 0;
f010630d:	c7 05 00 e0 26 f0 00 	movl   $0x0,0xf026e000
f0106314:	00 00 00 
		cprintf("SMP: configuration not found, SMP disabled\n");
f0106317:	c7 04 24 98 84 10 f0 	movl   $0xf0108498,(%esp)
f010631e:	e8 4f dc ff ff       	call   f0103f72 <cprintf>
		return;
f0106323:	eb 44                	jmp    f0106369 <mp_init+0x2ef>
	}
	cprintf("SMP: CPU %d found %d CPU(s)\n", bootcpu->cpu_id,  ncpu);
f0106325:	8b 15 c4 d3 22 f0    	mov    0xf022d3c4,%edx
f010632b:	89 54 24 08          	mov    %edx,0x8(%esp)
f010632f:	0f b6 00             	movzbl (%eax),%eax
f0106332:	89 44 24 04          	mov    %eax,0x4(%esp)
f0106336:	c7 04 24 1f 85 10 f0 	movl   $0xf010851f,(%esp)
f010633d:	e8 30 dc ff ff       	call   f0103f72 <cprintf>

	if (mp->imcrp) {
f0106342:	8b 45 e4             	mov    -0x1c(%ebp),%eax
f0106345:	80 78 0c 00          	cmpb   $0x0,0xc(%eax)
f0106349:	74 1e                	je     f0106369 <mp_init+0x2ef>
		// [MP 3.2.6.1] If the hardware implements PIC mode,
		// switch to getting interrupts from the LAPIC.
		cprintf("SMP: Setting IMCR to switch from PIC mode to symmetric I/O mode\n");
f010634b:	c7 04 24 c4 84 10 f0 	movl   $0xf01084c4,(%esp)
f0106352:	e8 1b dc ff ff       	call   f0103f72 <cprintf>
}
...
{
	__asm __volatile("outb %0,%w1" : : "a" (data), "d" (port));
f0106357:	ba 22 00 00 00       	mov    $0x22,%edx
f010635c:	b8 70 00 00 00       	mov    $0x70,%eax
f0106361:	ee                   	out    %al,(%dx)
...
inb(int port)
{
	uint8_t data;
	__asm __volatile("inb %w1,%0" : "=a" (data) : "d" (port));
f0106362:	b2 23                	mov    $0x23,%dl
f0106364:	ec                   	in     (%dx),%al
		outb(0x22, 0x70);   // Select IMCR
		outb(0x23, inb(0x23) | 1);  // Mask external interrupts.
f0106365:	83 c8 01             	or     $0x1,%eax
}
...
f0106369:	83 c4 2c             	add    $0x2c,%esp
f010636c:	5b                   	pop    %ebx
f010636d:	5e                   	pop    %esi
f010636e:	5f                   	pop    %edi
f010636f:	5d                   	pop    %ebp
...
{
f0106371:	55                   	push   %ebp
f0106372:	89 e5                	mov    %esp,%ebp
	lapic[index] = value;
f0106374:	8b 0d 04 e0 26 f0    	mov    0xf026e004,%ecx
f010637a:	8d 04 81             	lea    (%ecx,%eax,4),%eax
f010637d:	89 10                	mov    %edx,(%eax)
	lapic[ID];  // wait for write to finish, by reading
f010637f:	a1 04 e0 26 f0       	mov    0xf026e004,%eax
f0106384:	8b 40 20             	mov    0x20(%eax),%eax
}
f0106387:	5d                   	pop    %ebp
f0106388:	c3                   	ret    
...
f010638a:	89 e5                	mov    %esp,%ebp
	if (lapic)
f010638c:	a1 04 e0 26 f0       	mov    0xf026e004,%eax
f0106391:	85 c0                	test   %eax,%eax
f0106393:	74 08                	je     f010639d <cpunum+0x14>
		return lapic[ID] >> 24;
f0106395:	8b 40 20             	mov    0x20(%eax),%eax
f0106398:	c1 e8 18             	shr    $0x18,%eax
f010639b:	eb 05                	jmp    f01063a2 <cpunum+0x19>
	return 0;
...
{
	if (!lapicaddr)
f01063a4:	a1 00 e0 26 f0       	mov    0xf026e000,%eax
f01063a9:	85 c0                	test   %eax,%eax
f01063ab:	0f 84 23 01 00 00    	je     f01064d4 <lapic_init+0x130>
	lapic[ID];  // wait for write to finish, by reading
}
...
lapic_init(void)
{
f01063b1:	55                   	push   %ebp
f01063b2:	89 e5                	mov    %esp,%ebp
f01063b4:	83 ec 18             	sub    $0x18,%esp
	if (!lapicaddr)
		return;
...
f01063b7:	c7 44 24 04 00 10 00 	movl   $0x1000,0x4(%esp)
f01063be:	00 
f01063bf:	89 04 24             	mov    %eax,(%esp)
f01063c2:	e8 90 af ff ff       	call   f0101357 <mmio_map_region>
f01063c7:	a3 04 e0 26 f0       	mov    %eax,0xf026e004

	// Enable local APIC; set spurious interrupt vector.
	lapicw(SVR, ENABLE | (IRQ_OFFSET + IRQ_SPURIOUS));
f01063cc:	ba 27 01 00 00       	mov    $0x127,%edx
f01063d1:	b8 3c 00 00 00       	mov    $0x3c,%eax
f01063d6:	e8 96 ff ff ff       	call   f0106371 <lapicw>
	...
	lapicw(TDCR, X1);
f01063db:	ba 0b 00 00 00       	mov    $0xb,%edx
f01063e0:	b8 f8 00 00 00       	mov    $0xf8,%eax
f01063e5:	e8 87 ff ff ff       	call   f0106371 <lapicw>
	lapicw(TIMER, PERIODIC | (IRQ_OFFSET + IRQ_TIMER));
f01063ea:	ba 20 00 02 00       	mov    $0x20020,%edx
f01063ef:	b8 c8 00 00 00       	mov    $0xc8,%eax
f01063f4:	e8 78 ff ff ff       	call   f0106371 <lapicw>
	lapicw(TICR, 10000000); 
f01063f9:	ba 80 96 98 00       	mov    $0x989680,%edx
f01063fe:	b8 e0 00 00 00       	mov    $0xe0,%eax
f0106403:	e8 69 ff ff ff       	call   f0106371 <lapicw>
	//
	...
	if (thiscpu != bootcpu)
f0106408:	e8 7c ff ff ff       	call   f0106389 <cpunum>
f010640d:	6b c0 74             	imul   $0x74,%eax,%eax
f0106410:	05 20 d0 22 f0       	add    $0xf022d020,%eax
f0106415:	39 05 c0 d3 22 f0    	cmp    %eax,0xf022d3c0
f010641b:	74 0f                	je     f010642c <lapic_init+0x88>
		lapicw(LINT0, MASKED);
f010641d:	ba 00 00 01 00       	mov    $0x10000,%edx
f0106422:	b8 d4 00 00 00       	mov    $0xd4,%eax
f0106427:	e8 45 ff ff ff       	call   f0106371 <lapicw>

	// Disable NMI (LINT1) on all CPUs
	lapicw(LINT1, MASKED);
f010642c:	ba 00 00 01 00       	mov    $0x10000,%edx
f0106431:	b8 d8 00 00 00       	mov    $0xd8,%eax
f0106436:	e8 36 ff ff ff       	call   f0106371 <lapicw>

	// Disable performance counter overflow interrupts
	// on machines that provide that interrupt entry.
	if (((lapic[VER]>>16) & 0xFF) >= 4)
f010643b:	a1 04 e0 26 f0       	mov    0xf026e004,%eax
f0106440:	8b 40 30             	mov    0x30(%eax),%eax
f0106443:	c1 e8 10             	shr    $0x10,%eax
f0106446:	3c 03                	cmp    $0x3,%al
f0106448:	76 0f                	jbe    f0106459 <lapic_init+0xb5>
		lapicw(PCINT, MASKED);
f010644a:	ba 00 00 01 00       	mov    $0x10000,%edx
f010644f:	b8 d0 00 00 00       	mov    $0xd0,%eax
f0106454:	e8 18 ff ff ff       	call   f0106371 <lapicw>

	// Map error interrupt to IRQ_ERROR.
	lapicw(ERROR, IRQ_OFFSET + IRQ_ERROR);
f0106459:	ba 33 00 00 00       	mov    $0x33,%edx
f010645e:	b8 dc 00 00 00       	mov    $0xdc,%eax
f0106463:	e8 09 ff ff ff       	call   f0106371 <lapicw>

	// Clear error status register (requires back-to-back writes).
	lapicw(ESR, 0);
f0106468:	ba 00 00 00 00       	mov    $0x0,%edx
f010646d:	b8 a0 00 00 00       	mov    $0xa0,%eax
f0106472:	e8 fa fe ff ff       	call   f0106371 <lapicw>
	lapicw(ESR, 0);
f0106477:	ba 00 00 00 00       	mov    $0x0,%edx
f010647c:	b8 a0 00 00 00       	mov    $0xa0,%eax
f0106481:	e8 eb fe ff ff       	call   f0106371 <lapicw>

	// Ack any outstanding interrupts.
	lapicw(EOI, 0);
f0106486:	ba 00 00 00 00       	mov    $0x0,%edx
f010648b:	b8 2c 00 00 00       	mov    $0x2c,%eax
f0106490:	e8 dc fe ff ff       	call   f0106371 <lapicw>

	// Send an Init Level De-Assert to synchronize arbitration ID's.
	lapicw(ICRHI, 0);
f0106495:	ba 00 00 00 00       	mov    $0x0,%edx
f010649a:	b8 c4 00 00 00       	mov    $0xc4,%eax
f010649f:	e8 cd fe ff ff       	call   f0106371 <lapicw>
	lapicw(ICRLO, BCAST | INIT | LEVEL);
f01064a4:	ba 00 85 08 00       	mov    $0x88500,%edx
f01064a9:	b8 c0 00 00 00       	mov    $0xc0,%eax
f01064ae:	e8 be fe ff ff       	call   f0106371 <lapicw>
	while(lapic[ICRLO] & DELIVS)
f01064b3:	8b 15 04 e0 26 f0    	mov    0xf026e004,%edx
f01064b9:	8b 82 00 03 00 00    	mov    0x300(%edx),%eax
f01064bf:	f6 c4 10             	test   $0x10,%ah
f01064c2:	75 f5                	jne    f01064b9 <lapic_init+0x115>
		;

	// Enable interrupts on the APIC (but not on the processor).
	lapicw(TPR, 0);
f01064c4:	ba 00 00 00 00       	mov    $0x0,%edx
f01064c9:	b8 20 00 00 00       	mov    $0x20,%eax
f01064ce:	e8 9e fe ff ff       	call   f0106371 <lapicw>
}
f01064d3:	c9                   	leave  
f01064d4:	f3 c3                	repz ret 
...
{
	if (lapic)
f01064d6:	83 3d 04 e0 26 f0 00 	cmpl   $0x0,0xf026e004
f01064dd:	74 13                	je     f01064f2 <lapic_eoi+0x1c>
}
...
f01064ec:	e8 80 fe ff ff       	call   f0106371 <lapicw>
}
f01064f1:	5d                   	pop    %ebp
f01064f2:	f3 c3                	repz ret 

f01064f4 <lapic_startap>:
...
f01064f7:	56                   	push   %esi
f01064f8:	53                   	push   %ebx
f01064f9:	83 ec 10             	sub    $0x10,%esp
f01064fc:	8b 5d 08             	mov    0x8(%ebp),%ebx
f01064ff:	8b 75 0c             	mov    0xc(%ebp),%esi
f0106502:	ba 70 00 00 00       	mov    $0x70,%edx
f0106507:	b8 0f 00 00 00       	mov    $0xf,%eax
f010650c:	ee                   	out    %al,(%dx)
f010650d:	b2 71                	mov    $0x71,%dl
f010650f:	b8 0a 00 00 00       	mov    $0xa,%eax
f0106514:	ee                   	out    %al,(%dx)
#define KADDR(pa) _kaddr(__FILE__, __LINE__, pa)
...
{
	if (PGNUM(pa) >= npages)
f0106515:	83 3d 88 ce 22 f0 00 	cmpl   $0x0,0xf022ce88
f010651c:	75 24                	jne    f0106542 <lapic_startap+0x4e>
		_panic(file, line, "KADDR called with invalid pa %08lx", pa);
f010651e:	c7 44 24 0c 67 04 00 	movl   $0x467,0xc(%esp)
f0106525:	00 
f0106526:	c7 44 24 08 84 6a 10 	movl   $0xf0106a84,0x8(%esp)
f010652d:	f0 
f010652e:	c7 44 24 04 98 00 00 	movl   $0x98,0x4(%esp)
f0106535:	00 
f0106536:	c7 04 24 3c 85 10 f0 	movl   $0xf010853c,(%esp)
f010653d:	e8 fe 9a ff ff       	call   f0100040 <_panic>
	...
	wrv[0] = 0;
f0106542:	66 c7 05 67 04 00 f0 	movw   $0x0,0xf0000467
f0106549:	00 00 
	wrv[1] = addr >> 4;
f010654b:	89 f0                	mov    %esi,%eax
f010654d:	c1 e8 04             	shr    $0x4,%eax
f0106550:	66 a3 69 04 00 f0    	mov    %ax,0xf0000469

	// "Universal startup algorithm."
	// Send INIT (level-triggered) interrupt to reset other CPU.
	lapicw(ICRHI, apicid << 24);
f0106556:	c1 e3 18             	shl    $0x18,%ebx
f0106559:	89 da                	mov    %ebx,%edx
f010655b:	b8 c4 00 00 00       	mov    $0xc4,%eax
f0106560:	e8 0c fe ff ff       	call   f0106371 <lapicw>
	lapicw(ICRLO, INIT | LEVEL | ASSERT);
f0106565:	ba 00 c5 00 00       	mov    $0xc500,%edx
f010656a:	b8 c0 00 00 00       	mov    $0xc0,%eax
f010656f:	e8 fd fd ff ff       	call   f0106371 <lapicw>
	microdelay(200);
	lapicw(ICRLO, INIT | LEVEL);
f0106574:	ba 00 85 00 00       	mov    $0x8500,%edx
f0106579:	b8 c0 00 00 00       	mov    $0xc0,%eax
f010657e:	e8 ee fd ff ff       	call   f0106371 <lapicw>
...
f0106583:	c1 ee 0c             	shr    $0xc,%esi
f0106586:	81 ce 00 06 00 00    	or     $0x600,%esi
	...
	for (i = 0; i < 2; i++) {
		lapicw(ICRHI, apicid << 24);
f010658c:	89 da                	mov    %ebx,%edx
f010658e:	b8 c4 00 00 00       	mov    $0xc4,%eax
f0106593:	e8 d9 fd ff ff       	call   f0106371 <lapicw>
		lapicw(ICRLO, STARTUP | (addr >> 12));
f0106598:	89 f2                	mov    %esi,%edx
f010659a:	b8 c0 00 00 00       	mov    $0xc0,%eax
f010659f:	e8 cd fd ff ff       	call   f0106371 <lapicw>
	// Regular hardware is supposed to only accept a STARTUP
	// when it is in the halted state due to an INIT.  So the second
	// should be ignored, but it is part of the official Intel algorithm.
	// Bochs complains about the second one.  Too bad for Bochs.
	for (i = 0; i < 2; i++) {
		lapicw(ICRHI, apicid << 24);
f01065a4:	89 da                	mov    %ebx,%edx
f01065a6:	b8 c4 00 00 00       	mov    $0xc4,%eax
f01065ab:	e8 c1 fd ff ff       	call   f0106371 <lapicw>
		lapicw(ICRLO, STARTUP | (addr >> 12));
f01065b0:	89 f2                	mov    %esi,%edx
f01065b2:	b8 c0 00 00 00       	mov    $0xc0,%eax
f01065b7:	e8 b5 fd ff ff       	call   f0106371 <lapicw>
		microdelay(200);
	}
}
...
{
f01065c3:	55                   	push   %ebp
f01065c4:	89 e5                	mov    %esp,%ebp
	lapicw(ICRLO, OTHERS | FIXED | vector);
f01065c6:	8b 55 08             	mov    0x8(%ebp),%edx
f01065c9:	81 ca 00 00 0c 00    	or     $0xc0000,%edx
f01065cf:	b8 c0 00 00 00       	mov    $0xc0,%eax
f01065d4:	e8 98 fd ff ff       	call   f0106371 <lapicw>
	while (lapic[ICRLO] & DELIVS)
f01065d9:	8b 15 04 e0 26 f0    	mov    0xf026e004,%edx
f01065df:	8b 82 00 03 00 00    	mov    0x300(%edx),%eax
f01065e5:	f6 c4 10             	test   $0x10,%ah
f01065e8:	75 f5                	jne    f01065df <lapic_ipi+0x1c>
		;
}
f01065ea:	5d                   	pop    %ebp
f01065eb:	c3                   	ret    

f01065ec <__spin_initlock>:
}
#endif
...
f01065ef:	8b 45 08             	mov    0x8(%ebp),%eax
	lk->locked = 0;
f01065f2:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
#ifdef DEBUG_SPINLOCK
	lk->name = name;
f01065f8:	8b 55 0c             	mov    0xc(%ebp),%edx
f01065fb:	89 50 04             	mov    %edx,0x4(%eax)
	lk->cpu = 0;
f01065fe:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
#endif
}
f0106605:	5d                   	pop    %ebp
f0106606:	c3                   	ret    
...
f010660a:	56                   	push   %esi
f010660b:	53                   	push   %ebx
f010660c:	83 ec 20             	sub    $0x20,%esp
f010660f:	8b 5d 08             	mov    0x8(%ebp),%ebx
...
f0106612:	83 3b 00             	cmpl   $0x0,(%ebx)
f0106615:	75 07                	jne    f010661e <spin_lock+0x17>
xchg(volatile uint32_t *addr, uint32_t newval)
{
	uint32_t result;
	...
	// The + in "+m" denotes a read-modify-write operand.
	asm volatile("lock; xchgl %0, %1" :
f0106617:	ba 01 00 00 00       	mov    $0x1,%edx
f010661c:	eb 42                	jmp    f0106660 <spin_lock+0x59>
f010661e:	8b 73 08             	mov    0x8(%ebx),%esi
f0106621:	e8 63 fd ff ff       	call   f0106389 <cpunum>
f0106626:	6b c0 74             	imul   $0x74,%eax,%eax
f0106629:	05 20 d0 22 f0       	add    $0xf022d020,%eax
// other CPUs to waste time spinning to acquire it.
void
spin_lock(struct spinlock *lk)
{
#ifdef DEBUG_SPINLOCK
	if (holding(lk))
f010662e:	39 c6                	cmp    %eax,%esi
f0106630:	75 e5                	jne    f0106617 <spin_lock+0x10>
		panic("CPU %d cannot acquire %s: already holding", cpunum(), lk->name);
f0106632:	8b 5b 04             	mov    0x4(%ebx),%ebx
f0106635:	e8 4f fd ff ff       	call   f0106389 <cpunum>
f010663a:	89 5c 24 10          	mov    %ebx,0x10(%esp)
f010663e:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0106642:	c7 44 24 08 4c 85 10 	movl   $0xf010854c,0x8(%esp)
f0106649:	f0 
f010664a:	c7 44 24 04 41 00 00 	movl   $0x41,0x4(%esp)
f0106651:	00 
f0106652:	c7 04 24 b0 85 10 f0 	movl   $0xf01085b0,(%esp)
f0106659:	e8 e2 99 ff ff       	call   f0100040 <_panic>
	...
	while (xchg(&lk->locked, 1) != 0)
		asm volatile ("pause");
f010665e:	f3 90                	pause  
f0106660:	89 d0                	mov    %edx,%eax
f0106662:	f0 87 03             	lock xchg %eax,(%ebx)
#endif
	...
	// reordered before it. 
	while (xchg(&lk->locked, 1) != 0)
f0106665:	85 c0                	test   %eax,%eax
f0106667:	75 f5                	jne    f010665e <spin_lock+0x57>
		asm volatile ("pause");

	// Record info about lock acquisition for debugging.
#ifdef DEBUG_SPINLOCK
	lk->cpu = thiscpu;
f0106669:	e8 1b fd ff ff       	call   f0106389 <cpunum>
f010666e:	6b c0 74             	imul   $0x74,%eax,%eax
f0106671:	05 20 d0 22 f0       	add    $0xf022d020,%eax
f0106676:	89 43 08             	mov    %eax,0x8(%ebx)
	get_caller_pcs(lk->pcs);
f0106679:	83 c3 0c             	add    $0xc,%ebx
...
f010667c:	89 ea                	mov    %ebp,%edx
	for (i = 0; i < 10; i++){
f010667e:	b8 00 00 00 00       	mov    $0x0,%eax
		if (ebp == 0 || ebp < (uint32_t *)ULIM)
f0106683:	81 fa ff ff 7f ef    	cmp    $0xef7fffff,%edx
f0106689:	76 12                	jbe    f010669d <spin_lock+0x96>
			break;
		pcs[i] = ebp[1];          // saved %eip
f010668b:	8b 4a 04             	mov    0x4(%edx),%ecx
f010668e:	89 0c 83             	mov    %ecx,(%ebx,%eax,4)
		ebp = (uint32_t *)ebp[0]; // saved %ebp
f0106691:	8b 12                	mov    (%edx),%edx
{
	uint32_t *ebp;
	int i;
	...
	ebp = (uint32_t *)read_ebp();
	for (i = 0; i < 10; i++){
f0106693:	83 c0 01             	add    $0x1,%eax
f0106696:	83 f8 0a             	cmp    $0xa,%eax
f0106699:	75 e8                	jne    f0106683 <spin_lock+0x7c>
f010669b:	eb 0f                	jmp    f01066ac <spin_lock+0xa5>
			break;
		pcs[i] = ebp[1];          // saved %eip
		ebp = (uint32_t *)ebp[0]; // saved %ebp
	}
	for (; i < 10; i++)
		pcs[i] = 0;
f010669d:	c7 04 83 00 00 00 00 	movl   $0x0,(%ebx,%eax,4)
		if (ebp == 0 || ebp < (uint32_t *)ULIM)
			break;
		pcs[i] = ebp[1];          // saved %eip
		ebp = (uint32_t *)ebp[0]; // saved %ebp
	...
	for (; i < 10; i++)
f01066a4:	83 c0 01             	add    $0x1,%eax
f01066a7:	83 f8 09             	cmp    $0x9,%eax
f01066aa:	7e f1                	jle    f010669d <spin_lock+0x96>
	// Record info about lock acquisition for debugging.
#ifdef DEBUG_SPINLOCK
	lk->cpu = thiscpu;
	get_caller_pcs(lk->pcs);
...
f01066ac:	83 c4 20             	add    $0x20,%esp
f01066af:	5b                   	pop    %ebx
f01066b0:	5e                   	pop    %esi
f01066b1:	5d                   	pop    %ebp
f01066b2:	c3                   	ret    

f01066b3 <spin_unlock>:

// Release the lock.
void
spin_unlock(struct spinlock *lk)
{
f01066b3:	55                   	push   %ebp
f01066b4:	89 e5                	mov    %esp,%ebp
f01066b6:	57                   	push   %edi
f01066b7:	56                   	push   %esi
f01066b8:	53                   	push   %ebx
f01066b9:	83 ec 6c             	sub    $0x6c,%esp
f01066bc:	8b 75 08             	mov    0x8(%ebp),%esi
...
{
	return lock->locked && lock->cpu == thiscpu;
f01066bf:	83 3e 00             	cmpl   $0x0,(%esi)
f01066c2:	74 18                	je     f01066dc <spin_unlock+0x29>
f01066c4:	8b 5e 08             	mov    0x8(%esi),%ebx
f01066c7:	e8 bd fc ff ff       	call   f0106389 <cpunum>
f01066cc:	6b c0 74             	imul   $0x74,%eax,%eax
f01066cf:	05 20 d0 22 f0       	add    $0xf022d020,%eax
// Release the lock.
void
spin_unlock(struct spinlock *lk)
{
#ifdef DEBUG_SPINLOCK
	if (!holding(lk)) {
f01066d4:	39 c3                	cmp    %eax,%ebx
f01066d6:	0f 84 ce 00 00 00    	je     f01067aa <spin_unlock+0xf7>
		int i;
		uint32_t pcs[10];
		// Nab the acquiring EIP chain before it gets released
		memmove(pcs, lk->pcs, sizeof pcs);
f01066dc:	c7 44 24 08 28 00 00 	movl   $0x28,0x8(%esp)
f01066e3:	00 
f01066e4:	8d 46 0c             	lea    0xc(%esi),%eax
f01066e7:	89 44 24 04          	mov    %eax,0x4(%esp)
f01066eb:	8d 5d c0             	lea    -0x40(%ebp),%ebx
f01066ee:	89 1c 24             	mov    %ebx,(%esp)
f01066f1:	e8 8e f6 ff ff       	call   f0105d84 <memmove>
		cprintf("CPU %d cannot release %s: held by CPU %d\nAcquired at:", 
			cpunum(), lk->name, lk->cpu->cpu_id);
f01066f6:	8b 46 08             	mov    0x8(%esi),%eax
	if (!holding(lk)) {
		int i;
		uint32_t pcs[10];
		// Nab the acquiring EIP chain before it gets released
		memmove(pcs, lk->pcs, sizeof pcs);
		cprintf("CPU %d cannot release %s: held by CPU %d\nAcquired at:", 
f01066f9:	0f b6 38             	movzbl (%eax),%edi
f01066fc:	8b 76 04             	mov    0x4(%esi),%esi
f01066ff:	e8 85 fc ff ff       	call   f0106389 <cpunum>
f0106704:	89 7c 24 0c          	mov    %edi,0xc(%esp)
f0106708:	89 74 24 08          	mov    %esi,0x8(%esp)
f010670c:	89 44 24 04          	mov    %eax,0x4(%esp)
f0106710:	c7 04 24 78 85 10 f0 	movl   $0xf0108578,(%esp)
f0106717:	e8 56 d8 ff ff       	call   f0103f72 <cprintf>
			cpunum(), lk->name, lk->cpu->cpu_id);
		for (i = 0; i < 10 && pcs[i]; i++) {
			struct Eipdebuginfo info;
			if (debuginfo_eip(pcs[i], &info) >= 0)
f010671c:	8d 7d a8             	lea    -0x58(%ebp),%edi
f010671f:	eb 65                	jmp    f0106786 <spin_unlock+0xd3>
f0106721:	89 7c 24 04          	mov    %edi,0x4(%esp)
f0106725:	89 04 24             	mov    %eax,(%esp)
f0106728:	e8 99 ea ff ff       	call   f01051c6 <debuginfo_eip>
f010672d:	85 c0                	test   %eax,%eax
f010672f:	78 39                	js     f010676a <spin_unlock+0xb7>
				cprintf("  %08x %s:%d: %.*s+%x\n", pcs[i],
					info.eip_file, info.eip_line,
					info.eip_fn_namelen, info.eip_fn_name,
					pcs[i] - info.eip_fn_addr);
f0106731:	8b 06                	mov    (%esi),%eax
		cprintf("CPU %d cannot release %s: held by CPU %d\nAcquired at:", 
			cpunum(), lk->name, lk->cpu->cpu_id);
		for (i = 0; i < 10 && pcs[i]; i++) {
			struct Eipdebuginfo info;
...
f0106735:	2b 55 b8             	sub    -0x48(%ebp),%edx
f0106738:	89 54 24 18          	mov    %edx,0x18(%esp)
f010673c:	8b 55 b0             	mov    -0x50(%ebp),%edx
f010673f:	89 54 24 14          	mov    %edx,0x14(%esp)
f0106743:	8b 55 b4             	mov    -0x4c(%ebp),%edx
f0106746:	89 54 24 10          	mov    %edx,0x10(%esp)
f010674a:	8b 55 ac             	mov    -0x54(%ebp),%edx
f010674d:	89 54 24 0c          	mov    %edx,0xc(%esp)
f0106751:	8b 55 a8             	mov    -0x58(%ebp),%edx
f0106754:	89 54 24 08          	mov    %edx,0x8(%esp)
f0106758:	89 44 24 04          	mov    %eax,0x4(%esp)
f010675c:	c7 04 24 c0 85 10 f0 	movl   $0xf01085c0,(%esp)
f0106763:	e8 0a d8 ff ff       	call   f0103f72 <cprintf>
f0106768:	eb 12                	jmp    f010677c <spin_unlock+0xc9>
					info.eip_file, info.eip_line,
					info.eip_fn_namelen, info.eip_fn_name,
					pcs[i] - info.eip_fn_addr);
			else
				cprintf("  %08x\n", pcs[i]);
f010676a:	8b 06                	mov    (%esi),%eax
f010676c:	89 44 24 04          	mov    %eax,0x4(%esp)
f0106770:	c7 04 24 d7 85 10 f0 	movl   $0xf01085d7,(%esp)
f0106777:	e8 f6 d7 ff ff       	call   f0103f72 <cprintf>
f010677c:	83 c3 04             	add    $0x4,%ebx
		uint32_t pcs[10];
		// Nab the acquiring EIP chain before it gets released
		memmove(pcs, lk->pcs, sizeof pcs);
		cprintf("CPU %d cannot release %s: held by CPU %d\nAcquired at:", 
			cpunum(), lk->name, lk->cpu->cpu_id);
		for (i = 0; i < 10 && pcs[i]; i++) {
f010677f:	8d 45 e8             	lea    -0x18(%ebp),%eax
f0106782:	39 c3                	cmp    %eax,%ebx
f0106784:	74 08                	je     f010678e <spin_unlock+0xdb>
f0106786:	89 de                	mov    %ebx,%esi
f0106788:	8b 03                	mov    (%ebx),%eax
f010678a:	85 c0                	test   %eax,%eax
f010678c:	75 93                	jne    f0106721 <spin_unlock+0x6e>
					info.eip_fn_namelen, info.eip_fn_name,
					pcs[i] - info.eip_fn_addr);
			else
				cprintf("  %08x\n", pcs[i]);
		...
		panic("spin_unlock");
f010678e:	c7 44 24 08 df 85 10 	movl   $0xf01085df,0x8(%esp)
f0106795:	f0 
f0106796:	c7 44 24 04 67 00 00 	movl   $0x67,0x4(%esp)
f010679d:	00 
f010679e:	c7 04 24 b0 85 10 f0 	movl   $0xf01085b0,(%esp)
f01067a5:	e8 96 98 ff ff       	call   f0100040 <_panic>
	}

	lk->pcs[0] = 0;
f01067aa:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
	lk->cpu = 0;
f01067b1:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)
f01067b8:	b8 00 00 00 00       	mov    $0x0,%eax
f01067bd:	f0 87 06             	lock xchg %eax,(%esi)
...
f01067c0:	83 c4 6c             	add    $0x6c,%esp
f01067c3:	5b                   	pop    %ebx
f01067c4:	5e                   	pop    %esi
f01067c5:	5f                   	pop    %edi
f01067c6:	5d                   	pop    %ebp
f01067c7:	c3                   	ret    
f01067c8:	66 90                	xchg   %ax,%ax
f01067ca:	66 90                	xchg   %ax,%ax
f01067cc:	66 90                	xchg   %ax,%ax
f01067ce:	66 90                	xchg   %ax,%ax

f01067d0 <__udivdi3>:
f01067d0:	55                   	push   %ebp
f01067d1:	57                   	push   %edi
f01067d2:	56                   	push   %esi
f01067d3:	83 ec 0c             	sub    $0xc,%esp
f01067d6:	8b 44 24 28          	mov    0x28(%esp),%eax
f01067da:	8b 7c 24 1c          	mov    0x1c(%esp),%edi
f01067de:	8b 6c 24 20          	mov    0x20(%esp),%ebp
f01067e2:	8b 4c 24 24          	mov    0x24(%esp),%ecx
f01067e6:	85 c0                	test   %eax,%eax
f01067e8:	89 7c 24 04          	mov    %edi,0x4(%esp)
f01067ec:	89 ea                	mov    %ebp,%edx
f01067ee:	89 0c 24             	mov    %ecx,(%esp)
f01067f1:	75 2d                	jne    f0106820 <__udivdi3+0x50>
f01067f3:	39 e9                	cmp    %ebp,%ecx
f01067f5:	77 61                	ja     f0106858 <__udivdi3+0x88>
f01067f7:	85 c9                	test   %ecx,%ecx
f01067f9:	89 ce                	mov    %ecx,%esi
f01067fb:	75 0b                	jne    f0106808 <__udivdi3+0x38>
f01067fd:	b8 01 00 00 00       	mov    $0x1,%eax
f0106802:	31 d2                	xor    %edx,%edx
f0106804:	f7 f1                	div    %ecx
f0106806:	89 c6                	mov    %eax,%esi
f0106808:	31 d2                	xor    %edx,%edx
f010680a:	89 e8                	mov    %ebp,%eax
f010680c:	f7 f6                	div    %esi
f010680e:	89 c5                	mov    %eax,%ebp
f0106810:	89 f8                	mov    %edi,%eax
f0106812:	f7 f6                	div    %esi
f0106814:	89 ea                	mov    %ebp,%edx
f0106816:	83 c4 0c             	add    $0xc,%esp
f0106819:	5e                   	pop    %esi
f010681a:	5f                   	pop    %edi
f010681b:	5d                   	pop    %ebp
f010681c:	c3                   	ret    
f010681d:	8d 76 00             	lea    0x0(%esi),%esi
f0106820:	39 e8                	cmp    %ebp,%eax
f0106822:	77 24                	ja     f0106848 <__udivdi3+0x78>
f0106824:	0f bd e8             	bsr    %eax,%ebp
f0106827:	83 f5 1f             	xor    $0x1f,%ebp
f010682a:	75 3c                	jne    f0106868 <__udivdi3+0x98>
f010682c:	8b 74 24 04          	mov    0x4(%esp),%esi
f0106830:	39 34 24             	cmp    %esi,(%esp)
f0106833:	0f 86 9f 00 00 00    	jbe    f01068d8 <__udivdi3+0x108>
f0106839:	39 d0                	cmp    %edx,%eax
f010683b:	0f 82 97 00 00 00    	jb     f01068d8 <__udivdi3+0x108>
f0106841:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
f0106848:	31 d2                	xor    %edx,%edx
f010684a:	31 c0                	xor    %eax,%eax
f010684c:	83 c4 0c             	add    $0xc,%esp
f010684f:	5e                   	pop    %esi
f0106850:	5f                   	pop    %edi
f0106851:	5d                   	pop    %ebp
f0106852:	c3                   	ret    
f0106853:	90                   	nop
f0106854:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
f0106858:	89 f8                	mov    %edi,%eax
f010685a:	f7 f1                	div    %ecx
f010685c:	31 d2                	xor    %edx,%edx
f010685e:	83 c4 0c             	add    $0xc,%esp
f0106861:	5e                   	pop    %esi
f0106862:	5f                   	pop    %edi
f0106863:	5d                   	pop    %ebp
f0106864:	c3                   	ret    
f0106865:	8d 76 00             	lea    0x0(%esi),%esi
f0106868:	89 e9                	mov    %ebp,%ecx
f010686a:	8b 3c 24             	mov    (%esp),%edi
f010686d:	d3 e0                	shl    %cl,%eax
f010686f:	89 c6                	mov    %eax,%esi
f0106871:	b8 20 00 00 00       	mov    $0x20,%eax
f0106876:	29 e8                	sub    %ebp,%eax
f0106878:	89 c1                	mov    %eax,%ecx
f010687a:	d3 ef                	shr    %cl,%edi
f010687c:	89 e9                	mov    %ebp,%ecx
f010687e:	89 7c 24 08          	mov    %edi,0x8(%esp)
f0106882:	8b 3c 24             	mov    (%esp),%edi
f0106885:	09 74 24 08          	or     %esi,0x8(%esp)
f0106889:	89 d6                	mov    %edx,%esi
f010688b:	d3 e7                	shl    %cl,%edi
f010688d:	89 c1                	mov    %eax,%ecx
f010688f:	89 3c 24             	mov    %edi,(%esp)
f0106892:	8b 7c 24 04          	mov    0x4(%esp),%edi
f0106896:	d3 ee                	shr    %cl,%esi
f0106898:	89 e9                	mov    %ebp,%ecx
f010689a:	d3 e2                	shl    %cl,%edx
f010689c:	89 c1                	mov    %eax,%ecx
f010689e:	d3 ef                	shr    %cl,%edi
f01068a0:	09 d7                	or     %edx,%edi
f01068a2:	89 f2                	mov    %esi,%edx
f01068a4:	89 f8                	mov    %edi,%eax
f01068a6:	f7 74 24 08          	divl   0x8(%esp)
f01068aa:	89 d6                	mov    %edx,%esi
f01068ac:	89 c7                	mov    %eax,%edi
f01068ae:	f7 24 24             	mull   (%esp)
f01068b1:	39 d6                	cmp    %edx,%esi
f01068b3:	89 14 24             	mov    %edx,(%esp)
f01068b6:	72 30                	jb     f01068e8 <__udivdi3+0x118>
f01068b8:	8b 54 24 04          	mov    0x4(%esp),%edx
f01068bc:	89 e9                	mov    %ebp,%ecx
f01068be:	d3 e2                	shl    %cl,%edx
f01068c0:	39 c2                	cmp    %eax,%edx
f01068c2:	73 05                	jae    f01068c9 <__udivdi3+0xf9>
f01068c4:	3b 34 24             	cmp    (%esp),%esi
f01068c7:	74 1f                	je     f01068e8 <__udivdi3+0x118>
f01068c9:	89 f8                	mov    %edi,%eax
f01068cb:	31 d2                	xor    %edx,%edx
f01068cd:	e9 7a ff ff ff       	jmp    f010684c <__udivdi3+0x7c>
f01068d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
f01068d8:	31 d2                	xor    %edx,%edx
f01068da:	b8 01 00 00 00       	mov    $0x1,%eax
f01068df:	e9 68 ff ff ff       	jmp    f010684c <__udivdi3+0x7c>
f01068e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
f01068e8:	8d 47 ff             	lea    -0x1(%edi),%eax
f01068eb:	31 d2                	xor    %edx,%edx
f01068ed:	83 c4 0c             	add    $0xc,%esp
f01068f0:	5e                   	pop    %esi
f01068f1:	5f                   	pop    %edi
f01068f2:	5d                   	pop    %ebp
f01068f3:	c3                   	ret    
f01068f4:	66 90                	xchg   %ax,%ax
f01068f6:	66 90                	xchg   %ax,%ax
f01068f8:	66 90                	xchg   %ax,%ax
...
f0106903:	83 ec 14             	sub    $0x14,%esp
f0106906:	8b 44 24 28          	mov    0x28(%esp),%eax
f010690a:	8b 4c 24 24          	mov    0x24(%esp),%ecx
f010690e:	8b 74 24 2c          	mov    0x2c(%esp),%esi
f0106912:	89 c7                	mov    %eax,%edi
f0106914:	89 44 24 04          	mov    %eax,0x4(%esp)
f0106918:	8b 44 24 30          	mov    0x30(%esp),%eax
f010691c:	89 4c 24 10          	mov    %ecx,0x10(%esp)
f0106920:	89 34 24             	mov    %esi,(%esp)
f0106923:	89 4c 24 08          	mov    %ecx,0x8(%esp)
f0106927:	85 c0                	test   %eax,%eax
f0106929:	89 c2                	mov    %eax,%edx
f010692b:	89 7c 24 0c          	mov    %edi,0xc(%esp)
f010692f:	75 17                	jne    f0106948 <__umoddi3+0x48>
f0106931:	39 fe                	cmp    %edi,%esi
f0106933:	76 4b                	jbe    f0106980 <__umoddi3+0x80>
f0106935:	89 c8                	mov    %ecx,%eax
f0106937:	89 fa                	mov    %edi,%edx
f0106939:	f7 f6                	div    %esi
f010693b:	89 d0                	mov    %edx,%eax
f010693d:	31 d2                	xor    %edx,%edx
f010693f:	83 c4 14             	add    $0x14,%esp
f0106942:	5e                   	pop    %esi
f0106943:	5f                   	pop    %edi
f0106944:	5d                   	pop    %ebp
f0106945:	c3                   	ret    
f0106946:	66 90                	xchg   %ax,%ax
f0106948:	39 f8                	cmp    %edi,%eax
f010694a:	77 54                	ja     f01069a0 <__umoddi3+0xa0>
f010694c:	0f bd e8             	bsr    %eax,%ebp
f010694f:	83 f5 1f             	xor    $0x1f,%ebp
f0106952:	75 5c                	jne    f01069b0 <__umoddi3+0xb0>
f0106954:	8b 7c 24 08          	mov    0x8(%esp),%edi
f0106958:	39 3c 24             	cmp    %edi,(%esp)
f010695b:	0f 87 e7 00 00 00    	ja     f0106a48 <__umoddi3+0x148>
f0106961:	8b 7c 24 04          	mov    0x4(%esp),%edi
f0106965:	29 f1                	sub    %esi,%ecx
f0106967:	19 c7                	sbb    %eax,%edi
f0106969:	89 4c 24 08          	mov    %ecx,0x8(%esp)
f010696d:	89 7c 24 0c          	mov    %edi,0xc(%esp)
f0106971:	8b 44 24 08          	mov    0x8(%esp),%eax
f0106975:	8b 54 24 0c          	mov    0xc(%esp),%edx
f0106979:	83 c4 14             	add    $0x14,%esp
f010697c:	5e                   	pop    %esi
f010697d:	5f                   	pop    %edi
f010697e:	5d                   	pop    %ebp
f010697f:	c3                   	ret    
f0106980:	85 f6                	test   %esi,%esi
f0106982:	89 f5                	mov    %esi,%ebp
f0106984:	75 0b                	jne    f0106991 <__umoddi3+0x91>
f0106986:	b8 01 00 00 00       	mov    $0x1,%eax
f010698b:	31 d2                	xor    %edx,%edx
f010698d:	f7 f6                	div    %esi
f010698f:	89 c5                	mov    %eax,%ebp
f0106991:	8b 44 24 04          	mov    0x4(%esp),%eax
f0106995:	31 d2                	xor    %edx,%edx
f0106997:	f7 f5                	div    %ebp
f0106999:	89 c8                	mov    %ecx,%eax
f010699b:	f7 f5                	div    %ebp
f010699d:	eb 9c                	jmp    f010693b <__umoddi3+0x3b>
f010699f:	90                   	nop
f01069a0:	89 c8                	mov    %ecx,%eax
f01069a2:	89 fa                	mov    %edi,%edx
f01069a4:	83 c4 14             	add    $0x14,%esp
f01069a7:	5e                   	pop    %esi
f01069a8:	5f                   	pop    %edi
f01069a9:	5d                   	pop    %ebp
f01069aa:	c3                   	ret    
...
f01069b0:	8b 04 24             	mov    (%esp),%eax
f01069b3:	be 20 00 00 00       	mov    $0x20,%esi
f01069b8:	89 e9                	mov    %ebp,%ecx
f01069ba:	29 ee                	sub    %ebp,%esi
f01069bc:	d3 e2                	shl    %cl,%edx
f01069be:	89 f1                	mov    %esi,%ecx
f01069c0:	d3 e8                	shr    %cl,%eax
f01069c2:	89 e9                	mov    %ebp,%ecx
f01069c4:	89 44 24 04          	mov    %eax,0x4(%esp)
f01069c8:	8b 04 24             	mov    (%esp),%eax
f01069cb:	09 54 24 04          	or     %edx,0x4(%esp)
f01069cf:	89 fa                	mov    %edi,%edx
f01069d1:	d3 e0                	shl    %cl,%eax
f01069d3:	89 f1                	mov    %esi,%ecx
f01069d5:	89 44 24 08          	mov    %eax,0x8(%esp)
f01069d9:	8b 44 24 10          	mov    0x10(%esp),%eax
f01069dd:	d3 ea                	shr    %cl,%edx
f01069df:	89 e9                	mov    %ebp,%ecx
f01069e1:	d3 e7                	shl    %cl,%edi
f01069e3:	89 f1                	mov    %esi,%ecx
f01069e5:	d3 e8                	shr    %cl,%eax
f01069e7:	89 e9                	mov    %ebp,%ecx
f01069e9:	09 f8                	or     %edi,%eax
f01069eb:	8b 7c 24 10          	mov    0x10(%esp),%edi
f01069ef:	f7 74 24 04          	divl   0x4(%esp)
f01069f3:	d3 e7                	shl    %cl,%edi
f01069f5:	89 7c 24 0c          	mov    %edi,0xc(%esp)
f01069f9:	89 d7                	mov    %edx,%edi
f01069fb:	f7 64 24 08          	mull   0x8(%esp)
f01069ff:	39 d7                	cmp    %edx,%edi
f0106a01:	89 c1                	mov    %eax,%ecx
f0106a03:	89 14 24             	mov    %edx,(%esp)
f0106a06:	72 2c                	jb     f0106a34 <__umoddi3+0x134>
f0106a08:	39 44 24 0c          	cmp    %eax,0xc(%esp)
f0106a0c:	72 22                	jb     f0106a30 <__umoddi3+0x130>
f0106a0e:	8b 44 24 0c          	mov    0xc(%esp),%eax
f0106a12:	29 c8                	sub    %ecx,%eax
f0106a14:	19 d7                	sbb    %edx,%edi
f0106a16:	89 e9                	mov    %ebp,%ecx
f0106a18:	89 fa                	mov    %edi,%edx
f0106a1a:	d3 e8                	shr    %cl,%eax
f0106a1c:	89 f1                	mov    %esi,%ecx
f0106a1e:	d3 e2                	shl    %cl,%edx
f0106a20:	89 e9                	mov    %ebp,%ecx
f0106a22:	d3 ef                	shr    %cl,%edi
f0106a24:	09 d0                	or     %edx,%eax
f0106a26:	89 fa                	mov    %edi,%edx
f0106a28:	83 c4 14             	add    $0x14,%esp
f0106a2b:	5e                   	pop    %esi
f0106a2c:	5f                   	pop    %edi
f0106a2d:	5d                   	pop    %ebp
f0106a2e:	c3                   	ret    
f0106a2f:	90                   	nop
f0106a30:	39 d7                	cmp    %edx,%edi
f0106a32:	75 da                	jne    f0106a0e <__umoddi3+0x10e>
f0106a34:	8b 14 24             	mov    (%esp),%edx
f0106a37:	89 c1                	mov    %eax,%ecx
f0106a39:	2b 4c 24 08          	sub    0x8(%esp),%ecx
f0106a3d:	1b 54 24 04          	sbb    0x4(%esp),%edx
f0106a41:	eb cb                	jmp    f0106a0e <__umoddi3+0x10e>
f0106a43:	90                   	nop
f0106a44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
f0106a48:	3b 44 24 0c          	cmp    0xc(%esp),%eax
f0106a4c:	0f 82 0f ff ff ff    	jb     f0106961 <__umoddi3+0x61>
f0106a52:	e9 1a ff ff ff       	jmp    f0106971 <__umoddi3+0x71>
