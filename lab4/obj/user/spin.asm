...
umain(int argc, char **argv)
{
  ...
  800047:	c7 04 24 40 16 80 00 	movl   $0x801640,(%esp)
  80004e:	e8 74 01 00 00       	call   8001c7 <cprintf>
	if ((env = fork()) == 0) {
  800053:	e8 bb 0f 00 00       	call   801013 <fork>
  800058:	89 c3                	mov    %eax,%ebx
  80005a:	85 c0                	test   %eax,%eax
  80005c:	75 0e                	jne    80006c <umain+0x2c>
		cprintf("I am the child.  Spinning...\n");
  80005e:	c7 04 24 b8 16 80 00 	movl   $0x8016b8,(%esp)
  ...
  80006c:	c7 04 24 68 16 80 00 	movl   $0x801668,(%esp)
  ...
  8000a5:	c7 04 24 90 16 80 00 	movl   $0x801690,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024b:	e8 30 11 00 00       	call   801380 <__udivdi3>
  ...
  8002a0:	e8 0b 12 00 00       	call   8014b0 <__umoddi3>
  8002a5:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002a9:	0f be 80 e0 16 80 00 	movsbl 0x8016e0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003d2:	ff 24 95 a0 17 80 00 	jmp    *0x8017a0(,%edx,4)
  ...
  8004aa:	c7 44 24 08 01 17 80 	movl   $0x801701,0x8(%esp)
  8004b1:	00 
  ...
  8004df:	ba f1 16 80 00       	mov    $0x8016f1,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800bda:	00 
  800bdb:	c7 44 24 08 28 19 80 	movl   $0x801928,0x8(%esp)
  800be2:	00 
  800be3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bea:	00 
  800beb:	c7 04 24 45 19 80 00 	movl   $0x801945,(%esp)
  800bf2:	e8 51 06 00 00       	call   801248 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c99:	00 
  800c9a:	c7 44 24 08 28 19 80 	movl   $0x801928,0x8(%esp)
  800ca1:	00 
  800ca2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca9:	00 
  800caa:	c7 04 24 45 19 80 00 	movl   $0x801945,(%esp)
  800cb1:	e8 92 05 00 00       	call   801248 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cf7:	00 
  800cf8:	c7 44 24 08 28 19 80 	movl   $0x801928,0x8(%esp)
  800cff:	00 
  800d00:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d07:	00 
  800d08:	c7 04 24 45 19 80 00 	movl   $0x801945,(%esp)
  800d0f:	e8 34 05 00 00       	call   801248 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d55:	00 
  800d56:	c7 44 24 08 28 19 80 	movl   $0x801928,0x8(%esp)
  800d5d:	00 
  800d5e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d65:	00 
  800d66:	c7 04 24 45 19 80 00 	movl   $0x801945,(%esp)
  800d6d:	e8 d6 04 00 00       	call   801248 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800db3:	00 
  800db4:	c7 44 24 08 28 19 80 	movl   $0x801928,0x8(%esp)
  800dbb:	00 
  800dbc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dc3:	00 
  800dc4:	c7 04 24 45 19 80 00 	movl   $0x801945,(%esp)
  800dcb:	e8 78 04 00 00       	call   801248 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e11:	00 
  800e12:	c7 44 24 08 28 19 80 	movl   $0x801928,0x8(%esp)
  800e19:	00 
  800e1a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e21:	00 
  800e22:	c7 04 24 45 19 80 00 	movl   $0x801945,(%esp)
  800e29:	e8 1a 04 00 00       	call   801248 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800ea2:	00 
  800ea3:	c7 44 24 08 28 19 80 	movl   $0x801928,0x8(%esp)
  800eaa:	00 
  800eab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eb2:	00 
  800eb3:	c7 04 24 45 19 80 00 	movl   $0x801945,(%esp)
  800eba:	e8 89 03 00 00       	call   801248 <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800edd:	75 1c                	jne    800efb <pgfault+0x2f>
		 panic("The err is not right of the pgfault\n");
  800edf:	c7 44 24 08 54 19 80 	movl   $0x801954,0x8(%esp)
  800ee6:	00 
  800ee7:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800eee:	00 
  800eef:	c7 04 24 c2 1a 80 00 	movl   $0x801ac2,(%esp)
  800ef6:	e8 4d 03 00 00       	call   801248 <_panic>
  ...
  800f0a:	75 1c                	jne    800f28 <pgfault+0x5c>
		panic("The pgfault perm is not right\n");
  800f0c:	c7 44 24 08 7c 19 80 	movl   $0x80197c,0x8(%esp)
  800f13:	00 
  800f14:	c7 44 24 04 21 00 00 	movl   $0x21,0x4(%esp)
  800f1b:	00 
  800f1c:	c7 04 24 c2 1a 80 00 	movl   $0x801ac2,(%esp)
  800f23:	e8 20 03 00 00       	call   801248 <_panic>
  ...
  800f28:	e8 d7 fc ff ff       	call   800c04 <sys_getenvid>
  800f2d:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800f34:	00 
  800f35:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f3c:	00 
  800f3d:	89 04 24             	mov    %eax,(%esp)
  800f40:	e8 1f fd ff ff       	call   800c64 <sys_page_alloc>
  800f45:	85 c0                	test   %eax,%eax
  800f47:	79 1c                	jns    800f65 <pgfault+0x99>
		panic("pgfault sys_page_alloc is not right\n");
  800f49:	c7 44 24 08 9c 19 80 	movl   $0x80199c,0x8(%esp)
  800f50:	00 
  800f51:	c7 44 24 04 2b 00 00 	movl   $0x2b,0x4(%esp)
  800f58:	00 
  800f59:	c7 04 24 c2 1a 80 00 	movl   $0x801ac2,(%esp)
  800f60:	e8 e3 02 00 00       	call   801248 <_panic>
	addr = ROUNDDOWN(addr, PGSIZE);
  800f65:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
	memcpy((void*)PFTEMP, addr, PGSIZE);
  800f6b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  800f72:	00 
  800f73:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800f77:	c7 04 24 00 f0 7f 00 	movl   $0x7ff000,(%esp)
  800f7e:	e8 74 fa ff ff       	call   8009f7 <memcpy>

	if((r = sys_page_map(sys_getenvid(), (void*)PFTEMP, sys_getenvid(), addr, PTE_U|PTE_W|PTE_P)) < 0)
  800f83:	e8 7c fc ff ff       	call   800c04 <sys_getenvid>
  800f88:	89 c6                	mov    %eax,%esi
  800f8a:	e8 75 fc ff ff       	call   800c04 <sys_getenvid>
  ...
  800faa:	e8 14 fd ff ff       	call   800cc3 <sys_page_map>
  800faf:	85 c0                	test   %eax,%eax
  800fb1:	79 20                	jns    800fd3 <pgfault+0x107>
		panic("The sys_page_map is not right, the errno is %d\n", r);
  800fb3:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800fb7:	c7 44 24 08 c4 19 80 	movl   $0x8019c4,0x8(%esp)
  800fbe:	00 
  800fbf:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  800fc6:	00 
  800fc7:	c7 04 24 c2 1a 80 00 	movl   $0x801ac2,(%esp)
  800fce:	e8 75 02 00 00       	call   801248 <_panic>
	if( (r = sys_page_unmap(sys_getenvid(), (void*)PFTEMP)) <0 )
  800fd3:	e8 2c fc ff ff       	call   800c04 <sys_getenvid>
  800fd8:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800fdf:	00 
  800fe0:	89 04 24             	mov    %eax,(%esp)
  800fe3:	e8 39 fd ff ff       	call   800d21 <sys_page_unmap>
  800fe8:	85 c0                	test   %eax,%eax
  800fea:	79 20                	jns    80100c <pgfault+0x140>
		panic("The sys_page_unmap is not right, the errno is %d\n",r);
  800fec:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800ff0:	c7 44 24 08 f4 19 80 	movl   $0x8019f4,0x8(%esp)
  800ff7:	00 
  800ff8:	c7 44 24 04 32 00 00 	movl   $0x32,0x4(%esp)
  800fff:	00 
  801000:	c7 04 24 c2 1a 80 00 	movl   $0x801ac2,(%esp)
  801007:	e8 3c 02 00 00       	call   801248 <_panic>
...
fork(void)
{
  ...
  801017:	56                   	push   %esi
  801018:	53                   	push   %ebx
  801019:	83 ec 3c             	sub    $0x3c,%esp
	// LAB 4: Your code here.
	
	extern void*  _pgfault_upcall();
	//build the experition stack for the parent env
	set_pgfault_handler(pgfault);
  80101c:	c7 04 24 cc 0e 80 00 	movl   $0x800ecc,(%esp)
  801023:	e8 78 02 00 00       	call   8012a0 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  801028:	ba 07 00 00 00       	mov    $0x7,%edx
  ...
  801039:	79 20                	jns    80105b <fork+0x48>
		panic("sys_exofork() is not right, and the errno is  %d\n",childEid);
  80103b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80103f:	c7 44 24 08 28 1a 80 	movl   $0x801a28,0x8(%esp)
  801046:	00 
  801047:	c7 44 24 04 7a 00 00 	movl   $0x7a,0x4(%esp)
  80104e:	00 
  80104f:	c7 04 24 c2 1a 80 00 	movl   $0x801ac2,(%esp)
  801056:	e8 ed 01 00 00       	call   801248 <_panic>
	if(childEid == 0){
  80105b:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
  80105f:	75 1c                	jne    80107d <fork+0x6a>
		thisenv = &envs[ENVX(sys_getenvid())];
  801061:	e8 9e fb ff ff       	call   800c04 <sys_getenvid>
  801066:	25 ff 03 00 00       	and    $0x3ff,%eax
  80106b:	6b c0 7c             	imul   $0x7c,%eax,%eax
  80106e:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801073:	a3 04 20 80 00       	mov    %eax,0x802004
		return childEid;
  801078:	e9 9d 01 00 00       	jmp    80121a <fork+0x207>
	}

	int r = sys_env_set_pgfault_upcall(childEid,  _pgfault_upcall);
  80107d:	c7 44 24 04 38 13 80 	movl   $0x801338,0x4(%esp)
  801084:	00 
  801085:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801088:	89 04 24             	mov    %eax,(%esp)
  80108b:	e8 4d fd ff ff       	call   800ddd <sys_env_set_pgfault_upcall>
  801090:	89 c6                	mov    %eax,%esi
	if(r < 0)
  801092:	85 c0                	test   %eax,%eax
  801094:	79 20                	jns    8010b6 <fork+0xa3>
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
  801096:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80109a:	c7 44 24 08 5c 1a 80 	movl   $0x801a5c,0x8(%esp)
  8010a1:	00 
  8010a2:	c7 44 24 04 82 00 00 	movl   $0x82,0x4(%esp)
  8010a9:	00 
  8010aa:	c7 04 24 c2 1a 80 00 	movl   $0x801ac2,(%esp)
  8010b1:	e8 92 01 00 00       	call   801248 <_panic>
		thisenv = &envs[ENVX(sys_getenvid())];
		return childEid;
	}
	...
	int r = sys_env_set_pgfault_upcall(childEid,  _pgfault_upcall);
	if(r < 0)
  8010b6:	bb 00 10 00 00       	mov    $0x1000,%ebx
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
  ...
  8010c5:	eb 04                	jmp    8010cb <fork+0xb8>
  ...
  8010d9:	0f 84 f5 00 00 00    	je     8011d4 <fork+0x1c1>
				( (uvpt[PGNUM(pn*PGSIZE)] & PTE_U) != 0) &&
  8010df:	c1 ea 0c             	shr    $0xc,%edx
  8010e2:	8b 04 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%eax
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
	...
	for(pn=0; pn*PGSIZE < UTOP ; pn++){
		if ( ( 	(uvpd[PDX(pn*PGSIZE)] & PTE_P) != 0) &&
  8010e9:	a8 04                	test   $0x4,%al
  8010eb:	0f 84 e3 00 00 00    	je     8011d4 <fork+0x1c1>
				( (uvpt[PGNUM(pn*PGSIZE)] & PTE_U) != 0) &&
				( (uvpt[PGNUM(pn*PGSIZE)] & PTE_P) != 0))
  8010f1:	8b 04 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%eax
  ...
  8010fa:	0f 84 d4 00 00 00    	je     8011d4 <fork+0x1c1>
				( (uvpt[PGNUM(pn*PGSIZE)] & PTE_P) != 0))
		{
		//build experition stack for the child env
			if(pn*PGSIZE == UXSTACKTOP -PGSIZE)
  801100:	81 f9 00 f0 bf ee    	cmp    $0xeebff000,%ecx
  801106:	75 20                	jne    801128 <fork+0x115>
				sys_page_alloc(childEid, (void*) (pn*PGSIZE), PTE_U| PTE_W | PTE_P);
  801108:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  80110f:	00 
  801110:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  801117:	ee 
  801118:	8b 55 e0             	mov    -0x20(%ebp),%edx
  80111b:	89 14 24             	mov    %edx,(%esp)
  80111e:	e8 41 fb ff ff       	call   800c64 <sys_page_alloc>
  801123:	e9 88 00 00 00       	jmp    8011b0 <fork+0x19d>
duppage(envid_t envid, unsigned pn)
{
  ...
  801128:	8d 83 00 f0 ff ff    	lea    -0x1000(%ebx),%eax
  80112e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  801131:	c1 e8 0c             	shr    $0xc,%eax
  801134:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	int perm = PTE_U|PTE_P;
	if((PTE & PTE_W) || (PTE & PTE_COW))
  80113b:	25 02 08 00 00       	and    $0x802,%eax
{
	int r;
  ...
  801143:	19 ff                	sbb    %edi,%edi
  801145:	81 e7 00 f8 ff ff    	and    $0xfffff800,%edi
  80114b:	81 c7 05 08 00 00    	add    $0x805,%edi
	if((PTE & PTE_W) || (PTE & PTE_COW))
		perm |= PTE_COW;
	
	if( (	r =sys_page_map(sys_getenvid(), (void*)(pn*PGSIZE), envid, (void*)(pn*PGSIZE), perm)) 
  801151:	e8 ae fa ff ff       	call   800c04 <sys_getenvid>
  801156:	89 7c 24 10          	mov    %edi,0x10(%esp)
  80115a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  80115d:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801161:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801164:	89 54 24 08          	mov    %edx,0x8(%esp)
  801168:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  80116b:	89 54 24 04          	mov    %edx,0x4(%esp)
  80116f:	89 04 24             	mov    %eax,(%esp)
  801172:	e8 4c fb ff ff       	call   800cc3 <sys_page_map>
  801177:	89 c6                	mov    %eax,%esi
  801179:	85 c0                	test   %eax,%eax
  80117b:	78 33                	js     8011b0 <fork+0x19d>
						<0)  
		return r;

	if( (	r =sys_page_map(sys_getenvid(), (void*)(pn*PGSIZE), sys_getenvid(), (void*)(pn*PGSIZE), perm)) 
  80117d:	e8 82 fa ff ff       	call   800c04 <sys_getenvid>
  801182:	89 c6                	mov    %eax,%esi
  801184:	e8 7b fa ff ff       	call   800c04 <sys_getenvid>
  801189:	89 7c 24 10          	mov    %edi,0x10(%esp)
  80118d:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801190:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801194:	89 74 24 08          	mov    %esi,0x8(%esp)
  801198:	89 54 24 04          	mov    %edx,0x4(%esp)
  80119c:	89 04 24             	mov    %eax,(%esp)
  80119f:	e8 1f fb ff ff       	call   800cc3 <sys_page_map>
  ...
  8011ad:	0f 49 f0             	cmovns %eax,%esi
		//build experition stack for the child env
			if(pn*PGSIZE == UXSTACKTOP -PGSIZE)
				sys_page_alloc(childEid, (void*) (pn*PGSIZE), PTE_U| PTE_W | PTE_P);
			else
  ...
  8011b2:	79 20                	jns    8011d4 <fork+0x1c1>
				panic("fork() is wrong, and the errno is %d\n", r) ;
  8011b4:	89 74 24 0c          	mov    %esi,0xc(%esp)
  8011b8:	c7 44 24 08 9c 1a 80 	movl   $0x801a9c,0x8(%esp)
  8011bf:	00 
  8011c0:	c7 44 24 04 91 00 00 	movl   $0x91,0x4(%esp)
  8011c7:	00 
  8011c8:	c7 04 24 c2 1a 80 00 	movl   $0x801ac2,(%esp)
  8011cf:	e8 74 00 00 00       	call   801248 <_panic>
	if(r < 0)
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
	...
	int pn =0;
	for(pn=0; pn*PGSIZE < UTOP ; pn++){
  8011d4:	89 d9                	mov    %ebx,%ecx
  8011d6:	8d 83 00 10 00 00    	lea    0x1000(%ebx),%eax
  8011dc:	3d 00 10 c0 ee       	cmp    $0xeec01000,%eax
  8011e1:	0f 85 e0 fe ff ff    	jne    8010c7 <fork+0xb4>
				r = duppage(childEid, pn);
			if(r <0)
				panic("fork() is wrong, and the errno is %d\n", r) ;
		}
  ...
  8011f5:	e8 85 fb ff ff       	call   800d7f <sys_env_set_status>
  8011fa:	85 c0                	test   %eax,%eax
  8011fc:	79 1c                	jns    80121a <fork+0x207>
		panic("sys_env_set_status");
  8011fe:	c7 44 24 08 cd 1a 80 	movl   $0x801acd,0x8(%esp)
  801205:	00 
  801206:	c7 44 24 04 95 00 00 	movl   $0x95,0x4(%esp)
  80120d:	00 
  80120e:	c7 04 24 c2 1a 80 00 	movl   $0x801ac2,(%esp)
  801215:	e8 2e 00 00 00       	call   801248 <_panic>
	return childEid;
}
  80121a:	8b 45 dc             	mov    -0x24(%ebp),%eax
  80121d:	83 c4 3c             	add    $0x3c,%esp
  801220:	5b                   	pop    %ebx
  801221:	5e                   	pop    %esi
  801222:	5f                   	pop    %edi
  801223:	5d                   	pop    %ebp
...
sfork(void)
{
  ...
  80122b:	c7 44 24 08 e0 1a 80 	movl   $0x801ae0,0x8(%esp)
  801232:	00 
  801233:	c7 44 24 04 9d 00 00 	movl   $0x9d,0x4(%esp)
  80123a:	00 
  80123b:	c7 04 24 c2 1a 80 00 	movl   $0x801ac2,(%esp)
  801242:	e8 01 00 00 00       	call   801248 <_panic>
	...
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801259:	e8 a6 f9 ff ff       	call   800c04 <sys_getenvid>
  ...
  801274:	c7 04 24 f8 1a 80 00 	movl   $0x801af8,(%esp)
  80127b:	e8 47 ef ff ff       	call   8001c7 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801280:	89 74 24 04          	mov    %esi,0x4(%esp)
  801284:	8b 45 10             	mov    0x10(%ebp),%eax
  801287:	89 04 24             	mov    %eax,(%esp)
  80128a:	e8 d7 ee ff ff       	call   800166 <vcprintf>
	cprintf("\n");
  80128f:	c7 04 24 d4 16 80 00 	movl   $0x8016d4,(%esp)
  801296:	e8 2c ef ff ff       	call   8001c7 <cprintf>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8012a6:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  8012ad:	75 44                	jne    8012f3 <set_pgfault_handler+0x53>
		// First time through!
		// LAB 4: Your code here.
  ...
  8012ca:	e8 95 f9 ff ff       	call   800c64 <sys_page_alloc>
		if( r < 0)
  8012cf:	85 c0                	test   %eax,%eax
  8012d1:	79 20                	jns    8012f3 <set_pgfault_handler+0x53>
			panic("No memory for the UxStack, the mistake is %d\n",r);
  8012d3:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8012d7:	c7 44 24 08 1c 1b 80 	movl   $0x801b1c,0x8(%esp)
  8012de:	00 
  8012df:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8012e6:	00 
  8012e7:	c7 04 24 78 1b 80 00 	movl   $0x801b78,(%esp)
  8012ee:	e8 55 ff ff ff       	call   801248 <_panic>
  ...
  8012fb:	e8 04 f9 ff ff       	call   800c04 <sys_getenvid>
  801300:	c7 44 24 04 38 13 80 	movl   $0x801338,0x4(%esp)
  801307:	00 
  801308:	89 04 24             	mov    %eax,(%esp)
  80130b:	e8 cd fa ff ff       	call   800ddd <sys_env_set_pgfault_upcall>
  801310:	85 c0                	test   %eax,%eax
  801312:	79 20                	jns    801334 <set_pgfault_handler+0x94>
		panic("sys_env_set_pgfault_upcall is not right %d\n", r);
  801314:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801318:	c7 44 24 08 4c 1b 80 	movl   $0x801b4c,0x8(%esp)
  80131f:	00 
  801320:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  801327:	00 
  801328:	c7 04 24 78 1b 80 00 	movl   $0x801b78,(%esp)
  80132f:	e8 14 ff ff ff       	call   801248 <_panic>
...
_pgfault_upcall:
  ...
  801339:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  801340:	83 c4 04             	add    $0x4,%esp
	...
	//	trap-eip -> eax
		movl 0x28(%esp), %eax
  801343:	8b 44 24 28          	mov    0x28(%esp),%eax
	//	trap-ebp-> ebx		
		movl 0x10(%esp), %ebx
  801347:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	//  trap->esp -> ecx 
		movl 0x30(%esp), %ecx
  80134b:	8b 4c 24 30          	mov    0x30(%esp),%ecx

		movl %eax, -0x4(%ecx)
  80134f:	89 41 fc             	mov    %eax,-0x4(%ecx)
		movl %ebx, -0x8(%ecx)
  801352:	89 59 f8             	mov    %ebx,-0x8(%ecx)

		leal -0x8(%ecx), %ebp
  801355:	8d 69 f8             	lea    -0x8(%ecx),%ebp

		movl 0x8(%esp), %edi
  801358:	8b 7c 24 08          	mov    0x8(%esp),%edi
		movl 0xc(%esp),	%esi
  80135c:	8b 74 24 0c          	mov    0xc(%esp),%esi
		movl 0x18(%esp),%ebx
  801360:	8b 5c 24 18          	mov    0x18(%esp),%ebx
		movl 0x1c(%esp),%edx
  801364:	8b 54 24 1c          	mov    0x1c(%esp),%edx
		movl 0x20(%esp),%ecx
  801368:	8b 4c 24 20          	mov    0x20(%esp),%ecx
		movl 0x24(%esp),%eax
  80136c:	8b 44 24 24          	mov    0x24(%esp),%eax
	...
	// LAB 4: Your code here.
		leal 0x2c(%esp), %esp
  801370:	8d 64 24 2c          	lea    0x2c(%esp),%esp
		popf
  801374:	9d                   	popf   
...
00801380 <__udivdi3>:
  ...
  801383:	89 7c 24 14          	mov    %edi,0x14(%esp)
  801387:	8b 7c 24 2c          	mov    0x2c(%esp),%edi
  80138b:	8b 44 24 20          	mov    0x20(%esp),%eax
  80138f:	8b 4c 24 28          	mov    0x28(%esp),%ecx
  801393:	89 74 24 10          	mov    %esi,0x10(%esp)
  801397:	8b 74 24 24          	mov    0x24(%esp),%esi
  80139b:	85 ff                	test   %edi,%edi
  80139d:	89 6c 24 18          	mov    %ebp,0x18(%esp)
  8013a1:	89 44 24 08          	mov    %eax,0x8(%esp)
  8013a5:	89 cd                	mov    %ecx,%ebp
  8013a7:	89 44 24 04          	mov    %eax,0x4(%esp)
  8013ab:	75 33                	jne    8013e0 <__udivdi3+0x60>
  8013ad:	39 f1                	cmp    %esi,%ecx
  8013af:	77 57                	ja     801408 <__udivdi3+0x88>
  8013b1:	85 c9                	test   %ecx,%ecx
  8013b3:	75 0b                	jne    8013c0 <__udivdi3+0x40>
  8013b5:	b8 01 00 00 00       	mov    $0x1,%eax
  8013ba:	31 d2                	xor    %edx,%edx
  8013bc:	f7 f1                	div    %ecx
  8013be:	89 c1                	mov    %eax,%ecx
  ...
  8013e6:	77 e8                	ja     8013d0 <__udivdi3+0x50>
  8013e8:	0f bd cf             	bsr    %edi,%ecx
  8013eb:	83 f1 1f             	xor    $0x1f,%ecx
  8013ee:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  8013f2:	75 2c                	jne    801420 <__udivdi3+0xa0>
  8013f4:	3b 6c 24 08          	cmp    0x8(%esp),%ebp
  8013f8:	76 04                	jbe    8013fe <__udivdi3+0x7e>
  8013fa:	39 f7                	cmp    %esi,%edi
  8013fc:	73 d2                	jae    8013d0 <__udivdi3+0x50>
  8013fe:	31 d2                	xor    %edx,%edx
  801400:	b8 01 00 00 00       	mov    $0x1,%eax
  801405:	eb c9                	jmp    8013d0 <__udivdi3+0x50>
  801407:	90                   	nop
  801408:	89 f2                	mov    %esi,%edx
  80140a:	f7 f1                	div    %ecx
  80140c:	31 d2                	xor    %edx,%edx
  80140e:	8b 74 24 10          	mov    0x10(%esp),%esi
  801412:	8b 7c 24 14          	mov    0x14(%esp),%edi
  801416:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  80141a:	83 c4 1c             	add    $0x1c,%esp
  80141d:	c3                   	ret    
  80141e:	66 90                	xchg   %ax,%ax
  801420:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  801425:	b8 20 00 00 00       	mov    $0x20,%eax
  80142a:	89 ea                	mov    %ebp,%edx
  80142c:	2b 44 24 04          	sub    0x4(%esp),%eax
  801430:	d3 e7                	shl    %cl,%edi
  801432:	89 c1                	mov    %eax,%ecx
  801434:	d3 ea                	shr    %cl,%edx
  801436:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  80143b:	09 fa                	or     %edi,%edx
  80143d:	89 f7                	mov    %esi,%edi
  80143f:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801443:	89 f2                	mov    %esi,%edx
  801445:	8b 74 24 08          	mov    0x8(%esp),%esi
  801449:	d3 e5                	shl    %cl,%ebp
  80144b:	89 c1                	mov    %eax,%ecx
  80144d:	d3 ef                	shr    %cl,%edi
  80144f:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  801454:	d3 e2                	shl    %cl,%edx
  801456:	89 c1                	mov    %eax,%ecx
  801458:	d3 ee                	shr    %cl,%esi
  80145a:	09 d6                	or     %edx,%esi
  80145c:	89 fa                	mov    %edi,%edx
  80145e:	89 f0                	mov    %esi,%eax
  801460:	f7 74 24 0c          	divl   0xc(%esp)
  801464:	89 d7                	mov    %edx,%edi
  801466:	89 c6                	mov    %eax,%esi
  801468:	f7 e5                	mul    %ebp
  80146a:	39 d7                	cmp    %edx,%edi
  80146c:	72 22                	jb     801490 <__udivdi3+0x110>
  80146e:	8b 6c 24 08          	mov    0x8(%esp),%ebp
  801472:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  801477:	d3 e5                	shl    %cl,%ebp
  801479:	39 c5                	cmp    %eax,%ebp
  80147b:	73 04                	jae    801481 <__udivdi3+0x101>
  80147d:	39 d7                	cmp    %edx,%edi
  80147f:	74 0f                	je     801490 <__udivdi3+0x110>
  801481:	89 f0                	mov    %esi,%eax
  801483:	31 d2                	xor    %edx,%edx
  801485:	e9 46 ff ff ff       	jmp    8013d0 <__udivdi3+0x50>
  80148a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  801490:	8d 46 ff             	lea    -0x1(%esi),%eax
  801493:	31 d2                	xor    %edx,%edx
  801495:	8b 74 24 10          	mov    0x10(%esp),%esi
  801499:	8b 7c 24 14          	mov    0x14(%esp),%edi
  80149d:	8b 6c 24 18          	mov    0x18(%esp),%ebp
...
008014b0 <__umoddi3>:
  ...
  8014b3:	89 6c 24 18          	mov    %ebp,0x18(%esp)
  8014b7:	8b 6c 24 2c          	mov    0x2c(%esp),%ebp
  8014bb:	8b 44 24 20          	mov    0x20(%esp),%eax
  8014bf:	89 74 24 10          	mov    %esi,0x10(%esp)
  8014c3:	8b 4c 24 28          	mov    0x28(%esp),%ecx
  8014c7:	8b 74 24 24          	mov    0x24(%esp),%esi
  8014cb:	85 ed                	test   %ebp,%ebp
  8014cd:	89 7c 24 14          	mov    %edi,0x14(%esp)
  8014d1:	89 44 24 08          	mov    %eax,0x8(%esp)
  8014d5:	89 cf                	mov    %ecx,%edi
  8014d7:	89 04 24             	mov    %eax,(%esp)
  8014da:	89 f2                	mov    %esi,%edx
  8014dc:	75 1a                	jne    8014f8 <__umoddi3+0x48>
  8014de:	39 f1                	cmp    %esi,%ecx
  8014e0:	76 4e                	jbe    801530 <__umoddi3+0x80>
  8014e2:	f7 f1                	div    %ecx
  8014e4:	89 d0                	mov    %edx,%eax
  8014e6:	31 d2                	xor    %edx,%edx
  8014e8:	8b 74 24 10          	mov    0x10(%esp),%esi
  8014ec:	8b 7c 24 14          	mov    0x14(%esp),%edi
  8014f0:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  ...
  801506:	75 60                	jne    801568 <__umoddi3+0xb8>
  801508:	3b 0c 24             	cmp    (%esp),%ecx
  80150b:	0f 87 07 01 00 00    	ja     801618 <__umoddi3+0x168>
  801511:	89 f2                	mov    %esi,%edx
  801513:	8b 34 24             	mov    (%esp),%esi
  801516:	29 ce                	sub    %ecx,%esi
  801518:	19 ea                	sbb    %ebp,%edx
  80151a:	89 34 24             	mov    %esi,(%esp)
  80151d:	8b 04 24             	mov    (%esp),%eax
  ...
  80152f:	c3                   	ret    
  801530:	85 c9                	test   %ecx,%ecx
  801532:	75 0b                	jne    80153f <__umoddi3+0x8f>
  ...
  801543:	f7 f1                	div    %ecx
  801545:	8b 04 24             	mov    (%esp),%eax
  801548:	f7 f1                	div    %ecx
  80154a:	eb 98                	jmp    8014e4 <__umoddi3+0x34>
  80154c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801550:	89 f2                	mov    %esi,%edx
  801552:	8b 74 24 10          	mov    0x10(%esp),%esi
  801556:	8b 7c 24 14          	mov    0x14(%esp),%edi
  80155a:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  80155e:	83 c4 1c             	add    $0x1c,%esp
  801561:	c3                   	ret    
  801562:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  801568:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  80156d:	89 e8                	mov    %ebp,%eax
  80156f:	bd 20 00 00 00       	mov    $0x20,%ebp
  801574:	2b 6c 24 04          	sub    0x4(%esp),%ebp
  801578:	89 fa                	mov    %edi,%edx
  80157a:	d3 e0                	shl    %cl,%eax
  80157c:	89 e9                	mov    %ebp,%ecx
  80157e:	d3 ea                	shr    %cl,%edx
  801580:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  801585:	09 c2                	or     %eax,%edx
  801587:	8b 44 24 08          	mov    0x8(%esp),%eax
  80158b:	89 14 24             	mov    %edx,(%esp)
  80158e:	89 f2                	mov    %esi,%edx
  801590:	d3 e7                	shl    %cl,%edi
  801592:	89 e9                	mov    %ebp,%ecx
  801594:	d3 ea                	shr    %cl,%edx
  801596:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  80159b:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  80159f:	d3 e6                	shl    %cl,%esi
  8015a1:	89 e9                	mov    %ebp,%ecx
  8015a3:	d3 e8                	shr    %cl,%eax
  8015a5:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  8015aa:	09 f0                	or     %esi,%eax
  8015ac:	8b 74 24 08          	mov    0x8(%esp),%esi
  8015b0:	f7 34 24             	divl   (%esp)
  8015b3:	d3 e6                	shl    %cl,%esi
  8015b5:	89 74 24 08          	mov    %esi,0x8(%esp)
  8015b9:	89 d6                	mov    %edx,%esi
  8015bb:	f7 e7                	mul    %edi
  8015bd:	39 d6                	cmp    %edx,%esi
  8015bf:	89 c1                	mov    %eax,%ecx
  8015c1:	89 d7                	mov    %edx,%edi
  8015c3:	72 3f                	jb     801604 <__umoddi3+0x154>
  8015c5:	39 44 24 08          	cmp    %eax,0x8(%esp)
  8015c9:	72 35                	jb     801600 <__umoddi3+0x150>
  8015cb:	8b 44 24 08          	mov    0x8(%esp),%eax
  8015cf:	29 c8                	sub    %ecx,%eax
  8015d1:	19 fe                	sbb    %edi,%esi
  8015d3:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  8015d8:	89 f2                	mov    %esi,%edx
  8015da:	d3 e8                	shr    %cl,%eax
  8015dc:	89 e9                	mov    %ebp,%ecx
  8015de:	d3 e2                	shl    %cl,%edx
  8015e0:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  8015e5:	09 d0                	or     %edx,%eax
  8015e7:	89 f2                	mov    %esi,%edx
  8015e9:	d3 ea                	shr    %cl,%edx
  8015eb:	8b 74 24 10          	mov    0x10(%esp),%esi
  8015ef:	8b 7c 24 14          	mov    0x14(%esp),%edi
  8015f3:	8b 6c 24 18          	mov    0x18(%esp),%ebp
  8015f7:	83 c4 1c             	add    $0x1c,%esp
  8015fa:	c3                   	ret    
  8015fb:	90                   	nop
  8015fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801600:	39 d6                	cmp    %edx,%esi
  801602:	75 c7                	jne    8015cb <__umoddi3+0x11b>
  801604:	89 d7                	mov    %edx,%edi
  801606:	89 c1                	mov    %eax,%ecx
  801608:	2b 4c 24 0c          	sub    0xc(%esp),%ecx
  80160c:	1b 3c 24             	sbb    (%esp),%edi
  80160f:	eb ba                	jmp    8015cb <__umoddi3+0x11b>
  801611:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  801618:	39 f5                	cmp    %esi,%ebp
  80161a:	0f 82 f1 fe ff ff    	jb     801511 <__umoddi3+0x61>
  801620:	e9 f8 fe ff ff       	jmp    80151d <__umoddi3+0x6d>
