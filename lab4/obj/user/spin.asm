...
umain(int argc, char **argv)
{
  ...
  800047:	c7 04 24 e0 15 80 00 	movl   $0x8015e0,(%esp)
  80004e:	e8 6b 01 00 00       	call   8001be <cprintf>
	if ((env = fork()) == 0) {
  800053:	e8 7a 0f 00 00       	call   800fd2 <fork>
  800058:	89 c3                	mov    %eax,%ebx
  80005a:	85 c0                	test   %eax,%eax
  80005c:	75 0e                	jne    80006c <umain+0x2c>
		cprintf("I am the child.  Spinning...\n");
  80005e:	c7 04 24 58 16 80 00 	movl   $0x801658,(%esp)
  ...
  80006c:	c7 04 24 08 16 80 00 	movl   $0x801608,(%esp)
  ...
  8000a5:	c7 04 24 30 16 80 00 	movl   $0x801630,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024f:	e8 ec 10 00 00       	call   801340 <__udivdi3>
  ...
  8002af:	e8 bc 11 00 00       	call   801470 <__umoddi3>
  8002b4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002b8:	0f be 80 80 16 80 00 	movsbl 0x801680(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80039f:	ff 24 95 40 17 80 00 	jmp    *0x801740(,%edx,4)
  ...
  80047b:	c7 44 24 08 a1 16 80 	movl   $0x8016a1,0x8(%esp)
  800482:	00 
  ...
  8004ab:	b8 91 16 80 00       	mov    $0x801691,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bf0:	00 
  800bf1:	c7 44 24 08 c8 18 80 	movl   $0x8018c8,0x8(%esp)
  800bf8:	00 
  800bf9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c00:	00 
  800c01:	c7 04 24 e5 18 80 00 	movl   $0x8018e5,(%esp)
  800c08:	e8 fa 05 00 00       	call   801207 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c82:	00 
  800c83:	c7 44 24 08 c8 18 80 	movl   $0x8018c8,0x8(%esp)
  800c8a:	00 
  800c8b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c92:	00 
  800c93:	c7 04 24 e5 18 80 00 	movl   $0x8018e5,(%esp)
  800c9a:	e8 68 05 00 00       	call   801207 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cd5:	00 
  800cd6:	c7 44 24 08 c8 18 80 	movl   $0x8018c8,0x8(%esp)
  800cdd:	00 
  800cde:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce5:	00 
  800ce6:	c7 04 24 e5 18 80 00 	movl   $0x8018e5,(%esp)
  800ced:	e8 15 05 00 00       	call   801207 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d28:	00 
  800d29:	c7 44 24 08 c8 18 80 	movl   $0x8018c8,0x8(%esp)
  800d30:	00 
  800d31:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d38:	00 
  800d39:	c7 04 24 e5 18 80 00 	movl   $0x8018e5,(%esp)
  800d40:	e8 c2 04 00 00       	call   801207 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d7b:	00 
  800d7c:	c7 44 24 08 c8 18 80 	movl   $0x8018c8,0x8(%esp)
  800d83:	00 
  800d84:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d8b:	00 
  800d8c:	c7 04 24 e5 18 80 00 	movl   $0x8018e5,(%esp)
  800d93:	e8 6f 04 00 00       	call   801207 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dce:	00 
  800dcf:	c7 44 24 08 c8 18 80 	movl   $0x8018c8,0x8(%esp)
  800dd6:	00 
  800dd7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dde:	00 
  800ddf:	c7 04 24 e5 18 80 00 	movl   $0x8018e5,(%esp)
  800de6:	e8 1c 04 00 00       	call   801207 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e43:	00 
  800e44:	c7 44 24 08 c8 18 80 	movl   $0x8018c8,0x8(%esp)
  800e4b:	00 
  800e4c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e53:	00 
  800e54:	c7 04 24 e5 18 80 00 	movl   $0x8018e5,(%esp)
  800e5b:	e8 a7 03 00 00       	call   801207 <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800e73:	8b 33                	mov    (%ebx),%esi
	...
	if( (err & FEC_WR) == 0){
  800e75:	f6 43 04 02          	testb  $0x2,0x4(%ebx)
  800e79:	75 3f                	jne    800eba <pgfault+0x52>
		//cprintf(	" The eid = %x\n", sys_getenvid());
		//cprintf("The err is %d\n", err);
		cprintf("The va is 0x%x\n", (int)addr );
  800e7b:	89 74 24 04          	mov    %esi,0x4(%esp)
  800e7f:	c7 04 24 f3 18 80 00 	movl   $0x8018f3,(%esp)
  800e86:	e8 33 f3 ff ff       	call   8001be <cprintf>
		cprintf("The Eip is 0x%x\n", utf->utf_eip);
  800e8b:	8b 43 28             	mov    0x28(%ebx),%eax
  800e8e:	89 44 24 04          	mov    %eax,0x4(%esp)
  800e92:	c7 04 24 03 19 80 00 	movl   $0x801903,(%esp)
  800e99:	e8 20 f3 ff ff       	call   8001be <cprintf>

		 panic("The err is not right of the pgfault\n ");
  800e9e:	c7 44 24 08 48 19 80 	movl   $0x801948,0x8(%esp)
  800ea5:	00 
  800ea6:	c7 44 24 04 24 00 00 	movl   $0x24,0x4(%esp)
  800ead:	00 
  800eae:	c7 04 24 14 19 80 00 	movl   $0x801914,(%esp)
  800eb5:	e8 4d 03 00 00       	call   801207 <_panic>
	}
  ...
  800ec9:	75 1c                	jne    800ee7 <pgfault+0x7f>
		panic("The pgfault perm is not right\n");
  800ecb:	c7 44 24 08 70 19 80 	movl   $0x801970,0x8(%esp)
  800ed2:	00 
  800ed3:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  800eda:	00 
  800edb:	c7 04 24 14 19 80 00 	movl   $0x801914,(%esp)
  800ee2:	e8 20 03 00 00       	call   801207 <_panic>
  ...
  800ee7:	e8 29 fd ff ff       	call   800c15 <sys_getenvid>
  800eec:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800ef3:	00 
  800ef4:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800efb:	00 
  800efc:	89 04 24             	mov    %eax,(%esp)
  800eff:	e8 4f fd ff ff       	call   800c53 <sys_page_alloc>
  800f04:	85 c0                	test   %eax,%eax
  800f06:	79 1c                	jns    800f24 <pgfault+0xbc>
		panic("pgfault sys_page_alloc is not right\n");
  800f08:	c7 44 24 08 90 19 80 	movl   $0x801990,0x8(%esp)
  800f0f:	00 
  800f10:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  800f17:	00 
  800f18:	c7 04 24 14 19 80 00 	movl   $0x801914,(%esp)
  800f1f:	e8 e3 02 00 00       	call   801207 <_panic>
	addr = ROUNDDOWN(addr, PGSIZE);
  800f24:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
	memcpy((void*)PFTEMP, addr, PGSIZE);
  800f2a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  800f31:	00 
  800f32:	89 74 24 04          	mov    %esi,0x4(%esp)
  800f36:	c7 04 24 00 f0 7f 00 	movl   $0x7ff000,(%esp)
  800f3d:	e8 fa fa ff ff       	call   800a3c <memcpy>

	if((r = sys_page_map(sys_getenvid(), (void*)PFTEMP, sys_getenvid(), addr, PTE_U|PTE_W|PTE_P)) < 0)
  800f42:	e8 ce fc ff ff       	call   800c15 <sys_getenvid>
  800f47:	89 c3                	mov    %eax,%ebx
  800f49:	e8 c7 fc ff ff       	call   800c15 <sys_getenvid>
  800f4e:	c7 44 24 10 07 00 00 	movl   $0x7,0x10(%esp)
  800f55:	00 
  800f56:	89 74 24 0c          	mov    %esi,0xc(%esp)
  800f5a:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800f5e:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f65:	00 
  800f66:	89 04 24             	mov    %eax,(%esp)
  800f69:	e8 39 fd ff ff       	call   800ca7 <sys_page_map>
  800f6e:	85 c0                	test   %eax,%eax
  800f70:	79 20                	jns    800f92 <pgfault+0x12a>
		panic("The sys_page_map is not right, the errno is %d\n", r);
  800f72:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f76:	c7 44 24 08 b8 19 80 	movl   $0x8019b8,0x8(%esp)
  800f7d:	00 
  800f7e:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  800f85:	00 
  800f86:	c7 04 24 14 19 80 00 	movl   $0x801914,(%esp)
  800f8d:	e8 75 02 00 00       	call   801207 <_panic>
	if( (r = sys_page_unmap(sys_getenvid(), (void*)PFTEMP)) <0 )
  800f92:	e8 7e fc ff ff       	call   800c15 <sys_getenvid>
  800f97:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f9e:	00 
  800f9f:	89 04 24             	mov    %eax,(%esp)
  800fa2:	e8 53 fd ff ff       	call   800cfa <sys_page_unmap>
  800fa7:	85 c0                	test   %eax,%eax
  800fa9:	79 20                	jns    800fcb <pgfault+0x163>
		panic("The sys_page_unmap is not right, the errno is %d\n",r);
  800fab:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800faf:	c7 44 24 08 e8 19 80 	movl   $0x8019e8,0x8(%esp)
  800fb6:	00 
  800fb7:	c7 44 24 04 3b 00 00 	movl   $0x3b,0x4(%esp)
  800fbe:	00 
  800fbf:	c7 04 24 14 19 80 00 	movl   $0x801914,(%esp)
  800fc6:	e8 3c 02 00 00       	call   801207 <_panic>
	return;
...
fork(void)
{
  ...
  800fdb:	c7 04 24 68 0e 80 00 	movl   $0x800e68,(%esp)
  800fe2:	e8 76 02 00 00       	call   80125d <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800fee:	89 45 dc             	mov    %eax,-0x24(%ebp)
  800ff1:	89 45 e0             	mov    %eax,-0x20(%ebp)

	int childEid = sys_exofork();
	if(childEid < 0)
  800ff4:	85 c0                	test   %eax,%eax
  800ff6:	79 20                	jns    801018 <fork+0x46>
		panic("sys_exofork() is not right, and the errno is  %d\n",childEid);
  800ff8:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800ffc:	c7 44 24 08 1c 1a 80 	movl   $0x801a1c,0x8(%esp)
  801003:	00 
  801004:	c7 44 24 04 82 00 00 	movl   $0x82,0x4(%esp)
  80100b:	00 
  80100c:	c7 04 24 14 19 80 00 	movl   $0x801914,(%esp)
  801013:	e8 ef 01 00 00       	call   801207 <_panic>
	if(childEid == 0){
  801018:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
  80101c:	75 1c                	jne    80103a <fork+0x68>
		thisenv = &envs[ENVX(sys_getenvid())];
  80101e:	e8 f2 fb ff ff       	call   800c15 <sys_getenvid>
  801023:	25 ff 03 00 00       	and    $0x3ff,%eax
  801028:	6b c0 7c             	imul   $0x7c,%eax,%eax
  80102b:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801030:	a3 04 20 80 00       	mov    %eax,0x802004
		return childEid;
  801035:	e9 a0 01 00 00       	jmp    8011da <fork+0x208>
	}

	int r = sys_env_set_pgfault_upcall(childEid,  _pgfault_upcall);
  80103a:	c7 44 24 04 f3 12 80 	movl   $0x8012f3,0x4(%esp)
  801041:	00 
  801042:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801045:	89 04 24             	mov    %eax,(%esp)
  801048:	e8 53 fd ff ff       	call   800da0 <sys_env_set_pgfault_upcall>
  80104d:	89 c7                	mov    %eax,%edi
	if(r < 0)
  80104f:	85 c0                	test   %eax,%eax
  801051:	79 20                	jns    801073 <fork+0xa1>
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
  801053:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801057:	c7 44 24 08 50 1a 80 	movl   $0x801a50,0x8(%esp)
  80105e:	00 
  80105f:	c7 44 24 04 8a 00 00 	movl   $0x8a,0x4(%esp)
  801066:	00 
  801067:	c7 04 24 14 19 80 00 	movl   $0x801914,(%esp)
  80106e:	e8 94 01 00 00       	call   801207 <_panic>
		thisenv = &envs[ENVX(sys_getenvid())];
		return childEid;
	}
	...
	int r = sys_env_set_pgfault_upcall(childEid,  _pgfault_upcall);
	if(r < 0)
  801073:	be 00 10 00 00       	mov    $0x1000,%esi
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
  ...
  801082:	89 7d e4             	mov    %edi,-0x1c(%ebp)
  ...
  801094:	0f 84 f7 00 00 00    	je     801191 <fork+0x1bf>
  ...
  8010a7:	0f 84 e4 00 00 00    	je     801191 <fork+0x1bf>
				( (uvpt[PGNUM(pn*PGSIZE)] & PTE_U) != 0) &&
  ...
  8010b6:	0f 84 d5 00 00 00    	je     801191 <fork+0x1bf>
				( (uvpt[PGNUM(pn*PGSIZE)] & PTE_P) != 0))
		{
		//build experition stack for the child env
			if(pn*PGSIZE == UXSTACKTOP -PGSIZE)
  8010bc:	81 f9 00 f0 bf ee    	cmp    $0xeebff000,%ecx
  8010c2:	75 20                	jne    8010e4 <fork+0x112>
				sys_page_alloc(childEid, (void*) (pn*PGSIZE), PTE_U| PTE_W | PTE_P);
  8010c4:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  8010cb:	00 
  8010cc:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  8010d3:	ee 
  8010d4:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8010d7:	89 04 24             	mov    %eax,(%esp)
  8010da:	e8 74 fb ff ff       	call   800c53 <sys_page_alloc>
  8010df:	e9 84 00 00 00       	jmp    801168 <fork+0x196>
  8010e4:	8d be 00 f0 ff ff    	lea    -0x1000(%esi),%edi
duppage(envid_t envid, unsigned pn)
{
  ...
  8010f6:	25 02 08 00 00       	and    $0x802,%eax
{
	int r;
  ...
  8010fe:	19 db                	sbb    %ebx,%ebx
  801100:	81 e3 00 f8 ff ff    	and    $0xfffff800,%ebx
  801106:	81 c3 05 08 00 00    	add    $0x805,%ebx
	if((PTE & PTE_W) || (PTE & PTE_COW))
		perm |= PTE_COW;
	
	if( (	r =sys_page_map(sys_getenvid(), (void*)(pn*PGSIZE), envid, (void*)(pn*PGSIZE), perm)) 
  80110c:	e8 04 fb ff ff       	call   800c15 <sys_getenvid>
  801111:	89 5c 24 10          	mov    %ebx,0x10(%esp)
  801115:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801119:	8b 4d e0             	mov    -0x20(%ebp),%ecx
  80111c:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801120:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801124:	89 04 24             	mov    %eax,(%esp)
  801127:	e8 7b fb ff ff       	call   800ca7 <sys_page_map>
  80112c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  80112f:	85 c0                	test   %eax,%eax
  801131:	78 35                	js     801168 <fork+0x196>
						<0)  
		return r;

	if( (	r =sys_page_map(sys_getenvid(), (void*)(pn*PGSIZE), sys_getenvid(), (void*)(pn*PGSIZE), perm)) 
  801133:	e8 dd fa ff ff       	call   800c15 <sys_getenvid>
  801138:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  80113b:	e8 d5 fa ff ff       	call   800c15 <sys_getenvid>
  801140:	89 5c 24 10          	mov    %ebx,0x10(%esp)
  801144:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801148:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
  80114b:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80114f:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801153:	89 04 24             	mov    %eax,(%esp)
  801156:	e8 4c fb ff ff       	call   800ca7 <sys_page_map>
  80115b:	85 c0                	test   %eax,%eax
  80115d:	bf 00 00 00 00       	mov    $0x0,%edi
  801162:	0f 4f c7             	cmovg  %edi,%eax
  801165:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		//build experition stack for the child env
			...
			if(r <0)
  801168:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  80116c:	79 23                	jns    801191 <fork+0x1bf>
  80116e:	8b 7d e4             	mov    -0x1c(%ebp),%edi
				panic("fork() is wrong, and the errno is %d\n", r) ;
  801171:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801175:	c7 44 24 08 90 1a 80 	movl   $0x801a90,0x8(%esp)
  80117c:	00 
  80117d:	c7 44 24 04 99 00 00 	movl   $0x99,0x4(%esp)
  801184:	00 
  801185:	c7 04 24 14 19 80 00 	movl   $0x801914,(%esp)
  80118c:	e8 76 00 00 00       	call   801207 <_panic>
	if(r < 0)
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
	...
	int pn =0;
	for(pn=0; pn*PGSIZE < UTOP ; pn++){
  801191:	89 f1                	mov    %esi,%ecx
  801193:	89 f0                	mov    %esi,%eax
  801195:	81 c6 00 10 00 00    	add    $0x1000,%esi
  80119b:	81 fe 00 10 c0 ee    	cmp    $0xeec01000,%esi
  8011a1:	0f 85 de fe ff ff    	jne    801085 <fork+0xb3>
				r = duppage(childEid, pn);
			if(r <0)
				panic("fork() is wrong, and the errno is %d\n", r) ;
		}
  ...
  8011b5:	e8 93 fb ff ff       	call   800d4d <sys_env_set_status>
  8011ba:	85 c0                	test   %eax,%eax
  8011bc:	79 1c                	jns    8011da <fork+0x208>
		panic("sys_env_set_status");
  8011be:	c7 44 24 08 1f 19 80 	movl   $0x80191f,0x8(%esp)
  8011c5:	00 
  8011c6:	c7 44 24 04 9d 00 00 	movl   $0x9d,0x4(%esp)
  8011cd:	00 
  8011ce:	c7 04 24 14 19 80 00 	movl   $0x801914,(%esp)
  8011d5:	e8 2d 00 00 00       	call   801207 <_panic>
	return childEid;
}
...
sfork(void)
{
  ...
  8011eb:	c7 44 24 08 32 19 80 	movl   $0x801932,0x8(%esp)
  8011f2:	00 
  8011f3:	c7 44 24 04 a5 00 00 	movl   $0xa5,0x4(%esp)
  8011fa:	00 
  8011fb:	c7 04 24 14 19 80 00 	movl   $0x801914,(%esp)
  801202:	e8 00 00 00 00       	call   801207 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80120c:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  80120f:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  801212:	8b 35 00 20 80 00    	mov    0x802000,%esi
  801218:	e8 f8 f9 ff ff       	call   800c15 <sys_getenvid>
  80121d:	8b 55 0c             	mov    0xc(%ebp),%edx
  801220:	89 54 24 10          	mov    %edx,0x10(%esp)
  801224:	8b 55 08             	mov    0x8(%ebp),%edx
  801227:	89 54 24 0c          	mov    %edx,0xc(%esp)
  80122b:	89 74 24 08          	mov    %esi,0x8(%esp)
  80122f:	89 44 24 04          	mov    %eax,0x4(%esp)
  801233:	c7 04 24 b8 1a 80 00 	movl   $0x801ab8,(%esp)
  80123a:	e8 7f ef ff ff       	call   8001be <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80123f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801243:	8b 45 10             	mov    0x10(%ebp),%eax
  801246:	89 04 24             	mov    %eax,(%esp)
  801249:	e8 0f ef ff ff       	call   80015d <vcprintf>
	cprintf("\n");
  80124e:	c7 04 24 74 16 80 00 	movl   $0x801674,(%esp)
  801255:	e8 64 ef ff ff       	call   8001be <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  80125a:	cc                   	int3   
  80125b:	eb fd                	jmp    80125a <_panic+0x53>

0080125d <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801263:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  80126a:	75 44                	jne    8012b0 <set_pgfault_handler+0x53>
		// First time through!
		// LAB 4: Your code here.
		void* addr = (void*) (UXSTACKTOP-PGSIZE);
		r=sys_page_alloc(thisenv->env_id, addr, PTE_W|PTE_U|PTE_P);
  80126c:	a1 04 20 80 00       	mov    0x802004,%eax
  801271:	8b 40 48             	mov    0x48(%eax),%eax
  801274:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  80127b:	00 
  80127c:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  801283:	ee 
  801284:	89 04 24             	mov    %eax,(%esp)
  801287:	e8 c7 f9 ff ff       	call   800c53 <sys_page_alloc>
		if( r < 0)
  80128c:	85 c0                	test   %eax,%eax
  80128e:	79 20                	jns    8012b0 <set_pgfault_handler+0x53>
			panic("No memory for the UxStack, the mistake is %d\n",r);
  801290:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801294:	c7 44 24 08 dc 1a 80 	movl   $0x801adc,0x8(%esp)
  80129b:	00 
  80129c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8012a3:	00 
  8012a4:	c7 04 24 38 1b 80 00 	movl   $0x801b38,(%esp)
  8012ab:	e8 57 ff ff ff       	call   801207 <_panic>
  ...
  8012b8:	e8 58 f9 ff ff       	call   800c15 <sys_getenvid>
  8012bd:	c7 44 24 04 f3 12 80 	movl   $0x8012f3,0x4(%esp)
  8012c4:	00 
  8012c5:	89 04 24             	mov    %eax,(%esp)
  8012c8:	e8 d3 fa ff ff       	call   800da0 <sys_env_set_pgfault_upcall>
  8012cd:	85 c0                	test   %eax,%eax
  8012cf:	79 20                	jns    8012f1 <set_pgfault_handler+0x94>
		panic("sys_env_set_pgfault_upcall is not right %d\n", r);
  8012d1:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8012d5:	c7 44 24 08 0c 1b 80 	movl   $0x801b0c,0x8(%esp)
  8012dc:	00 
  8012dd:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  8012e4:	00 
  8012e5:	c7 04 24 38 1b 80 00 	movl   $0x801b38,(%esp)
  8012ec:	e8 16 ff ff ff       	call   801207 <_panic>
...
_pgfault_upcall:
  ...
  8012f4:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  8012fe:	8b 44 24 28          	mov    0x28(%esp),%eax
	//	trap-ebp-> ebx		
		movl 0x10(%esp), %ebx
  801302:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	//  trap->esp -> ecx 
		movl 0x30(%esp), %ecx
  801306:	8b 4c 24 30          	mov    0x30(%esp),%ecx

		movl %eax, -0x4(%ecx)
  80130a:	89 41 fc             	mov    %eax,-0x4(%ecx)
		movl %ebx, -0x8(%ecx)
  80130d:	89 59 f8             	mov    %ebx,-0x8(%ecx)

		leal -0x8(%ecx), %ebp
  801310:	8d 69 f8             	lea    -0x8(%ecx),%ebp

		movl 0x8(%esp), %edi
  801313:	8b 7c 24 08          	mov    0x8(%esp),%edi
		movl 0xc(%esp),	%esi
  801317:	8b 74 24 0c          	mov    0xc(%esp),%esi
		movl 0x18(%esp),%ebx
  80131b:	8b 5c 24 18          	mov    0x18(%esp),%ebx
		movl 0x1c(%esp),%edx
  80131f:	8b 54 24 1c          	mov    0x1c(%esp),%edx
		movl 0x20(%esp),%ecx
  801323:	8b 4c 24 20          	mov    0x20(%esp),%ecx
		movl 0x24(%esp),%eax
  801327:	8b 44 24 24          	mov    0x24(%esp),%eax
	...
	// LAB 4: Your code here.
		leal 0x2c(%esp), %esp
  80132b:	8d 64 24 2c          	lea    0x2c(%esp),%esp
		popf
  80132f:	9d                   	popf   
