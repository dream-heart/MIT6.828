...
sys_env_destroy(envid_t envid)
{
  ...
  8000f5:	00 
  8000f6:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  8000fd:	00 
  8000fe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800105:	00 
  800106:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  80010d:	e8 5b 02 00 00       	call   80036d <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80017a:	7e 28                	jle    8001a4 <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  80017c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800180:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  800187:	00 
  800188:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  80018f:	00 
  800190:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800197:	00 
  800198:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  80019f:	e8 c9 01 00 00       	call   80036d <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001cd:	7e 28                	jle    8001f7 <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001cf:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001d3:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8001da:	00 
  8001db:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  8001e2:	00 
  8001e3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001ea:	00 
  8001eb:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  8001f2:	e8 76 01 00 00       	call   80036d <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800220:	7e 28                	jle    80024a <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800222:	89 44 24 10          	mov    %eax,0x10(%esp)
  800226:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80022d:	00 
  80022e:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  800235:	00 
  800236:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80023d:	00 
  80023e:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  800245:	e8 23 01 00 00       	call   80036d <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800273:	7e 28                	jle    80029d <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800275:	89 44 24 10          	mov    %eax,0x10(%esp)
  800279:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  800280:	00 
  800281:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  800288:	00 
  800289:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800290:	00 
  800291:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  800298:	e8 d0 00 00 00       	call   80036d <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002c6:	7e 28                	jle    8002f0 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002c8:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002cc:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8002d3:	00 
  8002d4:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  8002db:	00 
  8002dc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002e3:	00 
  8002e4:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  8002eb:	e8 7d 00 00 00       	call   80036d <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800303:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  80033b:	7e 28                	jle    800365 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80033d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800341:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  800348:	00 
  800349:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  800350:	00 
  800351:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800358:	00 
  800359:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  800360:	e8 08 00 00 00       	call   80036d <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80037e:	e8 97 fd ff ff       	call   80011a <sys_getenvid>
  800383:	8b 55 0c             	mov    0xc(%ebp),%edx
  800386:	89 54 24 10          	mov    %edx,0x10(%esp)
  80038a:	8b 55 08             	mov    0x8(%ebp),%edx
  80038d:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800391:	89 74 24 08          	mov    %esi,0x8(%esp)
  800395:	89 44 24 04          	mov    %eax,0x4(%esp)
  800399:	c7 04 24 f8 10 80 00 	movl   $0x8010f8,(%esp)
  8003a0:	e8 c1 00 00 00       	call   800466 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8003a5:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8003a9:	8b 45 10             	mov    0x10(%ebp),%eax
  8003ac:	89 04 24             	mov    %eax,(%esp)
  8003af:	e8 51 00 00 00       	call   800405 <vcprintf>
	cprintf("\n");
  8003b4:	c7 04 24 1c 11 80 00 	movl   $0x80111c,(%esp)
  8003bb:	e8 a6 00 00 00       	call   800466 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8003c0:	cc                   	int3   
  8003c1:	eb fd                	jmp    8003c0 <_panic+0x53>
...
putch(int ch, struct printbuf *b)
{
  ...
  8003e0:	75 19                	jne    8003fb <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8003e2:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8003e9:	00 
  8003ea:	8d 43 08             	lea    0x8(%ebx),%eax
  8003ed:	89 04 24             	mov    %eax,(%esp)
  8003f0:	e8 96 fc ff ff       	call   80008b <sys_cputs>
		b->idx = 0;
  8003f5:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  8003fb:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80043a:	c7 04 24 c3 03 80 00 	movl   $0x8003c3,(%esp)
  800441:	e8 6e 01 00 00       	call   8005b4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800459:	e8 2d fc ff ff       	call   80008b <sys_cputs>
...
cprintf(const char *fmt, ...)
{
  ...
  800479:	e8 87 ff ff ff       	call   800405 <vcprintf>
	va_end(ap);
