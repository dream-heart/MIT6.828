...
handler(struct UTrapframe *utf)
{
  ...
  80004a:	e8 e7 01 00 00       	call   800236 <cprintf>
  ...
  800091:	e8 a7 00 00 00       	call   80013d <_panic>
...
umain(int argc, char **argv)
{
  ...
  8000c5:	e8 0e 0e 00 00       	call   800ed8 <set_pgfault_handler>
	cprintf("%s\n", (char*)0xDeadBeef);
  8000ca:	c7 44 24 04 ef be ad 	movl   $0xdeadbeef,0x4(%esp)
  8000d1:	de 
  8000d2:	c7 04 24 bc 11 80 00 	movl   $0x8011bc,(%esp)
  8000d9:	e8 58 01 00 00       	call   800236 <cprintf>
	cprintf("%s\n", (char*)0xCafeBffe);
  8000de:	c7 44 24 04 fe bf fe 	movl   $0xcafebffe,0x4(%esp)
  8000e5:	ca 
  8000e6:	c7 04 24 bc 11 80 00 	movl   $0x8011bc,(%esp)
  8000ed:	e8 44 01 00 00       	call   800236 <cprintf>
}
  8000f2:	c9                   	leave  
  8000f3:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  8000fa:	8b 45 08             	mov    0x8(%ebp),%eax
  8000fd:	8b 55 0c             	mov    0xc(%ebp),%edx
	// set thisenv to point at our Env structure in envs[].
	// LAB 3: Your code here.
	thisenv = 0;
  800100:	c7 05 04 20 80 00 00 	movl   $0x0,0x802004
  800107:	00 00 00 

	// save the name of the program so that panic() can use it
	if (argc > 0)
  80010a:	85 c0                	test   %eax,%eax
  80010c:	7e 08                	jle    800116 <libmain+0x22>
		binaryname = argv[0];
  80010e:	8b 0a                	mov    (%edx),%ecx
  800110:	89 0d 00 20 80 00    	mov    %ecx,0x802000

	// call user main routine
	umain(argc, argv);
  800116:	89 54 24 04          	mov    %edx,0x4(%esp)
  80011a:	89 04 24             	mov    %eax,(%esp)
  80011d:	e8 96 ff ff ff       	call   8000b8 <umain>

	// exit gracefully
	exit();
  800122:	e8 02 00 00 00       	call   800129 <exit>
}
  800127:	c9                   	leave  
  800128:	c3                   	ret    
...
exit(void)
{
  ...
  800136:	e8 f8 0a 00 00       	call   800c33 <sys_env_destroy>
}
  80013b:	c9                   	leave  
  80013c:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80014e:	e8 32 0b 00 00       	call   800c85 <sys_getenvid>
  800153:	8b 55 0c             	mov    0xc(%ebp),%edx
  800156:	89 54 24 10          	mov    %edx,0x10(%esp)
  80015a:	8b 55 08             	mov    0x8(%ebp),%edx
  80015d:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800161:	89 74 24 08          	mov    %esi,0x8(%esp)
  800165:	89 44 24 04          	mov    %eax,0x4(%esp)
  800169:	c7 04 24 18 12 80 00 	movl   $0x801218,(%esp)
  800170:	e8 c1 00 00 00       	call   800236 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800175:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800179:	8b 45 10             	mov    0x10(%ebp),%eax
  80017c:	89 04 24             	mov    %eax,(%esp)
  80017f:	e8 51 00 00 00       	call   8001d5 <vcprintf>
	cprintf("\n");
  800184:	c7 04 24 be 11 80 00 	movl   $0x8011be,(%esp)
  80018b:	e8 a6 00 00 00       	call   800236 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800190:	cc                   	int3   
  800191:	eb fd                	jmp    800190 <_panic+0x53>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002bf:	e8 4c 0c 00 00       	call   800f10 <__udivdi3>
  ...
  80031f:	e8 1c 0d 00 00       	call   801040 <__umoddi3>
  800324:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800328:	0f be 80 3b 12 80 00 	movsbl 0x80123b(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80040f:	ff 24 95 00 13 80 00 	jmp    *0x801300(,%edx,4)
  ...
  8004eb:	c7 44 24 08 5c 12 80 	movl   $0x80125c,0x8(%esp)
  8004f2:	00 
  ...
  80051b:	b8 4c 12 80 00       	mov    $0x80124c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c60:	00 
  800c61:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800c68:	00 
  800c69:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c70:	00 
  800c71:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  800c78:	e8 c0 f4 ff ff       	call   80013d <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cf2:	00 
  800cf3:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800cfa:	00 
  800cfb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d02:	00 
  800d03:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  800d0a:	e8 2e f4 ff ff       	call   80013d <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d45:	00 
  800d46:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800d4d:	00 
  800d4e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d55:	00 
  800d56:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d98:	00 
  800d99:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800da0:	00 
  800da1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800da8:	00 
  800da9:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  800db0:	e8 88 f3 ff ff       	call   80013d <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800deb:	00 
  800dec:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800df3:	00 
  800df4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dfb:	00 
  800dfc:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  800e03:	e8 35 f3 ff ff       	call   80013d <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e3e:	00 
  800e3f:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800e46:	00 
  800e47:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e4e:	00 
  800e4f:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  800e56:	e8 e2 f2 ff ff       	call   80013d <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800eb3:	00 
  800eb4:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800ebb:	00 
  800ebc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ec3:	00 
  800ec4:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  800ecb:	e8 6d f2 ff ff       	call   80013d <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800ede:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800ee5:	75 1c                	jne    800f03 <set_pgfault_handler+0x2b>
		// First time through!
		// LAB 4: Your code here.
		panic("set_pgfault_handler not implemented");
  800ee7:	c7 44 24 08 b4 14 80 	movl   $0x8014b4,0x8(%esp)
  800eee:	00 
  800eef:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  800ef6:	00 
  800ef7:	c7 04 24 d8 14 80 00 	movl   $0x8014d8,(%esp)
  800efe:	e8 3a f2 ff ff       	call   80013d <_panic>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  800f03:	8b 45 08             	mov    0x8(%ebp),%eax
  800f06:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800f0b:	c9                   	leave  
  800f0c:	c3                   	ret    
