...
top:
  ...
  800053:	e8 f8 12 00 00       	call   801350 <ipc_recv>
  ...
  80006a:	c7 04 24 60 18 80 00 	movl   $0x801860,(%esp)
  800071:	e8 39 02 00 00       	call   8002af <cprintf>

	// fork a right neighbor to continue the chain
	if ((id = fork()) < 0)
  800076:	e8 9d 10 00 00       	call   801118 <fork>
  80007b:	89 c7                	mov    %eax,%edi
  80007d:	85 c0                	test   %eax,%eax
  80007f:	79 20                	jns    8000a1 <primeproc+0x6d>
		panic("fork: %e", id);
  800081:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800085:	c7 44 24 08 6c 18 80 	movl   $0x80186c,0x8(%esp)
  80008c:	00 
  80008d:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  800094:	00 
  800095:	c7 04 24 75 18 80 00 	movl   $0x801875,(%esp)
  ...
  8000bb:	e8 90 12 00 00       	call   801350 <ipc_recv>
  ...
  8000e4:	e8 05 13 00 00       	call   8013ee <ipc_send>
...
umain(int argc, char **argv)
{
  ...
  8000f0:	83 ec 10             	sub    $0x10,%esp
	...
	if ((id = fork()) < 0)
  8000f3:	e8 20 10 00 00       	call   801118 <fork>
  8000f8:	89 c6                	mov    %eax,%esi
  8000fa:	85 c0                	test   %eax,%eax
  8000fc:	79 20                	jns    80011e <umain+0x33>
		panic("fork: %e", id);
  8000fe:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800102:	c7 44 24 08 6c 18 80 	movl   $0x80186c,0x8(%esp)
  800109:	00 
  80010a:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
  800111:	00 
  800112:	c7 04 24 75 18 80 00 	movl   $0x801875,(%esp)
  ...
  800143:	e8 a6 12 00 00       	call   8013ee <ipc_send>
		panic("fork: %e", id);
	if (id == 0)
		primeproc();
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001e0:	c7 04 24 90 18 80 00 	movl   $0x801890,(%esp)
  ...
  8001f6:	e8 53 00 00 00       	call   80024e <vcprintf>
	cprintf("\n");
  8001fb:	c7 04 24 8d 1d 80 00 	movl   $0x801d8d,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80032b:	e8 80 12 00 00       	call   8015b0 <__udivdi3>
  ...
  800380:	e8 5b 13 00 00       	call   8016e0 <__umoddi3>
  800385:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800389:	0f be 80 b3 18 80 00 	movsbl 0x8018b3(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004b2:	ff 24 95 80 19 80 00 	jmp    *0x801980(,%edx,4)
  ...
  80058a:	c7 44 24 08 d4 18 80 	movl   $0x8018d4,0x8(%esp)
  800591:	00 
  ...
  8005bf:	ba c4 18 80 00       	mov    $0x8018c4,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800cba:	00 
  800cbb:	c7 44 24 08 08 1b 80 	movl   $0x801b08,0x8(%esp)
  800cc2:	00 
  800cc3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cca:	00 
  800ccb:	c7 04 24 25 1b 80 00 	movl   $0x801b25,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d79:	00 
  800d7a:	c7 44 24 08 08 1b 80 	movl   $0x801b08,0x8(%esp)
  800d81:	00 
  800d82:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d89:	00 
  800d8a:	c7 04 24 25 1b 80 00 	movl   $0x801b25,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800dd7:	00 
  800dd8:	c7 44 24 08 08 1b 80 	movl   $0x801b08,0x8(%esp)
  800ddf:	00 
  800de0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de7:	00 
  800de8:	c7 04 24 25 1b 80 00 	movl   $0x801b25,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e35:	00 
  800e36:	c7 44 24 08 08 1b 80 	movl   $0x801b08,0x8(%esp)
  800e3d:	00 
  800e3e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e45:	00 
  800e46:	c7 04 24 25 1b 80 00 	movl   $0x801b25,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e93:	00 
  800e94:	c7 44 24 08 08 1b 80 	movl   $0x801b08,0x8(%esp)
  800e9b:	00 
  800e9c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ea3:	00 
  800ea4:	c7 04 24 25 1b 80 00 	movl   $0x801b25,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ef1:	00 
  800ef2:	c7 44 24 08 08 1b 80 	movl   $0x801b08,0x8(%esp)
  800ef9:	00 
  800efa:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f01:	00 
  800f02:	c7 04 24 25 1b 80 00 	movl   $0x801b25,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800f82:	00 
  800f83:	c7 44 24 08 08 1b 80 	movl   $0x801b08,0x8(%esp)
  800f8a:	00 
  800f8b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f92:	00 
  800f93:	c7 04 24 25 1b 80 00 	movl   $0x801b25,(%esp)
...
pgfault(struct UTrapframe *utf)
{
  ...
  800fb4:	8b 5d 08             	mov    0x8(%ebp),%ebx


	void *addr = (void *) utf->utf_fault_va;
  800fb7:	8b 33                	mov    (%ebx),%esi
	// Hint:
	...
	if( (err & FEC_WR) == 0){
  800fb9:	f6 43 04 02          	testb  $0x2,0x4(%ebx)
  800fbd:	75 3f                	jne    800ffe <pgfault+0x52>
		//cprintf(	" The eid = %x\n", sys_getenvid());
		//cprintf("The err is %d\n", err);
		cprintf("The va is 0x%x\n", (int)addr );
  800fbf:	89 74 24 04          	mov    %esi,0x4(%esp)
  800fc3:	c7 04 24 33 1b 80 00 	movl   $0x801b33,(%esp)
  800fca:	e8 e0 f2 ff ff       	call   8002af <cprintf>
		cprintf("The Eip is 0x%x\n", utf->utf_eip);
  800fcf:	8b 43 28             	mov    0x28(%ebx),%eax
  800fd2:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fd6:	c7 04 24 43 1b 80 00 	movl   $0x801b43,(%esp)
  800fdd:	e8 cd f2 ff ff       	call   8002af <cprintf>

		 panic("The err is not right of the pgfault\n ");
  800fe2:	c7 44 24 08 88 1b 80 	movl   $0x801b88,0x8(%esp)
  800fe9:	00 
  800fea:	c7 44 24 04 24 00 00 	movl   $0x24,0x4(%esp)
  800ff1:	00 
  800ff2:	c7 04 24 54 1b 80 00 	movl   $0x801b54,(%esp)
  800ff9:	e8 b6 f1 ff ff       	call   8001b4 <_panic>
	}
  ...
  80100d:	75 1c                	jne    80102b <pgfault+0x7f>
		panic("The pgfault perm is not right\n");
  80100f:	c7 44 24 08 b0 1b 80 	movl   $0x801bb0,0x8(%esp)
  801016:	00 
  801017:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  80101e:	00 
  80101f:	c7 04 24 54 1b 80 00 	movl   $0x801b54,(%esp)
  801026:	e8 89 f1 ff ff       	call   8001b4 <_panic>
  ...
  80102b:	e8 b4 fc ff ff       	call   800ce4 <sys_getenvid>
  801030:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  801037:	00 
  801038:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  80103f:	00 
  801040:	89 04 24             	mov    %eax,(%esp)
  801043:	e8 fc fc ff ff       	call   800d44 <sys_page_alloc>
  801048:	85 c0                	test   %eax,%eax
  80104a:	79 1c                	jns    801068 <pgfault+0xbc>
		panic("pgfault sys_page_alloc is not right\n");
  80104c:	c7 44 24 08 d0 1b 80 	movl   $0x801bd0,0x8(%esp)
  801053:	00 
  801054:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  80105b:	00 
  80105c:	c7 04 24 54 1b 80 00 	movl   $0x801b54,(%esp)
  ...
  801083:	e8 4f fa ff ff       	call   800ad7 <memcpy>

	if((r = sys_page_map(sys_getenvid(), (void*)PFTEMP, sys_getenvid(), addr, PTE_U|PTE_W|PTE_P)) < 0)
  801088:	e8 57 fc ff ff       	call   800ce4 <sys_getenvid>
  80108d:	89 c6                	mov    %eax,%esi
  80108f:	e8 50 fc ff ff       	call   800ce4 <sys_getenvid>
  801094:	c7 44 24 10 07 00 00 	movl   $0x7,0x10(%esp)
  80109b:	00 
  80109c:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  8010a0:	89 74 24 08          	mov    %esi,0x8(%esp)
  8010a4:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  8010ab:	00 
  8010ac:	89 04 24             	mov    %eax,(%esp)
  8010af:	e8 ef fc ff ff       	call   800da3 <sys_page_map>
  8010b4:	85 c0                	test   %eax,%eax
  8010b6:	79 20                	jns    8010d8 <pgfault+0x12c>
		panic("The sys_page_map is not right, the errno is %d\n", r);
  8010b8:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010bc:	c7 44 24 08 f8 1b 80 	movl   $0x801bf8,0x8(%esp)
  8010c3:	00 
  8010c4:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  8010cb:	00 
  8010cc:	c7 04 24 54 1b 80 00 	movl   $0x801b54,(%esp)
  8010d3:	e8 dc f0 ff ff       	call   8001b4 <_panic>
	if( (r = sys_page_unmap(sys_getenvid(), (void*)PFTEMP)) <0 )
  8010d8:	e8 07 fc ff ff       	call   800ce4 <sys_getenvid>
  8010dd:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  8010e4:	00 
  8010e5:	89 04 24             	mov    %eax,(%esp)
  8010e8:	e8 14 fd ff ff       	call   800e01 <sys_page_unmap>
  8010ed:	85 c0                	test   %eax,%eax
  8010ef:	79 20                	jns    801111 <pgfault+0x165>
		panic("The sys_page_unmap is not right, the errno is %d\n",r);
  8010f1:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010f5:	c7 44 24 08 28 1c 80 	movl   $0x801c28,0x8(%esp)
  8010fc:	00 
  8010fd:	c7 44 24 04 3b 00 00 	movl   $0x3b,0x4(%esp)
  801104:	00 
  801105:	c7 04 24 54 1b 80 00 	movl   $0x801b54,(%esp)
  80110c:	e8 a3 f0 ff ff       	call   8001b4 <_panic>
	return;
...
fork(void)
{
  ...
  801121:	c7 04 24 ac 0f 80 00 	movl   $0x800fac,(%esp)
  801128:	e8 ab 03 00 00       	call   8014d8 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  80112d:	ba 07 00 00 00       	mov    $0x7,%edx
  801132:	89 d0                	mov    %edx,%eax
  801134:	cd 30                	int    $0x30
  801136:	89 45 dc             	mov    %eax,-0x24(%ebp)
  801139:	89 45 e0             	mov    %eax,-0x20(%ebp)

	int childEid = sys_exofork();
	if(childEid < 0)
  80113c:	85 c0                	test   %eax,%eax
  80113e:	79 20                	jns    801160 <fork+0x48>
		panic("sys_exofork() is not right, and the errno is  %d\n",childEid);
  801140:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801144:	c7 44 24 08 5c 1c 80 	movl   $0x801c5c,0x8(%esp)
  80114b:	00 
  80114c:	c7 44 24 04 82 00 00 	movl   $0x82,0x4(%esp)
  801153:	00 
  801154:	c7 04 24 54 1b 80 00 	movl   $0x801b54,(%esp)
  80115b:	e8 54 f0 ff ff       	call   8001b4 <_panic>
	if(childEid == 0){
  801160:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
  801164:	75 1c                	jne    801182 <fork+0x6a>
		thisenv = &envs[ENVX(sys_getenvid())];
  801166:	e8 79 fb ff ff       	call   800ce4 <sys_getenvid>
  80116b:	25 ff 03 00 00       	and    $0x3ff,%eax
  801170:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801173:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801178:	a3 04 20 80 00       	mov    %eax,0x802004
		return childEid;
  80117d:	e9 9d 01 00 00       	jmp    80131f <fork+0x207>
	}

	int r = sys_env_set_pgfault_upcall(childEid,  _pgfault_upcall);
  801182:	c7 44 24 04 70 15 80 	movl   $0x801570,0x4(%esp)
  801189:	00 
  80118a:	8b 45 dc             	mov    -0x24(%ebp),%eax
  80118d:	89 04 24             	mov    %eax,(%esp)
  801190:	e8 28 fd ff ff       	call   800ebd <sys_env_set_pgfault_upcall>
  801195:	89 c6                	mov    %eax,%esi
	if(r < 0)
  801197:	85 c0                	test   %eax,%eax
  801199:	79 20                	jns    8011bb <fork+0xa3>
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
  80119b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80119f:	c7 44 24 08 90 1c 80 	movl   $0x801c90,0x8(%esp)
  8011a6:	00 
  8011a7:	c7 44 24 04 8a 00 00 	movl   $0x8a,0x4(%esp)
  8011ae:	00 
  8011af:	c7 04 24 54 1b 80 00 	movl   $0x801b54,(%esp)
  8011b6:	e8 f9 ef ff ff       	call   8001b4 <_panic>
		thisenv = &envs[ENVX(sys_getenvid())];
		return childEid;
	}
	...
	int r = sys_env_set_pgfault_upcall(childEid,  _pgfault_upcall);
	if(r < 0)
  8011bb:	bb 00 10 00 00       	mov    $0x1000,%ebx
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
  ...
  8011ca:	eb 04                	jmp    8011d0 <fork+0xb8>
  ...
  8011de:	0f 84 f5 00 00 00    	je     8012d9 <fork+0x1c1>
				( (uvpt[PGNUM(pn*PGSIZE)] & PTE_U) != 0) &&
  8011e4:	c1 ea 0c             	shr    $0xc,%edx
  8011e7:	8b 04 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%eax
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
	...
	for(pn=0; pn*PGSIZE < UTOP ; pn++){
		if ( ( 	(uvpd[PDX(pn*PGSIZE)] & PTE_P) != 0) &&
  8011ee:	a8 04                	test   $0x4,%al
  8011f0:	0f 84 e3 00 00 00    	je     8012d9 <fork+0x1c1>
				( (uvpt[PGNUM(pn*PGSIZE)] & PTE_U) != 0) &&
				( (uvpt[PGNUM(pn*PGSIZE)] & PTE_P) != 0))
  8011f6:	8b 04 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%eax
  ...
  8011ff:	0f 84 d4 00 00 00    	je     8012d9 <fork+0x1c1>
				( (uvpt[PGNUM(pn*PGSIZE)] & PTE_P) != 0))
		{
		//build experition stack for the child env
			if(pn*PGSIZE == UXSTACKTOP -PGSIZE)
  801205:	81 f9 00 f0 bf ee    	cmp    $0xeebff000,%ecx
  80120b:	75 20                	jne    80122d <fork+0x115>
				sys_page_alloc(childEid, (void*) (pn*PGSIZE), PTE_U| PTE_W | PTE_P);
  80120d:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  801214:	00 
  801215:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  80121c:	ee 
  80121d:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801220:	89 14 24             	mov    %edx,(%esp)
  801223:	e8 1c fb ff ff       	call   800d44 <sys_page_alloc>
  801228:	e9 88 00 00 00       	jmp    8012b5 <fork+0x19d>
duppage(envid_t envid, unsigned pn)
{
  ...
  80122d:	8d 83 00 f0 ff ff    	lea    -0x1000(%ebx),%eax
  801233:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  801236:	c1 e8 0c             	shr    $0xc,%eax
  801239:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	int perm = PTE_U|PTE_P;
	if((PTE & PTE_W) || (PTE & PTE_COW))
  801240:	25 02 08 00 00       	and    $0x802,%eax
{
	int r;
  ...
  801248:	19 ff                	sbb    %edi,%edi
  80124a:	81 e7 00 f8 ff ff    	and    $0xfffff800,%edi
  801250:	81 c7 05 08 00 00    	add    $0x805,%edi
	if((PTE & PTE_W) || (PTE & PTE_COW))
		perm |= PTE_COW;
	
	if( (	r =sys_page_map(sys_getenvid(), (void*)(pn*PGSIZE), envid, (void*)(pn*PGSIZE), perm)) 
  801256:	e8 89 fa ff ff       	call   800ce4 <sys_getenvid>
  80125b:	89 7c 24 10          	mov    %edi,0x10(%esp)
  80125f:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801262:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801266:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801269:	89 54 24 08          	mov    %edx,0x8(%esp)
  80126d:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801270:	89 54 24 04          	mov    %edx,0x4(%esp)
  801274:	89 04 24             	mov    %eax,(%esp)
  801277:	e8 27 fb ff ff       	call   800da3 <sys_page_map>
  80127c:	89 c6                	mov    %eax,%esi
  80127e:	85 c0                	test   %eax,%eax
  801280:	78 33                	js     8012b5 <fork+0x19d>
						<0)  
		return r;

	if( (	r =sys_page_map(sys_getenvid(), (void*)(pn*PGSIZE), sys_getenvid(), (void*)(pn*PGSIZE), perm)) 
  801282:	e8 5d fa ff ff       	call   800ce4 <sys_getenvid>
  801287:	89 c6                	mov    %eax,%esi
  801289:	e8 56 fa ff ff       	call   800ce4 <sys_getenvid>
  80128e:	89 7c 24 10          	mov    %edi,0x10(%esp)
  801292:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801295:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801299:	89 74 24 08          	mov    %esi,0x8(%esp)
  80129d:	89 54 24 04          	mov    %edx,0x4(%esp)
  8012a1:	89 04 24             	mov    %eax,(%esp)
  8012a4:	e8 fa fa ff ff       	call   800da3 <sys_page_map>
  ...
  8012b2:	0f 49 f0             	cmovns %eax,%esi
		//build experition stack for the child env
			if(pn*PGSIZE == UXSTACKTOP -PGSIZE)
				sys_page_alloc(childEid, (void*) (pn*PGSIZE), PTE_U| PTE_W | PTE_P);
			else
  ...
  8012b7:	79 20                	jns    8012d9 <fork+0x1c1>
				panic("fork() is wrong, and the errno is %d\n", r) ;
  8012b9:	89 74 24 0c          	mov    %esi,0xc(%esp)
  8012bd:	c7 44 24 08 d0 1c 80 	movl   $0x801cd0,0x8(%esp)
  8012c4:	00 
  8012c5:	c7 44 24 04 99 00 00 	movl   $0x99,0x4(%esp)
  8012cc:	00 
  8012cd:	c7 04 24 54 1b 80 00 	movl   $0x801b54,(%esp)
  8012d4:	e8 db ee ff ff       	call   8001b4 <_panic>
	if(r < 0)
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
  ...
  8012db:	8d 83 00 10 00 00    	lea    0x1000(%ebx),%eax
  8012e1:	3d 00 10 c0 ee       	cmp    $0xeec01000,%eax
  8012e6:	0f 85 e0 fe ff ff    	jne    8011cc <fork+0xb4>
				r = duppage(childEid, pn);
			if(r <0)
				panic("fork() is wrong, and the errno is %d\n", r) ;
		}
  ...
  8012ec:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  8012f3:	00 
  8012f4:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8012f7:	89 04 24             	mov    %eax,(%esp)
  8012fa:	e8 60 fb ff ff       	call   800e5f <sys_env_set_status>
  8012ff:	85 c0                	test   %eax,%eax
  801301:	79 1c                	jns    80131f <fork+0x207>
		panic("sys_env_set_status");
  801303:	c7 44 24 08 5f 1b 80 	movl   $0x801b5f,0x8(%esp)
  80130a:	00 
  80130b:	c7 44 24 04 9d 00 00 	movl   $0x9d,0x4(%esp)
  801312:	00 
  801313:	c7 04 24 54 1b 80 00 	movl   $0x801b54,(%esp)
  80131a:	e8 95 ee ff ff       	call   8001b4 <_panic>
	return childEid;
}
  80131f:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801322:	83 c4 3c             	add    $0x3c,%esp
  801325:	5b                   	pop    %ebx
  801326:	5e                   	pop    %esi
  801327:	5f                   	pop    %edi
  801328:	5d                   	pop    %ebp
...
sfork(void)
{
  ...
  801330:	c7 44 24 08 72 1b 80 	movl   $0x801b72,0x8(%esp)
  801337:	00 
  801338:	c7 44 24 04 a5 00 00 	movl   $0xa5,0x4(%esp)
  80133f:	00 
  801340:	c7 04 24 54 1b 80 00 	movl   $0x801b54,(%esp)
  801347:	e8 68 ee ff ff       	call   8001b4 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80135e:	8b 75 10             	mov    0x10(%ebp),%esi
	// LAB 4: Your code here.
	int r =0;
	int a;
	if(pg == 0)
  ...
  80136c:	e8 de fb ff ff       	call   800f4f <sys_ipc_recv>
  801371:	eb 08                	jmp    80137b <ipc_recv+0x2b>
	else
		r = sys_ipc_recv(pg);
  801373:	89 04 24             	mov    %eax,(%esp)
  801376:	e8 d4 fb ff ff       	call   800f4f <sys_ipc_recv>
	if(r == 0){
  ...
  8013a4:	c7 44 24 08 f8 1c 80 	movl   $0x801cf8,0x8(%esp)
  8013ab:	00 
  8013ac:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8013b3:	00 
  8013b4:	c7 04 24 74 1d 80 00 	movl   $0x801d74,(%esp)
  8013bb:	e8 f4 ed ff ff       	call   8001b4 <_panic>
  ...
  8013c0:	a1 04 20 80 00       	mov    0x802004,%eax
  ...
  8013d3:	c7 04 24 28 1d 80 00 	movl   $0x801d28,(%esp)
  8013da:	e8 d0 ee ff ff       	call   8002af <cprintf>
	return thisenv->env_ipc_value;
  8013df:	a1 04 20 80 00       	mov    0x802004,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80141a:	e8 fc fa ff ff       	call   800f1b <sys_ipc_try_send>
  ...
  801438:	e8 de fa ff ff       	call   800f1b <sys_ipc_try_send>
  80143d:	89 c3                	mov    %eax,%ebx

		if(r <0 && r != -E_IPC_NOT_RECV){
  80143f:	89 d8                	mov    %ebx,%eax
  801441:	c1 e8 1f             	shr    $0x1f,%eax
  801444:	84 c0                	test   %al,%al
  801446:	74 3a                	je     801482 <ipc_send+0x94>
  801448:	83 fb f8             	cmp    $0xfffffff8,%ebx
  80144b:	74 35                	je     801482 <ipc_send+0x94>
			cprintf("the envid is %x\n", sys_getenvid());
  80144d:	e8 92 f8 ff ff       	call   800ce4 <sys_getenvid>
  801452:	89 44 24 04          	mov    %eax,0x4(%esp)
  801456:	c7 04 24 7e 1d 80 00 	movl   $0x801d7e,(%esp)
  80145d:	e8 4d ee ff ff       	call   8002af <cprintf>
			panic("ipc_send is error, and the errno is %d\n", r);
  801462:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  801466:	c7 44 24 08 4c 1d 80 	movl   $0x801d4c,0x8(%esp)
  80146d:	00 
  80146e:	c7 44 24 04 53 00 00 	movl   $0x53,0x4(%esp)
  801475:	00 
  801476:	c7 04 24 74 1d 80 00 	movl   $0x801d74,(%esp)
  80147d:	e8 32 ed ff ff       	call   8001b4 <_panic>
		}
		else if(r == -E_IPC_NOT_RECV)
  801482:	83 fb f8             	cmp    $0xfffffff8,%ebx
  801485:	75 0e                	jne    801495 <ipc_send+0xa7>
			sys_yield();
  801487:	e8 88 f8 ff ff       	call   800d14 <sys_yield>
		else break;
	}
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8014de:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  8014e5:	75 44                	jne    80152b <set_pgfault_handler+0x53>
		// First time through!
		// LAB 4: Your code here.
  ...
  801502:	e8 3d f8 ff ff       	call   800d44 <sys_page_alloc>
		if( r < 0)
  801507:	85 c0                	test   %eax,%eax
  801509:	79 20                	jns    80152b <set_pgfault_handler+0x53>
			panic("No memory for the UxStack, the mistake is %d\n",r);
  80150b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80150f:	c7 44 24 08 90 1d 80 	movl   $0x801d90,0x8(%esp)
  801516:	00 
  801517:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80151e:	00 
  80151f:	c7 04 24 ec 1d 80 00 	movl   $0x801dec,(%esp)
  801526:	e8 89 ec ff ff       	call   8001b4 <_panic>
  ...
  80152e:	a3 08 20 80 00       	mov    %eax,0x802008
	if(( r= sys_env_set_pgfault_upcall(sys_getenvid(), _pgfault_upcall))<0)
  801533:	e8 ac f7 ff ff       	call   800ce4 <sys_getenvid>
  801538:	c7 44 24 04 70 15 80 	movl   $0x801570,0x4(%esp)
  80153f:	00 
  801540:	89 04 24             	mov    %eax,(%esp)
  801543:	e8 75 f9 ff ff       	call   800ebd <sys_env_set_pgfault_upcall>
  801548:	85 c0                	test   %eax,%eax
  80154a:	79 20                	jns    80156c <set_pgfault_handler+0x94>
		panic("sys_env_set_pgfault_upcall is not right %d\n", r);
  80154c:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801550:	c7 44 24 08 c0 1d 80 	movl   $0x801dc0,0x8(%esp)
  801557:	00 
  801558:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  80155f:	00 
  801560:	c7 04 24 ec 1d 80 00 	movl   $0x801dec,(%esp)
  801567:	e8 48 ec ff ff       	call   8001b4 <_panic>
...
_pgfault_upcall:
  ...
  801571:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  801578:	83 c4 04             	add    $0x4,%esp
	...
	//	trap-eip -> eax
		movl 0x28(%esp), %eax
  80157b:	8b 44 24 28          	mov    0x28(%esp),%eax
	//	trap-ebp-> ebx		
		movl 0x10(%esp), %ebx
  80157f:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	//  trap->esp -> ecx 
		movl 0x30(%esp), %ecx
  801583:	8b 4c 24 30          	mov    0x30(%esp),%ecx

		movl %eax, -0x4(%ecx)
  801587:	89 41 fc             	mov    %eax,-0x4(%ecx)
		movl %ebx, -0x8(%ecx)
  80158a:	89 59 f8             	mov    %ebx,-0x8(%ecx)

		leal -0x8(%ecx), %ebp
  80158d:	8d 69 f8             	lea    -0x8(%ecx),%ebp

		movl 0x8(%esp), %edi
  801590:	8b 7c 24 08          	mov    0x8(%esp),%edi
		movl 0xc(%esp),	%esi
  801594:	8b 74 24 0c          	mov    0xc(%esp),%esi
		movl 0x18(%esp),%ebx
  801598:	8b 5c 24 18          	mov    0x18(%esp),%ebx
		movl 0x1c(%esp),%edx
  80159c:	8b 54 24 1c          	mov    0x1c(%esp),%edx
		movl 0x20(%esp),%ecx
  8015a0:	8b 4c 24 20          	mov    0x20(%esp),%ecx
		movl 0x24(%esp),%eax
  8015a4:	8b 44 24 24          	mov    0x24(%esp),%eax
	...
	// LAB 4: Your code here.
		leal 0x2c(%esp), %esp
  8015a8:	8d 64 24 2c          	lea    0x2c(%esp),%esp
		popf
  8015ac:	9d                   	popf   
