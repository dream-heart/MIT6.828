...
sys_env_destroy(envid_t envid)
{
  ...
  800118:	00 
  800119:	c7 44 24 08 ca 0e 80 	movl   $0x800eca,0x8(%esp)
  800120:	00 
  800121:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  800128:	00 
  800129:	c7 04 24 e7 0e 80 00 	movl   $0x800ee7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800188:	c7 04 24 f8 0e 80 00 	movl   $0x800ef8,(%esp)
  ...
  80019e:	e8 51 00 00 00       	call   8001f4 <vcprintf>
	cprintf("\n");
  8001a3:	c7 04 24 1c 0f 80 00 	movl   $0x800f1c,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800230:	e8 6f 01 00 00       	call   8003a4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
