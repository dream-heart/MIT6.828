...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003a:	c7 05 00 20 80 00 20 	movl   $0x801120,0x802000
  800041:	11 80 00 
	...
	while (1) {
		sys_yield();
  800044:	e8 14 01 00 00       	call   80015d <sys_yield>
...
sys_env_destroy(envid_t envid)
{
  ...
  800119:	00 
  80011a:	c7 44 24 08 2f 11 80 	movl   $0x80112f,0x8(%esp)
  800121:	00 
  800122:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800129:	00 
  80012a:	c7 04 24 4c 11 80 00 	movl   $0x80114c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001ab:	00 
  8001ac:	c7 44 24 08 2f 11 80 	movl   $0x80112f,0x8(%esp)
  8001b3:	00 
  8001b4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001bb:	00 
  8001bc:	c7 04 24 4c 11 80 00 	movl   $0x80114c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001fe:	00 
  8001ff:	c7 44 24 08 2f 11 80 	movl   $0x80112f,0x8(%esp)
  800206:	00 
  800207:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020e:	00 
  80020f:	c7 04 24 4c 11 80 00 	movl   $0x80114c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800251:	00 
  800252:	c7 44 24 08 2f 11 80 	movl   $0x80112f,0x8(%esp)
  800259:	00 
  80025a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800261:	00 
  800262:	c7 04 24 4c 11 80 00 	movl   $0x80114c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a4:	00 
  8002a5:	c7 44 24 08 2f 11 80 	movl   $0x80112f,0x8(%esp)
  8002ac:	00 
  8002ad:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b4:	00 
  8002b5:	c7 04 24 4c 11 80 00 	movl   $0x80114c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002f7:	00 
  8002f8:	c7 44 24 08 2f 11 80 	movl   $0x80112f,0x8(%esp)
  8002ff:	00 
  800300:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800307:	00 
  800308:	c7 04 24 4c 11 80 00 	movl   $0x80114c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  80036c:	00 
  80036d:	c7 44 24 08 2f 11 80 	movl   $0x80112f,0x8(%esp)
  800374:	00 
  800375:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80037c:	00 
  80037d:	c7 04 24 4c 11 80 00 	movl   $0x80114c,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8003bd:	c7 04 24 5c 11 80 00 	movl   $0x80115c,(%esp)
  ...
  8003d3:	e8 51 00 00 00       	call   800429 <vcprintf>
	cprintf("\n");
  8003d8:	c7 04 24 80 11 80 00 	movl   $0x801180,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800465:	e8 7a 01 00 00       	call   8005e4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800588:	0f be 80 82 11 80 00 	movsbl 0x801182(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80072b:	c7 44 24 08 9a 11 80 	movl   $0x80119a,0x8(%esp)
  800732:	00 
  ...
  80074b:	c7 44 24 08 a3 11 80 	movl   $0x8011a3,0x8(%esp)
  800752:	00 
  ...
  80077b:	b8 93 11 80 00       	mov    $0x801193,%eax
