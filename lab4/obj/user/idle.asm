...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 20 80 00 e0 	movl   $0x8010e0,0x802000
  800040:	10 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 f9 00 00 00       	call   800141 <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  800066:	89 0d 00 20 80 00    	mov    %ecx,0x802000
	...
	umain(argc, argv);
  80006c:	89 54 24 04          	mov    %edx,0x4(%esp)
  800070:	89 04 24             	mov    %eax,(%esp)
  800073:	e8 bb ff ff ff       	call   800033 <umain>

	// exit gracefully
	exit();
  800078:	e8 02 00 00 00       	call   80007f <exit>
}
  80007d:	c9                   	leave  
  80007e:	c3                   	ret    
...
exit(void)
{
  ...
  800082:	83 ec 18             	sub    $0x18,%esp
	sys_env_destroy(0);
  800085:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80008c:	e8 3f 00 00 00       	call   8000d0 <sys_env_destroy>
}
  800091:	c9                   	leave  
  800092:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8000b6:	53                   	push   %ebx
	...
	asm volatile("int %1\n"
  8000b7:	ba 00 00 00 00       	mov    $0x0,%edx
  8000bc:	b8 01 00 00 00       	mov    $0x1,%eax
  8000c1:	89 d1                	mov    %edx,%ecx
  8000c3:	89 d3                	mov    %edx,%ebx
  8000c5:	89 d7                	mov    %edx,%edi
  8000c7:	89 d6                	mov    %edx,%esi
...
sys_env_destroy(envid_t envid)
{
  ...
  8000d6:	83 ec 2c             	sub    $0x2c,%esp
	...
	asm volatile("int %1\n"
  8000d9:	b9 00 00 00 00       	mov    $0x0,%ecx
  8000de:	b8 03 00 00 00       	mov    $0x3,%eax
  8000e3:	8b 55 08             	mov    0x8(%ebp),%edx
  8000e6:	89 cb                	mov    %ecx,%ebx
  8000e8:	89 cf                	mov    %ecx,%edi
  8000ea:	89 ce                	mov    %ecx,%esi
  ...
  8000f0:	7e 28                	jle    80011a <sys_env_destroy+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8000f2:	89 44 24 10          	mov    %eax,0x10(%esp)
  8000f6:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8000fd:	00 
  8000fe:	c7 44 24 08 ef 10 80 	movl   $0x8010ef,0x8(%esp)
  800105:	00 
  800106:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80010d:	00 
  80010e:	c7 04 24 0c 11 80 00 	movl   $0x80110c,(%esp)
  800115:	e8 5b 02 00 00       	call   800375 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800182:	7e 28                	jle    8001ac <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  800184:	89 44 24 10          	mov    %eax,0x10(%esp)
  800188:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  80018f:	00 
  800190:	c7 44 24 08 ef 10 80 	movl   $0x8010ef,0x8(%esp)
  800197:	00 
  800198:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80019f:	00 
  8001a0:	c7 04 24 0c 11 80 00 	movl   $0x80110c,(%esp)
  8001a7:	e8 c9 01 00 00       	call   800375 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d5:	7e 28                	jle    8001ff <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001d7:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001db:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8001e2:	00 
  8001e3:	c7 44 24 08 ef 10 80 	movl   $0x8010ef,0x8(%esp)
  8001ea:	00 
  8001eb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001f2:	00 
  8001f3:	c7 04 24 0c 11 80 00 	movl   $0x80110c,(%esp)
  8001fa:	e8 76 01 00 00       	call   800375 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800228:	7e 28                	jle    800252 <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80022a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80022e:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800235:	00 
  800236:	c7 44 24 08 ef 10 80 	movl   $0x8010ef,0x8(%esp)
  80023d:	00 
  80023e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800245:	00 
  800246:	c7 04 24 0c 11 80 00 	movl   $0x80110c,(%esp)
  80024d:	e8 23 01 00 00       	call   800375 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80027b:	7e 28                	jle    8002a5 <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80027d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800281:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  800288:	00 
  800289:	c7 44 24 08 ef 10 80 	movl   $0x8010ef,0x8(%esp)
  800290:	00 
  800291:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800298:	00 
  800299:	c7 04 24 0c 11 80 00 	movl   $0x80110c,(%esp)
  8002a0:	e8 d0 00 00 00       	call   800375 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002ce:	7e 28                	jle    8002f8 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002d0:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002d4:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8002db:	00 
  8002dc:	c7 44 24 08 ef 10 80 	movl   $0x8010ef,0x8(%esp)
  8002e3:	00 
  8002e4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002eb:	00 
  8002ec:	c7 04 24 0c 11 80 00 	movl   $0x80110c,(%esp)
  8002f3:	e8 7d 00 00 00       	call   800375 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800343:	7e 28                	jle    80036d <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800345:	89 44 24 10          	mov    %eax,0x10(%esp)
  800349:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  800350:	00 
  800351:	c7 44 24 08 ef 10 80 	movl   $0x8010ef,0x8(%esp)
  800358:	00 
  800359:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800360:	00 
  800361:	c7 04 24 0c 11 80 00 	movl   $0x80110c,(%esp)
  800368:	e8 08 00 00 00       	call   800375 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800378:	56                   	push   %esi
  800379:	53                   	push   %ebx
  80037a:	83 ec 20             	sub    $0x20,%esp
	va_list ap;

	va_start(ap, fmt);
  80037d:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800380:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800386:	e8 97 fd ff ff       	call   800122 <sys_getenvid>
  80038b:	8b 55 0c             	mov    0xc(%ebp),%edx
  80038e:	89 54 24 10          	mov    %edx,0x10(%esp)
  800392:	8b 55 08             	mov    0x8(%ebp),%edx
  800395:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800399:	89 74 24 08          	mov    %esi,0x8(%esp)
  80039d:	89 44 24 04          	mov    %eax,0x4(%esp)
  8003a1:	c7 04 24 1c 11 80 00 	movl   $0x80111c,(%esp)
  8003a8:	e8 c1 00 00 00       	call   80046e <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8003ad:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8003b1:	8b 45 10             	mov    0x10(%ebp),%eax
  8003b4:	89 04 24             	mov    %eax,(%esp)
  8003b7:	e8 51 00 00 00       	call   80040d <vcprintf>
	cprintf("\n");
  8003bc:	c7 04 24 40 11 80 00 	movl   $0x801140,(%esp)
  8003c3:	e8 a6 00 00 00       	call   80046e <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8003c8:	cc                   	int3   
  8003c9:	eb fd                	jmp    8003c8 <_panic+0x53>
...
putch(int ch, struct printbuf *b)
{
  ...
  8003ce:	53                   	push   %ebx
  8003cf:	83 ec 14             	sub    $0x14,%esp
  8003d2:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  8003d5:	8b 13                	mov    (%ebx),%edx
  8003d7:	8d 42 01             	lea    0x1(%edx),%eax
  8003da:	89 03                	mov    %eax,(%ebx)
  8003dc:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8003df:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
	if (b->idx == 256-1) {
  8003e3:	3d ff 00 00 00       	cmp    $0xff,%eax
  8003e8:	75 19                	jne    800403 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8003ea:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8003f1:	00 
  8003f2:	8d 43 08             	lea    0x8(%ebx),%eax
  8003f5:	89 04 24             	mov    %eax,(%esp)
  8003f8:	e8 96 fc ff ff       	call   800093 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800410:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  800434:	89 44 24 08          	mov    %eax,0x8(%esp)
  800438:	8d 85 f0 fe ff ff    	lea    -0x110(%ebp),%eax
  80043e:	89 44 24 04          	mov    %eax,0x4(%esp)
  800442:	c7 04 24 cb 03 80 00 	movl   $0x8003cb,(%esp)
  800449:	e8 76 01 00 00       	call   8005c4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  80044e:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  800454:	89 44 24 04          	mov    %eax,0x4(%esp)
  800458:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  80045e:	89 04 24             	mov    %eax,(%esp)
  800461:	e8 2d fc ff ff       	call   800093 <sys_cputs>
...
cprintf(const char *fmt, ...)
{
  ...
  800481:	e8 87 ff ff ff       	call   80040d <vcprintf>
	va_end(ap);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800568:	0f be 80 42 11 80 00 	movsbl 0x801142(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80070b:	c7 44 24 08 5a 11 80 	movl   $0x80115a,0x8(%esp)
  800712:	00 
  ...
  80072b:	c7 44 24 08 63 11 80 	movl   $0x801163,0x8(%esp)
  800732:	00 
  ...
  80075b:	b8 53 11 80 00       	mov    $0x801153,%eax
