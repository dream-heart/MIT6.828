...
umain(int argc, char **argv)
{
  ...
  800090:	c7 04 24 71 13 80 00 	movl   $0x801371,(%esp)
  ...
  8000bc:	e8 ad 0e 00 00       	call   800f6e <ipc_send>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024b:	e8 60 0e 00 00       	call   8010b0 <__udivdi3>
  ...
  8002a0:	e8 3b 0f 00 00       	call   8011e0 <__umoddi3>
  8002a5:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002a9:	0f be 80 92 13 80 00 	movsbl 0x801392(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003d2:	ff 24 95 60 14 80 00 	jmp    *0x801460(,%edx,4)
  ...
  8004aa:	c7 44 24 08 b3 13 80 	movl   $0x8013b3,0x8(%esp)
  8004b1:	00 
  ...
  8004df:	ba a3 13 80 00       	mov    $0x8013a3,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800bda:	00 
  800bdb:	c7 44 24 08 e8 15 80 	movl   $0x8015e8,0x8(%esp)
  800be2:	00 
  800be3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bea:	00 
  800beb:	c7 04 24 05 16 80 00 	movl   $0x801605,(%esp)
  800bf2:	e8 61 04 00 00       	call   801058 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c99:	00 
  800c9a:	c7 44 24 08 e8 15 80 	movl   $0x8015e8,0x8(%esp)
  800ca1:	00 
  800ca2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca9:	00 
  800caa:	c7 04 24 05 16 80 00 	movl   $0x801605,(%esp)
  800cb1:	e8 a2 03 00 00       	call   801058 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cf7:	00 
  800cf8:	c7 44 24 08 e8 15 80 	movl   $0x8015e8,0x8(%esp)
  800cff:	00 
  800d00:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d07:	00 
  800d08:	c7 04 24 05 16 80 00 	movl   $0x801605,(%esp)
  800d0f:	e8 44 03 00 00       	call   801058 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d55:	00 
  800d56:	c7 44 24 08 e8 15 80 	movl   $0x8015e8,0x8(%esp)
  800d5d:	00 
  800d5e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d65:	00 
  800d66:	c7 04 24 05 16 80 00 	movl   $0x801605,(%esp)
  800d6d:	e8 e6 02 00 00       	call   801058 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800db3:	00 
  800db4:	c7 44 24 08 e8 15 80 	movl   $0x8015e8,0x8(%esp)
  800dbb:	00 
  800dbc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dc3:	00 
  800dc4:	c7 04 24 05 16 80 00 	movl   $0x801605,(%esp)
  800dcb:	e8 88 02 00 00       	call   801058 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e11:	00 
  800e12:	c7 44 24 08 e8 15 80 	movl   $0x8015e8,0x8(%esp)
  800e19:	00 
  800e1a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e21:	00 
  800e22:	c7 04 24 05 16 80 00 	movl   $0x801605,(%esp)
  800e29:	e8 2a 02 00 00       	call   801058 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800ea2:	00 
  800ea3:	c7 44 24 08 e8 15 80 	movl   $0x8015e8,0x8(%esp)
  800eaa:	00 
  800eab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eb2:	00 
  800eb3:	c7 04 24 05 16 80 00 	movl   $0x801605,(%esp)
  800eba:	e8 99 01 00 00       	call   801058 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800ee3:	75 0e                	jne    800ef3 <ipc_recv+0x23>
		r= sys_ipc_recv( (void *)UTOP);
  800ee5:	c7 04 24 00 00 c0 ee 	movl   $0xeec00000,(%esp)
  800eec:	e8 7e ff ff ff       	call   800e6f <sys_ipc_recv>
  800ef1:	eb 08                	jmp    800efb <ipc_recv+0x2b>
	else
		r = sys_ipc_recv(pg);
  800ef3:	89 04 24             	mov    %eax,(%esp)
  800ef6:	e8 74 ff ff ff       	call   800e6f <sys_ipc_recv>
	if(r == 0){
  800efb:	85 c0                	test   %eax,%eax
  800efd:	8d 76 00             	lea    0x0(%esi),%esi
  800f00:	75 1e                	jne    800f20 <ipc_recv+0x50>
		if( from_env_store != 0 )
  800f02:	85 db                	test   %ebx,%ebx
  800f04:	74 0a                	je     800f10 <ipc_recv+0x40>
			*from_env_store = thisenv->env_ipc_from;
  800f06:	a1 04 20 80 00       	mov    0x802004,%eax
  800f0b:	8b 40 74             	mov    0x74(%eax),%eax
  800f0e:	89 03                	mov    %eax,(%ebx)

		if(perm_store != 0 )
  800f10:	85 f6                	test   %esi,%esi
  800f12:	74 2c                	je     800f40 <ipc_recv+0x70>
			*perm_store = thisenv->env_ipc_perm;
  800f14:	a1 04 20 80 00       	mov    0x802004,%eax
  800f19:	8b 40 78             	mov    0x78(%eax),%eax
  800f1c:	89 06                	mov    %eax,(%esi)
  800f1e:	eb 20                	jmp    800f40 <ipc_recv+0x70>
	}
	else{
		panic("The ipc_recv is not right, and the errno is %d\n",r);
  800f20:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f24:	c7 44 24 08 14 16 80 	movl   $0x801614,0x8(%esp)
  800f2b:	00 
  800f2c:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800f33:	00 
  800f34:	c7 04 24 90 16 80 00 	movl   $0x801690,(%esp)
  800f3b:	e8 18 01 00 00       	call   801058 <_panic>
  ...
  800f40:	a1 04 20 80 00       	mov    0x802004,%eax
  800f45:	8b 50 70             	mov    0x70(%eax),%edx
  800f48:	85 d2                	test   %edx,%edx
  800f4a:	75 13                	jne    800f5f <ipc_recv+0x8f>
		cprintf("the value is 0, the envid is %x\n", thisenv->env_id);
  800f4c:	8b 40 48             	mov    0x48(%eax),%eax
  800f4f:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f53:	c7 04 24 44 16 80 00 	movl   $0x801644,(%esp)
  800f5a:	e8 6c f2 ff ff       	call   8001cb <cprintf>
	return thisenv->env_ipc_value;
  800f5f:	a1 04 20 80 00       	mov    0x802004,%eax
  800f64:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800f7a:	8b 75 10             	mov    0x10(%ebp),%esi
	// LAB 4: Your code here.
  ...
  800f7f:	75 22                	jne    800fa3 <ipc_send+0x35>
			r=sys_ipc_try_send(to_env,  val, (void*) UTOP,  perm);
  800f81:	8b 45 14             	mov    0x14(%ebp),%eax
  800f84:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f88:	c7 44 24 08 00 00 c0 	movl   $0xeec00000,0x8(%esp)
  800f8f:	ee 
  800f90:	8b 45 0c             	mov    0xc(%ebp),%eax
  800f93:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f97:	89 3c 24             	mov    %edi,(%esp)
  800f9a:	e8 9c fe ff ff       	call   800e3b <sys_ipc_try_send>
  800f9f:	89 c3                	mov    %eax,%ebx
  800fa1:	eb 1c                	jmp    800fbf <ipc_send+0x51>
		else
			r = sys_ipc_try_send(to_env,  val, pg,  perm);
  800fa3:	8b 45 14             	mov    0x14(%ebp),%eax
  800fa6:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800faa:	89 74 24 08          	mov    %esi,0x8(%esp)
  800fae:	8b 45 0c             	mov    0xc(%ebp),%eax
  800fb1:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fb5:	89 3c 24             	mov    %edi,(%esp)
  800fb8:	e8 7e fe ff ff       	call   800e3b <sys_ipc_try_send>
  800fbd:	89 c3                	mov    %eax,%ebx

		if(r <0 && r != -E_IPC_NOT_RECV){
  800fbf:	89 d8                	mov    %ebx,%eax
  800fc1:	c1 e8 1f             	shr    $0x1f,%eax
  800fc4:	84 c0                	test   %al,%al
  800fc6:	74 3a                	je     801002 <ipc_send+0x94>
  800fc8:	83 fb f8             	cmp    $0xfffffff8,%ebx
  800fcb:	74 35                	je     801002 <ipc_send+0x94>
			cprintf("the envid is %x\n", sys_getenvid());
  800fcd:	e8 32 fc ff ff       	call   800c04 <sys_getenvid>
  800fd2:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fd6:	c7 04 24 9a 16 80 00 	movl   $0x80169a,(%esp)
  800fdd:	e8 e9 f1 ff ff       	call   8001cb <cprintf>
			panic("ipc_send is error, and the errno is %d\n", r);
  800fe2:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  800fe6:	c7 44 24 08 68 16 80 	movl   $0x801668,0x8(%esp)
  800fed:	00 
  800fee:	c7 44 24 04 53 00 00 	movl   $0x53,0x4(%esp)
  800ff5:	00 
  800ff6:	c7 04 24 90 16 80 00 	movl   $0x801690,(%esp)
  800ffd:	e8 56 00 00 00       	call   801058 <_panic>
		}
		else if(r == -E_IPC_NOT_RECV)
  801002:	83 fb f8             	cmp    $0xfffffff8,%ebx
  801005:	75 0e                	jne    801015 <ipc_send+0xa7>
			sys_yield();
  801007:	e8 28 fc ff ff       	call   800c34 <sys_yield>
		else break;
	}
  80100c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801010:	e9 68 ff ff ff       	jmp    800f7d <ipc_send+0xf>
...
ipc_find_env(enum EnvType type)
{
  ...
  801028:	6b d0 7c             	imul   $0x7c,%eax,%edx
  80102b:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801031:	8b 52 50             	mov    0x50(%edx),%edx
  801034:	39 ca                	cmp    %ecx,%edx
  801036:	75 0d                	jne    801045 <ipc_find_env+0x28>
			return envs[i].env_id;
  801038:	6b c0 7c             	imul   $0x7c,%eax,%eax
  80103b:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  801040:	8b 40 40             	mov    0x40(%eax),%eax
  801043:	eb 0e                	jmp    801053 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
	int i;
	for (i = 0; i < NENV; i++)
  801045:	83 c0 01             	add    $0x1,%eax
  801048:	3d 00 04 00 00       	cmp    $0x400,%eax
  80104d:	75 d9                	jne    801028 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  80104f:	66 b8 00 00          	mov    $0x0,%ax
}
  801053:	5d                   	pop    %ebp
  801054:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801069:	e8 96 fb ff ff       	call   800c04 <sys_getenvid>
  ...
  801084:	c7 04 24 ac 16 80 00 	movl   $0x8016ac,(%esp)
  80108b:	e8 3b f1 ff ff       	call   8001cb <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801090:	89 74 24 04          	mov    %esi,0x4(%esp)
  801094:	8b 45 10             	mov    0x10(%ebp),%eax
  801097:	89 04 24             	mov    %eax,(%esp)
  80109a:	e8 cb f0 ff ff       	call   80016a <vcprintf>
	cprintf("\n");
  80109f:	c7 04 24 6f 13 80 00 	movl   $0x80136f,(%esp)
  8010a6:	e8 20 f1 ff ff       	call   8001cb <cprintf>
