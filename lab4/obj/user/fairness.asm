...
umain(int argc, char **argv)
{
  ...
  800038:	83 ec 20             	sub    $0x20,%esp
	...
	id = sys_getenvid();
  80003b:	e8 c5 0b 00 00       	call   800c05 <sys_getenvid>
  ...
  800064:	e8 ef 0d 00 00       	call   800e58 <ipc_recv>
			cprintf("%x recv from %x\n", id, who);
  800069:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80006c:	89 54 24 08          	mov    %edx,0x8(%esp)
  800070:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800074:	c7 04 24 c0 11 80 00 	movl   $0x8011c0,(%esp)
  80007b:	e8 2e 01 00 00       	call   8001ae <cprintf>
  ...
  80008f:	c7 04 24 d1 11 80 00 	movl   $0x8011d1,(%esp)
  800096:	e8 13 01 00 00       	call   8001ae <cprintf>
		while (1)
  ...
  8000bb:	e8 ba 0d 00 00       	call   800e7a <ipc_send>
...
libmain(int argc, char **argv)
{
  ...
  8000cb:	8b 55 0c             	mov    0xc(%ebp),%edx
	// set thisenv to point at our Env structure in envs[].
	// LAB 3: Your code here.
	thisenv = 0;
  8000ce:	c7 05 04 20 80 00 00 	movl   $0x0,0x802004
  8000d5:	00 00 00 

	// save the name of the program so that panic() can use it
	if (argc > 0)
  8000d8:	85 c0                	test   %eax,%eax
  8000da:	7e 08                	jle    8000e4 <libmain+0x22>
		binaryname = argv[0];
  8000dc:	8b 0a                	mov    (%edx),%ecx
  8000de:	89 0d 00 20 80 00    	mov    %ecx,0x802000

	// call user main routine
	umain(argc, argv);
  8000e4:	89 54 24 04          	mov    %edx,0x4(%esp)
  8000e8:	89 04 24             	mov    %eax,(%esp)
  8000eb:	e8 43 ff ff ff       	call   800033 <umain>

	// exit gracefully
	exit();
  8000f0:	e8 02 00 00 00       	call   8000f7 <exit>
}
  8000f5:	c9                   	leave  
  8000f6:	c3                   	ret    
...
exit(void)
{
  ...
  800104:	e8 aa 0a 00 00       	call   800bb3 <sys_env_destroy>
}
  800109:	c9                   	leave  
  80010a:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  800128:	75 19                	jne    800143 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  80012a:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800131:	00 
  800132:	8d 43 08             	lea    0x8(%ebx),%eax
  800135:	89 04 24             	mov    %eax,(%esp)
  800138:	e8 39 0a 00 00       	call   800b76 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800150:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  80016d:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800171:	8b 45 08             	mov    0x8(%ebp),%eax
  800174:	89 44 24 08          	mov    %eax,0x8(%esp)
  800178:	8d 85 f0 fe ff ff    	lea    -0x110(%ebp),%eax
  80017e:	89 44 24 04          	mov    %eax,0x4(%esp)
  800182:	c7 04 24 0b 01 80 00 	movl   $0x80010b,(%esp)
  800189:	e8 76 01 00 00       	call   800304 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  80018e:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  800194:	89 44 24 04          	mov    %eax,0x4(%esp)
  800198:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  80019e:	89 04 24             	mov    %eax,(%esp)
  8001a1:	e8 d0 09 00 00       	call   800b76 <sys_cputs>
...
cprintf(const char *fmt, ...)
{
  ...
  8001c1:	e8 87 ff ff ff       	call   80014d <vcprintf>
	va_end(ap);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80023f:	e8 ec 0c 00 00       	call   800f30 <__udivdi3>
  ...
  80029f:	e8 bc 0d 00 00       	call   801060 <__umoddi3>
  8002a4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002a8:	0f be 80 f2 11 80 00 	movsbl 0x8011f2(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80038f:	ff 24 95 c0 12 80 00 	jmp    *0x8012c0(,%edx,4)
  ...
  80046b:	c7 44 24 08 13 12 80 	movl   $0x801213,0x8(%esp)
  800472:	00 
  ...
  80049b:	b8 03 12 80 00       	mov    $0x801203,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800be0:	00 
  800be1:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800be8:	00 
  800be9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bf0:	00 
  800bf1:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800bf8:	e8 d7 02 00 00       	call   800ed4 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c72:	00 
  800c73:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800c7a:	00 
  800c7b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c82:	00 
  800c83:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800c8a:	e8 45 02 00 00       	call   800ed4 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cc5:	00 
  800cc6:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800ccd:	00 
  800cce:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd5:	00 
  800cd6:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800cdd:	e8 f2 01 00 00       	call   800ed4 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d18:	00 
  800d19:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800d20:	00 
  800d21:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d28:	00 
  800d29:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800d30:	e8 9f 01 00 00       	call   800ed4 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d6b:	00 
  800d6c:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800d73:	00 
  800d74:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d7b:	00 
  800d7c:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800d83:	e8 4c 01 00 00       	call   800ed4 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dbe:	00 
  800dbf:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800dc6:	00 
  800dc7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dce:	00 
  800dcf:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800dd6:	e8 f9 00 00 00       	call   800ed4 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e33:	00 
  800e34:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800e3b:	00 
  800e3c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e43:	00 
  800e44:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800e4b:	e8 84 00 00 00       	call   800ed4 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800e5e:	c7 44 24 08 73 14 80 	movl   $0x801473,0x8(%esp)
  800e65:	00 
  800e66:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800e6d:	00 
  800e6e:	c7 04 24 8c 14 80 00 	movl   $0x80148c,(%esp)
  800e75:	e8 5a 00 00 00       	call   800ed4 <_panic>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800e80:	c7 44 24 08 96 14 80 	movl   $0x801496,0x8(%esp)
  800e87:	00 
  800e88:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  800e8f:	00 
  800e90:	c7 04 24 8c 14 80 00 	movl   $0x80148c,(%esp)
  800e97:	e8 38 00 00 00       	call   800ed4 <_panic>

00800e9c <ipc_find_env>:
...
ipc_find_env(enum EnvType type)
{
  ...
  800ea7:	6b d0 7c             	imul   $0x7c,%eax,%edx
  800eaa:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800eb0:	8b 52 50             	mov    0x50(%edx),%edx
  800eb3:	39 ca                	cmp    %ecx,%edx
  800eb5:	75 0d                	jne    800ec4 <ipc_find_env+0x28>
			return envs[i].env_id;
  800eb7:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800eba:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  800ebf:	8b 40 40             	mov    0x40(%eax),%eax
  800ec2:	eb 0e                	jmp    800ed2 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  800ec7:	3d 00 04 00 00       	cmp    $0x400,%eax
  800ecc:	75 d9                	jne    800ea7 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  800ece:	66 b8 00 00          	mov    $0x0,%ax
}
  800ed2:	5d                   	pop    %ebp
  800ed3:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ee5:	e8 1b fd ff ff       	call   800c05 <sys_getenvid>
  ...
  800ef8:	89 74 24 08          	mov    %esi,0x8(%esp)
  800efc:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f00:	c7 04 24 b0 14 80 00 	movl   $0x8014b0,(%esp)
  800f07:	e8 a2 f2 ff ff       	call   8001ae <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800f0c:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800f10:	8b 45 10             	mov    0x10(%ebp),%eax
  800f13:	89 04 24             	mov    %eax,(%esp)
  800f16:	e8 32 f2 ff ff       	call   80014d <vcprintf>
	cprintf("\n");
  800f1b:	c7 04 24 cf 11 80 00 	movl   $0x8011cf,(%esp)
  800f22:	e8 87 f2 ff ff       	call   8001ae <cprintf>
