...
umain(int argc, char **argv)
{
  ...
  80008f:	c7 04 24 f1 11 80 00 	movl   $0x8011f1,(%esp)
  ...
  8000bb:	e8 ca 0d 00 00       	call   800e8a <ipc_send>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024f:	e8 ec 0c 00 00       	call   800f40 <__udivdi3>
  ...
  8002af:	e8 bc 0d 00 00       	call   801070 <__umoddi3>
  8002b4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002b8:	0f be 80 12 12 80 00 	movsbl 0x801212(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80039f:	ff 24 95 e0 12 80 00 	jmp    *0x8012e0(,%edx,4)
  ...
  80047b:	c7 44 24 08 33 12 80 	movl   $0x801233,0x8(%esp)
  800482:	00 
  ...
  8004ab:	b8 23 12 80 00       	mov    $0x801223,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bf0:	00 
  800bf1:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800bf8:	00 
  800bf9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c00:	00 
  800c01:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800c08:	e8 d7 02 00 00       	call   800ee4 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c82:	00 
  800c83:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800c8a:	00 
  800c8b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c92:	00 
  800c93:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800c9a:	e8 45 02 00 00       	call   800ee4 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cd5:	00 
  800cd6:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800cdd:	00 
  800cde:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce5:	00 
  800ce6:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800ced:	e8 f2 01 00 00       	call   800ee4 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d28:	00 
  800d29:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800d30:	00 
  800d31:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d38:	00 
  800d39:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800d40:	e8 9f 01 00 00       	call   800ee4 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d7b:	00 
  800d7c:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800d83:	00 
  800d84:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d8b:	00 
  800d8c:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800d93:	e8 4c 01 00 00       	call   800ee4 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dce:	00 
  800dcf:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800dd6:	00 
  800dd7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dde:	00 
  800ddf:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800de6:	e8 f9 00 00 00       	call   800ee4 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e43:	00 
  800e44:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800e4b:	00 
  800e4c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e53:	00 
  800e54:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800e5b:	e8 84 00 00 00       	call   800ee4 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800e6e:	c7 44 24 08 93 14 80 	movl   $0x801493,0x8(%esp)
  800e75:	00 
  800e76:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800e7d:	00 
  800e7e:	c7 04 24 ac 14 80 00 	movl   $0x8014ac,(%esp)
  800e85:	e8 5a 00 00 00       	call   800ee4 <_panic>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800e90:	c7 44 24 08 b6 14 80 	movl   $0x8014b6,0x8(%esp)
  800e97:	00 
  800e98:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  800e9f:	00 
  800ea0:	c7 04 24 ac 14 80 00 	movl   $0x8014ac,(%esp)
  800ea7:	e8 38 00 00 00       	call   800ee4 <_panic>

00800eac <ipc_find_env>:
...
ipc_find_env(enum EnvType type)
{
  ...
  800eb7:	6b d0 7c             	imul   $0x7c,%eax,%edx
  800eba:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800ec0:	8b 52 50             	mov    0x50(%edx),%edx
  800ec3:	39 ca                	cmp    %ecx,%edx
  800ec5:	75 0d                	jne    800ed4 <ipc_find_env+0x28>
			return envs[i].env_id;
  800ec7:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800eca:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  800ecf:	8b 40 40             	mov    0x40(%eax),%eax
  800ed2:	eb 0e                	jmp    800ee2 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  800ed7:	3d 00 04 00 00       	cmp    $0x400,%eax
  800edc:	75 d9                	jne    800eb7 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  800ede:	66 b8 00 00          	mov    $0x0,%ax
}
  800ee2:	5d                   	pop    %ebp
  800ee3:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ee9:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800eec:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800eef:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800ef5:	e8 1b fd ff ff       	call   800c15 <sys_getenvid>
  800efa:	8b 55 0c             	mov    0xc(%ebp),%edx
  800efd:	89 54 24 10          	mov    %edx,0x10(%esp)
  800f01:	8b 55 08             	mov    0x8(%ebp),%edx
  800f04:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800f08:	89 74 24 08          	mov    %esi,0x8(%esp)
  800f0c:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f10:	c7 04 24 d0 14 80 00 	movl   $0x8014d0,(%esp)
  800f17:	e8 a5 f2 ff ff       	call   8001c1 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800f1c:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800f20:	8b 45 10             	mov    0x10(%ebp),%eax
  800f23:	89 04 24             	mov    %eax,(%esp)
  800f26:	e8 35 f2 ff ff       	call   800160 <vcprintf>
	cprintf("\n");
  800f2b:	c7 04 24 ef 11 80 00 	movl   $0x8011ef,(%esp)
  800f32:	e8 8a f2 ff ff       	call   8001c1 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800f37:	cc                   	int3   
  800f38:	eb fd                	jmp    800f37 <_panic+0x53>
