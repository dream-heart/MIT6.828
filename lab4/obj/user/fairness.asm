...
umain(int argc, char **argv)
{
  ...
  8000bb:	e8 38 0e 00 00       	call   800ef8 <ipc_send>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024f:	e8 cc 0d 00 00       	call   801020 <__udivdi3>
  ...
  8002af:	e8 9c 0e 00 00       	call   801150 <__umoddi3>
  8002b4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002b8:	0f be 80 f2 12 80 00 	movsbl 0x8012f2(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80039f:	ff 24 95 c0 13 80 00 	jmp    *0x8013c0(,%edx,4)
  ...
  80044c:	8b 14 85 20 15 80 00 	mov    0x801520(,%eax,4),%edx
  ...
  80047b:	c7 44 24 08 13 13 80 	movl   $0x801313,0x8(%esp)
  800482:	00 
  ...
  8004ab:	b8 03 13 80 00       	mov    $0x801303,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bf0:	00 
  800bf1:	c7 44 24 08 48 15 80 	movl   $0x801548,0x8(%esp)
  800bf8:	00 
  800bf9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c00:	00 
  800c01:	c7 04 24 65 15 80 00 	movl   $0x801565,(%esp)
  800c08:	e8 b5 03 00 00       	call   800fc2 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c82:	00 
  800c83:	c7 44 24 08 48 15 80 	movl   $0x801548,0x8(%esp)
  800c8a:	00 
  800c8b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c92:	00 
  800c93:	c7 04 24 65 15 80 00 	movl   $0x801565,(%esp)
  800c9a:	e8 23 03 00 00       	call   800fc2 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cd5:	00 
  800cd6:	c7 44 24 08 48 15 80 	movl   $0x801548,0x8(%esp)
  800cdd:	00 
  800cde:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce5:	00 
  800ce6:	c7 04 24 65 15 80 00 	movl   $0x801565,(%esp)
  800ced:	e8 d0 02 00 00       	call   800fc2 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d28:	00 
  800d29:	c7 44 24 08 48 15 80 	movl   $0x801548,0x8(%esp)
  800d30:	00 
  800d31:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d38:	00 
  800d39:	c7 04 24 65 15 80 00 	movl   $0x801565,(%esp)
  800d40:	e8 7d 02 00 00       	call   800fc2 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d7b:	00 
  800d7c:	c7 44 24 08 48 15 80 	movl   $0x801548,0x8(%esp)
  800d83:	00 
  800d84:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d8b:	00 
  800d8c:	c7 04 24 65 15 80 00 	movl   $0x801565,(%esp)
  800d93:	e8 2a 02 00 00       	call   800fc2 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dce:	00 
  800dcf:	c7 44 24 08 48 15 80 	movl   $0x801548,0x8(%esp)
  800dd6:	00 
  800dd7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dde:	00 
  800ddf:	c7 04 24 65 15 80 00 	movl   $0x801565,(%esp)
  800de6:	e8 d7 01 00 00       	call   800fc2 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e5b:	e8 62 01 00 00       	call   800fc2 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800e7f:	8b 75 10             	mov    0x10(%ebp),%esi
	...
	int a;
	if((int)pg == 0xb00000)
  800e82:	81 fb 00 00 b0 00    	cmp    $0xb00000,%ebx
  800e88:	75 0c                	jne    800e96 <ipc_recv+0x26>
		cprintf("\n");
  800e8a:	c7 04 24 84 15 80 00 	movl   $0x801584,(%esp)
  800e91:	e8 2b f3 ff ff       	call   8001c1 <cprintf>
	if(pg == 0)
  800e96:	85 db                	test   %ebx,%ebx
  800e98:	75 0e                	jne    800ea8 <ipc_recv+0x38>
		r= sys_ipc_recv( (void *)UTOP);
  800e9a:	c7 04 24 00 00 c0 ee 	movl   $0xeec00000,(%esp)
  800ea1:	e8 70 ff ff ff       	call   800e16 <sys_ipc_recv>
  800ea6:	eb 08                	jmp    800eb0 <ipc_recv+0x40>
	else
		r = sys_ipc_recv(pg);
  800ea8:	89 1c 24             	mov    %ebx,(%esp)
  800eab:	e8 66 ff ff ff       	call   800e16 <sys_ipc_recv>
	if(r == 0){
  800eb0:	85 c0                	test   %eax,%eax
  800eb2:	75 1e                	jne    800ed2 <ipc_recv+0x62>
		if( from_env_store != 0 )
  800eb4:	85 ff                	test   %edi,%edi
  800eb6:	74 0a                	je     800ec2 <ipc_recv+0x52>
			*from_env_store = thisenv->env_ipc_from;
  800eb8:	a1 04 20 80 00       	mov    0x802004,%eax
  800ebd:	8b 40 74             	mov    0x74(%eax),%eax
  800ec0:	89 07                	mov    %eax,(%edi)

		if(perm_store != 0 )
  800ec2:	85 f6                	test   %esi,%esi
  800ec4:	74 22                	je     800ee8 <ipc_recv+0x78>
			*perm_store = thisenv->env_ipc_perm;
  800ec6:	a1 04 20 80 00       	mov    0x802004,%eax
  800ecb:	8b 40 78             	mov    0x78(%eax),%eax
  800ece:	89 06                	mov    %eax,(%esi)
  800ed0:	eb 16                	jmp    800ee8 <ipc_recv+0x78>
	}
	else{
		if(from_env_store != 0 )
  800ed2:	85 ff                	test   %edi,%edi
  800ed4:	74 06                	je     800edc <ipc_recv+0x6c>
			*from_env_store = 0;
  800ed6:	c7 07 00 00 00 00    	movl   $0x0,(%edi)

		if(perm_store != 0 )
  800edc:	85 f6                	test   %esi,%esi
  800ede:	74 10                	je     800ef0 <ipc_recv+0x80>
			*perm_store = 0;
  800ee0:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  800ee6:	eb 08                	jmp    800ef0 <ipc_recv+0x80>
		return r;
	}

	return thisenv->env_ipc_value;
  800ee8:	a1 04 20 80 00       	mov    0x802004,%eax
  800eed:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800f01:	8b 7d 08             	mov    0x8(%ebp),%edi
  ...
  800f0c:	75 1d                	jne    800f2b <ipc_send+0x33>
			r=sys_ipc_try_send(to_env,  val, (void*) UTOP,  perm);
  800f0e:	8b 45 14             	mov    0x14(%ebp),%eax
  800f11:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f15:	c7 44 24 08 00 00 c0 	movl   $0xeec00000,0x8(%esp)
  800f1c:	ee 
  800f1d:	89 74 24 04          	mov    %esi,0x4(%esp)
  800f21:	89 3c 24             	mov    %edi,(%esp)
  800f24:	e8 ca fe ff ff       	call   800df3 <sys_ipc_try_send>
  800f29:	eb 1b                	jmp    800f46 <ipc_send+0x4e>
		else
			r = sys_ipc_try_send(to_env,  val, (void*) UTOP,  perm);
  800f2b:	8b 45 14             	mov    0x14(%ebp),%eax
  800f2e:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f32:	c7 44 24 08 00 00 c0 	movl   $0xeec00000,0x8(%esp)
  800f39:	ee 
  800f3a:	89 74 24 04          	mov    %esi,0x4(%esp)
  800f3e:	89 3c 24             	mov    %edi,(%esp)
  800f41:	e8 ad fe ff ff       	call   800df3 <sys_ipc_try_send>


		if(r == 0)
  800f46:	85 c0                	test   %eax,%eax
  800f48:	74 38                	je     800f82 <ipc_send+0x8a>
			return;
		if(r <0 && r != -E_IPC_NOT_RECV)
  800f4a:	83 f8 f8             	cmp    $0xfffffff8,%eax
  800f4d:	74 25                	je     800f74 <ipc_send+0x7c>
  800f4f:	89 c2                	mov    %eax,%edx
  800f51:	c1 ea 1f             	shr    $0x1f,%edx
  800f54:	84 d2                	test   %dl,%dl
  800f56:	74 1c                	je     800f74 <ipc_send+0x7c>
			panic("ipc_send is error\n");
  800f58:	c7 44 24 08 73 15 80 	movl   $0x801573,0x8(%esp)
  800f5f:	00 
  800f60:	c7 44 24 04 4f 00 00 	movl   $0x4f,0x4(%esp)
  800f67:	00 
  800f68:	c7 04 24 86 15 80 00 	movl   $0x801586,(%esp)
  800f6f:	e8 4e 00 00 00       	call   800fc2 <_panic>
		if(r == -E_IPC_NOT_RECV)
  800f74:	83 f8 f8             	cmp    $0xfffffff8,%eax
  800f77:	75 91                	jne    800f0a <ipc_send+0x12>
			sys_yield();
  800f79:	e8 b6 fc ff ff       	call   800c34 <sys_yield>
  800f7e:	66 90                	xchg   %ax,%ax
  800f80:	eb 88                	jmp    800f0a <ipc_send+0x12>
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  800f95:	6b d0 7c             	imul   $0x7c,%eax,%edx
  800f98:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800f9e:	8b 52 50             	mov    0x50(%edx),%edx
  800fa1:	39 ca                	cmp    %ecx,%edx
  800fa3:	75 0d                	jne    800fb2 <ipc_find_env+0x28>
			return envs[i].env_id;
  800fa5:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800fa8:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  800fad:	8b 40 40             	mov    0x40(%eax),%eax
  800fb0:	eb 0e                	jmp    800fc0 <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  800fba:	75 d9                	jne    800f95 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  800fbc:	66 b8 00 00          	mov    $0x0,%ax
}
  800fc0:	5d                   	pop    %ebp
  800fc1:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800fc7:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800fca:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800fcd:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800fd3:	e8 3d fc ff ff       	call   800c15 <sys_getenvid>
  800fd8:	8b 55 0c             	mov    0xc(%ebp),%edx
  800fdb:	89 54 24 10          	mov    %edx,0x10(%esp)
  800fdf:	8b 55 08             	mov    0x8(%ebp),%edx
  800fe2:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800fe6:	89 74 24 08          	mov    %esi,0x8(%esp)
  800fea:	89 44 24 04          	mov    %eax,0x4(%esp)
  800fee:	c7 04 24 90 15 80 00 	movl   $0x801590,(%esp)
  800ff5:	e8 c7 f1 ff ff       	call   8001c1 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800ffa:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800ffe:	8b 45 10             	mov    0x10(%ebp),%eax
  801001:	89 04 24             	mov    %eax,(%esp)
  801004:	e8 57 f1 ff ff       	call   800160 <vcprintf>
	cprintf("\n");
  801009:	c7 04 24 84 15 80 00 	movl   $0x801584,(%esp)
  801010:	e8 ac f1 ff ff       	call   8001c1 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  801015:	cc                   	int3   
  801016:	eb fd                	jmp    801015 <_panic+0x53>
