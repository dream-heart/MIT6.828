...
exit(void)
{
  ...
  800156:	e8 f8 0a 00 00       	call   800c53 <sys_env_destroy>
}
  80015b:	c9                   	leave  
  80015c:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80016e:	e8 32 0b 00 00       	call   800ca5 <sys_getenvid>
  ...
  800189:	c7 04 24 28 10 80 00 	movl   $0x801028,(%esp)
  ...
  80019f:	e8 51 00 00 00       	call   8001f5 <vcprintf>
	cprintf("\n");
  8001a4:	c7 04 24 f6 0f 80 00 	movl   $0x800ff6,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8001e0:	e8 31 0a 00 00       	call   800c16 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800231:	e8 6e 01 00 00       	call   8003a4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800249:	e8 c8 09 00 00       	call   800c16 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002df:	e8 ec 09 00 00       	call   800cd0 <__udivdi3>
  ...
  80033f:	e8 bc 0a 00 00       	call   800e00 <__umoddi3>
  800344:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800348:	0f be 80 4c 10 80 00 	movsbl 0x80104c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80042f:	ff 24 95 e0 10 80 00 	jmp    *0x8010e0(,%edx,4)
  ...
  80050b:	c7 44 24 08 6d 10 80 	movl   $0x80106d,0x8(%esp)
  800512:	00 
  ...
  80053b:	b8 5d 10 80 00       	mov    $0x80105d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c80:	00 
  800c81:	c7 44 24 08 60 12 80 	movl   $0x801260,0x8(%esp)
  800c88:	00 
  800c89:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  800c90:	00 
  800c91:	c7 04 24 7d 12 80 00 	movl   $0x80127d,(%esp)
  800c98:	e8 c0 f4 ff ff       	call   80015d <_panic>
