	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800238:	0f be 80 08 11 80 00 	movsbl 0x801108(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80031f:	ff 24 95 c0 11 80 00 	jmp    *0x8011c0(,%edx,4)
  ...
  8003fb:	c7 44 24 08 29 11 80 	movl   $0x801129,0x8(%esp)
  800402:	00 
  ...
  80042b:	b8 19 11 80 00       	mov    $0x801119,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e2a:	e8 ac f2 ff ff       	call   8000db <vcprintf>
	cprintf("\n");
  800e2f:	c7 04 24 fc 10 80 00 	movl   $0x8010fc,(%esp)
