	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 e8 0e 80 00 	movsbl 0x800ee8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003eb:	c7 44 24 08 00 0f 80 	movl   $0x800f00,0x8(%esp)
  8003f2:	00 
  ...
  80040b:	c7 44 24 08 09 0f 80 	movl   $0x800f09,0x8(%esp)
  800412:	00 
  ...
  80043b:	b8 f9 0e 80 00       	mov    $0x800ef9,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c06:	e8 e6 f4 ff ff       	call   8000f1 <vcprintf>
	cprintf("\n");
  800c0b:	c7 04 24 dc 0e 80 00 	movl   $0x800edc,(%esp)
