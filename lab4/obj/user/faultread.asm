	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800239:	0f be 80 a8 11 80 00 	movsbl 0x8011a8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800417:	c7 44 24 08 c0 11 80 	movl   $0x8011c0,0x8(%esp)
  80041e:	00 
  ...
  80043a:	c7 44 24 08 c9 11 80 	movl   $0x8011c9,0x8(%esp)
  800441:	00 
  ...
  80046f:	ba b9 11 80 00       	mov    $0x8011b9,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e9e:	e8 57 f2 ff ff       	call   8000fa <vcprintf>
	cprintf("\n");
  800ea3:	c7 04 24 9c 11 80 00 	movl   $0x80119c,(%esp)
