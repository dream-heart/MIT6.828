...
umain(int argc, char **argv)
{
  ...
  800052:	c7 04 24 8e 11 80 00 	movl   $0x80118e,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  800072:	e8 2d 0b 00 00       	call   800ba4 <sys_getenvid>
...
exit(void)
{
  ...
  8000bd:	e8 85 0a 00 00       	call   800b47 <sys_env_destroy>
}
  8000c2:	c9                   	leave  
  8000c3:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000f1:	e8 f2 09 00 00       	call   800ae8 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800142:	e8 96 01 00 00       	call   8002dd <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80015a:	e8 89 09 00 00       	call   800ae8 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800249:	0f be 80 af 11 80 00 	movsbl 0x8011af(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800372:	ff 24 95 80 12 80 00 	jmp    *0x801280(,%edx,4)
  ...
  80044a:	c7 44 24 08 d0 11 80 	movl   $0x8011d0,0x8(%esp)
  800451:	00 
  ...
  80047f:	ba c0 11 80 00       	mov    $0x8011c0,%edx
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c39:	00 
  800c3a:	c7 44 24 08 08 14 80 	movl   $0x801408,0x8(%esp)
  800c41:	00 
  800c42:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c49:	00 
  800c4a:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c97:	00 
  800c98:	c7 44 24 08 08 14 80 	movl   $0x801408,0x8(%esp)
  800c9f:	00 
  800ca0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca7:	00 
  800ca8:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cf5:	00 
  800cf6:	c7 44 24 08 08 14 80 	movl   $0x801408,0x8(%esp)
  800cfd:	00 
  800cfe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d05:	00 
  800d06:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d53:	00 
  800d54:	c7 44 24 08 08 14 80 	movl   $0x801408,0x8(%esp)
  800d5b:	00 
  800d5c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d63:	00 
  800d64:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800db1:	00 
  800db2:	c7 44 24 08 08 14 80 	movl   $0x801408,0x8(%esp)
  800db9:	00 
  800dba:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dc1:	00 
  800dc2:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e42:	00 
  800e43:	c7 44 24 08 08 14 80 	movl   $0x801408,0x8(%esp)
  800e4a:	00 
  800e4b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e52:	00 
  800e53:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e98:	c7 04 24 34 14 80 00 	movl   $0x801434,(%esp)
  800e9f:	e8 c3 f2 ff ff       	call   800167 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800ea4:	89 74 24 04          	mov    %esi,0x4(%esp)
  800ea8:	8b 45 10             	mov    0x10(%ebp),%eax
  800eab:	89 04 24             	mov    %eax,(%esp)
  800eae:	e8 53 f2 ff ff       	call   800106 <vcprintf>
	cprintf("\n");
  800eb3:	c7 04 24 8c 11 80 00 	movl   $0x80118c,(%esp)
  800eba:	e8 a8 f2 ff ff       	call   800167 <cprintf>
