...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 18             	sub    $0x18,%esp
	cprintf("hello, world\n");
  800039:	c7 04 24 e0 10 80 00 	movl   $0x8010e0,(%esp)
  ...
  800051:	c7 04 24 ee 10 80 00 	movl   $0x8010ee,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 0f 11 80 00 	movsbl 0x80110f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80032f:	ff 24 95 e0 11 80 00 	jmp    *0x8011e0(,%edx,4)
  ...
  80040b:	c7 44 24 08 30 11 80 	movl   $0x801130,0x8(%esp)
  800412:	00 
  ...
  80043b:	b8 20 11 80 00       	mov    $0x801120,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b80:	00 
  800b81:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800b88:	00 
  800b89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b90:	00 
  800b91:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c12:	00 
  800c13:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800c1a:	00 
  800c1b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c22:	00 
  800c23:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c65:	00 
  800c66:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800c6d:	00 
  800c6e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c75:	00 
  800c76:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cb8:	00 
  800cb9:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800cc0:	00 
  800cc1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc8:	00 
  800cc9:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d0b:	00 
  800d0c:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800d13:	00 
  800d14:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d1b:	00 
  800d1c:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d5e:	00 
  800d5f:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800d66:	00 
  800d67:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d6e:	00 
  800d6f:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800dd3:	00 
  800dd4:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800ddb:	00 
  800ddc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de3:	00 
  800de4:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e24:	c7 04 24 94 13 80 00 	movl   $0x801394,(%esp)
  800e2b:	e8 1b f3 ff ff       	call   80014b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e30:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800e34:	8b 45 10             	mov    0x10(%ebp),%eax
  800e37:	89 04 24             	mov    %eax,(%esp)
  800e3a:	e8 ab f2 ff ff       	call   8000ea <vcprintf>
	cprintf("\n");
  800e3f:	c7 04 24 ec 10 80 00 	movl   $0x8010ec,(%esp)
  800e46:	e8 00 f3 ff ff       	call   80014b <cprintf>
