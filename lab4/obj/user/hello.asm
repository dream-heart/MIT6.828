	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 ef 0e 80 00 	movsbl 0x800eef(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003fb:	c7 44 24 08 07 0f 80 	movl   $0x800f07,0x8(%esp)
  800402:	00 
  ...
  80041b:	c7 44 24 08 10 0f 80 	movl   $0x800f10,0x8(%esp)
  800422:	00 
  ...
  80044b:	b8 00 0f 80 00       	mov    $0x800f00,%eax
