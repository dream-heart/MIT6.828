	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 51 11 80 00 	movsbl 0x801151(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003fb:	c7 44 24 08 69 11 80 	movl   $0x801169,0x8(%esp)
  800402:	00 
  ...
  80041b:	c7 44 24 08 72 11 80 	movl   $0x801172,0x8(%esp)
  800422:	00 
  ...
  80044b:	b8 62 11 80 00       	mov    $0x801162,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e4a:	e8 aa f2 ff ff       	call   8000f9 <vcprintf>
	cprintf("\n");
  800e4f:	c7 04 24 f8 13 80 00 	movl   $0x8013f8,(%esp)
