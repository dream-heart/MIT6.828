...
umain(int argc, char **argv)
{
  ...
  800042:	c7 04 24 c0 0e 80 00 	movl   $0x800ec0,(%esp)
...
exit(void)
{
  ...
  8000a8:	e8 a6 0a 00 00       	call   800b53 <sys_env_destroy>
}
  8000ad:	c9                   	leave  
  8000ae:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000dc:	e8 35 0a 00 00       	call   800b16 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80012d:	e8 72 01 00 00       	call   8002a4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800145:	e8 cc 09 00 00       	call   800b16 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 f1 0e 80 00 	movsbl 0x800ef1(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003eb:	c7 44 24 08 09 0f 80 	movl   $0x800f09,0x8(%esp)
  8003f2:	00 
  ...
  80040b:	c7 44 24 08 12 0f 80 	movl   $0x800f12,0x8(%esp)
  800412:	00 
  ...
  80043b:	b8 02 0f 80 00       	mov    $0x800f02,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b88:	00 
  800b89:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  800b90:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800bf7:	e8 56 f5 ff ff       	call   800152 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800bfc:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800c00:	8b 45 10             	mov    0x10(%ebp),%eax
  800c03:	89 04 24             	mov    %eax,(%esp)
  800c06:	e8 e6 f4 ff ff       	call   8000f1 <vcprintf>
	cprintf("\n");
  800c0b:	c7 04 24 50 11 80 00 	movl   $0x801150,(%esp)
  800c12:	e8 3b f5 ff ff       	call   800152 <cprintf>
