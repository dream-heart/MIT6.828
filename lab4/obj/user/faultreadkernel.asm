	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 11 11 80 00 	movsbl 0x801111(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003eb:	c7 44 24 08 29 11 80 	movl   $0x801129,0x8(%esp)
  8003f2:	00 
  ...
  80040b:	c7 44 24 08 32 11 80 	movl   $0x801132,0x8(%esp)
  800412:	00 
  ...
  80043b:	b8 22 11 80 00       	mov    $0x801122,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e3a:	e8 af f2 ff ff       	call   8000ee <vcprintf>
	cprintf("\n");
  800e3f:	c7 04 24 b8 13 80 00 	movl   $0x8013b8,(%esp)
