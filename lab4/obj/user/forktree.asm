...
forkchild(const char *cur, char branch)
{
  ...
  8000ba:	e8 49 07 00 00       	call   800808 <snprintf>
	if (fork() == 0) {
  8000bf:	e8 2b 0f 00 00       	call   800fef <fork>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80027f:	e8 cc 10 00 00       	call   801350 <__udivdi3>
  ...
  8002df:	e8 9c 11 00 00       	call   801480 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003cf:	ff 24 95 c0 16 80 00 	jmp    *0x8016c0(,%edx,4)
  ...
  8004ab:	c7 44 24 08 21 16 80 	movl   $0x801621,0x8(%esp)
  8004b2:	00 
  ...
  8004db:	b8 11 16 80 00       	mov    $0x801611,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c20:	00 
  800c21:	c7 44 24 08 48 18 80 	movl   $0x801848,0x8(%esp)
  800c28:	00 
  800c29:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c30:	00 
  800c31:	c7 04 24 65 18 80 00 	movl   $0x801865,(%esp)
  800c38:	e8 e7 05 00 00       	call   801224 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cb2:	00 
  800cb3:	c7 44 24 08 48 18 80 	movl   $0x801848,0x8(%esp)
  800cba:	00 
  800cbb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc2:	00 
  800cc3:	c7 04 24 65 18 80 00 	movl   $0x801865,(%esp)
  800cca:	e8 55 05 00 00       	call   801224 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d05:	00 
  800d06:	c7 44 24 08 48 18 80 	movl   $0x801848,0x8(%esp)
  800d0d:	00 
  800d0e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d15:	00 
  800d16:	c7 04 24 65 18 80 00 	movl   $0x801865,(%esp)
  800d1d:	e8 02 05 00 00       	call   801224 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d58:	00 
  800d59:	c7 44 24 08 48 18 80 	movl   $0x801848,0x8(%esp)
  800d60:	00 
  800d61:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d68:	00 
  800d69:	c7 04 24 65 18 80 00 	movl   $0x801865,(%esp)
  800d70:	e8 af 04 00 00       	call   801224 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dab:	00 
  800dac:	c7 44 24 08 48 18 80 	movl   $0x801848,0x8(%esp)
  800db3:	00 
  800db4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dbb:	00 
  800dbc:	c7 04 24 65 18 80 00 	movl   $0x801865,(%esp)
  800dc3:	e8 5c 04 00 00       	call   801224 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dfe:	00 
  800dff:	c7 44 24 08 48 18 80 	movl   $0x801848,0x8(%esp)
  800e06:	00 
  800e07:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e0e:	00 
  800e0f:	c7 04 24 65 18 80 00 	movl   $0x801865,(%esp)
  800e16:	e8 09 04 00 00       	call   801224 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e73:	00 
  800e74:	c7 44 24 08 48 18 80 	movl   $0x801848,0x8(%esp)
  800e7b:	00 
  800e7c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e83:	00 
  800e84:	c7 04 24 65 18 80 00 	movl   $0x801865,(%esp)
  800e8b:	e8 94 03 00 00       	call   801224 <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800ea9:	75 2c                	jne    800ed7 <pgfault+0x3f>
		//cprintf(	" The eid = %x\n", sys_getenvid());
		//cprintf("The err is %d\n", err);
		cprintf("The va is 0x%x\n", (int)addr );
  800eab:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800eaf:	c7 04 24 73 18 80 00 	movl   $0x801873,(%esp)
  800eb6:	e8 37 f3 ff ff       	call   8001f2 <cprintf>

		 panic("The err is not right of the pgfault\n ");
  800ebb:	c7 44 24 08 b8 18 80 	movl   $0x8018b8,0x8(%esp)
  800ec2:	00 
  800ec3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eca:	00 
  800ecb:	c7 04 24 83 18 80 00 	movl   $0x801883,(%esp)
  800ed2:	e8 4d 03 00 00       	call   801224 <_panic>
	}
  ...
  800ee6:	75 1c                	jne    800f04 <pgfault+0x6c>
		panic("The pgfault perm is not right\n");
  800ee8:	c7 44 24 08 e0 18 80 	movl   $0x8018e0,0x8(%esp)
  800eef:	00 
  800ef0:	c7 44 24 04 29 00 00 	movl   $0x29,0x4(%esp)
  800ef7:	00 
  800ef8:	c7 04 24 83 18 80 00 	movl   $0x801883,(%esp)
  800eff:	e8 20 03 00 00       	call   801224 <_panic>
  ...
  800f04:	e8 3c fd ff ff       	call   800c45 <sys_getenvid>
  800f09:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  800f10:	00 
  800f11:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f18:	00 
  800f19:	89 04 24             	mov    %eax,(%esp)
  800f1c:	e8 62 fd ff ff       	call   800c83 <sys_page_alloc>
  800f21:	85 c0                	test   %eax,%eax
  800f23:	79 1c                	jns    800f41 <pgfault+0xa9>
		panic("pgfault sys_page_alloc is not right\n");
  800f25:	c7 44 24 08 00 19 80 	movl   $0x801900,0x8(%esp)
  800f2c:	00 
  800f2d:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  800f34:	00 
  800f35:	c7 04 24 83 18 80 00 	movl   $0x801883,(%esp)
  800f3c:	e8 e3 02 00 00       	call   801224 <_panic>
	addr = ROUNDDOWN(addr, PGSIZE);
  800f41:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
	memcpy((void*)PFTEMP, addr, PGSIZE);
  800f47:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  800f4e:	00 
  800f4f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800f53:	c7 04 24 00 f0 7f 00 	movl   $0x7ff000,(%esp)
  800f5a:	e8 0d fb ff ff       	call   800a6c <memcpy>

	if((r = sys_page_map(sys_getenvid(), (void*)PFTEMP, sys_getenvid(), addr, PTE_U|PTE_W|PTE_P)) < 0)
  800f5f:	e8 e1 fc ff ff       	call   800c45 <sys_getenvid>
  800f64:	89 c6                	mov    %eax,%esi
  800f66:	e8 da fc ff ff       	call   800c45 <sys_getenvid>
  800f6b:	c7 44 24 10 07 00 00 	movl   $0x7,0x10(%esp)
  800f72:	00 
  800f73:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  800f77:	89 74 24 08          	mov    %esi,0x8(%esp)
  800f7b:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f82:	00 
  800f83:	89 04 24             	mov    %eax,(%esp)
  800f86:	e8 4c fd ff ff       	call   800cd7 <sys_page_map>
  800f8b:	85 c0                	test   %eax,%eax
  800f8d:	79 20                	jns    800faf <pgfault+0x117>
		panic("The sys_page_map is not right, the errno is %d\n", r);
  800f8f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f93:	c7 44 24 08 28 19 80 	movl   $0x801928,0x8(%esp)
  800f9a:	00 
  800f9b:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
  800fa2:	00 
  800fa3:	c7 04 24 83 18 80 00 	movl   $0x801883,(%esp)
  800faa:	e8 75 02 00 00       	call   801224 <_panic>
	if( (r = sys_page_unmap(sys_getenvid(), (void*)PFTEMP)) <0 )
  800faf:	e8 91 fc ff ff       	call   800c45 <sys_getenvid>
  800fb4:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800fbb:	00 
  800fbc:	89 04 24             	mov    %eax,(%esp)
  800fbf:	e8 66 fd ff ff       	call   800d2a <sys_page_unmap>
  800fc4:	85 c0                	test   %eax,%eax
  800fc6:	79 20                	jns    800fe8 <pgfault+0x150>
		panic("The sys_page_unmap is not right, the errno is %d\n",r);
  800fc8:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800fcc:	c7 44 24 08 58 19 80 	movl   $0x801958,0x8(%esp)
  800fd3:	00 
  800fd4:	c7 44 24 04 3a 00 00 	movl   $0x3a,0x4(%esp)
  800fdb:	00 
  800fdc:	c7 04 24 83 18 80 00 	movl   $0x801883,(%esp)
  800fe3:	e8 3c 02 00 00       	call   801224 <_panic>
	return;
...
fork(void)
{
  ...
  800ff8:	c7 04 24 98 0e 80 00 	movl   $0x800e98,(%esp)
  800fff:	e8 76 02 00 00       	call   80127a <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  801013:	79 20                	jns    801035 <fork+0x46>
		panic("sys_exofork() is not right, and the errno is  %d\n",childEid);
  801015:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801019:	c7 44 24 08 8c 19 80 	movl   $0x80198c,0x8(%esp)
  801020:	00 
  801021:	c7 44 24 04 81 00 00 	movl   $0x81,0x4(%esp)
  801028:	00 
  801029:	c7 04 24 83 18 80 00 	movl   $0x801883,(%esp)
  801030:	e8 ef 01 00 00       	call   801224 <_panic>
	if(childEid == 0){
  801035:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
  801039:	75 1c                	jne    801057 <fork+0x68>
		thisenv = &envs[ENVX(sys_getenvid())];
  80103b:	e8 05 fc ff ff       	call   800c45 <sys_getenvid>
  801040:	25 ff 03 00 00       	and    $0x3ff,%eax
  801045:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801048:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  80104d:	a3 04 20 80 00       	mov    %eax,0x802004
		return childEid;
  801052:	e9 a0 01 00 00       	jmp    8011f7 <fork+0x208>
	}

	int r = sys_env_set_pgfault_upcall(childEid,  _pgfault_upcall);
  801057:	c7 44 24 04 10 13 80 	movl   $0x801310,0x4(%esp)
  80105e:	00 
  80105f:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801062:	89 04 24             	mov    %eax,(%esp)
  801065:	e8 66 fd ff ff       	call   800dd0 <sys_env_set_pgfault_upcall>
  80106a:	89 c7                	mov    %eax,%edi
	if(r < 0)
  80106c:	85 c0                	test   %eax,%eax
  80106e:	79 20                	jns    801090 <fork+0xa1>
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
  801070:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801074:	c7 44 24 08 c0 19 80 	movl   $0x8019c0,0x8(%esp)
  80107b:	00 
  80107c:	c7 44 24 04 89 00 00 	movl   $0x89,0x4(%esp)
  801083:	00 
  801084:	c7 04 24 83 18 80 00 	movl   $0x801883,(%esp)
  80108b:	e8 94 01 00 00       	call   801224 <_panic>
		thisenv = &envs[ENVX(sys_getenvid())];
		return childEid;
	}
	...
	int r = sys_env_set_pgfault_upcall(childEid,  _pgfault_upcall);
	if(r < 0)
  801090:	be 00 10 00 00       	mov    $0x1000,%esi
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
  ...
  80109f:	89 7d e4             	mov    %edi,-0x1c(%ebp)
  ...
  8010b1:	0f 84 f7 00 00 00    	je     8011ae <fork+0x1bf>
  ...
  8010c4:	0f 84 e4 00 00 00    	je     8011ae <fork+0x1bf>
				( (uvpt[PGNUM(pn*PGSIZE)] & PTE_U) != 0) &&
				( (uvpt[PGNUM(pn*PGSIZE)] & PTE_P) != 0))
  8010ca:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
  ...
  8010d3:	0f 84 d5 00 00 00    	je     8011ae <fork+0x1bf>
				( (uvpt[PGNUM(pn*PGSIZE)] & PTE_P) != 0))
		{
		//build experition stack for the child env
			if(pn*PGSIZE == UXSTACKTOP -PGSIZE)
  8010d9:	81 f9 00 f0 bf ee    	cmp    $0xeebff000,%ecx
  8010df:	75 20                	jne    801101 <fork+0x112>
  ...
  8010f7:	e8 87 fb ff ff       	call   800c83 <sys_page_alloc>
  8010fc:	e9 84 00 00 00       	jmp    801185 <fork+0x196>
  801101:	8d be 00 f0 ff ff    	lea    -0x1000(%esi),%edi
duppage(envid_t envid, unsigned pn)
{
  ...
  801113:	25 02 08 00 00       	and    $0x802,%eax
{
	int r;
	...
	pte_t  PTE= uvpt[PGNUM(pn*PGSIZE)];
	int perm = PTE_U|PTE_P;
  801118:	83 f8 01             	cmp    $0x1,%eax
  80111b:	19 db                	sbb    %ebx,%ebx
  80111d:	81 e3 00 f8 ff ff    	and    $0xfffff800,%ebx
  801123:	81 c3 05 08 00 00    	add    $0x805,%ebx
	if((PTE & PTE_W) || (PTE & PTE_COW))
		perm |= PTE_COW;
	
	if( (	r =sys_page_map(sys_getenvid(), (void*)(pn*PGSIZE), envid, (void*)(pn*PGSIZE), perm)) 
  801129:	e8 17 fb ff ff       	call   800c45 <sys_getenvid>
  80112e:	89 5c 24 10          	mov    %ebx,0x10(%esp)
  801132:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801136:	8b 4d e0             	mov    -0x20(%ebp),%ecx
  801139:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  80113d:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801141:	89 04 24             	mov    %eax,(%esp)
  801144:	e8 8e fb ff ff       	call   800cd7 <sys_page_map>
  801149:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  80114c:	85 c0                	test   %eax,%eax
  80114e:	78 35                	js     801185 <fork+0x196>
						<0)  
		return r;

	if( (	r =sys_page_map(sys_getenvid(), (void*)(pn*PGSIZE), sys_getenvid(), (void*)(pn*PGSIZE), perm)) 
  801150:	e8 f0 fa ff ff       	call   800c45 <sys_getenvid>
  801155:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  801158:	e8 e8 fa ff ff       	call   800c45 <sys_getenvid>
  80115d:	89 5c 24 10          	mov    %ebx,0x10(%esp)
  801161:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801165:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
  801168:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80116c:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801170:	89 04 24             	mov    %eax,(%esp)
  801173:	e8 5f fb ff ff       	call   800cd7 <sys_page_map>
  801178:	85 c0                	test   %eax,%eax
  80117a:	bf 00 00 00 00       	mov    $0x0,%edi
  80117f:	0f 4f c7             	cmovg  %edi,%eax
  801182:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		//build experition stack for the child env
			...
			if(r <0)
  801185:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  801189:	79 23                	jns    8011ae <fork+0x1bf>
  80118b:	8b 7d e4             	mov    -0x1c(%ebp),%edi
				panic("fork() is wrong, and the errno is %d\n", r) ;
  80118e:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801192:	c7 44 24 08 00 1a 80 	movl   $0x801a00,0x8(%esp)
  801199:	00 
  80119a:	c7 44 24 04 98 00 00 	movl   $0x98,0x4(%esp)
  8011a1:	00 
  8011a2:	c7 04 24 83 18 80 00 	movl   $0x801883,(%esp)
  8011a9:	e8 76 00 00 00       	call   801224 <_panic>
	if(r < 0)
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
  ...
  8011b2:	81 c6 00 10 00 00    	add    $0x1000,%esi
  8011b8:	81 fe 00 10 c0 ee    	cmp    $0xeec01000,%esi
  8011be:	0f 85 de fe ff ff    	jne    8010a2 <fork+0xb3>
				r = duppage(childEid, pn);
			if(r <0)
				panic("fork() is wrong, and the errno is %d\n", r) ;
		}
  ...
  8011c4:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  8011cb:	00 
  8011cc:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8011cf:	89 04 24             	mov    %eax,(%esp)
  8011d2:	e8 a6 fb ff ff       	call   800d7d <sys_env_set_status>
  8011d7:	85 c0                	test   %eax,%eax
  8011d9:	79 1c                	jns    8011f7 <fork+0x208>
		panic("sys_env_set_status");
  8011db:	c7 44 24 08 8e 18 80 	movl   $0x80188e,0x8(%esp)
  8011e2:	00 
  8011e3:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
  8011ea:	00 
  8011eb:	c7 04 24 83 18 80 00 	movl   $0x801883,(%esp)
  8011f2:	e8 2d 00 00 00       	call   801224 <_panic>
	return childEid;
}
  8011f7:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8011fa:	83 c4 2c             	add    $0x2c,%esp
  8011fd:	5b                   	pop    %ebx
  8011fe:	5e                   	pop    %esi
  8011ff:	5f                   	pop    %edi
  801200:	5d                   	pop    %ebp
...
sfork(void)
{
  ...
  801208:	c7 44 24 08 a1 18 80 	movl   $0x8018a1,0x8(%esp)
  80120f:	00 
  801210:	c7 44 24 04 a4 00 00 	movl   $0xa4,0x4(%esp)
  801217:	00 
  801218:	c7 04 24 83 18 80 00 	movl   $0x801883,(%esp)
  80121f:	e8 00 00 00 00       	call   801224 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801229:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  80122c:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80122f:	8b 35 00 20 80 00    	mov    0x802000,%esi
  801235:	e8 0b fa ff ff       	call   800c45 <sys_getenvid>
  ...
  801248:	89 74 24 08          	mov    %esi,0x8(%esp)
  80124c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801250:	c7 04 24 28 1a 80 00 	movl   $0x801a28,(%esp)
  801257:	e8 96 ef ff ff       	call   8001f2 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80125c:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801260:	8b 45 10             	mov    0x10(%ebp),%eax
  801263:	89 04 24             	mov    %eax,(%esp)
  801266:	e8 26 ef ff ff       	call   800191 <vcprintf>
	cprintf("\n");
  80126b:	c7 04 24 ef 15 80 00 	movl   $0x8015ef,(%esp)
  801272:	e8 7b ef ff ff       	call   8001f2 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  801277:	cc                   	int3   
  801278:	eb fd                	jmp    801277 <_panic+0x53>

0080127a <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801280:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  801287:	75 44                	jne    8012cd <set_pgfault_handler+0x53>
		// First time through!
		// LAB 4: Your code here.
		void* addr = (void*) (UXSTACKTOP-PGSIZE);
		r=sys_page_alloc(thisenv->env_id, addr, PTE_W|PTE_U|PTE_P);
  801289:	a1 04 20 80 00       	mov    0x802004,%eax
  80128e:	8b 40 48             	mov    0x48(%eax),%eax
  801291:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  801298:	00 
  801299:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  8012a0:	ee 
  8012a1:	89 04 24             	mov    %eax,(%esp)
  8012a4:	e8 da f9 ff ff       	call   800c83 <sys_page_alloc>
		if( r < 0)
  8012a9:	85 c0                	test   %eax,%eax
  8012ab:	79 20                	jns    8012cd <set_pgfault_handler+0x53>
			panic("No memory for the UxStack, the mistake is %d\n",r);
  8012ad:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8012b1:	c7 44 24 08 4c 1a 80 	movl   $0x801a4c,0x8(%esp)
  8012b8:	00 
  8012b9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8012c0:	00 
  8012c1:	c7 04 24 a8 1a 80 00 	movl   $0x801aa8,(%esp)
  8012c8:	e8 57 ff ff ff       	call   801224 <_panic>
  ...
  8012d0:	a3 08 20 80 00       	mov    %eax,0x802008
	if(( r= sys_env_set_pgfault_upcall(sys_getenvid(), _pgfault_upcall))<0)
  8012d5:	e8 6b f9 ff ff       	call   800c45 <sys_getenvid>
  8012da:	c7 44 24 04 10 13 80 	movl   $0x801310,0x4(%esp)
  8012e1:	00 
  8012e2:	89 04 24             	mov    %eax,(%esp)
  8012e5:	e8 e6 fa ff ff       	call   800dd0 <sys_env_set_pgfault_upcall>
  8012ea:	85 c0                	test   %eax,%eax
  8012ec:	79 20                	jns    80130e <set_pgfault_handler+0x94>
		panic("sys_env_set_pgfault_upcall is not right %d\n", r);
  8012ee:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8012f2:	c7 44 24 08 7c 1a 80 	movl   $0x801a7c,0x8(%esp)
  8012f9:	00 
  8012fa:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  801301:	00 
  801302:	c7 04 24 a8 1a 80 00 	movl   $0x801aa8,(%esp)
  801309:	e8 16 ff ff ff       	call   801224 <_panic>
...
_pgfault_upcall:
  ...
  801318:	83 c4 04             	add    $0x4,%esp
	...
	//	trap-eip -> eax
		movl 0x28(%esp), %eax
  80131b:	8b 44 24 28          	mov    0x28(%esp),%eax
	//	trap-ebp-> ebx		
		movl 0x10(%esp), %ebx
  80131f:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	//  trap->esp -> ecx 
		movl 0x30(%esp), %ecx
  801323:	8b 4c 24 30          	mov    0x30(%esp),%ecx

		movl %eax, -0x4(%ecx)
  801327:	89 41 fc             	mov    %eax,-0x4(%ecx)
		movl %ebx, -0x8(%ecx)
  80132a:	89 59 f8             	mov    %ebx,-0x8(%ecx)

		leal -0x8(%ecx), %ebp
  80132d:	8d 69 f8             	lea    -0x8(%ecx),%ebp

		movl 0x8(%esp), %edi
  801330:	8b 7c 24 08          	mov    0x8(%esp),%edi
		movl 0xc(%esp),	%esi
  801334:	8b 74 24 0c          	mov    0xc(%esp),%esi
		movl 0x18(%esp),%ebx
  801338:	8b 5c 24 18          	mov    0x18(%esp),%ebx
		movl 0x1c(%esp),%edx
  80133c:	8b 54 24 1c          	mov    0x1c(%esp),%edx
		movl 0x20(%esp),%ecx
  801340:	8b 4c 24 20          	mov    0x20(%esp),%ecx
		movl 0x24(%esp),%eax
  801344:	8b 44 24 24          	mov    0x24(%esp),%eax
	...
	// LAB 4: Your code here.
		leal 0x2c(%esp), %esp
  801348:	8d 64 24 2c          	lea    0x2c(%esp),%esp
		popf
  80134c:	9d                   	popf   
