...
forktree(const char *cur)
{
  ...
  80004b:	c7 04 24 80 16 80 00 	movl   $0x801680,(%esp)
...
forkchild(const char *cur, char branch)
{
  ...
  8000aa:	c7 44 24 08 91 16 80 	movl   $0x801691,0x8(%esp)
  8000b1:	00 
  ...
  8000c0:	e8 e0 06 00 00       	call   8007a5 <snprintf>
	if (fork() == 0) {
  8000c5:	e8 9e 0f 00 00       	call   801068 <fork>
...
umain(int argc, char **argv)
{
  ...
  8000eb:	83 ec 18             	sub    $0x18,%esp
	forktree("");
  8000ee:	c7 04 24 90 16 80 00 	movl   $0x801690,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80027b:	e8 50 11 00 00       	call   8013d0 <__udivdi3>
  ...
  8002d0:	e8 2b 12 00 00       	call   801500 <__umoddi3>
  8002d5:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002d9:	0f be 80 a0 16 80 00 	movsbl 0x8016a0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800402:	ff 24 95 60 17 80 00 	jmp    *0x801760(,%edx,4)
  ...
  8004da:	c7 44 24 08 c1 16 80 	movl   $0x8016c1,0x8(%esp)
  8004e1:	00 
  ...
  80050f:	ba b1 16 80 00       	mov    $0x8016b1,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800c0a:	00 
  800c0b:	c7 44 24 08 e8 18 80 	movl   $0x8018e8,0x8(%esp)
  800c12:	00 
  800c13:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c1a:	00 
  800c1b:	c7 04 24 05 19 80 00 	movl   $0x801905,(%esp)
  800c22:	e8 75 06 00 00       	call   80129c <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cc9:	00 
  800cca:	c7 44 24 08 e8 18 80 	movl   $0x8018e8,0x8(%esp)
  800cd1:	00 
  800cd2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd9:	00 
  800cda:	c7 04 24 05 19 80 00 	movl   $0x801905,(%esp)
  800ce1:	e8 b6 05 00 00       	call   80129c <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d27:	00 
  800d28:	c7 44 24 08 e8 18 80 	movl   $0x8018e8,0x8(%esp)
  800d2f:	00 
  800d30:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d37:	00 
  800d38:	c7 04 24 05 19 80 00 	movl   $0x801905,(%esp)
  800d3f:	e8 58 05 00 00       	call   80129c <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d85:	00 
  800d86:	c7 44 24 08 e8 18 80 	movl   $0x8018e8,0x8(%esp)
  800d8d:	00 
  800d8e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d95:	00 
  800d96:	c7 04 24 05 19 80 00 	movl   $0x801905,(%esp)
  800d9d:	e8 fa 04 00 00       	call   80129c <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800de3:	00 
  800de4:	c7 44 24 08 e8 18 80 	movl   $0x8018e8,0x8(%esp)
  800deb:	00 
  800dec:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800df3:	00 
  800df4:	c7 04 24 05 19 80 00 	movl   $0x801905,(%esp)
  800dfb:	e8 9c 04 00 00       	call   80129c <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e41:	00 
  800e42:	c7 44 24 08 e8 18 80 	movl   $0x8018e8,0x8(%esp)
  800e49:	00 
  800e4a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e51:	00 
  800e52:	c7 04 24 05 19 80 00 	movl   $0x801905,(%esp)
  800e59:	e8 3e 04 00 00       	call   80129c <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800ed2:	00 
  800ed3:	c7 44 24 08 e8 18 80 	movl   $0x8018e8,0x8(%esp)
  800eda:	00 
  800edb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ee2:	00 
  800ee3:	c7 04 24 05 19 80 00 	movl   $0x801905,(%esp)
  800eea:	e8 ad 03 00 00       	call   80129c <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800f13:	c7 04 24 13 19 80 00 	movl   $0x801913,(%esp)
  800f1a:	e8 e4 f2 ff ff       	call   800203 <cprintf>
		cprintf("The Eip is 0x%x\n", utf->utf_eip);
  800f1f:	8b 43 28             	mov    0x28(%ebx),%eax
  800f22:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f26:	c7 04 24 23 19 80 00 	movl   $0x801923,(%esp)
  800f2d:	e8 d1 f2 ff ff       	call   800203 <cprintf>

		 panic("The err is not right of the pgfault\n ");
  800f32:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  800f39:	00 
  800f3a:	c7 44 24 04 24 00 00 	movl   $0x24,0x4(%esp)
  800f41:	00 
  800f42:	c7 04 24 34 19 80 00 	movl   $0x801934,(%esp)
  800f49:	e8 4e 03 00 00       	call   80129c <_panic>
	}
  ...
  800f5f:	c7 44 24 08 90 19 80 	movl   $0x801990,0x8(%esp)
  800f66:	00 
  800f67:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  800f6e:	00 
  800f6f:	c7 04 24 34 19 80 00 	movl   $0x801934,(%esp)
  800f76:	e8 21 03 00 00       	call   80129c <_panic>
  ...
  800f9c:	c7 44 24 08 b0 19 80 	movl   $0x8019b0,0x8(%esp)
  800fa3:	00 
  800fa4:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  800fab:	00 
  800fac:	c7 04 24 34 19 80 00 	movl   $0x801934,(%esp)
  800fb3:	e8 e4 02 00 00       	call   80129c <_panic>
  ...
  80100c:	c7 44 24 08 d8 19 80 	movl   $0x8019d8,0x8(%esp)
  801013:	00 
  801014:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  80101b:	00 
  80101c:	c7 04 24 34 19 80 00 	movl   $0x801934,(%esp)
  801023:	e8 74 02 00 00       	call   80129c <_panic>
  ...
  801045:	c7 44 24 08 08 1a 80 	movl   $0x801a08,0x8(%esp)
  80104c:	00 
  80104d:	c7 44 24 04 3b 00 00 	movl   $0x3b,0x4(%esp)
  801054:	00 
  801055:	c7 04 24 34 19 80 00 	movl   $0x801934,(%esp)
  80105c:	e8 3b 02 00 00       	call   80129c <_panic>
	return;
...
fork(void)
{
  ...
  801078:	e8 77 02 00 00       	call   8012f4 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  801094:	c7 44 24 08 3c 1a 80 	movl   $0x801a3c,0x8(%esp)
  80109b:	00 
  80109c:	c7 44 24 04 82 00 00 	movl   $0x82,0x4(%esp)
  8010a3:	00 
  8010a4:	c7 04 24 34 19 80 00 	movl   $0x801934,(%esp)
  8010ab:	e8 ec 01 00 00       	call   80129c <_panic>
	if(childEid == 0){
  ...
  8010d2:	c7 44 24 04 8c 13 80 	movl   $0x80138c,0x4(%esp)
  8010d9:	00 
  ...
  8010ef:	c7 44 24 08 70 1a 80 	movl   $0x801a70,0x8(%esp)
  8010f6:	00 
  8010f7:	c7 44 24 04 8a 00 00 	movl   $0x8a,0x4(%esp)
  8010fe:	00 
  8010ff:	c7 04 24 34 19 80 00 	movl   $0x801934,(%esp)
  801106:	e8 91 01 00 00       	call   80129c <_panic>
		thisenv = &envs[ENVX(sys_getenvid())];
		return childEid;
	}
  ...
  801190:	25 02 08 00 00       	and    $0x802,%eax
{
  ...
  80120d:	c7 44 24 08 b0 1a 80 	movl   $0x801ab0,0x8(%esp)
  801214:	00 
  801215:	c7 44 24 04 99 00 00 	movl   $0x99,0x4(%esp)
  80121c:	00 
  80121d:	c7 04 24 34 19 80 00 	movl   $0x801934,(%esp)
  801224:	e8 73 00 00 00       	call   80129c <_panic>
	if(r < 0)
		panic("sys_env_set_pgfault_upcall is not right ,and the errno is %d\n", r);
  ...
  801253:	c7 44 24 08 3f 19 80 	movl   $0x80193f,0x8(%esp)
  80125a:	00 
  80125b:	c7 44 24 04 9d 00 00 	movl   $0x9d,0x4(%esp)
  801262:	00 
  801263:	c7 04 24 34 19 80 00 	movl   $0x801934,(%esp)
  80126a:	e8 2d 00 00 00       	call   80129c <_panic>
	return childEid;
}
...
sfork(void)
{
  ...
  801280:	c7 44 24 08 52 19 80 	movl   $0x801952,0x8(%esp)
  801287:	00 
  801288:	c7 44 24 04 a5 00 00 	movl   $0xa5,0x4(%esp)
  80128f:	00 
  801290:	c7 04 24 34 19 80 00 	movl   $0x801934,(%esp)
  801297:	e8 00 00 00 00       	call   80129c <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8012a1:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  8012a4:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8012a7:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  8012ad:	e8 82 f9 ff ff       	call   800c34 <sys_getenvid>
  8012b2:	8b 55 0c             	mov    0xc(%ebp),%edx
  8012b5:	89 54 24 10          	mov    %edx,0x10(%esp)
  8012b9:	8b 55 08             	mov    0x8(%ebp),%edx
  8012bc:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8012c0:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8012c4:	89 44 24 04          	mov    %eax,0x4(%esp)
  8012c8:	c7 04 24 d8 1a 80 00 	movl   $0x801ad8,(%esp)
  ...
  8012de:	e8 bf ee ff ff       	call   8001a2 <vcprintf>
	cprintf("\n");
  8012e3:	c7 04 24 8f 16 80 00 	movl   $0x80168f,(%esp)
  8012ea:	e8 14 ef ff ff       	call   800203 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8012ef:	cc                   	int3   
  8012f0:	eb fd                	jmp    8012ef <_panic+0x53>
	...
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8012fa:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  801301:	75 44                	jne    801347 <set_pgfault_handler+0x53>
		// First time through!
		// LAB 4: Your code here.
		void* addr = (void*) (UXSTACKTOP-PGSIZE);
		r=sys_page_alloc(thisenv->env_id, addr, PTE_W|PTE_U|PTE_P);
  801303:	a1 04 20 80 00       	mov    0x802004,%eax
  ...
  80131e:	e8 71 f9 ff ff       	call   800c94 <sys_page_alloc>
		if( r < 0)
  801323:	85 c0                	test   %eax,%eax
  801325:	79 20                	jns    801347 <set_pgfault_handler+0x53>
			panic("No memory for the UxStack, the mistake is %d\n",r);
  801327:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80132b:	c7 44 24 08 fc 1a 80 	movl   $0x801afc,0x8(%esp)
  801332:	00 
  801333:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80133a:	00 
  80133b:	c7 04 24 58 1b 80 00 	movl   $0x801b58,(%esp)
  801342:	e8 55 ff ff ff       	call   80129c <_panic>
  ...
  80134a:	a3 08 20 80 00       	mov    %eax,0x802008
	if(( r= sys_env_set_pgfault_upcall(sys_getenvid(), _pgfault_upcall))<0)
  80134f:	e8 e0 f8 ff ff       	call   800c34 <sys_getenvid>
  801354:	c7 44 24 04 8c 13 80 	movl   $0x80138c,0x4(%esp)
  80135b:	00 
  80135c:	89 04 24             	mov    %eax,(%esp)
  80135f:	e8 a9 fa ff ff       	call   800e0d <sys_env_set_pgfault_upcall>
  801364:	85 c0                	test   %eax,%eax
  801366:	79 20                	jns    801388 <set_pgfault_handler+0x94>
		panic("sys_env_set_pgfault_upcall is not right %d\n", r);
  801368:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80136c:	c7 44 24 08 2c 1b 80 	movl   $0x801b2c,0x8(%esp)
  801373:	00 
  801374:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  80137b:	00 
  80137c:	c7 04 24 58 1b 80 00 	movl   $0x801b58,(%esp)
  801383:	e8 14 ff ff ff       	call   80129c <_panic>
...
_pgfault_upcall:
  ...
  80138d:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  801394:	83 c4 04             	add    $0x4,%esp
	...
	//	trap-eip -> eax
		movl 0x28(%esp), %eax
  801397:	8b 44 24 28          	mov    0x28(%esp),%eax
	//	trap-ebp-> ebx		
		movl 0x10(%esp), %ebx
  80139b:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	//  trap->esp -> ecx 
		movl 0x30(%esp), %ecx
  80139f:	8b 4c 24 30          	mov    0x30(%esp),%ecx

		movl %eax, -0x4(%ecx)
  8013a3:	89 41 fc             	mov    %eax,-0x4(%ecx)
		movl %ebx, -0x8(%ecx)
  8013a6:	89 59 f8             	mov    %ebx,-0x8(%ecx)

		leal -0x8(%ecx), %ebp
  8013a9:	8d 69 f8             	lea    -0x8(%ecx),%ebp

		movl 0x8(%esp), %edi
  8013ac:	8b 7c 24 08          	mov    0x8(%esp),%edi
		movl 0xc(%esp),	%esi
  8013b0:	8b 74 24 0c          	mov    0xc(%esp),%esi
		movl 0x18(%esp),%ebx
  8013b4:	8b 5c 24 18          	mov    0x18(%esp),%ebx
		movl 0x1c(%esp),%edx
  8013b8:	8b 54 24 1c          	mov    0x1c(%esp),%edx
		movl 0x20(%esp),%ecx
  8013bc:	8b 4c 24 20          	mov    0x20(%esp),%ecx
		movl 0x24(%esp),%eax
  8013c0:	8b 44 24 24          	mov    0x24(%esp),%eax
	...
	// LAB 4: Your code here.
		leal 0x2c(%esp), %esp
  8013c4:	8d 64 24 2c          	lea    0x2c(%esp),%esp
		popf
  8013c8:	9d                   	popf   
