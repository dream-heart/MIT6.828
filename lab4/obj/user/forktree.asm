...
forktree(const char *cur)
{
  ...
  80003b:	8b 5d 08             	mov    0x8(%ebp),%ebx
	cprintf("%04x: I am '%s'\n", sys_getenvid(), cur);
  80003e:	e8 12 0c 00 00       	call   800c55 <sys_getenvid>
  800043:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800047:	89 44 24 04          	mov    %eax,0x4(%esp)
  80004b:	c7 04 24 00 12 80 00 	movl   $0x801200,(%esp)
  800052:	e8 ab 01 00 00       	call   800202 <cprintf>
...
forkchild(const char *cur, char branch)
{
  ...
  800093:	e8 a8 07 00 00       	call   800840 <strlen>
  ...
  8000aa:	c7 44 24 08 11 12 80 	movl   $0x801211,0x8(%esp)
  8000b1:	00 
  8000b2:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
  8000b9:	00 
  8000ba:	8d 45 f4             	lea    -0xc(%ebp),%eax
  8000bd:	89 04 24             	mov    %eax,(%esp)
  8000c0:	e8 53 07 00 00       	call   800818 <snprintf>
	if (fork() == 0) {
  8000c5:	e8 de 0d 00 00       	call   800ea8 <fork>
  ...
  8000d4:	e8 5b ff ff ff       	call   800034 <forktree>
		exit();
  8000d9:	e8 6d 00 00 00       	call   80014b <exit>
	}
}
...
umain(int argc, char **argv)
{
  ...
  8000eb:	83 ec 18             	sub    $0x18,%esp
	forktree("");
  8000ee:	c7 04 24 10 12 80 00 	movl   $0x801210,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  80010e:	e8 42 0b 00 00       	call   800c55 <sys_getenvid>
...
exit(void)
{
  ...
  800158:	e8 a6 0a 00 00       	call   800c03 <sys_env_destroy>
}
  80015d:	c9                   	leave  
  80015e:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  80018c:	e8 35 0a 00 00       	call   800bc6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8001d6:	c7 04 24 5f 01 80 00 	movl   $0x80015f,(%esp)
  8001dd:	e8 72 01 00 00       	call   800354 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  8001f5:	e8 cc 09 00 00       	call   800bc6 <sys_cputs>
...
cprintf(const char *fmt, ...)
{
  ...
  800215:	e8 87 ff ff ff       	call   8001a1 <vcprintf>
	va_end(ap);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80028f:	e8 bc 0c 00 00       	call   800f50 <__udivdi3>
  ...
  8002ef:	e8 8c 0d 00 00       	call   801080 <__umoddi3>
  8002f4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002f8:	0f be 80 20 12 80 00 	movsbl 0x801220(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003df:	ff 24 95 e0 12 80 00 	jmp    *0x8012e0(,%edx,4)
  ...
  8004bb:	c7 44 24 08 41 12 80 	movl   $0x801241,0x8(%esp)
  8004c2:	00 
  ...
  8004eb:	b8 31 12 80 00       	mov    $0x801231,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c30:	00 
  800c31:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800c38:	00 
  800c39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c40:	00 
  800c41:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800c48:	e8 9f 02 00 00       	call   800eec <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cc2:	00 
  800cc3:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800cca:	00 
  800ccb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd2:	00 
  800cd3:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800cda:	e8 0d 02 00 00       	call   800eec <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d15:	00 
  800d16:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800d1d:	00 
  800d1e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d25:	00 
  800d26:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800d2d:	e8 ba 01 00 00       	call   800eec <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d68:	00 
  800d69:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800d70:	00 
  800d71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d78:	00 
  800d79:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800d80:	e8 67 01 00 00       	call   800eec <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dbb:	00 
  800dbc:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800dc3:	00 
  800dc4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dcb:	00 
  800dcc:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800dd3:	e8 14 01 00 00       	call   800eec <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e0e:	00 
  800e0f:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800e16:	00 
  800e17:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e1e:	00 
  800e1f:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800e26:	e8 c1 00 00 00       	call   800eec <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e83:	00 
  800e84:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800e8b:	00 
  800e8c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e93:	00 
  800e94:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  800e9b:	e8 4c 00 00 00       	call   800eec <_panic>
...
fork(void)
{
  ...
  800eae:	c7 44 24 08 9f 14 80 	movl   $0x80149f,0x8(%esp)
  800eb5:	00 
  800eb6:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  800ebd:	00 
  800ebe:	c7 04 24 93 14 80 00 	movl   $0x801493,(%esp)
  800ec5:	e8 22 00 00 00       	call   800eec <_panic>
...
sfork(void)
{
  ...
  800ed0:	c7 44 24 08 9e 14 80 	movl   $0x80149e,0x8(%esp)
  800ed7:	00 
  800ed8:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800edf:	00 
  800ee0:	c7 04 24 93 14 80 00 	movl   $0x801493,(%esp)
  800ee7:	e8 00 00 00 00       	call   800eec <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ef1:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800ef4:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800ef7:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800efd:	e8 53 fd ff ff       	call   800c55 <sys_getenvid>
  800f02:	8b 55 0c             	mov    0xc(%ebp),%edx
  800f05:	89 54 24 10          	mov    %edx,0x10(%esp)
  800f09:	8b 55 08             	mov    0x8(%ebp),%edx
  800f0c:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800f10:	89 74 24 08          	mov    %esi,0x8(%esp)
  800f14:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f18:	c7 04 24 b4 14 80 00 	movl   $0x8014b4,(%esp)
  800f1f:	e8 de f2 ff ff       	call   800202 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800f24:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800f28:	8b 45 10             	mov    0x10(%ebp),%eax
  800f2b:	89 04 24             	mov    %eax,(%esp)
  800f2e:	e8 6e f2 ff ff       	call   8001a1 <vcprintf>
	cprintf("\n");
  800f33:	c7 04 24 0f 12 80 00 	movl   $0x80120f,(%esp)
  800f3a:	e8 c3 f2 ff ff       	call   800202 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800f3f:	cc                   	int3   
  800f40:	eb fd                	jmp    800f3f <_panic+0x53>
	...
