...
umain(int argc, char **argv)
{
  ...
  800054:	c7 04 24 e0 10 80 00 	movl   $0x8010e0,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 f8 10 80 00 	movsbl 0x8010f8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003eb:	c7 44 24 08 10 11 80 	movl   $0x801110,0x8(%esp)
  8003f2:	00 
  ...
  80040b:	c7 44 24 08 19 11 80 	movl   $0x801119,0x8(%esp)
  800412:	00 
  ...
  80043b:	b8 09 11 80 00       	mov    $0x801109,%eax
