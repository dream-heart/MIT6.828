...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80033f:	ff 24 95 e0 11 80 00 	jmp    *0x8011e0(,%edx,4)
  ...
  80041b:	c7 44 24 08 39 11 80 	movl   $0x801139,0x8(%esp)
  800422:	00 
  ...
  80044b:	b8 29 11 80 00       	mov    $0x801129,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b90:	00 
  800b91:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800b98:	00 
  800b99:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ba0:	00 
  800ba1:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c22:	00 
  800c23:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800c2a:	00 
  800c2b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c32:	00 
  800c33:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c75:	00 
  800c76:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800c7d:	00 
  800c7e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c85:	00 
  800c86:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cc8:	00 
  800cc9:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800cd0:	00 
  800cd1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd8:	00 
  800cd9:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d1b:	00 
  800d1c:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800d23:	00 
  800d24:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d2b:	00 
  800d2c:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d6e:	00 
  800d6f:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800d76:	00 
  800d77:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d7e:	00 
  800d7f:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800de3:	00 
  800de4:	c7 44 24 08 68 13 80 	movl   $0x801368,0x8(%esp)
  800deb:	00 
  800dec:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800df3:	00 
  800df4:	c7 04 24 85 13 80 00 	movl   $0x801385,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e34:	c7 04 24 94 13 80 00 	movl   $0x801394,(%esp)
  800e3b:	e8 21 f3 ff ff       	call   800161 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e40:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800e44:	8b 45 10             	mov    0x10(%ebp),%eax
  800e47:	89 04 24             	mov    %eax,(%esp)
  800e4a:	e8 b1 f2 ff ff       	call   800100 <vcprintf>
	cprintf("\n");
  800e4f:	c7 04 24 0c 11 80 00 	movl   $0x80110c,(%esp)
  800e56:	e8 06 f3 ff ff       	call   800161 <cprintf>
