	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80021f:	e8 ac 0c 00 00       	call   800ed0 <__udivdi3>
  ...
  80027f:	e8 7c 0d 00 00       	call   801000 <__umoddi3>
  800284:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800288:	0f be 80 86 11 80 00 	movsbl 0x801186(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80036f:	ff 24 95 40 12 80 00 	jmp    *0x801240(,%edx,4)
  ...
  80044b:	c7 44 24 08 a7 11 80 	movl   $0x8011a7,0x8(%esp)
  800452:	00 
  ...
  80047b:	b8 97 11 80 00       	mov    $0x801197,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bc0:	00 
  800bc1:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800bc8:	00 
  800bc9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bd0:	00 
  800bd1:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800bd8:	e8 90 02 00 00       	call   800e6d <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c52:	00 
  800c53:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800c5a:	00 
  800c5b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c62:	00 
  800c63:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800c6a:	e8 fe 01 00 00       	call   800e6d <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800ca5:	00 
  800ca6:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800cad:	00 
  800cae:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb5:	00 
  800cb6:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800cbd:	e8 ab 01 00 00       	call   800e6d <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cf8:	00 
  800cf9:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800d00:	00 
  800d01:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d08:	00 
  800d09:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800d10:	e8 58 01 00 00       	call   800e6d <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d4b:	00 
  800d4c:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800d53:	00 
  800d54:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d5b:	00 
  800d5c:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800d63:	e8 05 01 00 00       	call   800e6d <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d9e:	00 
  800d9f:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800da6:	00 
  800da7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dae:	00 
  800daf:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800db6:	e8 b2 00 00 00       	call   800e6d <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e13:	00 
  800e14:	c7 44 24 08 c8 13 80 	movl   $0x8013c8,0x8(%esp)
  800e1b:	00 
  800e1c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e23:	00 
  800e24:	c7 04 24 e5 13 80 00 	movl   $0x8013e5,(%esp)
  800e2b:	e8 3d 00 00 00       	call   800e6d <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e45:	75 1c                	jne    800e63 <set_pgfault_handler+0x2b>
		// First time through!
		// LAB 4: Your code here.
		panic("set_pgfault_handler not implemented");
  800e47:	c7 44 24 08 f4 13 80 	movl   $0x8013f4,0x8(%esp)
  800e4e:	00 
  800e4f:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  800e56:	00 
  800e57:	c7 04 24 18 14 80 00 	movl   $0x801418,(%esp)
  800e5e:	e8 0a 00 00 00       	call   800e6d <_panic>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  800e63:	8b 45 08             	mov    0x8(%ebp),%eax
  800e66:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800e6b:	c9                   	leave  
  800e6c:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e70:	56                   	push   %esi
  800e71:	53                   	push   %ebx
  800e72:	83 ec 20             	sub    $0x20,%esp
	va_list ap;

	va_start(ap, fmt);
  800e75:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800e78:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800e7e:	e8 62 fd ff ff       	call   800be5 <sys_getenvid>
  800e83:	8b 55 0c             	mov    0xc(%ebp),%edx
  800e86:	89 54 24 10          	mov    %edx,0x10(%esp)
  ...
  800e99:	c7 04 24 28 14 80 00 	movl   $0x801428,(%esp)
  800ea0:	e8 ec f2 ff ff       	call   800191 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800ea5:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800ea9:	8b 45 10             	mov    0x10(%ebp),%eax
  800eac:	89 04 24             	mov    %eax,(%esp)
  800eaf:	e8 7c f2 ff ff       	call   800130 <vcprintf>
	cprintf("\n");
  800eb4:	c7 04 24 7a 11 80 00 	movl   $0x80117a,(%esp)
  800ebb:	e8 d1 f2 ff ff       	call   800191 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800ec0:	cc                   	int3   
  800ec1:	eb fd                	jmp    800ec0 <_panic+0x53>
