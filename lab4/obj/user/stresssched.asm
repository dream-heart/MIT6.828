...
umain(int argc, char **argv)
{
  ...
  800048:	e8 58 0c 00 00       	call   800ca5 <sys_getenvid>
  ...
  80004f:	bb 00 00 00 00       	mov    $0x0,%ebx
		if (fork() == 0)
  800054:	e8 9f 0e 00 00       	call   800ef8 <fork>
  ...
  80007b:	eb 0c                	jmp    800089 <umain+0x49>
	...
	if (i == 20) {
		sys_yield();
  80007d:	e8 42 0c 00 00       	call   800cc4 <sys_yield>
		return;
  ...
  800092:	bb 0a 00 00 00       	mov    $0xa,%ebx
	...
	for (i = 0; i < 10; i++) {
		sys_yield();
  800097:	e8 28 0c 00 00       	call   800cc4 <sys_yield>
  ...
  8000e6:	e8 6f 00 00 00       	call   80015a <_panic>
  ...
  800105:	e8 49 01 00 00       	call   800253 <cprintf>
...
libmain(int argc, char **argv)
{
  ...
  80011a:	8b 55 0c             	mov    0xc(%ebp),%edx
	...
	thisenv = 0;
  80011d:	c7 05 08 20 80 00 00 	movl   $0x0,0x802008
  800124:	00 00 00 

	// save the name of the program so that panic() can use it
	if (argc > 0)
  800127:	85 c0                	test   %eax,%eax
  800129:	7e 08                	jle    800133 <libmain+0x22>
		binaryname = argv[0];
  80012b:	8b 0a                	mov    (%edx),%ecx
  80012d:	89 0d 00 20 80 00    	mov    %ecx,0x802000

	// call user main routine
	umain(argc, argv);
  800133:	89 54 24 04          	mov    %edx,0x4(%esp)
  800137:	89 04 24             	mov    %eax,(%esp)
  80013a:	e8 01 ff ff ff       	call   800040 <umain>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800186:	c7 04 24 44 12 80 00 	movl   $0x801244,(%esp)
  ...
  80019c:	e8 51 00 00 00       	call   8001f2 <vcprintf>
	cprintf("\n");
  8001a1:	c7 04 24 37 12 80 00 	movl   $0x801237,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800348:	0f be 80 68 12 80 00 	movsbl 0x801268(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80042f:	ff 24 95 20 13 80 00 	jmp    *0x801320(,%edx,4)
  ...
  80050b:	c7 44 24 08 89 12 80 	movl   $0x801289,0x8(%esp)
  800512:	00 
  ...
  80053b:	b8 79 12 80 00       	mov    $0x801279,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c80:	00 
  800c81:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800c88:	00 
  800c89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c90:	00 
  800c91:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d12:	00 
  800d13:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800d1a:	00 
  800d1b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d22:	00 
  800d23:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d65:	00 
  800d66:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800d6d:	00 
  800d6e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d75:	00 
  800d76:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800db8:	00 
  800db9:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800dc0:	00 
  800dc1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dc8:	00 
  800dc9:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e0b:	00 
  800e0c:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800e13:	00 
  800e14:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e1b:	00 
  800e1c:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e5e:	00 
  800e5f:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800e66:	00 
  800e67:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e6e:	00 
  800e6f:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800ed3:	00 
  800ed4:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800edb:	00 
  800edc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ee3:	00 
  800ee4:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
fork(void)
{
  ...
  800efe:	c7 44 24 08 df 14 80 	movl   $0x8014df,0x8(%esp)
  800f05:	00 
  800f06:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  800f0d:	00 
  800f0e:	c7 04 24 d3 14 80 00 	movl   $0x8014d3,(%esp)
  800f15:	e8 40 f2 ff ff       	call   80015a <_panic>
...
sfork(void)
{
  ...
  800f20:	c7 44 24 08 de 14 80 	movl   $0x8014de,0x8(%esp)
  800f27:	00 
  800f28:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800f2f:	00 
  800f30:	c7 04 24 d3 14 80 00 	movl   $0x8014d3,(%esp)
  800f37:	e8 1e f2 ff ff       	call   80015a <_panic>
