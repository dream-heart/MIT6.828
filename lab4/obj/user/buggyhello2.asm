...
umain(int argc, char **argv)
{
  ...
  80004a:	e8 68 00 00 00       	call   8000b7 <sys_cputs>
}
  80004f:	c9                   	leave  
  800050:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  800066:	e8 db 00 00 00       	call   800146 <sys_getenvid>
...
exit(void)
{
  ...
  8000b0:	e8 3f 00 00 00       	call   8000f4 <sys_env_destroy>
}
  8000b5:	c9                   	leave  
  8000b6:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  800114:	7e 28                	jle    80013e <sys_env_destroy+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800116:	89 44 24 10          	mov    %eax,0x10(%esp)
  80011a:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800121:	00 
  800122:	c7 44 24 08 38 11 80 	movl   $0x801138,0x8(%esp)
  800129:	00 
  80012a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800131:	00 
  800132:	c7 04 24 55 11 80 00 	movl   $0x801155,(%esp)
  800139:	e8 5b 02 00 00       	call   800399 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001a6:	7e 28                	jle    8001d0 <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001a8:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001ac:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  8001b3:	00 
  8001b4:	c7 44 24 08 38 11 80 	movl   $0x801138,0x8(%esp)
  8001bb:	00 
  8001bc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001c3:	00 
  8001c4:	c7 04 24 55 11 80 00 	movl   $0x801155,(%esp)
  8001cb:	e8 c9 01 00 00       	call   800399 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001f9:	7e 28                	jle    800223 <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001fb:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001ff:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  800206:	00 
  800207:	c7 44 24 08 38 11 80 	movl   $0x801138,0x8(%esp)
  80020e:	00 
  80020f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800216:	00 
  800217:	c7 04 24 55 11 80 00 	movl   $0x801155,(%esp)
  80021e:	e8 76 01 00 00       	call   800399 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80024c:	7e 28                	jle    800276 <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80024e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800252:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800259:	00 
  80025a:	c7 44 24 08 38 11 80 	movl   $0x801138,0x8(%esp)
  800261:	00 
  800262:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800269:	00 
  80026a:	c7 04 24 55 11 80 00 	movl   $0x801155,(%esp)
  800271:	e8 23 01 00 00       	call   800399 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80029f:	7e 28                	jle    8002c9 <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002a1:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002a5:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  8002ac:	00 
  8002ad:	c7 44 24 08 38 11 80 	movl   $0x801138,0x8(%esp)
  8002b4:	00 
  8002b5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002bc:	00 
  8002bd:	c7 04 24 55 11 80 00 	movl   $0x801155,(%esp)
  8002c4:	e8 d0 00 00 00       	call   800399 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002f2:	7e 28                	jle    80031c <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002f4:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002f8:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8002ff:	00 
  800300:	c7 44 24 08 38 11 80 	movl   $0x801138,0x8(%esp)
  800307:	00 
  800308:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80030f:	00 
  800310:	c7 04 24 55 11 80 00 	movl   $0x801155,(%esp)
  800317:	e8 7d 00 00 00       	call   800399 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  80032f:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  800355:	b8 0c 00 00 00       	mov    $0xc,%eax
  80035a:	8b 55 08             	mov    0x8(%ebp),%edx
  80035d:	89 cb                	mov    %ecx,%ebx
  80035f:	89 cf                	mov    %ecx,%edi
  800361:	89 ce                	mov    %ecx,%esi
  ...
  800367:	7e 28                	jle    800391 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800369:	89 44 24 10          	mov    %eax,0x10(%esp)
  80036d:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  800374:	00 
  800375:	c7 44 24 08 38 11 80 	movl   $0x801138,0x8(%esp)
  80037c:	00 
  80037d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800384:	00 
  800385:	c7 04 24 55 11 80 00 	movl   $0x801155,(%esp)
  80038c:	e8 08 00 00 00       	call   800399 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80039c:	56                   	push   %esi
  80039d:	53                   	push   %ebx
  80039e:	83 ec 20             	sub    $0x20,%esp
	va_list ap;

	va_start(ap, fmt);
  8003a1:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8003a4:	8b 35 04 20 80 00    	mov    0x802004,%esi
  8003aa:	e8 97 fd ff ff       	call   800146 <sys_getenvid>
  8003af:	8b 55 0c             	mov    0xc(%ebp),%edx
  8003b2:	89 54 24 10          	mov    %edx,0x10(%esp)
  8003b6:	8b 55 08             	mov    0x8(%ebp),%edx
  8003b9:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8003bd:	89 74 24 08          	mov    %esi,0x8(%esp)
  8003c1:	89 44 24 04          	mov    %eax,0x4(%esp)
  8003c5:	c7 04 24 64 11 80 00 	movl   $0x801164,(%esp)
  8003cc:	e8 c1 00 00 00       	call   800492 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8003d1:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8003d5:	8b 45 10             	mov    0x10(%ebp),%eax
  8003d8:	89 04 24             	mov    %eax,(%esp)
  8003db:	e8 51 00 00 00       	call   800431 <vcprintf>
	cprintf("\n");
  8003e0:	c7 04 24 2c 11 80 00 	movl   $0x80112c,(%esp)
  8003e7:	e8 a6 00 00 00       	call   800492 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8003ec:	cc                   	int3   
  8003ed:	eb fd                	jmp    8003ec <_panic+0x53>
...
putch(int ch, struct printbuf *b)
{
  ...
  80040c:	75 19                	jne    800427 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  80040e:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800415:	00 
  800416:	8d 43 08             	lea    0x8(%ebx),%eax
  800419:	89 04 24             	mov    %eax,(%esp)
  80041c:	e8 96 fc ff ff       	call   8000b7 <sys_cputs>
		b->idx = 0;
  800421:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  800427:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800434:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  800451:	89 44 24 0c          	mov    %eax,0xc(%esp)
  ...
  800466:	c7 04 24 ef 03 80 00 	movl   $0x8003ef,(%esp)
  80046d:	e8 72 01 00 00       	call   8005e4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  800472:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  800478:	89 44 24 04          	mov    %eax,0x4(%esp)
  80047c:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  800482:	89 04 24             	mov    %eax,(%esp)
  800485:	e8 2d fc ff ff       	call   8000b7 <sys_cputs>

	return b.cnt;
}
  80048a:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
  800490:	c9                   	leave  
  800491:	c3                   	ret    
...
cprintf(const char *fmt, ...)
{
  ...
  8004a5:	e8 87 ff ff ff       	call   800431 <vcprintf>
	va_end(ap);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800588:	0f be 80 88 11 80 00 	movsbl 0x801188(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80072b:	c7 44 24 08 a0 11 80 	movl   $0x8011a0,0x8(%esp)
  800732:	00 
  ...
  80074b:	c7 44 24 08 a9 11 80 	movl   $0x8011a9,0x8(%esp)
  800752:	00 
  ...
  80077b:	b8 99 11 80 00       	mov    $0x801199,%eax
