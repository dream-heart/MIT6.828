...
sys_env_destroy(envid_t envid)
{
  ...
  800103:	00 
  800104:	c7 44 24 08 aa 0e 80 	movl   $0x800eaa,0x8(%esp)
  80010b:	00 
  80010c:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  800113:	00 
  800114:	c7 04 24 c7 0e 80 00 	movl   $0x800ec7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800173:	c7 04 24 d8 0e 80 00 	movl   $0x800ed8,(%esp)
  ...
  800189:	e8 51 00 00 00       	call   8001df <vcprintf>
	cprintf("\n");
  80018e:	c7 04 24 fc 0e 80 00 	movl   $0x800efc,(%esp)
