...
sys_ipc_recv(void *dstva)
{
  ...
  800353:	00 
  800354:	c7 44 24 08 ea 10 80 	movl   $0x8010ea,0x8(%esp)
  80035b:	00 
  80035c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800363:	00 
  800364:	c7 04 24 07 11 80 00 	movl   $0x801107,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8003a4:	c7 04 24 18 11 80 00 	movl   $0x801118,(%esp)
  ...
  8003ba:	e8 51 00 00 00       	call   800410 <vcprintf>
	cprintf("\n");
  8003bf:	c7 04 24 3c 11 80 00 	movl   $0x80113c,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80044c:	e8 73 01 00 00       	call   8005c4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
