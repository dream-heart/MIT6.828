...
sys_env_destroy(envid_t envid)
{
  ...
  8000ed:	00 
  8000ee:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  8000f5:	00 
  8000f6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8000fd:	00 
  8000fe:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  800105:	e8 5b 02 00 00       	call   800365 <_panic>
...
sys_yield(void)
{
  ...
  80013c:	b8 0a 00 00 00       	mov    $0xa,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800156:	83 ec 2c             	sub    $0x2c,%esp
	...
	asm volatile("int %1\n"
  800159:	be 00 00 00 00       	mov    $0x0,%esi
  ...
  800172:	7e 28                	jle    80019c <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  800174:	89 44 24 10          	mov    %eax,0x10(%esp)
  800178:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  80017f:	00 
  800180:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  800187:	00 
  800188:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80018f:	00 
  800190:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  800197:	e8 c9 01 00 00       	call   800365 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001c5:	7e 28                	jle    8001ef <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001c7:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001cb:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8001d2:	00 
  8001d3:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  8001da:	00 
  8001db:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001e2:	00 
  8001e3:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  8001ea:	e8 76 01 00 00       	call   800365 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800218:	7e 28                	jle    800242 <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80021a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80021e:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800225:	00 
  800226:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  80022d:	00 
  80022e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800235:	00 
  800236:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  80023d:	e8 23 01 00 00       	call   800365 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80026b:	7e 28                	jle    800295 <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80026d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800271:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  800278:	00 
  800279:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  800280:	00 
  800281:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800288:	00 
  800289:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  800290:	e8 d0 00 00 00       	call   800365 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002be:	7e 28                	jle    8002e8 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002c0:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002c4:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8002cb:	00 
  8002cc:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  8002d3:	00 
  8002d4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002db:	00 
  8002dc:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  8002e3:	e8 7d 00 00 00       	call   800365 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8002fb:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  800333:	7e 28                	jle    80035d <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800335:	89 44 24 10          	mov    %eax,0x10(%esp)
  800339:	c7 44 24 0c 0c 00 00 	movl   $0xc,0xc(%esp)
  800340:	00 
  800341:	c7 44 24 08 ca 10 80 	movl   $0x8010ca,0x8(%esp)
  800348:	00 
  800349:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800350:	00 
  800351:	c7 04 24 e7 10 80 00 	movl   $0x8010e7,(%esp)
  800358:	e8 08 00 00 00       	call   800365 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800376:	e8 97 fd ff ff       	call   800112 <sys_getenvid>
  80037b:	8b 55 0c             	mov    0xc(%ebp),%edx
  80037e:	89 54 24 10          	mov    %edx,0x10(%esp)
  800382:	8b 55 08             	mov    0x8(%ebp),%edx
  800385:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800389:	89 74 24 08          	mov    %esi,0x8(%esp)
  80038d:	89 44 24 04          	mov    %eax,0x4(%esp)
  800391:	c7 04 24 f8 10 80 00 	movl   $0x8010f8,(%esp)
  800398:	e8 c1 00 00 00       	call   80045e <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80039d:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8003a1:	8b 45 10             	mov    0x10(%ebp),%eax
  8003a4:	89 04 24             	mov    %eax,(%esp)
  8003a7:	e8 51 00 00 00       	call   8003fd <vcprintf>
	cprintf("\n");
  8003ac:	c7 04 24 1c 11 80 00 	movl   $0x80111c,(%esp)
  8003b3:	e8 a6 00 00 00       	call   80045e <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8003b8:	cc                   	int3   
  8003b9:	eb fd                	jmp    8003b8 <_panic+0x53>
...
putch(int ch, struct printbuf *b)
{
  ...
  8003d8:	75 19                	jne    8003f3 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8003da:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8003e1:	00 
  8003e2:	8d 43 08             	lea    0x8(%ebx),%eax
  8003e5:	89 04 24             	mov    %eax,(%esp)
  8003e8:	e8 96 fc ff ff       	call   800083 <sys_cputs>
		b->idx = 0;
  8003ed:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  8003f3:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800432:	c7 04 24 bb 03 80 00 	movl   $0x8003bb,(%esp)
  800439:	e8 76 01 00 00       	call   8005b4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800451:	e8 2d fc ff ff       	call   800083 <sys_cputs>
...
cprintf(const char *fmt, ...)
{
  ...
  800471:	e8 87 ff ff ff       	call   8003fd <vcprintf>
	va_end(ap);
