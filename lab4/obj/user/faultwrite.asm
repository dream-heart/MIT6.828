...
sys_env_destroy(envid_t envid)
{
  ...
  80013a:	00 
  80013b:	c7 44 24 08 6a 11 80 	movl   $0x80116a,0x8(%esp)
  800142:	00 
  800143:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80014a:	00 
  80014b:	c7 04 24 87 11 80 00 	movl   $0x801187,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001f9:	00 
  8001fa:	c7 44 24 08 6a 11 80 	movl   $0x80116a,0x8(%esp)
  800201:	00 
  800202:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800209:	00 
  80020a:	c7 04 24 87 11 80 00 	movl   $0x801187,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002b5:	00 
  8002b6:	c7 44 24 08 6a 11 80 	movl   $0x80116a,0x8(%esp)
  8002bd:	00 
  8002be:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002c5:	00 
  8002c6:	c7 04 24 87 11 80 00 	movl   $0x801187,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800313:	00 
  800314:	c7 44 24 08 6a 11 80 	movl   $0x80116a,0x8(%esp)
  80031b:	00 
  80031c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800323:	00 
  800324:	c7 04 24 87 11 80 00 	movl   $0x801187,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800371:	00 
  800372:	c7 44 24 08 6a 11 80 	movl   $0x80116a,0x8(%esp)
  800379:	00 
  80037a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800381:	00 
  800382:	c7 04 24 87 11 80 00 	movl   $0x801187,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800402:	00 
  800403:	c7 44 24 08 6a 11 80 	movl   $0x80116a,0x8(%esp)
  80040a:	00 
  80040b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800412:	00 
  800413:	c7 04 24 87 11 80 00 	movl   $0x801187,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800458:	c7 04 24 98 11 80 00 	movl   $0x801198,(%esp)
  ...
  80046e:	e8 53 00 00 00       	call   8004c6 <vcprintf>
	cprintf("\n");
  800473:	c7 04 24 bc 11 80 00 	movl   $0x8011bc,(%esp)
