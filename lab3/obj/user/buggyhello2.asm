...
sys_env_destroy(envid_t envid)
{
  ...
  800119:	00 
  80011a:	c7 44 24 08 d8 0e 80 	movl   $0x800ed8,0x8(%esp)
  800121:	00 
  800122:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  800129:	00 
  80012a:	c7 04 24 f5 0e 80 00 	movl   $0x800ef5,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800189:	c7 04 24 04 0f 80 00 	movl   $0x800f04,(%esp)
  ...
  80019f:	e8 51 00 00 00       	call   8001f5 <vcprintf>
	cprintf("\n");
  8001a4:	c7 04 24 cc 0e 80 00 	movl   $0x800ecc,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800348:	0f be 80 28 0f 80 00 	movsbl 0x800f28(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004eb:	c7 44 24 08 40 0f 80 	movl   $0x800f40,0x8(%esp)
  8004f2:	00 
  ...
  80050b:	c7 44 24 08 49 0f 80 	movl   $0x800f49,0x8(%esp)
  800512:	00 
  ...
  80053b:	b8 39 0f 80 00       	mov    $0x800f39,%eax
