...
sys_env_destroy(envid_t envid)
{
  ...
  800107:	00 
  800108:	c7 44 24 08 aa 0e 80 	movl   $0x800eaa,0x8(%esp)
  80010f:	00 
  800110:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  800117:	00 
  800118:	c7 04 24 c7 0e 80 00 	movl   $0x800ec7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800177:	c7 04 24 d8 0e 80 00 	movl   $0x800ed8,(%esp)
  ...
  80018d:	e8 51 00 00 00       	call   8001e3 <vcprintf>
	cprintf("\n");
  800192:	c7 04 24 fc 0e 80 00 	movl   $0x800efc,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80021f:	e8 70 01 00 00       	call   800394 <vprintfmt>
	sys_cputs(b.buf, b.idx);
